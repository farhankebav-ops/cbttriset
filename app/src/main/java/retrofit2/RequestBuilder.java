...
final class RequestBuilder {
    ...
    public RequestBuilder(String str, HttpUrl httpUrl, String str2, Headers headers, MediaType mediaType, boolean z2, boolean z7, boolean z8) {
        this.method = str;
    ...
    private static String canonicalizeForPath(String str, boolean z2) throws EOFException {
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt < 32 || iCodePointAt >= 127 || PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) != -1 || (!z2 && (iCodePointAt == 47 || iCodePointAt == 37))) {
                j jVar = new j();
                jVar.c0(0, iCharCount, str);
                canonicalizeForPath(jVar, str, iCharCount, length, z2);
                return jVar.r();
            }
    ...
    public void addPathParam(String str, String str2, boolean z2) throws EOFException {
        ...
        if (PATH_TRAVERSAL.matcher(strReplace).matches()) {
            throw new IllegalArgumentException(a1.a.l("@Path parameters shouldn't perform path traversal ('.' or '..'): ", str2));
        }
    ...
    private static void canonicalizeForPath(j jVar, String str, int i2, int i8, boolean z2) throws EOFException {
        j jVar2 = null;
        while (i2 < i8) {
            ...
            if (!z2 || (iCodePointAt != 9 && iCodePointAt != 10 && iCodePointAt != 12 && iCodePointAt != 13)) {
                if (iCodePointAt >= 32 && iCodePointAt < 127 && PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) == -1 && (z2 || (iCodePointAt != 47 && iCodePointAt != 37))) {
                    ...
                    long j = jVar2.f12868b;
                    for (long j3 = 0; j3 < j; j3++) {
                        byte bI = jVar2.i(j3);
                        jVar.x(37);
                        char[] cArr = HEX_DIGITS;
                        jVar.x(cArr[((bI & 255) >> 4) & 15]);
                        jVar.x(cArr[bI & 15]);
                    }
                    jVar2.a();
                }
