...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return a1.a.r(new StringBuilder(), Utils.typeToString(this.componentType), _UrlKt.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static Type getParameterUpperBound(int i2, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbV = a1.a.v(i2, "Index ", " not in range [0,");
    ...
    public static boolean isUnit(Type type) {
        return checkForKotlinUnit && type == x.class;
    }
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i2, String str, Object... objArr) {
        return methodError(method, th, androidx.camera.core.processing.util.a.l(str, " (", Platform.reflection.describeMethodParameter(method, i2), ")"), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder sbX = a1.a.x(String.format(str, objArr), "\n    for method ");
    ...
    public static RuntimeException parameterError(Method method, int i2, String str, Object... objArr) {
        return methodError(method, androidx.camera.core.processing.util.a.l(str, " (", Platform.reflection.describeMethodParameter(method, i2), ")"), objArr);
    }
}
