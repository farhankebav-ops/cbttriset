...
final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i2, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                Headers headersOf = Headers.of("Content-Disposition", a1.a.m("form-data; name=\"", strValue5, "\""), "Content-Transfer-Encoding", part.encoding());
                if (!Iterable.class.isAssignableFrom(rawType8)) {
                    if (!rawType8.isArray()) {
                        if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
            ...
            for (int i8 = i2 - 1; i8 >= 0; i8--) {
                ParameterHandler<?> parameterHandler = this.parameterHandlers[i8];
                if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(clsBoxIfPrimitive2)) {
                    ...
                    sb.append(clsBoxIfPrimitive2.getName());
                    sb.append(" is duplicate of ");
                    throw Utils.parameterError(method, i2, a1.a.r(sb, Platform.reflection.describeMethodParameter(this.method, i8), " and would always overwrite its value."), new Object[0]);
                }
            }
        ...
        public RequestFactory build() {
            ...
            while (true) {
                ...
                Annotation[] annotationArr = this.parameterAnnotationsArray[i8];
                if (i8 != i2) {
                    z2 = false;
                }
                parameterHandlerArr[i8] = parseParameter(i8, type, annotationArr, z2);
                i8++;
            }
    ...
    public Request create(Object obj, Object[] objArr) throws IOException {
        ...
        if (length != parameterHandlerArr.length) {
            throw new IllegalArgumentException(a1.a.q(a1.a.v(length, "Argument count (", ") doesn't match expected count ("), ")", parameterHandlerArr.length));
        }
