...
public class OkHttpClient implements Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m3570addInterceptor(final l block) {
            k.e(block, "block");
        ...
        public final Builder m3571addNetworkInterceptor(final l block) {
            k.e(block, "block");
        ...
        public final Builder m3572callTimeoutLRDsOJo(long j) {
            this.callTimeout = _UtilJvmKt.m3600checkDurationHG0u8IE("duration", j);
            return this;
        }
        ...
        public final Builder m3573connectTimeoutLRDsOJo(long j) {
            this.connectTimeout = _UtilJvmKt.m3600checkDurationHG0u8IE("duration", j);
            return this;
        }
        ...
        public final Builder minWebSocketMessageToCompress(long j) {
            if (j < 0) {
                throw new IllegalArgumentException(androidx.camera.core.processing.util.a.j("minWebSocketMessageToCompress must be positive: ", j).toString());
            }
        ...
        public final Builder m3574pingIntervalLRDsOJo(long j) {
            this.pingInterval = _UtilJvmKt.m3600checkDurationHG0u8IE("duration", j);
            return this;
        }

        public final Builder protocols(List<? extends Protocol> protocols) {
            k.e(protocols, "protocols");
            ArrayList arrayListO1 = r5.l.o1(protocols);
            Protocol protocol = Protocol.H2_PRIOR_KNOWLEDGE;
            if (!arrayListO1.contains(protocol) && !arrayListO1.contains(Protocol.HTTP_1_1)) {
                throw new IllegalArgumentException(("protocols must contain h2_prior_knowledge or http/1.1: " + arrayListO1).toString());
            }
            if (arrayListO1.contains(protocol) && arrayListO1.size() > 1) {
            ...
            if (arrayListO1.contains(Protocol.HTTP_1_0)) {
            ...
            arrayListO1.remove(Protocol.SPDY_3);
            if (!arrayListO1.equals(this.protocols)) {
                this.routeDatabase = null;
            }
            List<? extends Protocol> listUnmodifiableList = Collections.unmodifiableList(arrayListO1);
        ...
        public final Builder m3575readTimeoutLRDsOJo(long j) {
            this.readTimeout = _UtilJvmKt.m3600checkDurationHG0u8IE("duration", j);
            return this;
        }
        ...
        public final Builder m3576webSocketCloseTimeoutLRDsOJo(long j) {
            this.webSocketCloseTimeout = _UtilJvmKt.m3600checkDurationHG0u8IE("duration", j);
            return this;
        }
        ...
        public final Builder m3577writeTimeoutLRDsOJo(long j) {
            this.writeTimeout = _UtilJvmKt.m3600checkDurationHG0u8IE("duration", j);
            return this;
        }
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            r5.l.Q0(okHttpClient.interceptors(), this.interceptors);
            r5.l.Q0(okHttpClient.networkInterceptors(), this.networkInterceptors);
