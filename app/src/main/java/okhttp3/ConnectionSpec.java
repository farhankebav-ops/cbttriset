...
public final class ConnectionSpec {
    ...
    static {
        ...
        List<CipherSuite> listH0 = m.H0(cipherSuite, cipherSuite2, cipherSuite3, cipherSuite4, cipherSuite5, cipherSuite6, cipherSuite7, cipherSuite8, cipherSuite9);
        RESTRICTED_CIPHER_SUITES = listH0;
        List<CipherSuite> listH02 = m.H0(cipherSuite, cipherSuite2, cipherSuite3, cipherSuite4, cipherSuite5, cipherSuite6, cipherSuite7, cipherSuite8, cipherSuite9, CipherSuite.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, CipherSuite.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA, CipherSuite.TLS_RSA_WITH_AES_128_GCM_SHA256, CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_RSA_WITH_AES_128_CBC_SHA, CipherSuite.TLS_RSA_WITH_AES_256_CBC_SHA, CipherSuite.TLS_RSA_WITH_3DES_EDE_CBC_SHA);
    ...
    public ConnectionSpec(boolean z2, boolean z7, String[] strArr, String[] strArr2) {
        this.isTls = z2;
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z2) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            enabledProtocols = _UtilCommonKt.intersect(enabledProtocols2, this.tlsVersionsAsString, t5.a.f17409b);
        } else {
    ...
    public final List<CipherSuite> m3487deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* JADX INFO: renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m3488deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* JADX INFO: renamed from: -deprecated_tlsVersions, reason: not valid java name */
    public final List<TlsVersion> m3489deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket socket) {
        ...
        if (strArr != null && !_UtilCommonKt.hasIntersection(strArr, socket.getEnabledProtocols(), t5.a.f17409b)) {
            return false;
        }
    ...
    public String toString() {
        ...
        return a1.a.t(sb, this.supportsTlsExtensions, ')');
    }
