...
public final class TaskRunner implements Lockable {
    ...
    public final List<TaskQueue> activeQueues() {
        ArrayList arrayListF1;
        synchronized (this) {
            arrayListF1 = l.f1(this.readyQueues, this.busyQueues);
        }
        return arrayListF1;
    }
    ...
    public final TaskQueue newQueue() {
        ...
        return new TaskQueue(this, a.g(i2, "Q"));
    }

    public /* synthetic */ TaskRunner(Backend backend, Logger logger2, int i2, f fVar) {
