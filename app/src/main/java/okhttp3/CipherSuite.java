...
public final class CipherSuite {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String a8, String b8) {
                ...
                for (int i2 = 4; i2 < iMin; i2++) {
                    char cCharAt = a8.charAt(i2);
                    char cCharAt2 = b8.charAt(i2);
                    if (cCharAt != cCharAt2) {
                        return k.g(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public final String m3486deprecated_javaName() {
