...
public final class j implements l {
    ...
    public final void onMessageChannelReady(c cVar, Bundle bundle) {
        ...
        try {
            parcelObtain.writeInterfaceToken(l.f3237u6);
            ...
            this.f3236a.transact(2, parcelObtain, parcelObtain2, 0);
    ...
    public final void onPostMessage(c cVar, String str, Bundle bundle) {
        ...
        try {
            ...
            this.f3236a.transact(3, parcelObtain, parcelObtain2, 0);
            parcelObtain2.readException();
        } finally {
            parcelObtain2.recycle();
            parcelObtain.recycle();
