...
public final class m extends e<sg.bigo.ads.controller.a.f> {
    public m(@NonNull Map<String, Object> map, @NonNull sg.bigo.ads.common.g gVar, @NonNull sg.bigo.ads.controller.a.b bVar, @NonNull sg.bigo.ads.controller.b bVar2) {
    ...
    public final long e() {
        ...
        return bVar != null ? bVar.f16310a.l.e : super.e();
    }

    @Override // sg.bigo.ads.controller.g.a
    @NonNull
    public final /* synthetic */ sg.bigo.ads.common.u.a f() {
        return this.f16653c.b("/Ad/ReportUniBaina", null);
    }
    ...
    public final boolean j() {
        return sg.bigo.ads.api.a.i.f15457a.f() && sg.bigo.ads.common.x.a.B();
    }
}
