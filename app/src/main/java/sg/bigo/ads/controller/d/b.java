...
public final class b extends a {
    public b(@NonNull g gVar, @NonNull sg.bigo.ads.controller.a.b bVar) {
        super(gVar, bVar);
    }

    @Override // sg.bigo.ads.common.j
    public final void a(@NonNull Map<String, Object> map, final j.a aVar) {
        new sg.bigo.ads.controller.g.f(map, this.f16527a, this.f16528b, new sg.bigo.ads.controller.b() { // from class: sg.bigo.ads.controller.d.b.1
