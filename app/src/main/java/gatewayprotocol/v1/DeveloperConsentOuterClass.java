...
public final class DeveloperConsentOuterClass {
    ...
    public static final class DeveloperConsent extends GeneratedMessageLite<DeveloperConsent, Builder> implements DeveloperConsentOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DeveloperConsent, Builder> implements DeveloperConsentOrBuilder {
            public /* synthetic */ Builder(h4.l lVar) {
                this();
            }
            ...
            public DeveloperConsentOption getOptions(int i2) {
                return ((DeveloperConsent) this.instance).getOptions(i2);
            }
            ...
            public Builder removeOptions(int i2) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).removeOptions(i2);
                return this;
            }

            public Builder setOptions(int i2, DeveloperConsentOption developerConsentOption) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).setOptions(i2, developerConsentOption);
                return this;
            }
            ...
            public Builder addOptions(int i2, DeveloperConsentOption developerConsentOption) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).addOptions(i2, developerConsentOption);
                return this;
            }

            public Builder setOptions(int i2, DeveloperConsentOption.Builder builder) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).setOptions(i2, builder.build());
                return this;
            }
            ...
            public Builder addOptions(int i2, DeveloperConsentOption.Builder builder) {
                copyOnWrite();
                ((DeveloperConsent) this.instance).addOptions(i2, builder.build());
                return this;
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setOptions(int i2, DeveloperConsentOption developerConsentOption) {
            developerConsentOption.getClass();
            ensureOptionsIsMutable();
            this.options_.set(i2, developerConsentOption);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            h4.l lVar = null;
            switch (h4.l.f11705a[methodToInvoke.ordinal()]) {
                case 1:
        ...
        public DeveloperConsentOptionOrBuilder getOptionsOrBuilder(int i2) {
            return this.options_.get(i2);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addOptions(int i2, DeveloperConsentOption developerConsentOption) {
            developerConsentOption.getClass();
            ensureOptionsIsMutable();
            this.options_.add(i2, developerConsentOption);
        }
    ...
    public enum DeveloperConsentChoice implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<DeveloperConsentChoice> internalValueMap = new k();
    ...
    public static final class DeveloperConsentOption extends GeneratedMessageLite<DeveloperConsentOption, Builder> implements DeveloperConsentOptionOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<DeveloperConsentOption, Builder> implements DeveloperConsentOptionOrBuilder {
            ...
            public Builder setTypeValue(int i2) {
                copyOnWrite();
                ((DeveloperConsentOption) this.instance).setTypeValue(i2);
                return this;
            }
            ...
            public Builder setValueValue(int i2) {
                copyOnWrite();
                ((DeveloperConsentOption) this.instance).setValueValue(i2);
                return this;
            }
    ...
    public interface DeveloperConsentOrBuilder extends MessageLiteOrBuilder {
        DeveloperConsentOption getOptions(int i2);
    ...
    public enum DeveloperConsentType implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<DeveloperConsentType> internalValueMap = new m();
        private final int value;
