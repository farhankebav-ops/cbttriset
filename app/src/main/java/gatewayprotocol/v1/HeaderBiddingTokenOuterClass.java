...
public final class HeaderBiddingTokenOuterClass {
    ...
    public static final class HeaderBiddingToken extends GeneratedMessageLite<HeaderBiddingToken, Builder> implements HeaderBiddingTokenOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<HeaderBiddingToken, Builder> implements HeaderBiddingTokenOrBuilder {
            public /* synthetic */ Builder(h4.r rVar) {
                this();
            }
            ...
            public Builder setAdFormatValue(int i2) {
                copyOnWrite();
                ((HeaderBiddingToken) this.instance).setAdFormatValue(i2);
                return this;
            }
            ...
            public Builder setOfferwallEnabled(boolean z2) {
                copyOnWrite();
                ((HeaderBiddingToken) this.instance).setOfferwallEnabled(z2);
                return this;
            }
            ...
            public Builder setScarSignalsCollected(boolean z2) {
                copyOnWrite();
                ((HeaderBiddingToken) this.instance).setScarSignalsCollected(z2);
                return this;
            }
            ...
            public Builder setTokenNumber(int i2) {
                copyOnWrite();
                ((HeaderBiddingToken) this.instance).setTokenNumber(i2);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setOfferwallEnabled(boolean z2) {
            this.bitField0_ |= 16384;
            this.offerwallEnabled_ = z2;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setScarSignalsCollected(boolean z2) {
            this.bitField0_ |= 256;
            this.scarSignalsCollected_ = z2;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setTokenNumber(int i2) {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            h4.r rVar = null;
            switch (h4.r.f11712a[methodToInvoke.ordinal()]) {
                case 1:
                    return new HeaderBiddingToken();
                case 2:
                    return new Builder(rVar);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0014\u0000\u0001\u0001\u0014\u0014\u0001\u0000\u0000\u0001\n\u0002\u0004\u0003\n\u0004ဉ\u0000\u0005ဉ\u0001\u0006ဉ\u0002\u0007ဉ\u0003\bဉ\u0004\tဉ\u0005\nဉ\u0006\u000bည\u0007\fဇ\b\rဉ\t\u000eဉ\n\u000fဌ\u000b\u0010ဉ\f\u0011ဉ\r\u0012ဇ\u000e\u00132\u0014ဉ\u000f", new Object[]{"bitField0_", "tokenId_", "tokenNumber_", "sessionToken_", "clientInfo_", "timestamps_", "sessionCounters_", "staticDeviceInfo_", "dynamicDeviceInfo_", "pii_", "campaignState_", "tcf_", "scarSignalsCollected_", "limitedSessionToken_", "initializationData_", "adFormat_", "testData_", "tokenCounters_", "offerwallEnabled_", "extras_", b0.f11636a, "mediationInfo_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    public static final class TokenCounters extends GeneratedMessageLite<TokenCounters, Builder> implements TokenCountersOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<TokenCounters, Builder> implements TokenCountersOrBuilder {
            ...
            public Builder setSeq(int i2) {
                copyOnWrite();
                ((TokenCounters) this.instance).setSeq(i2);
                return this;
            }

            public Builder setStarts(int i2) {
                copyOnWrite();
                ((TokenCounters) this.instance).setStarts(i2);
                return this;
            }

            public Builder setWins(int i2) {
                copyOnWrite();
                ((TokenCounters) this.instance).setWins(i2);
                return this;
            }
