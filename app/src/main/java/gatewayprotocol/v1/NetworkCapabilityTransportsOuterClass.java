...
public final class NetworkCapabilityTransportsOuterClass {
    ...
    public static final class NetworkCapabilityTransports extends GeneratedMessageLite<NetworkCapabilityTransports, Builder> implements NetworkCapabilityTransportsOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<NetworkCapabilityTransports, Builder> implements NetworkCapabilityTransportsOrBuilder {
            public /* synthetic */ Builder(h4.z zVar) {
                this();
            }
            ...
            public Builder setBluetooth(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setBluetooth(z2);
                return this;
            }

            public Builder setCellular(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setCellular(z2);
                return this;
            }

            public Builder setEthernet(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setEthernet(z2);
                return this;
            }

            public Builder setLowpan(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setLowpan(z2);
                return this;
            }

            public Builder setSatellite(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setSatellite(z2);
                return this;
            }

            public Builder setThread(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setThread(z2);
                return this;
            }

            public Builder setUsb(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setUsb(z2);
                return this;
            }

            public Builder setVpn(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setVpn(z2);
                return this;
            }

            public Builder setWifi(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setWifi(z2);
                return this;
            }

            public Builder setWifiAware(boolean z2) {
                copyOnWrite();
                ((NetworkCapabilityTransports) this.instance).setWifiAware(z2);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setCellular(boolean z2) {
            this.bitField0_ |= 2;
            this.cellular_ = z2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setEthernet(boolean z2) {
            this.bitField0_ |= 4;
            this.ethernet_ = z2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setLowpan(boolean z2) {
            this.bitField0_ |= 8;
            this.lowpan_ = z2;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setWifiAware(boolean z2) {
            this.bitField0_ |= 512;
            this.wifiAware_ = z2;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            h4.z zVar = null;
            switch (h4.z.f11720a[methodToInvoke.ordinal()]) {
                case 1:
