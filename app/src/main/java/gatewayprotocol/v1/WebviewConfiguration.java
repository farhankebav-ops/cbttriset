...
public final class WebviewConfiguration {
    ...
    public static final class WebViewConfiguration extends GeneratedMessageLite<WebViewConfiguration, Builder> implements WebViewConfigurationOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<WebViewConfiguration, Builder> implements WebViewConfigurationOrBuilder {
            public /* synthetic */ Builder(h4.l0 l0Var) {
                this();
            }
            ...
            public String getAdditionalFiles(int i2) {
                return ((WebViewConfiguration) this.instance).getAdditionalFiles(i2);
            }

            @Override // gatewayprotocol.v1.WebviewConfiguration.WebViewConfigurationOrBuilder
            public ByteString getAdditionalFilesBytes(int i2) {
                return ((WebViewConfiguration) this.instance).getAdditionalFilesBytes(i2);
            }
            ...
            public Builder setAdditionalFiles(int i2, String str) {
                copyOnWrite();
                ((WebViewConfiguration) this.instance).setAdditionalFiles(i2, str);
                return this;
            }
            ...
            public Builder setVersion(int i2) {
                copyOnWrite();
                ((WebViewConfiguration) this.instance).setVersion(i2);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setAdditionalFiles(int i2, String str) {
            str.getClass();
            ensureAdditionalFilesIsMutable();
            this.additionalFiles_.set(i2, str);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            h4.l0 l0Var = null;
            switch (h4.l0.f11706a[methodToInvoke.ordinal()]) {
                case 1:
        ...
        @Override // gatewayprotocol.v1.WebviewConfiguration.WebViewConfigurationOrBuilder
        public String getAdditionalFiles(int i2) {
            return this.additionalFiles_.get(i2);
        }

        @Override // gatewayprotocol.v1.WebviewConfiguration.WebViewConfigurationOrBuilder
        public ByteString getAdditionalFilesBytes(int i2) {
            return ByteString.copyFromUtf8(this.additionalFiles_.get(i2));
        }
    ...
    public interface WebViewConfigurationOrBuilder extends MessageLiteOrBuilder {
        String getAdditionalFiles(int i2);

        ByteString getAdditionalFilesBytes(int i2);
