...
public final class InitializationResponseOuterClass {
    ...
    public static final class InitializationResponse extends GeneratedMessageLite<InitializationResponse, Builder> implements InitializationResponseOrBuilder {
        ...
        private static final Internal.ListAdapter.Converter<Integer, AdFormatOuterClass.AdFormat> scarEligibleFormats_converter_ = new d0();
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<InitializationResponse, Builder> implements InitializationResponseOrBuilder {
            public /* synthetic */ Builder(h4.v vVar) {
                this();
            }
            ...
            public Builder addScarEligibleFormatsValue(int i2) {
                copyOnWrite();
                ((InitializationResponse) this.instance).addScarEligibleFormatsValue(i2);
                return this;
            }
            ...
            @Override // gatewayprotocol.v1.InitializationResponseOuterClass.InitializationResponseOrBuilder
            public AdFormatOuterClass.AdFormat getScarEligibleFormats(int i2) {
                return ((InitializationResponse) this.instance).getScarEligibleFormats(i2);
            }
            ...
            @Override // gatewayprotocol.v1.InitializationResponseOuterClass.InitializationResponseOrBuilder
            public int getScarEligibleFormatsValue(int i2) {
                return ((InitializationResponse) this.instance).getScarEligibleFormatsValue(i2);
            }
            ...
            public Builder setCountOfLastShownCampaigns(int i2) {
                copyOnWrite();
                ((InitializationResponse) this.instance).setCountOfLastShownCampaigns(i2);
                return this;
            }
            ...
            public Builder setScarEligibleFormats(int i2, AdFormatOuterClass.AdFormat adFormat) {
                copyOnWrite();
                ((InitializationResponse) this.instance).setScarEligibleFormats(i2, adFormat);
                return this;
            }

            public Builder setScarEligibleFormatsValue(int i2, int i8) {
                copyOnWrite();
                ((InitializationResponse) this.instance).setScarEligibleFormatsValue(i2, i8);
                return this;
            }

            public Builder setTriggerInitializationCompletedRequest(boolean z2) {
                copyOnWrite();
                ((InitializationResponse) this.instance).setTriggerInitializationCompletedRequest(z2);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addScarEligibleFormatsValue(int i2) {
            ensureScarEligibleFormatsIsMutable();
            this.scarEligibleFormats_.addInt(i2);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setCountOfLastShownCampaigns(int i2) {
            this.countOfLastShownCampaigns_ = i2;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setScarEligibleFormats(int i2, AdFormatOuterClass.AdFormat adFormat) {
            adFormat.getClass();
            ensureScarEligibleFormatsIsMutable();
            this.scarEligibleFormats_.setInt(i2, adFormat.getNumber());
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setScarEligibleFormatsValue(int i2, int i8) {
            ensureScarEligibleFormatsIsMutable();
            this.scarEligibleFormats_.setInt(i2, i8);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setTriggerInitializationCompletedRequest(boolean z2) {
            this.triggerInitializationCompletedRequest_ = z2;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            h4.v vVar = null;
            switch (h4.v.f11716a[methodToInvoke.ordinal()]) {
                case 1:
                    return new InitializationResponse();
                case 2:
                    return new Builder(vVar);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0007\u0000\u0001\u0001\u0007\u0007\u0001\u0001\u0000\u0001ဉ\u0000\u0002ለ\u0001\u0003ဉ\u0002\u0004\u0007\u0005\u0004\u00062\u0007,", new Object[]{"bitField0_", "nativeConfiguration_", "universalRequestUrl_", "error_", "triggerInitializationCompletedRequest_", "countOfLastShownCampaigns_", "scarPlacements_", e0.f11640a, "scarEligibleFormats_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        @Override // gatewayprotocol.v1.InitializationResponseOuterClass.InitializationResponseOrBuilder
        public AdFormatOuterClass.AdFormat getScarEligibleFormats(int i2) {
            AdFormatOuterClass.AdFormat adFormatForNumber = AdFormatOuterClass.AdFormat.forNumber(this.scarEligibleFormats_.getInt(i2));
        ...
        @Override // gatewayprotocol.v1.InitializationResponseOuterClass.InitializationResponseOrBuilder
        public int getScarEligibleFormatsValue(int i2) {
            return this.scarEligibleFormats_.getInt(i2);
        }
    ...
    public interface InitializationResponseOrBuilder extends MessageLiteOrBuilder {
        ...
        AdFormatOuterClass.AdFormat getScarEligibleFormats(int i2);

        int getScarEligibleFormatsCount();

        List<AdFormatOuterClass.AdFormat> getScarEligibleFormatsList();

        int getScarEligibleFormatsValue(int i2);
    ...
    public static final class Placement extends GeneratedMessageLite<Placement, Builder> implements PlacementOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Placement, Builder> implements PlacementOrBuilder {
            ...
            public Builder setAdFormatValue(int i2) {
                copyOnWrite();
                ((Placement) this.instance).setAdFormatValue(i2);
                return this;
            }
