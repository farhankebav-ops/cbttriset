...
public final class SessionCountersOuterClass {
    ...
    public static final class SessionCounters extends GeneratedMessageLite<SessionCounters, Builder> implements SessionCountersOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<SessionCounters, Builder> implements SessionCountersOrBuilder {
            public /* synthetic */ Builder(h4.e0 e0Var) {
                this();
            }
            ...
            public Builder setBannerImpressions(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setBannerImpressions(i2);
                return this;
            }

            public Builder setBannerLoadRequests(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setBannerLoadRequests(i2);
                return this;
            }

            public Builder setBannerRequestsAdm(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setBannerRequestsAdm(i2);
                return this;
            }

            public Builder setFocusChangeCount(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setFocusChangeCount(i2);
                return this;
            }

            public Builder setGlobalAdsFocusChangeCount(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setGlobalAdsFocusChangeCount(i2);
                return this;
            }

            public Builder setGlobalAdsFocusTime(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setGlobalAdsFocusTime(i2);
                return this;
            }

            public Builder setLoadRequests(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setLoadRequests(i2);
                return this;
            }

            public Builder setLoadRequestsAdm(int i2) {
                copyOnWrite();
                ((SessionCounters) this.instance).setLoadRequestsAdm(i2);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setBannerImpressions(int i2) {
            this.bannerImpressions_ = i2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setBannerLoadRequests(int i2) {
            this.bannerLoadRequests_ = i2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setBannerRequestsAdm(int i2) {
            this.bannerRequestsAdm_ = i2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setFocusChangeCount(int i2) {
            this.focusChangeCount_ = i2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setGlobalAdsFocusChangeCount(int i2) {
            this.globalAdsFocusChangeCount_ = i2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setGlobalAdsFocusTime(int i2) {
            this.globalAdsFocusTime_ = i2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setLoadRequests(int i2) {
            this.loadRequests_ = i2;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setLoadRequestsAdm(int i2) {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            h4.e0 e0Var = null;
            switch (h4.e0.f11692a[methodToInvoke.ordinal()]) {
                case 1:
