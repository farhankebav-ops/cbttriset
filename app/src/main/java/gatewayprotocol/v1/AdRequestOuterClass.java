...
public final class AdRequestOuterClass {
    ...
    public static final class AdRequest extends GeneratedMessageLite<AdRequest, Builder> implements AdRequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<AdRequest, Builder> implements AdRequestOrBuilder {
            public /* synthetic */ Builder(h4.e eVar) {
                this();
            }
            ...
            public Builder setAdFormatValue(int i2) {
                copyOnWrite();
                ((AdRequest) this.instance).setAdFormatValue(i2);
                return this;
            }
            ...
            public Builder setAdRequestTypeValue(int i2) {
                copyOnWrite();
                ((AdRequest) this.instance).setAdRequestTypeValue(i2);
                return this;
            }
            ...
            public Builder setRequestImpressionConfiguration(boolean z2) {
                copyOnWrite();
                ((AdRequest) this.instance).setRequestImpressionConfiguration(z2);
                return this;
            }
            ...
            public Builder setWebviewVersion(int i2) {
                copyOnWrite();
                ((AdRequest) this.instance).setWebviewVersion(i2);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setAdRequestTypeValue(int i2) {
            this.bitField0_ |= 64;
            this.adRequestType_ = i2;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setRequestImpressionConfiguration(boolean z2) {
            this.requestImpressionConfiguration_ = z2;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            h4.e eVar = null;
            switch (h4.e.f11691a[methodToInvoke.ordinal()]) {
                case 1:
                    return new AdRequest();
                case 2:
                    return new Builder(eVar);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0010\u0000\u0001\u0001\u0010\u0010\u0001\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u0003ဉ\u0002\u0004ဉ\u0003\u0005\n\u0006Ȉ\u0007\u0007\b\n\tင\u0004\nည\u0005\u000bဌ\u0006\fဉ\u0007\rဌ\b\u000eለ\t\u000f2\u0010ဉ\n", new Object[]{"bitField0_", "sessionCounters_", "staticDeviceInfo_", "dynamicDeviceInfo_", "campaignState_", "impressionOpportunityId_", "placementId_", "requestImpressionConfiguration_", "scarSignal_", "webviewVersion_", "tcf_", "adRequestType_", "bannerSize_", "adFormat_", "mediationAdUnitId_", "extras_", d.f11639a, "mediationInfo_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    public static final class BannerSize extends GeneratedMessageLite<BannerSize, Builder> implements BannerSizeOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<BannerSize, Builder> implements BannerSizeOrBuilder {
            ...
            public Builder setHeight(int i2) {
                copyOnWrite();
                ((BannerSize) this.instance).setHeight(i2);
                return this;
            }

            public Builder setWidth(int i2) {
                copyOnWrite();
                ((BannerSize) this.instance).setWidth(i2);
                return this;
            }
