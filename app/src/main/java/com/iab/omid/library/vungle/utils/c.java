...
public class c {
    ...
    private static WindowManager f6234a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f6235b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f6236c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f6238a);
            jSONObject.put("height", bVarA.f6239b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f6234a != null) {
            ...
            f6234a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f6236c = context.getResources().getDisplayMetrics().density;
            f6234a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0162a c0162a) {
        com.iab.omid.library.vungle.internal.e eVarA = c0162a.a();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> arrayListB = c0162a.b();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f6237a[outputDeviceStatus.ordinal()] == 1;
    }
