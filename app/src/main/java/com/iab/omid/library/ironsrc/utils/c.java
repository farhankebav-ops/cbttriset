...
public class c {
    ...
    private static WindowManager f6023a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f6024b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f6025c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f6027a);
            jSONObject.put("height", bVarA.f6028b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f6023a != null) {
            ...
            f6023a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f6025c = context.getResources().getDisplayMetrics().density;
            f6023a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0154a c0154a) {
        com.iab.omid.library.ironsrc.internal.e eVarA = c0154a.a();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> arrayListB = c0154a.b();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f6026a[outputDeviceStatus.ordinal()] == 1;
    }
