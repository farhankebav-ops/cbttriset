...
class c {
    ...
    private static final Pattern f6071a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f6072b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f6073c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f6074d = Pattern.compile("<(body)( [^>]*?)?/>", 2);
    private static final Pattern e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f6075f = Pattern.compile("<(html)( [^>]*?)?/>", 2);
    ...
    public static String a(String str, String str2) {
        ...
        if (!b(str, sb, f6072b, str2, iArrA) && !a(str, sb, f6071a, str2, iArrA) && !b(str, sb, f6074d, str2, iArrA) && !a(str, sb, f6073c, str2, iArrA) && !b(str, sb, f6075f, str2, iArrA) && !a(str, sb, e, str2, iArrA) && !a(str, sb, g, str2, iArrA)) {
