...
public class a extends AdSession {
    ...
    private final AdSessionContext f5847a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final AdSessionConfiguration f5848b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final f f5849c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private com.iab.omid.library.bytedance2.weakreference.a f5850d;
    ...
    public void addFriendlyObstruction(View view, FriendlyObstructionPurpose friendlyObstructionPurpose, @Nullable String str) {
        ...
        this.f5849c.a(view, friendlyObstructionPurpose, str);
    }
    ...
    public boolean h() {
        return this.f5848b.isNativeImpressionOwner();
    }

    public boolean i() {
        return this.f5848b.isNativeMediaEventsOwner();
    }
    ...
    public a(AdSessionConfiguration adSessionConfiguration, AdSessionContext adSessionContext, String str) {
        ...
        this.f5851f = false;
        this.g = false;
        this.f5848b = adSessionConfiguration;
        this.f5847a = adSessionContext;
        this.h = str;
        b(null);
    ...
    private void b(View view) {
        this.f5850d = new com.iab.omid.library.bytedance2.weakreference.a(view);
    }
