...
public class b extends AdSessionStatePublisher {
    ...
    private final Map<String, VerificationScriptResource> f6018i;
    ...
    public class RunnableC0153b implements Runnable {
        ...
        private final WebView f6020a;

        public RunnableC0153b() {
            this.f6020a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0153b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
    ...
    public void j() {
        ...
        a(this.g);
        h.a().c(this.g, this.j);
        for (String str : this.f6018i.keySet()) {
            h.a().d(this.g, this.f6018i.get(str).getResourceUrl().toExternalForm(), str);
        }
