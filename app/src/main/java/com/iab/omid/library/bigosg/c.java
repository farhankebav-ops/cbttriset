...
class c {
    ...
    private static final Pattern f5789a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f5790b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f5791c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f5792d = Pattern.compile("<(body)( [^>]*?)?/>", 2);
    private static final Pattern e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f5793f = Pattern.compile("<(html)( [^>]*?)?/>", 2);
    private static final Pattern g = Pattern.compile("<!DOCTYPE [^>]*>", 2);

    public static String a(String str, String str2) {
        return b(str2, a1.a.m("<script type=\"text/javascript\">", str, "</script>"));
    }
    ...
    public static String b(String str, String str2) {
        ...
        if (!b(str, sb, f5790b, str2, iArrA) && !a(str, sb, f5789a, str2, iArrA) && !b(str, sb, f5792d, str2, iArrA) && !a(str, sb, f5791c, str2, iArrA) && !b(str, sb, f5793f, str2, iArrA) && !a(str, sb, e, str2, iArrA) && !a(str, sb, g, str2, iArrA)) {
