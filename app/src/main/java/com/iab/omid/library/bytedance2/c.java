...
class c {
    ...
    private static final Pattern f5858a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f5859b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f5860c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f5861d = Pattern.compile("<(body)( [^>]*?)?/>", 2);
    private static final Pattern e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f5862f = Pattern.compile("<(html)( [^>]*?)?/>", 2);
    ...
    public static String a(String str, String str2) {
        ...
        if (!b(str, sb, f5859b, str2, iArrA) && !a(str, sb, f5858a, str2, iArrA) && !b(str, sb, f5861d, str2, iArrA) && !a(str, sb, f5860c, str2, iArrA) && !b(str, sb, f5862f, str2, iArrA) && !a(str, sb, e, str2, iArrA) && !a(str, sb, g, str2, iArrA)) {
