...
class c {
    ...
    private static final Pattern f5962a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f5963b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f5964c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f5965d = Pattern.compile("<(body)( [^>]*?)?/>", 2);
    private static final Pattern e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f5966f = Pattern.compile("<(html)( [^>]*?)?/>", 2);
    ...
    public static String a(String str, String str2) {
        ...
        if (!b(str, sb, f5963b, str2, iArrA) && !a(str, sb, f5962a, str2, iArrA) && !b(str, sb, f5965d, str2, iArrA) && !a(str, sb, f5964c, str2, iArrA) && !b(str, sb, f5966f, str2, iArrA) && !a(str, sb, e, str2, iArrA) && !a(str, sb, g, str2, iArrA)) {
