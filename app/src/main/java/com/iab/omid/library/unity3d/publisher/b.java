...
public class b extends AdSessionStatePublisher {
    ...
    private final Map<String, VerificationScriptResource> f6120i;
    ...
    public class RunnableC0157b implements Runnable {
        ...
        private final WebView f6122a;

        public RunnableC0157b() {
            this.f6122a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0157b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
    ...
    public void j() {
        ...
        a(this.g);
        g.a().c(this.g, this.j);
        for (String str : this.f6120i.keySet()) {
            g.a().c(this.g, this.f6120i.get(str).getResourceUrl().toExternalForm(), str);
        }
