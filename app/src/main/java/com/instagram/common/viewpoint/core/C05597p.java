...
public final class C05597p {
    ...
    public static final C05597p A04;
    public static final C05597p A05;

    @MetaExoPlayerCustomization(type = {"FEATURE_LOGIC"}, value = "Prevent throwing when building the map")
    public static final AbstractC2025mj<Integer, Integer> A06;
    ...
    static {
        A06();
        A04 = new C05597p(new int[]{2}, 8);
        A05 = new C05597p(new int[]{2, 5, 6}, 8);
        A06 = new C2023mh().A05(5, 6).A05(17, 6).A05(7, 6).A05(18, 6).A05(6, 8).A05(8, 8).A05(14, 8).A07();
    }

    public C05597p(int[] iArr, int i2) {
        if (iArr != null) {
    ...
    */
    public static int A00(int r4) {
        ...
        Lb:
            ...
            java.lang.String r0 = com.instagram.common.viewpoint.core.AbstractC04664a.A03
            ...
            r4 = 2
        L26:
            int r0 = com.instagram.common.viewpoint.core.AbstractC04664a.A01(r4)
            return r0
        L2b:
            r0 = 3
            if (r4 == r0) goto L65
            r3 = 4
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C05597p.A03
            r0 = 1
            r1 = r1[r0]
            r0 = 21
            ...
            r0 = 49
            if (r1 == r0) goto L6d
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C05597p.A03
        ...
        L6d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C05597p.A00(int):int");
    }

    public static int A01(int i2, int i8) {
        if (AbstractC04664a.A02 >= 29) {
            return C05587o.A00(i2, i8);
        }
        Integer orDefault = A06.getOrDefault(Integer.valueOf(i2), 0);
    ...
    public static C05597p A02(Context context) {
        Intent intent = context.registerReceiver(null, new IntentFilter(A05(68, 36, 113)));
        return A03(context, intent);
    }

    public static C05597p A03(Context context, Intent intent) {
        if (A07() && Settings.Global.getInt(context.getContentResolver(), A05(206, 31, 58), 0) == 1) {
            return A05;
        }
        if (AbstractC04664a.A02 >= 29 && (AbstractC04664a.A18(context) || AbstractC04664a.A17(context))) {
            return new C05597p(C05587o.A01(), 8);
        }
        if (intent == null || intent.getIntExtra(A05(104, 36, 91), 0) == 0) {
            return A04;
        }
        return new C05597p(intent.getIntArrayExtra(A05(140, 29, 55)), intent.getIntExtra(A05(169, 37, 84), 8));
    }

    public static boolean A07() {
        if (AbstractC04664a.A02 >= 17) {
            if (A05(21, 6, 52).equals(AbstractC04664a.A05) || A05(61, 6, 7).equals(AbstractC04664a.A05)) {
                return true;
            }
        }
        return false;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final android.util.Pair<java.lang.Integer, java.lang.Integer> A09(com.instagram.common.viewpoint.core.C2154or r9) {
        /*
            r8 = this;
            ...
            int r4 = com.instagram.common.viewpoint.core.AbstractC04212h.A03(r1, r0)
            com.facebook.ads.redexgen.X.mj<java.lang.Integer, java.lang.Integer> r1 = com.instagram.common.viewpoint.core.C05597p.A06
        ...
        La6:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C05597p.A09(com.facebook.ads.redexgen.X.or):android.util.Pair");
    }
    ...
    public final boolean A0B(C2154or c2154or) {
        return A09(c2154or) != null;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C05597p)) {
            return false;
        }
        C05597p c05597p = (C05597p) obj;
        return Arrays.equals(this.A01, c05597p.A01) && this.A00 == c05597p.A00;
    }
