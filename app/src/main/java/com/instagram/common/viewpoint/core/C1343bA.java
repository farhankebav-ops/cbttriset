...
public final class C1343bA extends RelativeLayout {
    public final View A00;
    public final C1292aL A01;

    public C1343bA(C1477dL c1477dL, View view) {
        super(c1477dL);
        this.A00 = view;
        this.A01 = new C1292aL(c1477dL);
        XP.A0I(this.A01);
    }
     ...
     */
    public final void A01(C1297aQ c1297aQ, boolean z2) {
        ...
        if (c1297aQ != null) {
            if (z2) {
                ...
                c1297aQ.setAlignment(3);
                layoutParams2.setMargins(AbstractC1311ae.A07 / 2, AbstractC1311ae.A07 / 2, AbstractC1311ae.A07 / 2, AbstractC1311ae.A07 / 2);
                linearLayout.addView(c1297aQ, layoutParams2);
                ...
                insideLayoutParams.setMargins(0, AbstractC1311ae.A07, 0, 0);
                c1297aQ.setAlignment(17);
                addView(c1297aQ, insideLayoutParams);
            }
        }
