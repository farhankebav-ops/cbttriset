...
public abstract class WZ {
    ...
    */
    public static int A05(org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
        L0:
            int r1 = r5.next()
            r0 = 1
        ...
        L23:
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.WZ.A02
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r2 = r2[r0]
        ...
        L6a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.WZ.A05(org.xmlpull.v1.XmlPullParser):int");
    }
    ...
    public static void A0A(SQ sq, Throwable th) {
        sq.A08().AAy(A06(38, 7, 85), AbstractC1090Sv.A1c, new C1091Sw(th));
    }
    ...
    public static boolean A0C(SQ sq) {
        ...
        if (cachedValue != null) {
            ...
            boolean z2 = true;
            try {
                xmlResourceParserOpenXmlResourceParser = sq.getAssets().openXmlResourceParser(A06(0, 19, 21));
                loop0: while (true) {
                    ...
                    if (xmlResourceParserOpenXmlResourceParser.getEventType() == 2 && (xmlResourceParserOpenXmlResourceParser.getName().equals(A06(27, 11, 23)) || xmlResourceParserOpenXmlResourceParser.getName().equals(A06(19, 8, 90)))) {
                        for (int i2 = 0; i2 < xmlResourceParserOpenXmlResourceParser.getAttributeCount(); i2++) {
                            if (xmlResourceParserOpenXmlResourceParser.getAttributeName(i2).equals(A06(58, 18, 8)) && !Boolean.parseBoolean(xmlResourceParserOpenXmlResourceParser.getAttributeValue(i2))) {
                                z2 = false;
                                break loop0;
                            }
                        }
