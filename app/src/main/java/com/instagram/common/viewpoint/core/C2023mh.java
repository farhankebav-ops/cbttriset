...
public class C2023mh<K, V> {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.mh != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2023mh(int initialCapacity) {
    ...
    */
    private com.instagram.common.viewpoint.core.AbstractC2025mj<K, V> A00(boolean r7) {
        /*
            r6 = this;
            if (r7 == 0) goto L6
        ...
        Lf:
            r6.A03 = r5
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C2023mh.A05
            r0 = 7
            r1 = r2[r0]
            r0 = 6
            r2 = r2[r0]
            ...
            r0 = 5
            r2[r0] = r1
            com.facebook.ads.redexgen.X.AL r0 = com.instagram.common.viewpoint.core.AL.A00(r4, r3, r6)
            if (r7 == 0) goto L3a
        ...
        L9f:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2023mh.A00(boolean):com.facebook.ads.redexgen.X.AL");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.mh != com.google.common.collect.ImmutableMap$Builder<K, V> */
    private void A01(int minCapacity) {
        if (minCapacity * 2 > this.A04.length) {
            this.A04 = Arrays.copyOf(this.A04, AbstractC2015mZ.A03(this.A04.length, minCapacity * 2));
            this.A03 = false;
        }
    }
    ...
    public static <V> void A02(Object[] alternatingKeysAndValues, int size, Comparator<? super V> valueComparator) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            Object key = Objects.requireNonNull(alternatingKeysAndValues[i2 * 2]);
            entryArr[i2] = new AbstractMap.SimpleImmutableEntry(key, Objects.requireNonNull(alternatingKeysAndValues[(i2 * 2) + 1]));
        }
        Arrays.sort(entryArr, 0, size, AbstractC2133oV.A04(valueComparator).A05(AbstractC2102nz.A04()));
        for (int i8 = 0; i8 < size; i8++) {
            int i9 = i8 * 2;
            alternatingKeysAndValues[i9] = entryArr[i8].getKey();
            int i10 = (i8 * 2) + 1;
            alternatingKeysAndValues[i10] = entryArr[i8].getValue();
        }
    }
    ...
    */
    private java.lang.Object[] A03(java.lang.Object[] r9, int r10) {
        ...
        La3:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2023mh.A03(java.lang.Object[], int):java.lang.Object[]");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.mh != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2023mh<K, V> A04(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.mh != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2023mh<K, V> A05(K key, V value) {
        A01(this.A00 + 1);
        AbstractC1966ll.A03(key, value);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.mh != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public C2023mh<K, V> A06(Map.Entry<? extends K, ? extends V> entry) {
        return A05(entry.getKey(), entry.getValue());
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.mh != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public AbstractC2025mj<K, V> A07() {
        return A08();
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.mh != com.google.common.collect.ImmutableMap$Builder<K, V> */
    public AbstractC2025mj<K, V> A08() {
        return A00(true);
    }
}
