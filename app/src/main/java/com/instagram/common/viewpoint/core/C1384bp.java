...
public class C1384bp extends WebViewClient {
    ...
    public static String A00(int i2, int i8, int i9) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            ...
            bArrCopyOfRange[i10] = (byte) (i11 ^ 33);
        }
    ...
    public C1384bp(C1388bt c1388bt) {
        this.A00 = c1388bt;
    }
    ...
    private void A02(int i2, String str, String str2, boolean z2) {
        ...
        this.A00.A0E.A04(AbstractC1090Sv.A16, string);
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        String string = jSONObject.toString();
        C1477dL c1477dL = this.A00.A0B;
        String message = A02[5];
        if (message.charAt(10) == 'q') {
            A02[3] = "cKmn9F08G0LbJgt48cswTZGSotGQ5jj";
            c1477dL.A0F().A62(string);
            AbstractC1389bu.A04(this.A00.A09.A17());
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        return C1399c4.A00(this.A00.A0B, this.A00.A0A, webResourceRequest, this.A00.A0H, this.A00.A09.A1O());
    }
}
