...
public final class IC {
     ...
     */
    public static Pair<String, List<byte[]>> A02(C4J c4j) throws C04222i {
        try {
            c4j.A0g(16);
            long jA0O = c4j.A0O();
            if (jA0O == 1482049860) {
            ...
            throw C04222i.A01(A03(267, 45, 108), null);
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw C04222i.A01(A03(166, 33, 80), null);
        }
    }

    public static String A03(int i2, int i8, int i9) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0p, i2, i2 + i8);
    ...
    public static List<byte[]> A05(byte[] bArr) throws C04222i {
        ...
        try {
            if (bArr[0] == 2) {
                ...
                int i8 = vorbisInfoLength + 1;
                int i9 = i2 + (bArr[vorbisInfoLength] & 255);
                int offset = 0;
                while ((bArr[i8] & 255) == 255) {
                    offset += 255;
                    i8++;
                }
                int vorbisInfoLength2 = i8 + 1;
                int offset2 = offset + (bArr[i8] & 255);
                if (bArr[vorbisInfoLength2] == 1) {
                    byte[] bArr2 = new byte[i9];
                    System.arraycopy(bArr, vorbisInfoLength2, bArr2, 0, i9);
                    int vorbisInfoLength3 = vorbisInfoLength2 + i9;
    ...
    public static boolean A09(C4J c4j) throws C04222i {
        try {
            int iA0G = c4j.A0G();
            if (iA0G == 1) {
                return true;
            ...
            throw C04222i.A01(A03(199, 34, 58), null);
        }
    }
    ...
    private byte[] A0C() {
        ...
        if (f4 == -1.0f || this.A04 == -1.0f || this.A05 == -1.0f || this.A02 == -1.0f || this.A03 == -1.0f) {
            return null;
        }
        float f8 = this.A0B;
        if (A0q[7].charAt(7) != '5') {
    ...
    private byte[] A0D(String str) throws C04222i {
        if (this.A0j != null) {
            byte[] bArr = this.A0j;
            if (A0q[1].charAt(11) != 'i') {
                throw new RuntimeException();
        ...
        throw C04222i.A01(A03(329, 31, 93) + str, null);
    }
    ...
    */
    public final void A0G(com.instagram.common.viewpoint.core.GY r20, int r21) throws com.instagram.common.viewpoint.core.C04222i {
        /*
            Method dump skipped, instruction units count: 2498
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.IC.A0G(com.facebook.ads.redexgen.X.GY, int):void");
    }
}
