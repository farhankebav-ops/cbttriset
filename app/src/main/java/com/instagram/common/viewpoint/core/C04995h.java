...
public class C04995h extends AbstractC0830Ir {
    public YM A00;
    public InterfaceC1366bX A01;
    public C1446cp A02;
    public boolean A03;
    public boolean A04;
    public boolean A05;
    ...
    public static final int A0L = (int) (AbstractC1180Wl.A02 * 0.0f);
    public static final int A0M = (int) (AbstractC1180Wl.A02 * 9.0f);
    public static final int A0K = (int) (AbstractC1180Wl.A02 * 9.0f);

    public C04995h(C1315ai c1315ai, boolean z2, String str, FH fh) {
        super(c1315ai, z2);
        this.A0G = new Path();
        this.A0H = new RectF();
    ...
    public void A00() {
        if (this.A0I.A0F() != null && this.A02 != null) {
            C0680Cw c0680CwA0F = this.A0I.A0F();
            ...
            c0680CwA0F.AAm(simpleVideoView);
    ...
    */
    public void A02() {
        ...
        L5:
            ...
            if (r0 == 0) goto L25
            boolean r3 = r4.A05
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C04995h.A0J
            r0 = 4
            r1 = r1[r0]
            r0 = 16
            ...
            r0 = 83
            if (r1 == r0) goto L35
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C04995h.A0J
        ...
        L35:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C04995h.A02():void");
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int width = getWidth();
        int radius3 = A0L;
        float f8 = width - radius3;
        int height = getHeight();
        int radius4 = A0L;
        rectF.set(f4, 0.0f, f8, height - radius4);
        if (z2) {
            i2 = A0M;
        }
        this.A0G.addRoundRect(this.A0H, i2, i2, Path.Direction.CW);
    ...
    public void setCTAInfo(C0941Mz c0941Mz, Map<String, String> extraData) {
        getCtaButton().setCta(c0941Mz, this.A0E, extraData);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC1366bX interfaceC1366bX) {
        this.A01 = interfaceC1366bX;
    }

    public void setUpImageView(C1477dL c1477dL) {
        this.A00 = new YM(c1477dL);
        if (U7.A1I(c1477dL)) {
            AbstractC1265Zs.A00(this.A00, U7.A1J(c1477dL), new ViewOnClickListenerC1283aC(this));
        }
        A04(this.A00);
    }
    ...
    public void setUpVideoView(C1477dL c1477dL) {
        this.A02 = new C1446cp(c1477dL, new C1120Ua(this.A0E, getAdEventManager()));
        if (U7.A1K(c1477dL)) {
            AbstractC1265Zs.A00(this.A02, U7.A1L(c1477dL), new ViewOnClickListenerC1284aD(this));
        }
        C1446cp c1446cp = this.A02;
        if (A0J[2].charAt(30) != 'G') {
            throw new RuntimeException();
