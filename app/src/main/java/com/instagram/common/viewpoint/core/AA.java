...
public final class AA implements InterfaceC2204px {
    ...
    public final InterfaceC2207q2 A03;
    ...
    private final void A02(List<Rect> list) {
        ...
        Iterator<InterfaceC2208q3> it = this.A03.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public AA(View view, InterfaceC2207q2 interfaceC2207q2) {
        this.A00 = new WeakReference<>(view);
        this.A03 = interfaceC2207q2;
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC2204px
