...
public final class AX<V> implements InterfaceC1830jM<List<V>>, Serializable {
    ...
    public static String A00(int i2, int i8, int i9) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            ...
            bArrCopyOfRange[i10] = (byte) (i11 - 73);
        }
    ...
    public AX(int expectedValuesPerKey) {
        this.A00 = AbstractC1966ll.A00(expectedValuesPerKey, A00(0, 20, 92));
    }
