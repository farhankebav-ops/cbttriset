...
public final class C1073Se {
    ...
    public C1073Se(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
    ...
    public C1073Se(String[] strArr, Integer num, Integer num2) {
    ...
    public static C1073Se A00(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (zFind) {
                ...
                return new C1073Se(linkedHashSet, numValueOf, numValueOf2, str);
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C1073Se)) {
            return false;
        }
        C1073Se c1073Se = (C1073Se) obj;
        if (this.A00 == c1073Se.A00 || (this.A00 != null && this.A00.equals(c1073Se.A00))) {
            return (this.A01 == c1073Se.A01 || (this.A01 != null && this.A01.equals(c1073Se.A01))) && this.A03.equals(c1073Se.A03);
        }
        return false;
    }
