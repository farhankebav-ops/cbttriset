...
public final class C1259Zm extends Drawable {
    ...
    public String A05;
    public String A06;
    public WeakReference<C1550eX> A07;
    public boolean A08;
    ...
    public final Runnable A0F = new C0868Kd(this);
    ...
    */
    public void A03() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1259Zm.A03():void");
    }
    ...
    public final void A08(int i2, int i8) {
        this.A00 = i2;
        this.A01 = i8;
        A03();
    }
    ...
    public final void A0A(C1550eX c1550eX) {
        this.A07 = new WeakReference<>(c1550eX);
        A03();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float textMiddleX = f8 - height2;
        float textMiddleY = f4 + width2;
        canvas.drawRect(canvasMiddleY - 40.0f, textMiddleX - 40.0f, textMiddleY + 40.0f, f8 + height2 + 40.0f, this.A0B);
        canvas.save();
        canvas.translate(f4 - width2, f8 - height2);
