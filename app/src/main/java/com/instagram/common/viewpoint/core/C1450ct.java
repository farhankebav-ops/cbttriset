...
public final class C1450ct extends AbstractC1072Sd {
    ...
    static {
        ...
        A03 = new SX(7, A00(ModuleDescriptor.MODULE_VERSION, 4, 103), strA004);
        A02 = new SX(8, A00(148, 7, 8), strA002);
        A0B = new SX[]{A04, A09, A05, A0A, A08, A07, A06, A03, A02};
        A0C = AbstractC1072Sd.A02(A00(167, 6, 97), A0B);
    }

    public C1450ct(SZ sz) {
        super(sz);
    }
    ...
    public final String A0E(String str, int i2, String str2, double d8, double d9, String str3, Map<String, String> map) throws SQLiteException {
        ...
        contentValues.put(A08.A01, Double.valueOf(d8));
