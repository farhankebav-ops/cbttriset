...
public abstract class AbstractC2016ma<E> extends AbstractCollection<E> implements Serializable {
    public static byte[] A00 = null;
    public static final Object[] A01;
    public static final long serialVersionUID = 912559;

    public static String A0E(int i2, int i8, int i9) {
    ...
    public abstract AbstractC0621Am<E> A0J();
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC1819jA.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC2135oY.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC2129oR.A05(tArr, size);
