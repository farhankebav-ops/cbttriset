...
public enum EnumC1754i3 {
    ...
    public static EnumC1754i3[] valuesCustom() {
        EnumC1754i3[] enumC1754i3ArrValuesCustom = values();
        if (A01[0].charAt(28) == 't') {
            throw new RuntimeException();
        }
        A01[7] = "Z";
        return (EnumC1754i3[]) enumC1754i3ArrValuesCustom.clone();
    }
}
