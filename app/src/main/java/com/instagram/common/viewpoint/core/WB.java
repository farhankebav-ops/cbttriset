...
public final class WB {
    ...
    public static final Set<C1477dL> A06;
    ...
    public static int A00(C1477dL c1477dL, Intent intent) throws W9 {
        Intent intentA01 = A01(intent);
        int usedContext = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c1477dL.A0E();
                usedContext = 1;
            }
            if (activityA00 != null) {
            ...
            c1477dL.startActivity(intentA01);
            return 2;
    ...
    public static C1477dL A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C1477dL c1477dL : A06) {
                String adId = c1477dL.A0F().getId();
    ...
    public static AdActivityIntent A05(C1477dL c1477dL) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c1477dL.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c1477dL.A0F().getId());
        A06.add(c1477dL);
    ...
    public static void A0B(C1477dL c1477dL, AdActivityIntent adActivityIntent) throws W9 {
        Context launchContext;
        Context applicationContext = c1477dL.getApplicationContext();
        if (U7.A2V(c1477dL) && (launchContext = c1477dL.A0E()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0I(c1477dL, adActivityIntent)) {
                    c1477dL.A0F().AHS();
                    return;
                }
                return;
    ...
    public static boolean A0D(C1477dL c1477dL, Intent intent) throws W9 {
        A07.get();
        return A0F(c1477dL, intent, null);
    }

    public static boolean A0E(C1477dL c1477dL, Intent intent) throws W9 {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    ...
                    c1477dL.A08().AAy(A07(90, 8, 57), AbstractC1090Sv.A07, new C1091Sw(e4));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C1477dL c1477dL, Intent intent, WK wk) throws W9 {
        if (A0C(intent, U7.A0Z(c1477dL))) {
            return false;
        }
        Context context = c1477dL;
        if (A01[1].charAt(5) != 'g') {
            A01[2] = "mGLT8eS8inmCxtBfGXr0XCfYNSNKmj30";
            Context startContext = c1477dL.A0E();
            if (startContext != null) {
                context = startContext;
            } else {
                intent.addFlags(268435456);
            }
            if (wk != null && !A0C(intent, U7.A0b(c1477dL))) {
                c1477dL.A0C();
                try {
                    ...
                    c1477dL.A08().AAy(A07(90, 8, 57), AbstractC1090Sv.A08, new C1091Sw(e4));
                    return false;
                }
            }
            try {
    ...
    public static boolean A0G(C1477dL c1477dL, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c1477dL, uri, str, null);
    }

    public static boolean A0H(C1477dL c1477dL, Uri uri, String str, WM wm) throws ActivityNotFoundException {
        if (wm == null || c1477dL.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C1477dL c1477dL, AdActivityIntent adActivityIntent) throws W9 {
        Intent intentA01 = A01(adActivityIntent);
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c1477dL.A0E();
            }
            if (currentActivity == null) {
                return false;
            }
