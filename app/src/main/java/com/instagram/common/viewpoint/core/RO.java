...
public final class RO implements NativeAdsManagerApi {
    ...
    public RO(Context context, String str, int i2) {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        V6 v62 = V6.A06;
        int i2 = this.A06;
        C1717hK c1717hK = this.A02;
        this.A02 = new C1717hK(this.A07, this.A08, v62, null, i2);
        if (this.A05) {
            this.A02.A06();
        }
        this.A02.A09(this.A03);
        this.A02.A08(new C1614fa(this, this.A07, mediaCacheFlag));
        this.A02.A07();
    }
    ...
    public final NativeAd nextNativeAd(NativeAdListener nativeAdListener) {
        ...
        if (nativeAdListener != null) {
            ((C1020Qc) nativeAd.getInternalNativeAd()).A1U(nativeAd, nativeAdListener);
        }
