...
public abstract class AbstractC0930Mo implements Serializable {
    ...
    public static AbstractC0930Mo A03(JSONObject jSONObject, C1477dL c1477dL) {
        ...
        if (zHas) {
            try {
                abstractC0930MoA00 = C1750hw.A00(jSONObject, c1477dL);
        ...
        if (abstractC0930MoA00 == null) {
            zHas = false;
            abstractC0930MoA00 = AnonymousClass73.A00(jSONObject, c1477dL);
        }
        abstractC0930MoA00.A1L(zHas);
        abstractC0930MoA00.A0Z(z2);
        return abstractC0930MoA00;
    }

    private void A06(double d8) {
        this.A00 = d8;
    }
    ...
    private void A0P(JSONObject jSONObject) {
        ...
        A0L(jSONObject.optString(A04(1420, 19, 14), A04(Sdk.SDKError.Reason.STORE_REGION_CODE_ERROR_VALUE, 26, 14)));
    }

    private final void A0Q(boolean z2) {
        this.A0Z = z2;
    }

    private final void A0R(boolean z2) {
        this.A0c = z2;
    }

    private final void A0S(boolean z2) {
        this.A0d = z2;
    }

    private final void A0T(boolean z2) {
        this.A0e = z2;
    }

    private final void A0U(boolean z2) {
        this.A0f = z2;
    }

    private final void A0V(boolean z2) {
        this.A0X = z2;
    }

    private final void A0W(boolean z2) {
        this.A0Y = z2;
    }

    private final void A0X(boolean z2) {
        this.A0g = z2;
    }

    private final void A0Y(boolean z2) {
        this.A0h = z2;
    }

    private final void A0Z(boolean z2) {
        this.A0a = z2;
    }
    ...
    */
    public final java.lang.String A0r() {
        ...
        L39:
            ...
            goto La
        L4b:
            com.facebook.ads.redexgen.X.dg r0 = com.instagram.common.viewpoint.core.EnumC1498dg.A03
            java.lang.String r0 = r0.A03()
            return r0
        L52:
            com.facebook.ads.redexgen.X.dh r0 = com.instagram.common.viewpoint.core.EnumC1499dh.A04
            java.lang.String r0 = r0.A03()
            return r0
        L59:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0930Mo.A0r():java.lang.String");
    }
    ...
    public final void A1K(JSONObject jSONObject) {
        ...
        A0B(jSONObject.optString(A04(928, 13, Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE)));
        A0O(jSONObject);
        A07(jSONObject.optInt(A04(1628, 31, 85), 0));
        A1D(jSONObject.optInt(A04(1659, 26, 90), 1000));
        A0A(jSONObject.optString(A04(TypedValues.Custom.TYPE_COLOR, 26, Sdk.SDKError.Reason.TPAT_ERROR_VALUE), strA042));
        ...
        A0V(jSONObject.optBoolean(A04(964, 22, Sdk.SDKError.Reason.TPAT_ERROR_VALUE), false));
        ...
        this.A0V = jSONObject.optBoolean(A04(870, 14, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE));
        ...
        if (TextUtils.isEmpty(this.A0E)) {
            this.A0E = C1300aT.A00();
        }
        this.A0S = jSONObject.optString(A04(1572, 41, 41), A04(IronSourceError.ERROR_AD_UNIT_CAPPED, Sdk.SDKError.Reason.TPAT_ERROR_VALUE, 94));
        ...
        this.A0n = jSONObject.optBoolean(A04(1715, 40, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE), false);
    }
