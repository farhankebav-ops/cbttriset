...
public final class C1762iC extends MR {
    ...
    public EnumC0919Mc A03;
    public EnumC0920Md A04;
    public EnumC1138Us A05;
    public String A06;
    public WeakReference<C1637fx> A07;
    ...
    public C1762iC(C1477dL c1477dL, MS ms, C1550eX c1550eX, C1773iN c1773iN) {
        super(c1477dL, ms, c1550eX);
        this.A03 = EnumC0919Mc.A03;
        this.A04 = null;
        this.A0F = c1773iN;
    }
    ...
    private JSONObject A04(View view) throws JSONException {
        ...
        boolean z2 = false;
        jSONObject.putOpt(A01(Sdk.SDKError.Reason.EMPTY_TPAT_ERROR_VALUE, 6, 114), String.format(Locale.US, A01(205, 12, 61), Integer.valueOf(view.getTop()), Integer.valueOf(view.getLeft())));
        ...
        jSONObject.putOpt(A01(40, 9, 103), Boolean.valueOf(z2));
        ...
        if (view instanceof Button) {
            ...
            boolean z7 = view instanceof MediaView;
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 != null && (this.A02.getNativeAdLayoutApi() instanceof C1620fg)) {
            C1620fg c1620fg = (C1620fg) this.A02.getNativeAdLayoutApi();
            if (c1620fg.A05()) {
                map.put(A01(87, 7, 108), Boolean.TRUE.toString());
            }
            boolean zA04 = c1620fg.A04();
            if (A0H[2].charAt(5) == '8') {
                throw new RuntimeException();
            }
            String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A01 != null) {
            map.put(A01(98, 4, 80), String.valueOf((int) (this.A01.getWidth() / AbstractC1180Wl.A02)));
            map.put(A01(94, 4, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE), String.valueOf((int) (this.A01.getHeight() / AbstractC1180Wl.A02)));
        }
        if (this.A04 != null) {
    ...
    public final void A0C(EnumC0919Mc enumC0919Mc) {
        this.A03 = enumC0919Mc;
    }

    public final void A0D(EnumC0920Md enumC0920Md) {
        this.A04 = enumC0920Md;
    }

    public final void A0E(EnumC1138Us enumC1138Us) {
        this.A05 = enumC1138Us;
    }
    ...
    public final void A0G(WeakReference<C1637fx> weakReference) {
