...
public final class CJ extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, InterfaceC1545eS {
    ...
    public EnumC1493db A0B;
    public EnumC1547eU A0C;
    public EnumC1547eU A0D;
    public InterfaceC1548eV A0E;
    public boolean A0F;
    public boolean A0G;
    public boolean A0H;
    public boolean A0I;
    ...
    public CJ(C1477dL c1477dL) {
        super(c1477dL);
        this.A0C = EnumC1547eU.A04;
        this.A0D = EnumC1547eU.A04;
        this.A0J = false;
        this.A03 = 0;
        this.A05 = 0;
        this.A04 = 0;
        ...
        this.A02 = 0;
        this.A0G = false;
        this.A0B = EnumC1493db.A03;
        this.A0M = new C1542eP(this);
        this.A0I = false;
        this.A0N = c1477dL;
    }

    public CJ(C1477dL c1477dL, AttributeSet attributeSet) {
    ...
    public CJ(C1477dL c1477dL, AttributeSet attributeSet, int i2) {
    ...
    private boolean A06() {
        return (this.A0C == EnumC1547eU.A08 || this.A0C == EnumC1547eU.A07) ? false : true;
    }

    private boolean A07() {
        return this.A0C == EnumC1547eU.A07 || this.A0C == EnumC1547eU.A0A || this.A0C == EnumC1547eU.A05 || this.A0C == EnumC1547eU.A06;
    }
    ...
    private boolean A09() {
        ...
        try {
            ...
            this.A0N.A08().AAy(A03(384, 6, 110), AbstractC1090Sv.A2H, new C1091Sw(e));
            return false;
        }
    }
    ...
    private boolean A0A(Surface surface) {
        ...
        try {
            ...
            this.A0N.A08().AAy(A03(384, 6, 110), AbstractC1090Sv.A2I, new C1091Sw(e));
            return false;
        }
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1545eS
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1545eS
    public final void AG7(boolean z2, int i2) {
        this.A0N.A0F().A3W(i2);
        this.A0D = EnumC1547eU.A05;
        if (this.A06 != null) {
            if (!A06()) {
                return;
            }
            this.A0J = z2;
            this.A06.pause();
            if (this.A0C != EnumC1547eU.A06) {
                setVideoState(EnumC1547eU.A05);
                return;
            }
            return;
        }
        setVideoState(EnumC1547eU.A04);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1545eS
    public final void AJH(int i2) {
        this.A0N.A0F().ABy(i2);
        setVideoState(EnumC1547eU.A09);
        AJU(5);
        this.A03 = 0;
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1545eS
    public final void AJM(EnumC1493db enumC1493db, int i2) {
        this.A0N.A0F().A3h(i2);
        this.A0J = false;
        this.A0D = EnumC1547eU.A0A;
        this.A0B = enumC1493db;
        if (this.A0C == EnumC1547eU.A0A || this.A0C == EnumC1547eU.A07 || this.A0C == EnumC1547eU.A04 || this.A0C == EnumC1547eU.A05 || this.A0C == EnumC1547eU.A06) {
            if (this.A06 == null) {
                setup(this.A07);
            } else {
                if (this.A03 > 0) {
                ...
                this.A06.start();
                if (this.A0C != EnumC1547eU.A07 || this.A0K) {
                    setVideoState(EnumC1547eU.A0A);
                }
            }
        }
        if (isAvailable()) {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1545eS
    public EnumC1493db getStartReason() {
        return this.A0B;
    }
    ...
    public EnumC1547eU getTargetState() {
        return this.A0D;
    }
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i2, int i8) {
        this.A0N.A0F().ABx(A03(390, 11, 85) + i2 + A03(0, 14, 21) + i8 + A03(14, 2, 108));
        if (this.A01 > 0 && getState() == EnumC1547eU.A0A) {
            this.A01--;
            AJU(6);
            AJM(this.A0B, 10);
        } else {
    ...
    public final boolean onInfo(MediaPlayer mediaPlayer, int i2, int i8) {
        switch (i2) {
            case 3:
                this.A0K = true;
                if (this.A0D == EnumC1547eU.A0A) {
                    setVideoState(EnumC1547eU.A0A);
                }
                return true;
            case 701:
                setVideoState(EnumC1547eU.A02);
                return false;
            case 702:
                if (!A08()) {
                    return false;
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (this.A03 > 0) {
            int i2 = this.A03;
            int duration = ((MediaPlayer) AbstractC1654gF.A00(this.A06)).getDuration();
            if (A0P[3].length() != 17) {
                throw new RuntimeException();
            }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i2, int i8) {
        ...
        if (!A0A(this.A08)) {
            ...
            this.A0N.A0F().A3a(4);
            destroy();
        } else if (this.A0C == EnumC1547eU.A05 && !this.A0J) {
            AJM(this.A0B, 7);
        }
    }
    ...
    */
    public final void onWindowFocusChanged(boolean r6) {
        ...
        L15:
            ...
            com.facebook.ads.redexgen.X.eU r0 = com.instagram.common.viewpoint.core.EnumC1547eU.A05
            if (r1 == r0) goto La6
            ...
            if (r0 != 0) goto L8d
            com.facebook.ads.redexgen.X.dL r0 = r5.A0N
            boolean r3 = com.instagram.common.viewpoint.core.U7.A1z(r0)
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.CJ.A0P
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 22
        ...
        L42:
            ...
            com.facebook.ads.redexgen.X.eU r3 = com.instagram.common.viewpoint.core.EnumC1547eU.A05
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.CJ.A0P
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
        ...
        L54:
            ...
            throw r0
        L6d:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.CJ.A0P
        ...
        La7:
            ...
            goto La6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.CJ.onWindowFocusChanged(boolean):void");
    }
    ...
    public void setControlsAnchorView(View view) {
        this.A09 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC1544eR(this));
    }
    ...
    public void setFullScreen(boolean z2) {
        this.A0H = z2;
        if (this.A0H && !this.A0G) {
            setOnTouchListener(new ViewOnTouchListenerC1543eQ(this));
        }
    }
    ...
    public void setRequestedVolume(float f4) {
        this.A00 = f4;
        if (this.A06 == null || this.A0C == EnumC1547eU.A08) {
            return;
        }
        EnumC1547eU enumC1547eU = this.A0C;
        String[] strArr = A0P;
        if (strArr[0].charAt(16) == strArr[7].charAt(16)) {
            throw new RuntimeException();
        }
        A0P[3] = "xC5rxgqNbqLUjjPrr";
        if (enumC1547eU != EnumC1547eU.A04) {
    ...
    private void setVideoState(EnumC1547eU enumC1547eU) {
        if (enumC1547eU != this.A0C) {
            if (this.A0N.A05().AAF()) {
                String str = A03(356, 23, 106) + enumC1547eU;
            }
            this.A0C = enumC1547eU;
            if (this.A0E != null) {
                this.A0E.AFt(enumC1547eU);
            }
        }
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1545eS
    public void setVideoStateChangeListener(InterfaceC1548eV interfaceC1548eV) {
        this.A0E = interfaceC1548eV;
    }
    ...
    public void setup(Uri uri) {
        ...
        try {
            if (((String) AbstractC1654gF.A00(uri.getScheme())).equals(A03(379, 5, 2))) {
                A05(mediaPlayer, uri);
            } else {
