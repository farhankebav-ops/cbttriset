...
public final class C0R<T extends Enum<T>> extends C1F<T> implements InterfaceC06059w<T>, Serializable {
    ...
    public C0R(T[] tArr) {
        C2168p6.A09(tArr, A03(7, 7, 113));
        this.A00 = tArr;
    }

    private final int A00(T t3) {
        C2168p6.A09(t3, A03(0, 7, 111));
        int iOrdinal = t3.ordinal();
        if (((Enum) C0T.A00(this.A00, iOrdinal)) == t3) {
            return iOrdinal;
        }
        return -1;
    }
    ...
    public final T get(int i2) {
        C1F.A02.A03(i2, this.A00.length);
        return this.A00[i2];
    }

    private final boolean A05(T t3) {
        C2168p6.A09(t3, A03(0, 7, 111));
        Enum target = (Enum) C0T.A00(this.A00, t3.ordinal());
        return target == t3;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.A3, java.util.Collection, java.util.List
