...
public final class KR {
    ...
    private void A00(int i2) {
        ...
        boolean z2 = this.A0B;
        this.A0C.AIA(this.A04, z2 ? 1 : 0, (int) (this.A01 - this.A03), i2, null);
    }
    ...
    public final void A04(long j, int i2, int i8, long j3, boolean z2) {
        this.A06 = false;
        this.A05 = false;
        this.A02 = j3;
        this.A00 = 0;
        ...
        this.A08 = i8 >= 16 && i8 <= 21;
        this.A07 = this.A08 || i8 <= 9;
        if (A0D[6].length() != 30) {
    ...
    public final void A05(long j, int i2, boolean z2) {
    ...
    public final void A06(byte[] bArr, int i2, int i8) {
        if (this.A07) {
            int i9 = (i2 + 2) - this.A00;
            if (i9 < i8) {
