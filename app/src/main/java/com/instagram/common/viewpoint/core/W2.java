...
public final class W2 {
    ...
    private void A06(String str, int i2) {
        ...
        if (str.equals(AdPlacementType.INTERSTITIAL.toString())) {
            this.A01.A05(this.A00, A01(65, 23, Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE), i2);
            return;
        }
        ...
        if (str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString())) {
            ...
            this.A01.A05(this.A00, A01(Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE, 17, 5), i2);
        } else {
            if (!str.equals(AdPlacementType.NATIVE_BANNER.toString())) {
                return;
            }
            this.A01.A05(this.A00, A01(114, 23, 66), i2);
        }
    }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(strA01)) {
                            ...
                            if (System.currentTimeMillis() - jSONObject.getLong(strA01) < U7.A02(this.A00)) {
