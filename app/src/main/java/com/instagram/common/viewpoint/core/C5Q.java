...
public abstract class C5Q extends AbstractC0830Ir implements Wf {
    ...
    public final C1176Wh A0C;
    public final InterfaceC1208Xn A0D;
    public final C1315ai A0E;
    public final DX A0F;
    public final DR A0G;
    public final DP A0H;
    public final DN A0I;
    ...
    public abstract void A1V(C1477dL c1477dL);

    static {
        A03();
        A0O = (int) (AbstractC1180Wl.A02 * 1.0f);
        A0P = (int) (AbstractC1180Wl.A02 * 4.0f);
        A0N = (int) (AbstractC1180Wl.A02 * 6.0f);
    }

    public C5Q(C1315ai c1315ai, boolean z2, String str, FH fh) {
        super(c1315ai, z2);
        this.A09 = new Path();
        this.A0A = new RectF();
        ...
        this.A0D = c1315ai.A0D();
        this.A0E = c1315ai;
        this.A03 = fh;
        this.A0K = str;
        this.A0B = c1315ai.A06();
        this.A0C = C1176Wh.A00(c1315ai.A06(), c1315ai.A05(), this);
        setGravity(17);
    ...
    public final void A1Q() {
        if (A1T()) {
            A1R();
            C1446cp c1446cp = this.A04;
            EnumC1493db enumC1493db = EnumC1493db.A02;
            if (A0M[2].length() == 4) {
                throw new RuntimeException();
            }
            A0M[2] = "GrzUS";
            c1446cp.A05(enumC1493db);
        }
    }
    ...
    public final C1446cp getVideoView() {
        return this.A04;
    }
    ...
    public void setCTAInfo(C0941Mz c0941Mz, Map<String, String> extraData) {
        getCtaButton().setCta(c0941Mz, this.A0K, extraData);
    }

    public void setImageUrl(String str) {
        this.A01.setVisibility(0);
        this.A04.setVisibility(8);
        new KZ(this.A01, this.A0B).A04().A06(new C0824Il(this)).A07(str);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC1366bX interfaceC1366bX) {
        this.A02 = interfaceC1366bX;
    }

    public void setUpImageView(C1477dL c1477dL) {
        this.A01 = new YM(c1477dL);
        if (U7.A1I(c1477dL)) {
            AbstractC1265Zs.A00(this.A01, U7.A1J(c1477dL), new ViewOnClickListenerC1372bd(this));
        }
        A04(this.A01);
    }

    public void setUpMediaContainer(C1477dL c1477dL) {
        this.A00 = new RelativeLayout(c1477dL);
        A04(this.A00);
        C1175Wg c1175WgA02 = this.A0C.A02(this.A0E.A05());
        this.A0E.A06().A0H().A00(c1175WgA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(this.A0C);
        if (this.A0E.A05().A1W() && U7.A2o(this.A0B)) {
            this.A00.setOnClickListener(new ViewOnClickListenerC1371bc(this));
        } else {
            if (!c1175WgA02.A00) {
                return;
            }
    ...
    public void setUpVideoView(C1477dL c1477dL) {
        this.A04 = new C1446cp(c1477dL, new C1120Ua(this.A0K, getAdEventManager()));
        if (U7.A1K(c1477dL)) {
            AbstractC1265Zs.A00(this.A04, U7.A1L(c1477dL), new ViewOnClickListenerC1373be(this));
        }
        A04(this.A04);
    }

    private void setUpView(C1477dL c1477dL) {
        setUpImageView(c1477dL);
        setUpVideoView(c1477dL);
        setUpMediaContainer(c1477dL);
