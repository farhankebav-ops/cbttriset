...
public final class C0926Mj extends BroadcastReceiver {
    ...
    public C0926Mj(AnonymousClass64 anonymousClass64, Context context) {
        ...
        if (str3.length() == action4.length()) {
            ...
            if (str4.equals(action6)) {
                ...
                if (serializableExtra instanceof DL) {
                    ...
                    this.A01.A0h(EnumC1493db.A04, 1);
                    return;
                }
                if (serializableExtra instanceof DT) {
                    ...
                    if (serializableExtra instanceof C04433d) {
                        if (this.A01.getListener() != null) {
                    ...
                    boolean z2 = serializableExtra instanceof C3Y;
                    String[] strArr5 = A04;
