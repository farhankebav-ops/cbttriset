...
public class C1618fe extends PH {
    public int A00;

    public C1618fe(Context context) {
        super(context);
        this.A00 = 0;
    }
    ...
    */
    public final void onMeasure(int r5, int r6) {
        ...
        L1f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1618fe.onMeasure(int, int):void");
    }
}
