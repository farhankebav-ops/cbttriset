...
public final class C1474dI {
    ...
    public C1474dI(C1477dL c1477dL, YY yy, String str, InterfaceC1208Xn interfaceC1208Xn) {
        this.A01 = c1477dL;
        this.A03 = yy;
        this.A04 = str;
    ...
    public static String A03(RewardData rewardData, String str, String str2) {
        ...
        if (rewardData != null) {
            ...
            String serverSideProxyURL2 = A02(Sdk.SDKError.Reason.STORE_REGION_CODE_ERROR_VALUE, 4, 110);
            ...
            String urlPrefix10 = A02(Sdk.SDKError.Reason.MRAID_DOWNLOAD_JS_ERROR_VALUE, 4, 99);
    ...
    public final void A05() {
        if (!TextUtils.isEmpty(this.A04)) {
            AsyncTaskC1576ex asyncTaskC1576ex = new AsyncTaskC1576ex(this.A01, new HashMap());
            asyncTaskC1576ex.A07(new EV(this));
            asyncTaskC1576ex.executeOnExecutor(this.A00, this.A04);
        }
    }
}
