...
public final class C1049Rf {
    ...
    public final InterfaceC1048Re A01;
    public final SF A02;
    ...
    public C1049Rf(SF sf, JSONObject jSONObject, String str, String str2, boolean z2, InterfaceC1048Re interfaceC1048Re) {
        this.A02 = sf;
        this.A05 = jSONObject;
        this.A03 = str;
        this.A04 = str2;
        this.A06 = z2 && A0A(this.A05);
        this.A01 = interfaceC1048Re;
        this.A00 = new Handler(Looper.getMainLooper());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A09(boolean z2, C1047Rd c1047Rd) {
        String strA03 = A03(6, 4, 8);
        String strA032 = A03(15, 5, 16);
        String strA033 = A03(10, 5, 53);
        if (z2) {
            if (strA033.equals(c1047Rd.A02)) {
                this.A02.A0d(new SD(c1047Rd.A03, -1, -1, this.A04, this.A03));
                return;
            } else if (strA032.equals(c1047Rd.A02)) {
                this.A02.A0a(new SB(c1047Rd.A03, this.A04, this.A03));
                return;
            } else {
                if (!strA03.equals(c1047Rd.A02)) {
                    return;
                }
                this.A02.A0Z(new SB(c1047Rd.A03, this.A04, this.A03));
                return;
            }
        }
        boolean zEquals = strA033.equals(c1047Rd.A02);
        String[] strArr = A08;
        ...
        if (zEquals) {
            this.A02.A0c(new SD(c1047Rd.A03, -1, -1, this.A04, this.A03));
        } else if (strA032.equals(c1047Rd.A02)) {
            this.A02.A0b(new SB(c1047Rd.A03, this.A04, this.A03));
        } else {
            if (!strA03.equals(c1047Rd.A02)) {
                return;
            }
            this.A02.A0Y(new SB(c1047Rd.A03, this.A04, this.A03));
        }
    }
    ...
    public final void A0B() {
        ...
        XU.A06.execute(new C1609fV(this));
    }
}
