...
public final class LJ extends AbstractC1251Ze {
    ...
    public LJ(C1477dL c1477dL, Activity activity, ZY zy) {
        super(activity, c1477dL);
        this.A02 = -1L;
        this.A00 = -1L;
        this.A03 = -1L;
        this.A01 = -1L;
    ...
    public LJ(C1477dL c1477dL, ZY zy) {
        super(c1477dL);
        this.A02 = -1L;
        this.A00 = -1L;
        this.A03 = -1L;
    ...
    public final C1248Zb A0H() {
        return new C1248Zb(new WeakReference(this.A04), new WeakReference(this.A06), new WeakReference(this.A05));
    }
    ...
    public static void A07(int i2, int i8, Intent intent) {
        if (A08 != null && i2 == 1001) {
            A08.onReceiveValue(WebChromeClient.FileChooserParams.parseResult(i8, intent));
            A08 = null;
        }
    }

    private void A08(C1477dL c1477dL, ZY zy) {
        this.A04 = c1477dL;
        this.A06 = zy;
    ...
    public final WebChromeClient A0G() {
        return new C1247Za(new WeakReference(this.A04), new WeakReference(this.A06), new WeakReference(this.A05));
    }
