...
public class C1620fg extends R8 implements NativeAdLayoutApi {
    public View A02;
    ...
    public final void A03(AbstractC1224Yd abstractC1224Yd) {
        this.A02 = abstractC1224Yd;
        abstractC1224Yd.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
        XP.A0R(this.A03);
