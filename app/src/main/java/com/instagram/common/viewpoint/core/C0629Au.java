...
public final class C0629Au {
    ...
    public C0629Au(String str, boolean z2, boolean z7) {
        this.A00 = str;
        this.A01 = z2;
        this.A02 = z7;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != C0629Au.class) {
            return false;
        }
        C0629Au c0629Au = (C0629Au) obj;
        String str = this.A00;
        String str2 = c0629Au.A00;
        String[] strArr = A03;
        if (strArr[1].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
        A03[0] = "8OzGK6f1ltbus";
        return TextUtils.equals(str, str2) && this.A01 == c0629Au.A01 && this.A02 == c0629Au.A02;
    }
