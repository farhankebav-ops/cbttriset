...
public final class FB {
    ...
    public static InterfaceC04453f A00(float f4) throws Exception {
        A04();
        Object objNewInstance = A00.newInstance(new Object[0]);
        A04.invoke(objNewInstance, Float.valueOf(f4));
        Object builder = A02.invoke(objNewInstance, new Object[0]);
        C3M.A01(builder);
        return null;
    }

    public static InterfaceC04684c A01() throws Exception {
        A04();
