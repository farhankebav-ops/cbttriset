...
public final class CM extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC1529eC, InterfaceC1545eS, InterfaceC1531eE {
    ...
    public EnumC1547eU A0E;
    public InterfaceC1548eV A0F;
    public String A0G;
    public boolean A0H;
    public boolean A0I;
    public boolean A0J;
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (U7.A1v(this.A0A)) {
            EnumC1547eU enumC1547eU = this.A0D;
            if (A0P[6].length() != 18) {
            ...
            strArr[0] = "Md";
            strArr[1] = "f0";
            if (enumC1547eU == EnumC1547eU.A08) {
                return;
            }
            if (!this.A0L) {
                this.A0L = true;
    ...
    public CM(C1477dL c1477dL) {
        super(c1477dL);
        this.A0D = EnumC1547eU.A04;
        this.A0E = EnumC1547eU.A04;
        this.A0M = false;
        this.A0N = false;
        this.A0J = false;
        this.A03 = 0;
    ...
    public CM(C1477dL c1477dL, AttributeSet attributeSet) {
    ...
    public CM(C1477dL c1477dL, AttributeSet attributeSet, int i2) {
    ...
    */
    private void A04() {
        ...
        L4a:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.CM.A0P
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 18
        ...
        L66:
            ...
            if (r1 == r0) goto L7f
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.CM.A0P
        ...
        La4:
            ...
            r2.A0F(r1, r0)
        Lb1:
            com.facebook.ads.redexgen.X.eU r0 = com.instagram.common.viewpoint.core.EnumC1547eU.A08
            r5.setVideoState(r0)
        ...
        Lc3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.CM.A04():void");
    }
    ...
    private void A08(int i2, int i8) {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1529eC
    public final void AEe(String str, Exception exc) {
        this.A0A.A0F().ABx(str);
        this.A0A.A0F().A3a(1);
        setVideoState(EnumC1547eU.A03);
        this.A0A.A08().AAy(A03(Sdk.SDKError.Reason.MRAID_JS_COPY_FAILED_VALUE, 7, 15), AbstractC1090Sv.A1N, new C1091Sw(exc));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x005e, code lost:
        ...
        r3 = com.instagram.common.viewpoint.core.EnumC1547eU.A05;
    ...
    */
    public final void AEf(boolean r8, int r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.CM.AEf(boolean, int):void");
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1531eE
    ...
    public final void AJM(EnumC1493db enumC1493db, int i2) {
        this.A0A.A0F().A3h(i2);
        this.A0M = false;
        this.A0E = EnumC1547eU.A0A;
        this.A0B = enumC1493db;
        if (this.A0C == null) {
            setup(this.A06);
            return;
        }
        if (this.A0D != EnumC1547eU.A07 && this.A0D != EnumC1547eU.A05 && this.A0D != EnumC1547eU.A06) {
            return;
        }
        this.A0C.A0I(true);
        EnumC1547eU enumC1547eU = EnumC1547eU.A0A;
        String[] strArr = A0P;
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i2, int i8) {
        ...
        if (this.A0D == EnumC1547eU.A05 && !this.A0M) {
            AJM(this.A0B, 7);
        }
    }
    ...
    public void setControlsAnchorView(View view) {
        this.A08 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC1540eN(this));
    }
    ...
    public void setFullScreen(boolean z2) {
        this.A0J = z2;
        if (z2 && !this.A0I) {
            setOnTouchListener(new ViewOnTouchListenerC1539eM(this));
        }
    }
    ...
    public void setRequestedVolume(float f4) {
        this.A00 = f4;
        if (this.A0C != null && this.A0D != EnumC1547eU.A08 && this.A0D != EnumC1547eU.A04) {
            this.A0C.A0C(f4);
        }
    }
    ...
    private void setVideoState(EnumC1547eU enumC1547eU) {
        if (enumC1547eU != this.A0D) {
            if (this.A0A.A05().AAF()) {
                String str = A03(196, 23, 81) + enumC1547eU;
            }
            this.A0D = enumC1547eU;
            if (this.A0D == EnumC1547eU.A0A) {
                this.A0N = true;
            }
            if (this.A0F != null) {
                this.A0F.AFt(enumC1547eU);
            }
        }
    }
