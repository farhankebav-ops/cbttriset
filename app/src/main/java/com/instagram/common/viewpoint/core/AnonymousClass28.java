...
public abstract class AnonymousClass28 {
    ...
    */
    public static int A01(java.lang.String r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AnonymousClass28.A01(java.lang.String):int");
    }

    public static int A02(Map<String, List<String>> responseHeaders) {
        List<String> list = responseHeaders.get(A03(Sdk.SDKError.Reason.MRAID_DOWNLOAD_JS_ERROR_VALUE, 12, 34));
