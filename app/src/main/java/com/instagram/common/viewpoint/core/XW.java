...
public abstract class XW {
    ...
    public static Bitmap A00(C1477dL c1477dL, Bitmap bitmap, int i2) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c1477dL);
    ...
    public static Bitmap A01(C1477dL c1477dL, Bitmap bitmap, int i2, int i8) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c1477dL, bitmapCreateBitmap, i2);
                if (i8 != 1) {
                ...
                return new C0982Oq().A02(bitmapCreateBitmap, i2);
            }
        }
        return null;
    }
