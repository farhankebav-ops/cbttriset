...
public final class UZ {
    ...
    static {
        ...
        A04 = new UZ(A00(0, 15, 98), 2, A00(1196, 15, Sdk.SDKError.Reason.INVALID_METRICS_ENDPOINT_VALUE));
        ...
        A0i = new UZ(A00(754, 25, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE), 7, A00(1786, 25, 105));
        A0j = new UZ(A00(779, 20, 98), 8, A00(1811, 20, 41));
        A0V = new UZ(A00(463, 37, Sdk.SDKError.Reason.ASSET_FAILED_STATUS_CODE_VALUE), 9, A00(1495, 37, 91));
        A06 = new UZ(A00(33, 9, 25), 10, A00(1058, 9, 54));
        A07 = new UZ(A00(42, 16, 33), 11, A00(IronSourceError.ERROR_RV_ALL_SMASHES_SESSION_CAPPED, 16, Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE));
        ...
        A0Y = new UZ(A00(IronSourceError.ERROR_NO_INTERNET_CONNECTION, 16, 94), 22, A00(1552, 16, Sdk.SDKError.Reason.INVALID_METRICS_ENDPOINT_VALUE));
        ...
        A0l = new UZ(A00(813, 20, 110), 35, A00(1845, 17, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE));
        ...
        A0C = new UZ(A00(Sdk.SDKError.Reason.STORE_REGION_CODE_ERROR_VALUE, 33, 18), 39, A00(1132, 33, 66));
        A0B = new UZ(A00(104, 30, 88), 40, A00(1102, 30, 97));
        A09 = new UZ(A00(76, 11, 40), 41, A00(1165, 11, 77));
        A0E = new UZ(A00(187, 23, 54), 42, A00(InterfaceC2238ae.a.k, 23, 111));
        A0F = new UZ(A00(Sdk.SDKError.Reason.AD_NOT_LOADED_VALUE, 26, 11), 43, A00(1234, 26, 120));
        ...
        A0R = new UZ(A00(404, 19, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE), 47, A00(1436, 19, 27));
    ...
    public UZ(String str, int i2, String str2) {
        this.A00 = str2;
    }
