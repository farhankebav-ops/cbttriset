...
public final class C06069x implements List, Serializable, RandomAccess {
    ...
    private final Void A04(int i2) {
        throw new IndexOutOfBoundsException(A03(11, 44, 74) + i2 + '.');
    }
    ...
    public final boolean containsAll(Collection elements) {
        C2168p6.A09(elements, A03(127, 8, 126));
