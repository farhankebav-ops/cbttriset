...
public final class ZU extends LinearLayout {
    ...
    public static String A00(int i2, int i8, int i9) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            ...
            bArrCopyOfRange[i10] = (byte) ((b8 ^ i9) ^ 11);
        }
    ...
    static {
        A02();
        A07 = (int) (AbstractC1180Wl.A03 * 2.0f);
        A06 = (int) (AbstractC1180Wl.A02 * 12.0f);
    }

    public ZU(C1477dL c1477dL) {
        super(c1477dL);
        this.A03 = c1477dL;
        A01();
    }
    ...
    public void setSubtitle(@Nullable String str) {
        ...
        if (A00(0, 5, Sdk.SDKError.Reason.INVALID_METRICS_ENDPOINT_VALUE).equals(uriA00.getScheme())) {
