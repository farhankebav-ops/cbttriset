...
public class C1256Zj extends WebViewClient {
    ...
    public final WeakReference<C0873Ki> A03;
    ...
    public final WeakReference<C1550eX> A07;
    ...
    public C1256Zj(C1477dL c1477dL, WeakReference<InterfaceC1254Zh> weakReference, WeakReference<C1550eX> weakReference2, WeakReference<XH> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C0873Ki> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z2) {
        this.A02 = c1477dL;
    ...
    private void A03(int i2, CharSequence charSequence, long j) {
        JSONObject jSONObject = new JSONObject();
        boolean z2 = charSequence != null;
        try {
            jSONObject.put(A01(160, 10, 100), i2);
            jSONObject.put(A01(170, 17, 77), charSequence);
            jSONObject.put(A01(202, 21, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE), z2);
        ...
        this.A02.A08().AAy(A01(306, 8, 81), AbstractC1090Sv.A2f, new C1091Sw(AdErrorType.WEB_VIEW_FAILED_TO_LOAD.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
    }
    ...
    private final void A05(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0F().AKH(webResourceResponse.getStatusCode(), AbstractC1184Wp.A01(webResourceResponse.getStatusCode(), A01(67, 10, 126), A01(0, 0, 53) + webResourceRequest.getUrl()));
    }
    ...
    private void A07(String str, String str2) {
        ...
        if (this.A02 != null) {
            this.A02.A08().AAy(A01(306, 8, 81), AbstractC1090Sv.A2c, new C1091Sw(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    */
    private boolean A08(android.net.Uri r8) {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1256Zj.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L6c:
            ...
            java.util.List r5 = com.instagram.common.viewpoint.core.SF.A09(r0)
            ...
            r0.toString()
        L98:
            java.lang.String r4 = com.instagram.common.viewpoint.core.C0873Ki.A01()
        ...
        Lbb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1256Zj.A08(android.net.Uri):boolean");
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0F().AKF();
        this.A00 = new Date();
        new Handler().postDelayed(new C0875Kk(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (zA12 || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0F().AKG(AbstractC1184Wp.A01(webResourceError.getErrorCode(), strA01 + ((Object) webResourceError.getDescription()), strA01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC1251Ze.A0D(AbstractC1090Sv.A2b);
        InterfaceC1254Zh adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().ACj(str, new C1262Zp().A03(this.A07.get()).A02(this.A06.get()).A05());
        }
