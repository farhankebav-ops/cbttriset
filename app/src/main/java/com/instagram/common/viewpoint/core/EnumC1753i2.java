...
public enum EnumC1753i2 {
    ...
    public static String A00(int i2, int i8, int i9) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            ...
            bArrCopyOfRange[i10] = (byte) (i11 - 60);
        }
    ...
    public static EnumC1753i2[] valuesCustom() {
        EnumC1753i2[] enumC1753i2Arr = (EnumC1753i2[]) values().clone();
        String[] strArr = A01;
        if (strArr[5].charAt(20) == strArr[4].charAt(20)) {
            throw new RuntimeException();
        }
        A01[3] = "UcBpUNe8sR";
        return enumC1753i2Arr;
    }
}
