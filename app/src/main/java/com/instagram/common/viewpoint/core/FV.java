...
public final class FV {
    ...
    public static long A00(long j, long j3, long j8) {
        long j9;
        long vsyncCount = j8 * ((j - j3) / j8);
        long j10 = j3 + vsyncCount;
        if (j <= j10) {
            j9 = j10 - j8;
        } else {
            j9 = j10;
    ...
    public static FT A01(Context context) {
        C1951lW c1951lWA01 = null;
        if (context == null) {
            return null;
        }
        Context applicationContext = context.getApplicationContext();
        if (AbstractC04664a.A02 >= 17) {
            c1951lWA01 = C1951lW.A01(applicationContext);
        }
        if (c1951lWA01 == null) {
            return C1952lX.A00(applicationContext);
        }
        return c1951lWA01;
    }

    private void A03() {
        if (AbstractC04664a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE || this.A03 == 0.0f) {
            return;
        }
        this.A03 = 0.0f;
    ...
    */
    private void A05() {
        ...
        L78:
            ...
            goto L5a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.FV.A05():void");
    }
    ...
    private void A09(boolean z2) {
        if (AbstractC04664a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE) {
            return;
        }
        float f4 = 0.0f;
        if (this.A0D && this.A02 != -1.0f) {
            ...
            f4 = f8 * surfacePlaybackFrameRate;
        }
        if (!z2) {
            float surfacePlaybackFrameRate2 = this.A03;
            if (surfacePlaybackFrameRate2 == f4) {
                return;
            }
        }
        this.A03 = f4;
    ...
    public static boolean A0A(long j, long j3) {
    ...
    public final long A0B(long j) {
        ...
        if (this.A06 != -1 && this.A0E.A06()) {
            ...
            long frameDurationNs2 = frameDurationNs + ((long) (((j8 - adjustedReleaseTimeNs) * jA02) / this.A01));
            if (A0A(j3, frameDurationNs2)) {
                j3 = frameDurationNs2;
            } else {
                A04();
            }
        ...
        long j9 = this.A0G.A04;
        if (j9 == -9223372036854775807L) {
            return j3;
        }
        long sampledVsyncTimeNs = A00(j3, j9, this.A0A);
    ...
    public final void A0F(float f4) {
        this.A00 = f4;
        this.A0E.A04();
        A05();
    }
