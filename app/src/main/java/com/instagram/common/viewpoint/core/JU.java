...
public final class JU extends AbstractC1311ae {
    ...
    public TextView A0G;
    public AbstractC1752hy A0H;
    public AbstractRunnableC1164Vt A0I;
    public ZO A0J;
    public ZP A0K;
    public LJ A0L;
    public KE A0M;
    ...
    public final InterfaceC1277a4 A0j;
    public final InterfaceC1288aH A0k;
    public final C1289aI A0l;
    public final C0680Cw A0m;
    ...
    static {
        A0Z();
        A0x = (int) (AbstractC1180Wl.A02 * 26.0f);
        A0u = (int) (AbstractC1180Wl.A02 * 4.0f);
        A0z = (int) (AbstractC1180Wl.A02 * 8.0f);
        A0v = (int) (AbstractC1180Wl.A02 * 24.0f);
        A0w = OP.A02(-1, 77);
        A0y = (int) (AbstractC1180Wl.A02 * 12.0f);
    }

    public JU(C1315ai c1315ai) {
        super(c1315ai, true);
        this.A0c = false;
        this.A02 = -1;
        this.A0d = false;
        ...
        this.A0o = new RunnableC1337b4(this);
        this.A0R = false;
        ...
        this.A0C = (InputMethodManager) c1315ai.A06().getSystemService(A0J(13, 12, 60));
        this.A0N = c1315ai;
        this.A0H = this.A0N.A05();
        this.A0i = new C1120Ua(c1315ai.A05().A25(), c1315ai.A07());
        this.A0m = this.A0N.A0F();
        if (this.A0m != null) {
            XP.A0I(this.A0m);
        }
        this.A0g = this.A0N.A03();
        this.A0h = MI.A01(c1315ai.A06(), c1315ai.A07(), c1315ai.A05().A25(), WQ.A00(c1315ai.A05().A20().A0J().A05()), new HashMap(), false, true, this.A0H.A21());
        this.A0j = new C0840Jb(this);
        ...
        this.A0l = new C1289aI(c1315ai, this.A0H, e12, this.A0N.A0D(), this.A0k, this.A0G, this.A0O, this.A0m, this.A0g);
        if (e12 != null && U7.A1K(getAdContextWrapper())) {
            AbstractC1265Zs.A00(e12.getVideoImplView(), U7.A1L(getAdContextWrapper()), new ViewOnClickListenerC1338b5(this));
        } else if (e12 == null && this.A0B != null && U7.A1I(getAdContextWrapper())) {
            AbstractC1265Zs.A00(this.A0B, U7.A1J(getAdContextWrapper()), new ViewOnClickListenerC1339b6(this));
        }
        this.A0F = null;
        this.A0M = null;
        this.A0q = c1315ai.A05().A1e();
        this.A0r = c1315ai.A05().A1p();
        getAdContextWrapper().A0F().ABe(this.A0q, this.A0r, c1315ai.A05().A2C());
    }

    public JU(C1315ai c1315ai, boolean z2) {
        this(c1315ai);
        this.A0c = z2;
        AbstractC1752hy abstractC1752hyA05 = c1315ai.A05();
        this.A0d = this.A0c && abstractC1752hyA05.A1q();
        if (this.A0c) {
            this.A02 = abstractC1752hyA05.A0k();
            if (this.A02 == 0) {
                A1R();
            } else if (this.A02 > 0 && this.A02 <= 10000) {
                this.A0f.postDelayed(this.A0n, this.A02);
            }
            String strA1B = abstractC1752hyA05.A1B();
            if (!TextUtils.isEmpty(strA1B)) {
                for (String stringToCheck : strA1B.split(A0J(0, 1, 10))) {
    ...
    private void A0P() {
        ...
        if (this.A0N.A05().A1n() && (abstractC1207XmA0C = this.A0N.A0C()) != null) {
    ...
    private void A0R() {
        if (this.A0g != null) {
            XP.A0H(this.A0g);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC1311ae.A08, AbstractC1311ae.A08);
            layoutParams.addRule(10);
            layoutParams.addRule(11);
            layoutParams.setMargins(AbstractC1311ae.A07, this.A07, AbstractC1311ae.A07, AbstractC1311ae.A07);
    ...
    private void A0T() {
        AbstractC1207Xm abstractC1207XmA0C = this.A0N.A0C();
        if (abstractC1207XmA0C == null) {
            return;
        }
        abstractC1207XmA0C.setPageDetailsVisible((this.A0Q || abstractC1207XmA0C.A0B()) ? false : true);
    }

    private void A0U() {
        this.A0B = this.A0N.A02();
        if (this.A0H.A1W()) {
            this.A0B.setOnClickListener(new ViewOnClickListenerC1340b7(this));
        }
        XP.A0H(this.A0B);
        XP.A0I(this.A0B);
        ...
        XP.A0I(this.A0G);
        this.A0O = new C1352bJ(this.A0N.A06(), getCtaButton(), this.A0N.A05(), this.A0N.A07(), this.A0N.A0D(), this.A0N.A0G(), this.A0N.A0A(), getColors(), this.A0j);
        ...
        if (U7.A17(this.A0N.A06())) {
            this.A0E.setOnClickListener(new ViewOnClickListenerC1341b8(this));
            if (this.A0N.A0C() != null) {
                this.A0N.A0C().setCTAClickListener(new ViewOnClickListenerC1342b9(this));
            }
        }
    }
    ...
    private void A0V() {
        ...
        addView(new C1327au(this.A0N.A06(), this.A0H, this.A0i, this.A0A, this.A0N.A0D()).A09(getRegularCtaForEndCard()));
    }
    ...
    public void A0f(String str) {
        ...
        XP.A0H(this.A0L);
        C0843Je c0843Je = new C0843Je(this);
        if (this.A0N.A06().A0E() == null) {
            this.A0N.A06().A0F().A9n();
        }
        if (!U8.A02(this.A0N.A06()) && this.A0N.A06().A0E() != null) {
            lj = new LJ(this.A0N.A06(), this.A0N.A06().A0E(), c0843Je);
        } else {
            lj = new LJ(this.A0N.A06(), c0843Je);
        }
        this.A0L = lj;
        if (this.A0c) {
        ...
        if (this.A0H.A1d()) {
            this.A0L.addJavascriptInterface(new C1300aT(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.av
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.A00.A1S(view);
                }
            }, this.A0L, new InterfaceC1299aS() { // from class: com.facebook.ads.redexgen.X.Jn
        ...
        this.A0L.setOnTouchListener(new ViewOnTouchListenerC1334b1(this));
        setUpBrowserControls(this.A0L);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -1);
        layoutParams.weight = 0.9f;
        if (this.A0d || this.A0H.A1d()) {
            C1477dL c1477dLA06 = this.A0N.A06();
            String strA0r = this.A0N.A05().A0r();
            if (this.A0N.A00() == 1) {
                c0940MyA00 = this.A0N.A05().A1z().A01();
            } else {
                c0940MyA00 = this.A0N.A05().A1z().A00();
            }
            this.A0M = new KE(c1477dLA06, strA0r, c0940MyA00, this.A0N.A05().A20().A0J().A06(), this.A0N.A07(), this.A0N.A0D(), this.A0N.A0G(), this.A0N.A0A(), this.A0N.A05().A21());
        ...
        if (!this.A0d || this.A0M == null) {
            ...
            if (getContext().getResources().getConfiguration().orientation == 1) {
                c0940MyA002 = this.A0N.A05().A1z().A01();
            } else {
                c0940MyA002 = this.A0N.A05().A1z().A00();
            }
            this.A0M.setUpButtonColors(c0940MyA002);
            if (this.A0P) {
                this.A0M.setPadding(A0v, 0, A0v, 0);
            }
    ...
    public void A0i(boolean z2) {
        ...
        if (!this.A0W) {
            postDelayed(new C0841Jc(this, z2), 250L);
        }
        String strA0J = A0J(85, 1, 34);
        if (z2) {
            browserTransAnim = ObjectAnimator.ofFloat(this.A0O, strA0J, this.A0O.getY(), this.A05 / 5);
        }
        LinearLayout linearLayout = this.A0D;
        ...
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(linearLayout, strA0J, y, i2);
        ...
        duration.addUpdateListener(new C1335b2(this));
        ...
        animatorSet.addListener(new C1336b3(this, z2));
        if (this.A0r && (this.A0B instanceof E1)) {
            ((E1) this.A0B).A0f(animatorSet, z2);
        }
        animatorSet.start();
    }

    private void A0j(boolean z2) {
    ...
    private void A0k(boolean z2, int i2) {
        if (this.A0J != null && this.A0q) {
            this.A0J.setCloseButtonVisibility(z2 ? 0 : 4);
            C1477dL adContextWrapper = getAdContextWrapper();
            String[] strArr = A0t;
            ...
            adContextWrapper.A0F().ABc(!z2, i2);
        }
    }
    ...
    public final void A1C() {
        AbstractC1207Xm abstractC1207XmA0C = this.A0N.A0C();
        if (abstractC1207XmA0C != null) {
            abstractC1207XmA0C.setPageDetailsVisible((A1U() || abstractC1207XmA0C.A0B()) ? false : true);
        }
        this.A0b = false;
    }
    ...
    */
    public final void A1G(com.instagram.common.viewpoint.core.C0931Mp r6, java.lang.String r7, double r8, android.os.Bundle r10) {
        /*
            r5 = this;
        ...
        L33:
            ...
            r0 = 8
            com.instagram.common.viewpoint.core.XP.A0L(r1, r0)
            com.facebook.ads.redexgen.X.ai r0 = r5.A0N
            com.facebook.ads.redexgen.X.dL r0 = r0.A06()
            boolean r0 = com.instagram.common.viewpoint.core.U7.A17(r0)
            if (r0 == 0) goto L4c
            android.widget.LinearLayout r1 = r5.A0E
            r0 = 0
            r1.setClickable(r0)
        ...
        L65:
            ...
            r3 = 1
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.JU.A0t
            r0 = 2
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        L9d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.JU.A1G(com.facebook.ads.redexgen.X.Mp, java.lang.String, double, android.os.Bundle):void");
    }
    ...
    private KE getRegularCtaForEndCard() {
        KE ke = new KE(getAdContextWrapper(), this.A0N.A05().A0r(), this.A0H.A1z().A01(), getAdEventManager(), this.A0N.A0D(), (C1550eX) null, this.A0N.A0A(), this.A0H.A21());
    ...
    private void setUpBrowserControls(LJ lj) {
        ...
        this.A0J.setListener(new C0844Jf(this));
        this.A0J.setOnTouchListener(new ViewOnTouchListenerC1333b0(this));
