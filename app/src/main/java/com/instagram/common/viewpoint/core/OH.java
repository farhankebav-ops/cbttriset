...
public final class OH extends Drawable {
    ...
    public OH(ColorStateList colorStateList, float f4) {
        this.A01 = f4;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = OJ.A01(this.A00, this.A01, this.A07);
    ...
    public final void A07(float f4, boolean z2, boolean z7) {
        if (f4 == this.A00 && this.A06 == z2 && this.A07 == z7) {
            return;
        }
        this.A00 = f4;
        this.A06 = z2;
