...
public final class AnonymousClass56 {
    ...
    public AnonymousClass56(Uri uri, long j, int i2, byte[] bArr, Map<String, String> map, long j3, long j8, String str, int i8, C0900Lj c0900Lj) {
        boolean z2 = true;
        C3M.A07(j + j3 >= 0);
        C3M.A07(j3 >= 0);
        if (j8 <= 0 && j8 != -1) {
    ...
    @MetaExoPlayerCustomization
    @Deprecated
    public AnonymousClass56(Uri uri, int i2, int i8) {
        this(uri, 0L, 1, null, Collections.emptyMap(), 0L, -1L, null, i2, new C0900Lj(A02(0, 0, 9), -1L, false, -1, -1, -1, -1, false, false, i8, -1L, new C0899Li(), -1L, false, -1, -1, -1L, -1L, -1, null, -1, null, null, C0898Lh.A02, -1, false, null, A02(0, 0, 9), A02(0, 0, 9), null, -1L, -1L));
    }

    @MetaExoPlayerCustomization("creation and passage of FbDataSpecExtension")
    @Deprecated
    public AnonymousClass56(Uri uri, long j, long j3, String str) {
        this(uri, 0L, 1, null, Collections.emptyMap(), j, j3, str, 0, new C0900Lj());
    }
    ...
    public final AnonymousClass56 A05(long j, long j3) {
        if (j == 0 && this.A03 == j3) {
            return this;
        }
        return new AnonymousClass56(this.A06, this.A05, this.A01, this.A0A, this.A09, this.A04 + j, j3, this.A08, this.A00, new C0900Lj(this.A07));
    }
