...
public final class VJ implements UR {
    ...
    public final C1451cu A06;
    public final UQ A07;
    public final InterfaceC1556ed A08;
    ...
    public VJ(C1451cu c1451cu, UQ uq) {
        this.A07 = uq;
        this.A06 = c1451cu;
        this.A04 = (ConnectivityManager) c1451cu.getSystemService(A03(293, 12, 115));
        this.A08 = C1574ev.A01(c1451cu);
        this.A03 = U9.A0K(c1451cu);
        this.A02 = U9.A0J(c1451cu);
    }
    ...
    public final void A0B() throws Exception {
        try {
            ...
            c1570er.put(A03(315, 7, 6), jSONObjectA5D.toString());
            InterfaceC1555ec interfaceC1555ecAGD = this.A08.AGD(this.A06.A05().A7y(), c1570er.A08());
            String strA6v = interfaceC1555ecAGD != null ? interfaceC1555ecAGD.A6v() : null;
            if (!TextUtils.isEmpty(strA6v) && interfaceC1555ecAGD != null) {
                if (interfaceC1555ecAGD.A94() != 200) {
                    if (this.A06.A05().AAF()) {
                        String responseBody = A0F;
                        Log.e(responseBody, A03(Sdk.SDKError.Reason.CONFIG_REFRESH_FAILED_VALUE, 48, 30) + interfaceC1555ecAGD.A94() + A03(3, 1, 55));
                    }
                    if (interfaceC1555ecAGD.A94() == 413 && U7.A2R(this.A06)) {
                        this.A07.AEr();
                        A05();
                        return;
                    } else {
