...
public final class C1550eX {
    ...
    @Nullable
    public AbstractRunnableC1164Vt A04;
    public C1551eY A05;
    ...
    public final WeakReference<AbstractC1549eW> A0E;
    ...
    public static int A08(Vector<Rect> vector) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            Rect rectElementAt = vector.elementAt(i9);
            int i10 = i2 + 1;
            iArr[i2] = rectElementAt.left;
            int i11 = i8 + 1;
            iArr2[i8] = rectElementAt.bottom;
            i2 = i10 + 1;
            iArr[i10] = rectElementAt.right;
            i8 = i11 + 1;
            iArr2[i11] = rectElementAt.top;
        }
        Arrays.sort(iArr);
        Arrays.sort(iArr2);
        for (int i12 = 0; i12 < size; i12++) {
            Rect rectElementAt2 = vector.elementAt(i12);
            ...
            for (int i13 = iA09 + 1; i13 <= iA092; i13++) {
                for (int i14 = iA093 + 1; i14 <= iA094; i14++) {
                    zArr[i13][i14] = true;
                }
            }
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00a3, code lost:
        ...
        return new com.instagram.common.viewpoint.core.C1551eY(com.instagram.common.viewpoint.core.LF.A0G);
     */
    ...
    */
    public static com.instagram.common.viewpoint.core.C1551eY A0E(android.view.View r7, int r8, com.instagram.common.viewpoint.core.C1477dL r9) {
        /*
            Method dump skipped, instruction units count: 659
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1550eX.A0E(android.view.View, int, com.facebook.ads.redexgen.X.dL):com.facebook.ads.redexgen.X.eY");
    }
    ...
    static {
        A0M();
        A0I = C1550eX.class.getSimpleName();
    }

    public C1550eX(View view, int i2, int i8, boolean z2, WeakReference<AbstractC1549eW> weakReference, C1477dL c1477dL) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = 1000;
        this.A08 = true;
        this.A05 = new C1551eY(LF.A0L);
    ...
    public C1550eX(View view, int i2, WeakReference<AbstractC1549eW> weakReference, C1477dL c1477dL) {
        this(view, i2, 0, false, weakReference, c1477dL);
    }

    public C1550eX(View view, int i2, boolean z2, WeakReference<AbstractC1549eW> weakReference, C1477dL c1477dL) {
        this(view, i2, 0, z2, weakReference, c1477dL);
    }
    ...
    public static /* synthetic */ int A05(C1550eX c1550eX) {
        int i2 = c1550eX.A00;
        c1550eX.A00 = i2 + 1;
        return i2;
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int iIndexOfChild = viewGroup.indexOfChild(view) + 1; iIndexOfChild < viewGroup.getChildCount(); iIndexOfChild++) {
            ...
            int childIndex = 1;
            boolean z2 = !(childAt instanceof C1453cw);
            if ((childAt instanceof I5) && AbstractC1552eZ.A00(childAt)) {
                childIndex = 0;
            }
            if (z2 && childIndex != 0) {
    ...
    */
    public static java.util.Vector<android.graphics.Rect> A0L(android.view.View r5) {
        ...
        L15:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1550eX.A0H
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 13
            if (r1 == r0) goto L85
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1550eX.A0H
        ...
        L50:
            ...
            if (r0 == 0) goto L76
            boolean r0 = com.instagram.common.viewpoint.core.AbstractC1552eZ.A00(r5)
            if (r0 != 0) goto L5c
            if (r1 == 0) goto L76
        L5c:
        ...
        L85:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1550eX.A0L(android.view.View):java.util.Vector");
    }
