...
public final class JR extends AbstractC1311ae {
    ...
    public final C1477dL A0M;
    public final C1120Ua A0N;
    public final C1291aK A0O;
    public final C1293aM A0P;
    public final C1315ai A0Q;
    public final E1 A0R;
    public final DX A0S;
    public final DP A0T;
    ...
    public static String A0J(int i2, int i8, int i9) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0V, i2, i2 + i8);
    ...
    static {
        A0Q();
        A0X = (int) (AbstractC1180Wl.A02 * 32.0f);
        A0Y = (int) (AbstractC1180Wl.A02 * 38.0f);
        A0Z = (int) (AbstractC1180Wl.A02 * 40.0f);
        A0a = (int) (AbstractC1180Wl.A02 * 44.0f);
        A0b = (int) (AbstractC1180Wl.A02 * 48.0f);
        A0c = (int) (AbstractC1180Wl.A02 * 16.0f);
    }

    public JR(C1315ai c1315ai) {
        super(c1315ai, false);
        ...
        this.A0S = new DX() { // from class: com.facebook.ads.redexgen.X.5Z
            ...
            public final void A03(C04433d c04433d) {
                this.A00.A0R.A0h(EnumC1493db.A02, 20);
            }
        };
        this.A0U = new RunnableC1346bD(this);
        this.A0M = c1315ai.A06();
        this.A0Q = c1315ai;
        this.A0N = new C1120Ua(this.A0Q.A05().A25(), getAdEventManager());
        ...
        this.A0R.A0h(EnumC1493db.A02, 20);
        ...
        XP.A0I(this.A0E);
        AbstractC1298aR.A00(this.A0Q.A06(), this, this.A0Q.A05().A20().A0H().A08());
    ...
    private RelativeLayout A07(String str, int i2) {
        RelativeLayout relativeLayout = new RelativeLayout(this.A0M);
        relativeLayout.setPadding(AbstractC1311ae.A0A, AbstractC1311ae.A0A, AbstractC1311ae.A0A, AbstractC1311ae.A0A);
        XP.A0Q(relativeLayout, XP.A06(i2, 30));
    ...
    private C1291aK A0D() {
        C1291aK c1291aK = new C1291aK(this.A0M);
        XP.A0K(c1291aK, 0);
        int i2 = (int) (this.A00 * 0.13f);
        new KZ(c1291aK, this.A0M).A05(i2, i2).A07(this.A0Q.A05().A23().A01());
        return c1291aK;
    }

    private C1293aM A0E() {
        C1293aM c1293aM = new C1293aM(this.A0M, A0c, 5, 0, -1);
        c1293aM.setRating(getRating());
        return c1293aM;
    }

    private E1 A0G() {
        E1 e12 = new E1(this.A0Q.A06());
        this.A09 = new C04483i(this.A0M, getAdEventManager(), e12, this.A0Q.A05().A25(), 0, 0, true, null, null);
        if (U7.A1v(this.A0M)) {
    ...
    private void A0K() {
        this.A0E.setOnClickListener(new ViewOnClickListenerC1348bF(this));
        if (this.A0Q.A05().A1g()) {
            this.A0L.setOnClickListener(new ViewOnClickListenerC1349bG(this));
        } else {
            this.A0G.setOnClickListener(new ViewOnClickListenerC1350bH(this));
        }
    }
    ...
    private void A0N() {
        if (this.A05 != null) {
            this.A05.setOnClickListener(new ViewOnClickListenerC1347bE(this));
        }
        A0S(8);
    }
    ...
    private void A0P() {
        ...
        layoutParams.setMargins(AbstractC1311ae.A0B, 0, 0, 0);
        layoutParams.addRule(15);
        this.A0H.setLayoutParams(layoutParams);
    }

    private void A0R(int i2) {
        if (i2 == 1) {
            addView(this.A0O);
            addView(this.A0C);
            addView(this.A0J);
    ...
    private void A0U(int i2) {
        ...
        if (i2 == 1) {
            ...
            layoutParams.setMargins(0, AbstractC1311ae.A0A, 0, 0);
            layoutParams.addRule(14);
        } else {
            layoutParams.addRule(1, this.A0O.getId());
            layoutParams.setMargins(AbstractC1311ae.A0A, 0, 0, 0);
        }
    ...
    private void A0V(int i2) {
        ...
        layoutParams.setMargins(0, AbstractC1311ae.A0E, 0, 0);
        if (i2 == 1) {
            layoutParams.addRule(14);
        }
    ...
    private void A0W(int i2) {
        if (this.A04 == null) {
            return;
        }
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) this.A04.getLayoutParams();
        int i8 = AbstractC1311ae.A0A;
        if (i2 == 1) {
            i8 = A0Y;
        }
        int leftMargin = AbstractC1311ae.A0A;
        layoutParams.setMargins(i8, 0, 0, leftMargin);
    ...
    private void A0X(int i2) {
        int i8;
        if (i2 == 1) {
            i8 = (int) (this.A00 * 0.13f);
            if (this.A0Q.A05().A1h()) {
                C1291aK c1291aK = this.A0O;
                String[] strArr = A0W;
                ...
                c1291aK.setVisibility(8);
            } else {
                this.A0O.setRadius(30);
            }
        } else {
            i8 = (int) (this.A01 * 0.08f);
    ...
    private void A0Y(int i2) {
        ...
        layoutParams.addRule(3, this.A0K.getId());
        if (i2 == 1) {
            topMargin = AbstractC1311ae.A0I;
            layoutParams.addRule(14);
        } else {
            topMargin = AbstractC1311ae.A0E;
        }
        layoutParams.setMargins(0, topMargin, 0, 0);
        this.A0P.setLayoutParams(layoutParams);
        this.A0P.setItemSpacing(AbstractC1311ae.A0I);
    }

    private void A0Z(int i2) {
        int i8;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(3, this.A0P.getId());
        if (i2 == 1) {
            i8 = AbstractC1311ae.A0I;
        } else {
            i8 = AbstractC1311ae.A0E;
        }
    ...
    private void A0a(int i2) {
        ...
        if (i2 == 1) {
            ...
            layoutParams.setMargins(A0a, AbstractC1311ae.A0A, A0a, 0);
        } else {
            layoutParams.addRule(3, this.A0O.getId());
            layoutParams.setMargins(0, AbstractC1311ae.A0C, 0, 0);
        }
    ...
    private void A0c(int i2) {
        ...
        if (i2 == 1) {
            if (this.A0Q.A05().A1g()) {
                view = this.A0L;
                i8 = AbstractC1311ae.A0C;
            } else {
                view = this.A0G;
                i8 = AbstractC1311ae.A0I;
            }
            layoutParams.setMargins(A0Y, 0, A0Y, i8);
            layoutParams.addRule(2, view.getId());
        } else {
            int topMargin = A0X;
            if (this.A0Q.A05().A2H()) {
                topMargin = AbstractC1311ae.A0D;
            }
            layoutParams.setMargins(0, topMargin, 0, 0);
    ...
    */
    private void A0e(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.JR.A0e(int):void");
    }
    ...
    private void A0g(int i2) {
        ...
        if (i2 == 1) {
            if (this.A0Q.A05().A2H() && this.A04 != null) {
                ...
                i8 = AbstractC1311ae.A0A;
            } else {
                layoutParams.addRule(12);
                i8 = A0a;
            }
            int bottomMargin = A0Y;
            layoutParams.setMargins(bottomMargin, 0, A0Y, i8);
        } else {
            layoutParams.addRule(3, this.A0E.getId());
            int i9 = AbstractC1311ae.A0I;
            String[] strArr = A0W;
            if (strArr[2].length() == strArr[4].length()) {
                throw new RuntimeException();
            }
    ...
    public final void A1O(C04483i c04483i) {
        if (this.A09 != null) {
            this.A09.A0o(c04483i);
        }
    }
