...
public final class YA extends RelativeLayout {
    ...
    public static final int A08 = (int) (AbstractC1180Wl.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC1180Wl.A02 * 8.0f);
    public static final int A09 = (int) (AbstractC1180Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC1180Wl.A02 * 24.0f);
    public static final int A06 = (int) (AbstractC1180Wl.A02 * 12.0f);

    public YA(C1477dL c1477dL, int i2, int i8, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1477dL);
        this.A05 = new TextView(c1477dL);
        this.A02 = new Button(c1477dL);
        this.A01 = new Button(c1477dL);
        ...
        int iA02 = OP.A02(i8, 20);
        XP.A0M(this.A02, i2, A07);
