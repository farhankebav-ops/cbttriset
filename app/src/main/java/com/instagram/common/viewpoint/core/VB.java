...
public final class VB {
     ...
     */
    public VB(SQ sq, String str, String str2, V6 v62) throws V2 {
        ...
        try {
            ...
            switch (V9.A00[VA.valueOf(jSONObject.getString(strA014).toUpperCase()).ordinal()]) {
                case 1:
                    ...
                    if (!jSONObject.getString(strA012).equals(sq.A05().A9L()) && !ProcessUtils.isRemoteRenderingProcess() && UA.A03(jSONObject) != Boolean.TRUE) {
                        throw new V2(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, A01(0, 54, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE), this.A01, jSONObject.getString(strA012), sq.A05().A9L()));
                    }
                    ...
                    return;
                default:
                    throw new V2(AdErrorType.BID_PAYLOAD_ERROR, A01(Sdk.SDKError.Reason.AD_NOT_LOADED_VALUE, 28, 68) + jSONObject.getString(strA014));
            }
        } catch (JSONException e) {
            sq.A08().AAy(A01(238, 3, 5), AbstractC1090Sv.A0P, new C1091Sw(e));
