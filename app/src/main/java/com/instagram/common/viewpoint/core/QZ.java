...
public class QZ {
    ...
    public QZ(int i2, int i8) {
        this(i2, i8, Integer.MIN_VALUE, null);
    }

    public QZ(int i2, int i8, int i9, Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i2;
    ...
    public final void A04(int i2, int i8, int i9, Interpolator interpolator) {
        this.A02 = i2;
        this.A03 = i8;
        this.A01 = i9;
        this.A05 = interpolator;
    ...
    public final void A05(C05246g c05246g) {
        if (this.A04 >= 0) {
            int i2 = this.A04;
            this.A04 = -1;
            c05246g.A1U(i2);
        ...
        if (this.A06) {
            ...
            if (interpolator == null) {
                if (this.A01 == Integer.MIN_VALUE) {
                    c05246g.A08.A0A(this.A02, this.A03);
                } else {
                    RunnableC1023Qf runnableC1023Qf = c05246g.A08;
                    int i8 = this.A02;
                    int i9 = this.A03;
                    if (A08[1].length() != 25) {
                        runnableC1023Qf.A0B(i8, i9, this.A01);
                    } else {
                        String[] strArr2 = A08;
                ...
                c05246g.A08.A0C(this.A02, this.A03, this.A01, this.A05);
            }
            this.A00++;
            if (this.A00 > 10) {
