...
public abstract class VQ {
    ...
    public static void A04() {
        A04 = new byte[]{96, 54, 127, 96, 54, 127, 96, 33, 127, 96, 33, 127, 96, 33, 80, 85, 3, 1, 82, 82, 83, 84, 11, 45, 55, 48, 57, 126, 50, 63, 45, 42, 126, 63, 58, 126, 44, 59, 45, 46, 49, 48, 45, 59, 65, 67, 82, 106, 71, 85, 82, 116, 67, 85, 86, 73, 72, 85, 67};
    }
    ...
    public static boolean A08(VR vr) {
        ...
        String strA03 = A03(vr);
        if (A00.containsKey(strA03)) {
            return System.currentTimeMillis() - A00.get(strA03).longValue() < A00(strA03, vr.A07());
        }
        return false;
    }
}
