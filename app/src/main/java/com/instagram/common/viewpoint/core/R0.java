...
public final class R0 implements AudienceNetworkActivityApi, Repairable {
    ...
    public EnumC1147Vb A07;
    public InterfaceC1209Xo A08;
    public AbstractC1224Yd A09;
    public C1453cw A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public R0(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        this.A0I = new C1046Rc(this.A0J, this.A0E);
        this.A0G = new RA(this, this.A0J, this.A0E);
    }

    private String A00() {
        if (this.A07 == null || this.A07.A03() == null) {
            return A01(Sdk.SDKError.Reason.CONFIG_REFRESH_FAILED_VALUE, 4, 114);
        }
        return this.A07.A03();
    }
    ...
    private void A03(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            this.A07 = (EnumC1147Vb) bundleA03.getSerializable(strA01);
            return;
        }
        this.A01 = intent.getIntExtra(strA013, -1);
        this.A0B = intent.getStringExtra(strA012);
        this.A07 = (EnumC1147Vb) intent.getSerializableExtra(strA01);
    ...
    public final void A0D(String str, N9 n9) {
        ...
        AbstractC1224Yd abstractC1224Yd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC1224Yd == null) {
            this.A09 = AbstractC1225Ye.A02(this.A0J, this.A0J.A0A(), str, n9, this.A08, new C1636fw(this));
    ...
    public final void A0E(String str, C1098Td c1098Td) {
        this.A0G.A08(str, c1098Td, this.A0B);
    }
    ...
    public final void finish(int i2) {
        this.A0J.A0F().A35(String.valueOf(A05().hashCode()), i2, A00());
    ...
    public final void onActivityResult(int i2, int i8, Intent intent) {
        if (this.A08 != null && this.A08.onActivityResult(i2, i8, intent)) {
            return;
        }
        LJ.A07(i2, i8, intent);
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            if (i2 == 1) {
                ...
                map.put(strA01, A01(Sdk.SDKError.Reason.EMPTY_TPAT_ERROR_VALUE, 9, 32));
            }
            C1120Ua.A02(UZ.A0K, map, this.A08 == null ? A01(0, 0, 15) : this.A08.getCurrentClientToken(), this.A0J.A0A());
    ...
    public final void onCreate(Bundle bundle) {
        ...
        C1477dL c1477dLA04 = WB.A04(this.A05);
        if (c1477dLA04 != null) {
            C1477dL startAdContext = this.A0J;
            startAdContext.A0M(c1477dLA04);
        }
        A03(this.A05, bundle);
        C1477dL startAdContext2 = this.A0J;
        ...
        C1477dL startAdContext3 = this.A0J;
        US usA0A = startAdContext3.A0A();
        C1477dL startAdContext4 = this.A0J;
        this.A08 = new R5(this, intent, usA0A, startAdContext4).A0N(this.A07, this.A06);
        if (this.A08 == null) {
            C1477dL startAdContext5 = this.A0J;
            startAdContext5.A08().AAy(A01(58, 11, 105), AbstractC1090Sv.A0A, new C1091Sw(A01(0, 58, 116)));
            A09();
            finish(7);
            return;
        }
    ...
    public final void onPause() {
        ...
        if (this.A08 != null) {
            this.A08.AEV(false);
            if (!this.A0E.isFinishing()) {
                C1120Ua.A02(UZ.A0E, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
                this.A0D = true;
            }
        }
    }
    ...
    public final void onResume() {
        ...
        if (this.A08 != null) {
            ...
            interfaceC1209Xo.AF0(false);
            if (this.A0D) {
                C1120Ua.A02(UZ.A0F, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
            }
        }
    }
    ...
    public final void onStart() {
        ...
        if (this.A01 != -1) {
            AbstractC1203Xi.A02(this.A0E, this.A01, this.A0J);
        }
    }
