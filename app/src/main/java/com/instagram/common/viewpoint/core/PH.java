...
public class PH extends ViewGroup {
    ...
    private P9 A03() {
        ...
        P9 p9 = null;
        int i8 = 0;
        while (i8 < this.A0r.size()) {
            P9 p92 = this.A0r.get(i8);
            if (!z2 && p92.A02 != i2 + 1) {
                p92 = this.A0p;
                p92.A00 = f8 + f9 + f4;
                p92.A02 = i2 + 1;
            ...
            if (scrollX < f11 || i8 == this.A0r.size() - 1) {
                return p92;
            }
            z2 = false;
            i2 = p92.A02;
    ...
    public static String A08(int i2, int i8, int i9) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0s, i2, i2 + i8);
     ...
     */
    private final void A0J(int i2, int i8, int i9) {
        int scrollX;
        if (getChildCount() == 0) {
        ...
        float fA00 = i12 + (i12 * A00(Math.min(1.0f, (Math.abs(i10) * 1.0f) / clientWidth)));
        int iAbs = Math.abs(i9);
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fA00 / iAbs) * 1000.0f) * 4 : (int) ((1.0f + (Math.abs(i10) / (this.A0M + (clientWidth * this.A01.A00(this.A00))))) * 100.0f), 600);
        this.A0j = false;
        this.A0X.startScroll(scrollX, scrollY, i10, i11, iMin);
        P3.A07(this);
    }
    ...
    */
    public void onMeasure(int r16, int r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.onMeasure(int, int):void");
    }
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r10) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private int A01(int i2, float f4, int i8, int i9) {
        if (Math.abs(i9) > this.A0H && Math.abs(i8) > this.A0K) {
            if (i8 <= 0) {
                i2++;
            }
        } else {
        ...
        if (targetPage2 > 0) {
            ...
            int i10 = lastItem.A02;
            int targetPage4 = p9.A02;
            return Math.max(i10, Math.min(i2, targetPage4));
        }
        return i2;
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.P9 A04(int r7) {
        /*
            r6 = this;
            r5 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.P9 r4 = (com.instagram.common.viewpoint.core.P9) r4
            int r3 = r4.A02
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.PH.A0t
            r0 = 6
            r1 = r1[r0]
            r0 = 18
            ...
            r0 = 53
            if (r1 == r0) goto L34
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.PH.A0t
        ...
        L3a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.A04(int):com.facebook.ads.redexgen.X.P9");
    }

    private final P9 A05(int i2, int i8) {
        P9 p9 = new P9();
        p9.A02 = i2;
        p9.A03 = this.A01.A04(this, i2);
        p9.A01 = this.A01.A00(i2);
        if (i8 < 0 || i8 >= this.A0r.size()) {
            this.A0r.add(p9);
        } else {
            this.A0r.add(i8, p9);
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.P9 A07(android.view.View r5) {
        /*
            r4 = this;
            r3 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.P9 r2 = (com.instagram.common.viewpoint.core.P9) r2
        ...
        L1f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.A07(android.view.View):com.facebook.ads.redexgen.X.P9");
    }
    ...
    */
    private void A0A() {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.PA r0 = (com.instagram.common.viewpoint.core.PA) r0
            boolean r0 = r0.A05
            if (r0 != 0) goto L1a
            r2.removeViewAt(r1)
            int r1 = r1 + (-1)
        ...
        L1d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.A0A():void");
    }
    ...
    private final void A0D() {
        ...
        P3.A0B(this, new C1669gV(this));
        if (P3.A00(this) == 0) {
            P3.A09(this, 1);
        }
        P3.A0C(this, new C1670gW(this));
    }
    ...
    */
    private final void A0G(int r17) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.A0G(int):void");
    }

    private void A0H(int i2, float f4, int i8) {
        if (this.A0d != null) {
            int z2 = this.A0d.size();
    ...
    private final void A0I(int i2, float f4, int i8) {
        int iMax;
        if (this.A0D > 0) {
            ...
            for (int childCount = 0; childCount < i9; childCount++) {
                ...
                if (paddingLeft2 != 53) {
                    ...
                    if (lp.A05) {
                        ...
                        int i10 = (iMax + childLeft) - scrollX6;
                        String[] strArr = A0t;
                        String str = strArr[4];
    ...
    private void A0K(int i2, int i8, int i9, int i10) {
        if (i8 > 0 && !this.A0r.isEmpty()) {
            if (!this.A0X.isFinished()) {
                this.A0X.setFinalX(getCurrentItem() * getClientWidth());
                return;
            }
            int paddingLeft = ((i2 - getPaddingLeft()) - getPaddingRight()) + i9;
            int widthWithMargin = getPaddingLeft();
            int i11 = i8 - widthWithMargin;
            int widthWithMargin2 = getPaddingRight();
            int i12 = (i11 - widthWithMargin2) + i10;
            int widthWithMargin3 = getScrollX();
            int oldWidthWithMargin = (int) (paddingLeft * (widthWithMargin3 / i12));
    ...
    private void A0M(int i2, boolean z2, int i8, boolean z7) {
        P9 p9A04 = A04(i2);
        int destX = 0;
        if (p9A04 != null) {
            destX = (int) (getClientWidth() * Math.max(this.A02, Math.min(p9A04.A00, this.A07)));
        }
        if (z2) {
            A0J(destX, 0, i8);
            if (z7) {
    ...
    private final void A0N(int i2, boolean z2, boolean z7) {
        A0O(i2, z2, z7, 0);
    }

    private final void A0O(int i2, boolean z2, boolean z7, int i8) {
        ...
        int i9 = this.A0L;
        if (i2 > this.A00 + i9 || i2 < this.A00 - i9) {
            for (int i10 = 0; i10 < this.A0r.size(); i10++) {
                this.A0r.get(i10).A04 = true;
            }
        }
        boolean z8 = this.A00 != i2;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0Q(com.instagram.common.viewpoint.core.P9 r13, int r14, com.instagram.common.viewpoint.core.P9 r15) {
        /*
            Method dump skipped, instruction units count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.A0Q(com.facebook.ads.redexgen.X.P9, int, com.facebook.ads.redexgen.X.P9):void");
    }

    private void A0R(boolean z2) {
        boolean z7 = this.A0P == 2;
        if (z7) {
            setScrollingCacheEnabled(false);
    ...
    private boolean A0X(float f4) {
        boolean z2 = false;
        float f8 = this.A05 - f4;
        this.A05 = f4;
        float scrollX = getScrollX() + f8;
        int clientWidth = getClientWidth();
        float f9 = clientWidth * this.A02;
    ...
    private final boolean A0Y(float f4, float f8) {
        return (f4 < ((float) this.A0I) && f8 > 0.0f) || (f4 > ((float) (getWidth() - this.A0I)) && f8 < 0.0f);
    }
    ...
    private boolean A0Z(int i2) {
        ...
        int i8 = p9A03.A02;
        float f4 = ((i2 / currentPage) - p9A03.A00) / (p9A03.A01 + (this.A0M / currentPage));
        this.A0e = false;
        A0I(i8, f4, (int) (widthWithMargin * f4));
        if (this.A0e) {
            return true;
        }
        throw new IllegalStateException(strA08);
    ...
    private final boolean A0a(int i2) {
        ...
        if (viewFindFocus == this) {
            ...
            if (!z2) {
                ...
                Log.e(A08(MlKitException.LOW_LIGHT_AUTO_EXPOSURE_COMPUTATION_FAILURE, 9, 73), A08(309, 72, 43) + sb.toString());
                viewFindFocus = null;
            }
        }
        boolean zA0V = false;
        View nextFocused = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, i2);
    ...
    private final boolean A0d(View view, boolean z2, int i2, int i8, int i9) {
        if (view instanceof ViewGroup) {
            ...
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                ...
                if (i8 + count >= childAt.getLeft() && i8 + count < childAt.getRight() && i9 + scrollY >= childAt.getTop() && i9 + scrollY < childAt.getBottom() && A0d(childAt, true, i2, (i8 + count) - childAt.getLeft(), (i9 + scrollY) - childAt.getTop())) {
                    return true;
                }
            }
        }
    ...
    */
    public final void A0e() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.A0e():void");
    }
    ...
    public final void addFocusables(ArrayList<View> views, int i2, int i8) {
        ...
        if (descendantFocusability != 393216) {
            ...
            while (true) {
                ...
                if (focusableCount == 0 && (p9A07 = A07(childAt)) != null) {
                    int descendantFocusability3 = p9A07.A02;
        ...
        int descendantFocusability4 = i8 & 1;
                ...
                for (int i2 = 0; i2 < childCount; i2++) {
                    ...
                    if (childCount2 == 0) {
                        ...
                        if (p9A07 != null) {
                            ...
                            if (i9 == childCount4 && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                                return true;
                            }
                        } else {
                            continue;
    ...
    public AbstractC0980Oo getAdapter() {
        return this.A01;
    }

    @Override // android.view.ViewGroup
    public final int getChildDrawingOrder(int i2, int i8) {
        int result = this.A0F == 2 ? (i2 - 1) - i8 : i8;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            int scrollX = getScrollX();
            int pos = getWidth();
            float f8 = this.A0M / pos;
            int firstPos = 0;
            P9 p9 = this.A0r.get(0);
            float marginOffset = p9.A00;
            int itemCount = this.A0r.size();
            int i2 = this.A0r.get(itemCount - 1).A02;
            for (int i8 = p9.A02; i8 < i2; i8++) {
                while (i8 > p9.A02 && firstPos < itemCount) {
                    firstPos++;
                    p9 = this.A0r.get(firstPos);
                }
                if (i8 == p9.A02) {
                    f4 = (p9.A00 + p9.A01) * pos;
                    float marginOffset2 = p9.A00;
                    marginOffset = marginOffset2 + p9.A01 + f8;
                } else {
                    float fA00 = this.A01.A00(i8);
                    f4 = (marginOffset + fA00) * pos;
                    marginOffset += fA00 + f8;
                }
                if (this.A0M + f4 > scrollX) {
                    Drawable drawable = this.A0S;
                    int iRound = Math.round(f4);
                    int i9 = this.A0Q;
                    int width = Math.round(this.A0M + f4);
                    drawable.setBounds(iRound, i9, width, this.A09);
    ...
    */
    public final boolean onInterceptTouchEvent(android.view.MotionEvent r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
            ...
            if (paddingTop < scrollX) {
                ...
                while (paddingBottom3 < scrollX) {
                    ...
                    if (childAt2.getVisibility() != count2) {
                        ...
                        if (!pa2.A05 && (p9A07 = A07(childAt2)) != null) {
                            int i12 = vgrav + ((int) (childLeft2 * p9A07.A00));
                            if (pa2.A03) {
                                pa2.A03 = false;
                                int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childLeft2 * pa2.A00), BasicMeasure.EXACTLY);
                                childAt2.measure(widthSpec, View.MeasureSpec.makeMeasureSpec((childWidth - width) - paddingBottom, BasicMeasure.EXACTLY));
                            }
                            int childTop3 = childAt2.getMeasuredWidth() + i12;
                            width = width;
                            ...
                            if (widthSpec2 != str4.charAt(20)) {
                                ...
                                childAt2.layout(i12, width, childTop3, height);
                            } else {
                                childAt2.layout(i12, width, childTop3, height);
                            }
                        }
    ...
    public final boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        while (i8 != childCount) {
            ...
            if (count2 == 0 && (p9A07 = A07(childAt)) != null) {
                int index = p9A07.A02;
                int count3 = this.A00;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setAdapter(com.instagram.common.viewpoint.core.AbstractC0980Oo r7) {
        /*
            r6 = this;
        ...
        Lc:
            ...
            com.facebook.ads.redexgen.X.P9 r0 = (com.instagram.common.viewpoint.core.P9) r0
        ...
        Lc2:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.PH.setAdapter(com.facebook.ads.redexgen.X.Oo):void");
    }
    ...
    public void setOffscreenPageLimit(int i2) {
        if (i2 < 1) {
            Log.w(A08(MlKitException.LOW_LIGHT_AUTO_EXPOSURE_COMPUTATION_FAILURE, 9, 73), A08(127, 31, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE) + i2 + A08(51, 26, 45) + 1);
            i2 = 1;
        }
        if (i2 != this.A0L) {
            this.A0L = i2;
    ...
    public void setPageMarginDrawable(int i2) {
        setPageMarginDrawable(OK.A00(getContext(), i2));
    }
