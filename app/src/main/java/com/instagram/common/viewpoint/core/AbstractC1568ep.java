...
public abstract class AbstractC1568ep {
    ...
    public AbstractC1568ep(String str, C1570er c1570er, C1564el c1564el) {
        this.A03 = A00(0, 0, 34);
        if (str != null) {
            this.A03 = str;
        }
        if (c1570er != null && !c1570er.A06().isEmpty()) {
            this.A03 += A00(0, 1, 55) + c1570er.A06();
        }
        this.A00 = c1564el;
    }

    public final C1564el A02() {
        return this.A00;
    }

    public final EnumC1567eo A03() {
        return this.A01;
    }
