...
public final class JS extends AbstractC1311ae {
    public RelativeLayout A00;
    public RelativeLayout A01;
    public InterfaceC1435ce A02;
    public EG A03;
    public E1 A04;
    public C04483i A05;
    ...
    public static final int A0V = (int) (AbstractC1180Wl.A02 * 24.0f);
    public static final int A0U = (int) (AbstractC1180Wl.A02 * 8.0f);
    public static final int A0N = (int) (AbstractC1180Wl.A02 * 1.0f);
    public static final int A0O = (int) (AbstractC1180Wl.A02 * 24.0f);
    public static final int A0T = (int) (AbstractC1180Wl.A02 * 3.0f);
    public static final int A0I = (int) (AbstractC1180Wl.A02 * 5.0f);
    public static final int A0W = (int) (AbstractC1180Wl.A02 * 8.0f);
    public static final int A0J = (int) (AbstractC1180Wl.A02 * 16.0f);
    public static final int A0L = (int) (AbstractC1180Wl.A02 * 16.0f);
    public static final int A0K = (int) (AbstractC1180Wl.A02 * 8.0f);
    public static final int A0M = (int) (AbstractC1180Wl.A02 * 8.0f);
    public static final int A0P = (int) (AbstractC1180Wl.A02 * 12.0f);
    public static final int A0H = (int) (AbstractC1180Wl.A02 * 40.0f);
    public static final int A0S = (int) (AbstractC1180Wl.A02 * 16.0f);
    public static final int A0R = (int) (AbstractC1180Wl.A02 * 24.0f);
    public static final int A0Q = (int) (AbstractC1180Wl.A02 * 16.0f);
    public static final int A0G = (int) (AbstractC1180Wl.A02 * 6.0f);

    public JS(C1315ai c1315ai) {
        super(c1315ai, false);
        ...
        this.A0D = new DX() { // from class: com.facebook.ads.redexgen.X.5b
            ...
            public final void A03(C04433d c04433d) {
                this.A00.A04.A0h(EnumC1493db.A02, 20);
            }
        };
        this.A0B = c1315ai.A06();
        this.A0C = c1315ai;
    ...
    private LinearLayout A00() {
        ...
        if (!TextUtils.isEmpty(strA0B)) {
            XX xx = XX.RATINGS;
            AbstractC1752hy abstractC1752hyA05 = this.A0C.A05();
            String[] strArr = A0F;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            A0F[2] = "";
            LinearLayout videoMetaDataLayout = A01(xx, abstractC1752hyA05.A20().A0I().A0B());
    ...
    private LinearLayout A01(XX xx, String str) {
        ...
        C1285aE c1285aE = new C1285aE(this.A0C.A06(), 0, -1, xx);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(A0P, A0P);
        layoutParams2.gravity = 16;
        c1285aE.setLayoutParams(layoutParams2);
    ...
    private final RelativeLayout A02(String str, int i2, XX xx) {
        ...
        XP.A0Q(relativeLayout, XP.A06(i2, A0G));
        ...
        C1285aE iconView = new C1285aE(this.A0C.A06(), 0, -1, xx);
    ...
    private TextView A03(String str, boolean z2, int i2, int i8, int i9) {
        TextView textView = new TextView(this.A0B);
        textView.setText(str);
        textView.setTextColor(i8);
        XP.A0W(textView, z2, i2);
    ...
    private E1 A05() {
        ...
        this.A05 = new C04483i(this.A0B, getAdEventManager(), e12, this.A0C.A05().A25(), 0, 0, true, null, null);
        if (U7.A1v(this.A0B)) {
    ...
    private void A07() {
        ...
        this.A00.setOnClickListener(new ViewOnClickListenerC1344bB(this));
        this.A01.setOnClickListener(new ViewOnClickListenerC1345bC(this));
    }

    private void A08() {
        new C1120Ua(this.A0C.A05().A25(), getAdEventManager()).A04(UZ.A0f, null);
        AbstractC1298aR.A00(this.A0C.A06(), this, this.A0C.A05().A20().A0H().A08());
        ...
        this.A04.A0h(EnumC1493db.A02, 20);
