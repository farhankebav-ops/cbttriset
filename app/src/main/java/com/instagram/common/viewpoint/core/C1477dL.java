...
public class C1477dL extends SQ {
    ...
    public C1477dL(Activity activity, SS ss, LH lh) {
    ...
    public C1477dL(Context context, SS ss, LH lh) {
    ...
    public static Activity A00(Context context) {
        while (context instanceof ContextWrapper) {
            ...
            if ((context instanceof C1477dL) && ((C1477dL) context).A0E() != null) {
                return ((C1477dL) context).A0E();
            }
    ...
    public final void A0L(C1477dL c1477dL) {
        c1477dL.A01.putAll(this.A01);
        this.A01 = c1477dL.A01;
    }

    public final void A0M(C1477dL c1477dL) {
        A0K(c1477dL.A0F());
        A0D(c1477dL.A0C());
        A0N(c1477dL.A0G());
    }
