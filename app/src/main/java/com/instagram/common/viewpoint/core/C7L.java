...
public final class C7L<NativeViewabilityLogger> implements InterfaceC1789id {
    ...
    public US A05;
    public V4 A06;
    public InterfaceC1254Zh A08;
    public C0873Ki A09;
    public C5G A0A;
    public AbstractC1549eW A0B;
    public C1550eX A0C;
    public String A0E;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.7L != com.facebook.ads.internal.adapters.FacebookBannerAdapter<NativeViewabilityLogger> */
    public void A0C(int i2, TF tf) {
        C1785iZ c1785iZ = new C1785iZ(this);
        this.A0A = new C5G(this.A04, this.A05, c1785iZ, this.A03, A08(0, 31, 79), 2, this.A07);
        this.A0B = new C1780iU(this);
        this.A0C = new C1550eX(this.A0A, tf.A04(), tf.A09(), true, new WeakReference(this.A0B), this.A04);
    ...
    private void A0F(TF tf, JSONObject jSONObject, V4 v42) {
        this.A0G = false;
        final C1766iG c1766iGA00 = C1766iG.A00(this.A04, jSONObject);
        this.A0E = c1766iGA00.A7G();
        if (ML.A06(this.A04, c1766iGA00, this.A05)) {
            this.A04.A0F().A4u();
            this.A00.ADj(this, V1.A00(AdErrorType.NO_FILL));
            return;
        }
        this.A08 = new AbstractC0884Kt() { // from class: com.facebook.ads.redexgen.X.7M
            ...
            public final void ACj(String str, Map<String, String> map) {
                ...
                if (adAction != null) {
                    try {
                        ...
                        Log.e(C7L.A0L, A00(0, 22, 111), e);
                    }
                }
                if (A00(32, 4, Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE).equals(uriA00.getScheme()) && MI.A04(uriA00.getAuthority()) && this.A00.A00 != null && meA0G != ME.A06) {
        ...
        this.A09 = new C0873Ki(this.A04, (WeakReference<InterfaceC1254Zh>) new WeakReference(this.A08), tf.A04(), A7G());
        this.A09.A0L(tf.A07(), tf.A08());
        MS impressionHelper = new C1779iT(this);
        this.A02 = new C1764iE(this.A04, this.A05, this.A09, this.A09.getViewabilityChecker(), impressionHelper, v42);
        this.A02.A0A(c1766iGA00);
        this.A09.loadDataWithBaseURL(AbstractC1257Zk.A01(AdInternalSettings.getUrlPrefix()), c1766iGA00.A04(), A08(31, 9, 19), A08(40, 5, 12), null);
        this.A0F = true;
        A0A();
    }
  ...
  0x007c: PHI (r1v11 int) = (r1v10 int), (r1v13 int), (r1v17 int) binds: [B:20:0x0079, B:14:0x005d, B:12:0x0051] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private void A0G(com.instagram.common.viewpoint.core.V4 r11, com.instagram.common.viewpoint.core.TF r12) {
        /*
            r10 = this;
            com.facebook.ads.redexgen.X.78 r0 = r10.A03
            if (r0 == 0) goto L23
            com.facebook.ads.redexgen.X.US r3 = r10.A05
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C7L.A0K
            r0 = 1
            r1 = r1[r0]
            r0 = 21
            ...
            r0 = 73
            if (r1 == r0) goto La7
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C7L.A0K
        ...
        L24:
            ...
            boolean r0 = com.instagram.common.viewpoint.core.U7.A2A(r0)
            if (r0 == 0) goto L7c
        L53:
            com.facebook.ads.redexgen.X.78 r0 = r10.A03
            org.json.JSONObject r0 = r0.A1C()
            boolean r0 = com.instagram.common.viewpoint.core.C1049Rf.A0A(r0)
            if (r0 == 0) goto L7c
            r0 = 1
        L60:
            if (r0 != 0) goto L7e
        ...
        La7:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C7L.A0G(com.facebook.ads.redexgen.X.V4, com.facebook.ads.redexgen.X.TF):void");
    }
