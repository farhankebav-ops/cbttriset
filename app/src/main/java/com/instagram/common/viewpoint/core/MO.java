...
public final class MO {
    ...
    public MO(US us, final Activity activity, int i2) {
        this.A08 = us;
    ...
    public static MO A01(US us, Activity activity, int i2) {
        if (activity != null && i2 >= 14) {
            return new MO(us, activity, i2);
        }
        return null;
    }

    private void A04(String str, long j, long j3, ME me) {
        HashMap map = new HashMap();
        map.put(A02(54, 10, 111), Long.toString(j));
        map.put(A02(45, 9, 113), Long.toString(j3));
        if (me != null) {
            map.put(A02(64, 7, 66), me.name());
        }
    ...
    public final void A05() {
        ...
        if (this.A06 != null) {
            ...
            if (application != null && (this.A02.getBaseContext() instanceof C1477dL)) {
                ((C1477dL) this.A02.getBaseContext()).A08().AAy(A02(71, 9, 21), AbstractC1090Sv.A22, new C1091Sw(strA02));
            }
            Log.w(A0B, strA02);
        }
