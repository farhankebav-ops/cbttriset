...
public abstract class AnonymousClass14 extends C9Z {
    ...
    public final C2076nY A0q;
    public final C2076nY A0r;
    public final C6N A0s;
    public final C9U A0t;
    public final InterfaceC0626Ar A0u;
    public final ArrayDeque<C0609Aa> A0v;
    public final List<Long> A0w;
    public final boolean A0x;
    public final boolean A0y;
    public final boolean A0z;
    public final MediaCodecRendererMetaParameters A10;
    public final C1749hv A11;

    @MetaExoPlayerCustomization(type = {"TEMPORARY"}, value = "D60404164: Merge init calls in the renderer")
    public final boolean A12;

    public static String A0x(int i2, int i8, int i9) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A13, i2, i2 + i8);
    ...
    public abstract int A1g(AO ao, AR ar, C2154or c2154or, C2154or c2154or2);

    public abstract int A1h(InterfaceC0626Ar interfaceC0626Ar, C9U c9u, C2154or c2154or) throws C0630Av;

    public abstract List<AR> A1l(InterfaceC0626Ar interfaceC0626Ar, C2154or c2154or, boolean z2) throws C0630Av;

    public abstract void A1u(C2076nY c2076nY);

    public abstract void A1v(@MetaExoPlayerCustomization AO ao, MediaFormat mediaFormat) throws C9Y;

    public abstract void A1w(AR ar, AO ao, C2154or c2154or, MediaCrypto mediaCrypto) throws C0630Av;

    @MetaExoPlayerCustomization("D45988204: [FBLite][Video] Add Codec Hooks for Logging")
    public abstract void A1x(String str);

    public abstract void A1y(String str, long j, long j3);

    public abstract boolean A22();

    public abstract boolean A23(long j, long j3, AO ao, ByteBuffer byteBuffer, int i2, int i8, long j8, boolean z2, boolean z7) throws C9Y;
    ...
    public AnonymousClass14(int i2, C1749hv c1749hv, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, InterfaceC0626Ar interfaceC0626Ar, C9U c9u, boolean z2, boolean z7, int i8, int i9) {
        super(i2);
        this.A09 = -9223372036854775807L;
        this.A08 = -9223372036854775807L;
        this.A0m = false;
        this.A0k = false;
        C3M.A08(AbstractC04664a.A02 >= 16);
        this.A11 = (C1749hv) C3M.A01(c1749hv);
        this.A10 = (MediaCodecRendererMetaParameters) C3M.A01(mediaCodecRendererMetaParameters);
        this.A0u = (InterfaceC0626Ar) C3M.A01(interfaceC0626Ar);
        this.A0t = c9u;
        this.A0z = z2;
        this.A0x = z7;
        this.A0o = i8;
        this.A0n = i9;
        this.A0q = new C2076nY(0);
        this.A0r = C2076nY.A02();
        this.A0s = new C6N();
        ...
        this.A0y = MetaExoPlayerUpgradeConfig.A03(EnumC1753i2.A1r);
        this.A12 = MetaExoPlayerUpgradeConfig.A03(EnumC1753i2.A1c);
    }
    ...
    */
    private int A0w(java.lang.String r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AnonymousClass14.A0w(java.lang.String):int");
    }

    private ByteBuffer A0y(int i2) {
        return this.A0G.A8B(i2);
    }

    private ByteBuffer A0z(int i2) {
        return this.A0G.A8W(i2);
    }

    private List<AR> A10(boolean z2) throws C0630Av {
        String alternativeMimeType;
        List<AR> listA1l = A1l(this.A0u, this.A0i, z2);
        if (listA1l.isEmpty() && z2) {
        ...
        if (listA1l.isEmpty() && this.A0l && (alternativeMimeType = C0633Ay.A0P(this.A0i)) != null) {
    ...
    private void A16(AR ar, MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            new C2030mo().A00();
            aoA0K = AV.A02().A0K(A22(), this.A11, this.A10.getA00(), EnumC1746hq.A05, str);
            try {
                this.A0K = str;
                C4S.A00();
    ...
    private void A17(AR ar, AR ar2, MediaCrypto mediaCrypto) throws Exception {
        int iA00 = MetaExoPlayerUpgradeConfig.A00(EnumC1754i3.A06);
        if (iA00 >= 0) {
            try {
                A16(ar2, mediaCrypto);
                return;
    ...
    private void A18(C0609Aa c0609Aa) {
        this.A0J = c0609Aa;
        if (c0609Aa.A02 != -9223372036854775807L) {
            this.A0a = true;
        }
    }
    ...
    private boolean A19() {
        ...
        boolean z2 = this.A08 == -9223372036854775807L || System.currentTimeMillis() - this.A08 <= ((long) this.A0n);
    ...
    private boolean A1A() throws C9Y {
        ...
        if (this.A0g) {
            ...
            boolean zA03 = MetaExoPlayerUpgradeConfig.A03(EnumC1753i2.A10);
        ...
        if (this.A0q.A05()) {
            ...
            try {
                ...
                C2154or c2154or = this.A0i;
                int adaptiveReconfigurationBytes = e.getErrorCode();
                throw A1S(e, c2154or, AbstractC04664a.A02(adaptiveReconfigurationBytes));
            }
        }
        ...
        if (bufferEncrypted4 && !skipIfSampleTooLarge) {
            AbstractC0778Gq.A0G(this.A0q.A02);
        ...
        try {
            ...
            C2154or c2154or2 = this.A0i;
            int adaptiveReconfigurationBytes2 = e4.getErrorCode();
            throw A1S(e4, c2154or2, AbstractC04664a.A02(adaptiveReconfigurationBytes2));
        }
    }
    ...
    private boolean A1C(int i2) throws C9Y {
        C6N c6nA1U = A1U();
        this.A0r.A0A();
        int iA1R = A1R(c6nA1U, this.A0r, i2 | 4);
        if (iA1R == -5) {
            A1s(c6nA1U.A00);
            return true;
        }
    ...
    private boolean A1D(long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            if (this.A0w.get(i2).longValue() == j) {
                this.A0w.remove(i2);
                return true;
            }
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A1E(long r21, long r23) throws com.instagram.common.viewpoint.core.C9Y {
        /*
            Method dump skipped, instruction units count: 450
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AnonymousClass14.A1E(long, long):boolean");
    }

    private boolean A1F(MediaCrypto mediaCrypto, boolean z2) throws AY {
        if (this.A0M == null) {
            try {
                List<AR> listA10 = A10(z2);
                if (this.A0x) {
                ...
                throw new AY(this.A0i, e, z2, -49998);
            }
        }
        if (!this.A0k && A21()) {
        ...
        if (!this.A0M.isEmpty()) {
            ...
            do {
                ...
                try {
                    ...
                    AnonymousClass44.A0A(A0x(Sdk.SDKError.Reason.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(156, 30, 18) + arPeekFirst2, e4);
                    this.A0M.removeFirst();
                    AY ay = new AY(this.A0i, e4, z2, arPeekFirst2);
                    if (this.A0I == null) {
                        this.A0I = ay;
                    } else {
        ...
        throw new AY(this.A0i, (Throwable) null, z2, -49999);
    }

    public static boolean A1G(C2154or c2154or) {
        return c2154or.A07 == 0 || c2154or.A07 == 2;
    }
    ...
    */
    public static boolean A1I(java.lang.String r6) {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AnonymousClass14.A14
            r0 = 4
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L34:
            ...
            r0 = 19
            if (r1 > r0) goto L96
            java.lang.String r3 = com.instagram.common.viewpoint.core.AbstractC04664a.A03
        ...
        L98:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AnonymousClass14.A1I(java.lang.String):boolean");
    }

    public static boolean A1J(String str) {
        return AbstractC04664a.A02 == 21 && A0x(519, 22, 41).equals(str);
    }

    public static boolean A1K(String str) {
        if (AbstractC04664a.A02 >= 18 && (AbstractC04664a.A02 != 18 || (!A0x(382, 15, 68).equals(str) && !A0x(397, 22, 77).equals(str)))) {
            if (AbstractC04664a.A02 == 19 && AbstractC04664a.A06.startsWith(A0x(667, 7, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE))) {
    ...
    public static boolean A1L(String str, C2154or c2154or) {
        return AbstractC04664a.A02 < 21 && c2154or.A0X.isEmpty() && A0x(306, 25, 22).equals(str);
    }

    public static boolean A1M(String str, C2154or c2154or) {
        return AbstractC04664a.A02 <= 18 && c2154or.A06 == 1 && A0x(281, 25, 33).equals(str);
    }

    private boolean A1N(boolean z2) throws C9Y {
        if (this.A0E == null || (!z2 && this.A0z)) {
            return false;
        }
        ...
        throw A1S(c9eA7s, c2154or, drmSessionState);
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C9Z
    public void A1a(long j, boolean z2) throws C9Y {
        this.A0Y = false;
        this.A0b = false;
        if (this.A0G != null) {
            A1m();
    ...
    public void A1b(boolean z2, boolean z7) throws C9Y {
        this.A0j = new C04985g();
        this.A0h = 0L;
    }

    @Override // com.instagram.common.viewpoint.core.C9Z
    public void A1c(C2154or[] c2154orArr, long j, long j3) throws C9Y {
    }
    ...
    public void A1n() {
        ...
        if (this.A0G != null) {
            this.A0j.A03++;
            try {
                AV.A02().A0L(A22(), this.A11, this.A10.getA00(), EnumC1746hq.A05, this.A0K, this.A0G);
                this.A0G = null;
                C9G c9g = this.A0E;
                String[] strArr = A14;
                if (strArr[6].length() == strArr[5].length()) {
    ...
    public void A1r(C2154or c2154or) {
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1s(com.instagram.common.viewpoint.core.C2154or r9) throws com.instagram.common.viewpoint.core.C9Y {
        /*
            Method dump skipped, instruction units count: 320
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AnonymousClass14.A1s(com.facebook.ads.redexgen.X.or):void");
    }

    public void A1t(C2154or c2154or) throws C9Y {
    }

    public void A1z(String str, C2154or c2154or) throws C9Y {
        A1t(c2154or);
    }
    ...
    public final boolean A24(C2154or c2154or) {
        if (c2154or == null || !this.A0m || !A0x(838, 10, 89).equalsIgnoreCase(c2154or.A0W)) {
            return false;
        }
        return true;
    }
    ...
    public boolean AAV() {
        if (this.A0i == null) {
            super.A0B = EnumC1730hX.A07;
        } else if (this.A0g) {
            super.A0B = EnumC1730hX.A0A;
        } else if (!A1d() && !A1B()) {
            super.A0B = EnumC1730hX.A06;
        }
        if (this.A0i != null) {
            boolean z2 = this.A0g;
            if (A14[2].charAt(29) == 'f') {
            ...
            if (!z2 && (A1d() || A1B() || (this.A07 != -9223372036854775807L && SystemClock.elapsedRealtime() < this.A07))) {
                return true;
            }
        }
        return false;
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC2064nM
    public void AHn(long j, long j3) throws C9Y {
        if (this.A0b) {
            A1o();
            return;
        }
    ...
    public final int AJb(C2154or c2154or) throws C9Y {
        try {
            return A1h(this.A0u, this.A0t, c2154or);
        } catch (C0630Av e) {
            throw A1S(e, c2154or, 4002);
        }
    }
