...
public final class C1621fh extends R8 implements MediaViewApi, Repairable, SM {
    ...
    private void A07() {
        ...
        EnumC1185Wq.A04(this.A09, EnumC1185Wq.A0B);
        EnumC1185Wq.A04(this.A05, EnumC1185Wq.A0B);
        EnumC1185Wq.A04(this.A01, EnumC1185Wq.A0B);
    }
    ...
    private void A0A(View view, C1020Qc c1020Qc) {
        if (this.A0B != null) {
        ...
        String strA1D = c1020Qc.A1D();
        if (this.A03.getContext() == null) {
            return;
        }
        this.A0B = AbstractC1452cv.A01(this.A07, strA1D);
        if (this.A0B != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0C(C1477dL c1477dL, AttributeSet attributeSet, int i2, int i8, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1477dL, attributeSet, i2, i8));
        A0H(new C1258Zl(c1477dL, attributeSet, i2, i8));
        this.A08 = new C0L(c1477dL, attributeSet, i2);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1477dL, attributeSet, i2, i8));
        A07();
    }

    private final void A0D(C1477dL c1477dL, AttributeSet attributeSet, int i2, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1477dL, attributeSet, i2));
        A0H(new C1258Zl(c1477dL, attributeSet, i2));
        this.A08 = new C0L(c1477dL, attributeSet, i2);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1477dL, attributeSet, i2));
        A07();
    }

    private final void A0E(C1477dL c1477dL, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1477dL, attributeSet));
        A0H(new C1258Zl(c1477dL, attributeSet));
        this.A08 = new C0L(c1477dL, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1477dL, attributeSet));
        A07();
    }

    private final void A0F(C1477dL c1477dL, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1477dL));
        A0H(new C1258Zl(c1477dL));
        this.A08 = new C0L(c1477dL);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1477dL));
        A07();
    }

    private void A0G(C1020Qc c1020Qc, boolean z2, C1135Up c1135Up) {
        KZ kzA04 = new KZ(this.A02, this.A07).A04();
        if (z2) {
            kzA04.A06(new C1628fo(this, c1020Qc));
        }
        kzA04.A07(c1135Up.getUrl());
    }

    private void A0H(C1258Zl c1258Zl) {
        if (!this.A0D) {
            if (this.A09 != null) {
                this.A03.removeView(this.A09);
            }
            c1258Zl.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c1258Zl, layoutParams);
            this.A09 = c1258Zl;
            return;
        }
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1621fh.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z2) {
        C1477dL c1477dLA12 = ((C1020Qc) nativeAdBaseApi).A12();
        C1477dL adObjectContext = this.A07;
        adObjectContext.A0L(c1477dLA12);
        c1477dLA12.A0O(this);
        this.A0D = true;
        C1020Qc c1020QcA0L = C1020Qc.A0L(nativeAdBaseApi);
        c1020QcA0L.A1S(this.A03);
        ...
        if (this.A01 != null) {
            ...
            if (this.A01 instanceof C1249Zc) {
                ((C1249Zc) this.A01).A04();
            } else {
                ((C05246g) this.A01).setAdapter(null);
            }
        }
        ...
        if (adIcon != null) {
            ...
            if (bitmapA0N != null) {
                ...
                if (z2) {
                    this.A03.post(new C1629fp(this, c1020QcA0L));
                }
            } else {
                A0G(c1020QcA0L, z2, adIcon);
            }
        } else {
            QQ qqA16 = c1020QcA0L.A16();
            AdErrorType adErrorType = AdErrorType.NATIVE_AD_IS_NOT_LOADED;
            c1477dLA12.A0F().A3F(c1020QcA0L.A0y(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (qqA16 != null) {
            ...
            if (nativeAdBaseApi.isAdLoaded()) {
                C1477dL adObjectContext2 = this.A07;
                adObjectContext2.A08().AAy(A04(258, 3, 44), AbstractC1090Sv.A0W, new C1091Sw(A04(192, 23, 42)));
            }
        }
        A0A(this.A02, c1020QcA0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1621fh.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1621fh.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1621fh.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        switch (adViewConstructorParams.getInitializationType()) {
            ...
            case 2:
                ...
                A0D(c1477dL, attributeSet, adViewConstructorParams.getDefStyleAttr(), mediaView);
                break;
                break;
            case 3:
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ...
            ((RH) this.A05.getMediaViewVideoRendererApi()).A07(new C1622fi(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C1621fh) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
