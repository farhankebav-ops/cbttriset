...
public class C2190pi {
    ...
    public final Map<String, C2201pu> A00;
    public final Set<C2201pu> A01;
    ...
    public Collection<C2201pu> A00() {
        return this.A01;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Collection<C2201pu> A01() {
    ...
    public void A04() {
        this.A00.clear();
        Iterator<C2201pu> it = this.A01.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A06(C2201pu c2201pu) {
        if (this.A01.add(c2201pu)) {
            this.A00.remove(c2201pu.A02);
            return true;
        }
        return false;
    }
