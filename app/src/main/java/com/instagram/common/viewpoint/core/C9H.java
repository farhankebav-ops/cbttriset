...
public final class C9H implements InterfaceC2009mT {
    ...
    public boolean A00;
    public final InterfaceC04784m A01;
    ...
    public static B8 A01(Cursor cursor) {
        ...
        return new B8(downloadRequestA05, i2, cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), i2 == 4 ? cursor.getInt(11) : 0, bu);
    }
    ...
    public C9H(InterfaceC04784m interfaceC04784m) {
        this(interfaceC04784m, A04(0, 0, 21));
    }

    public C9H(InterfaceC04784m interfaceC04784m, String str) {
        this.A03 = str;
        this.A01 = interfaceC04784m;
        this.A04 = A04(448, 18, 64) + str;
        this.A02 = new Object();
    }

    private Cursor A00(String str, String[] strArr) throws C04774l {
        try {
    ...
    public static String A06(List<StreamKey> streamKeys) {
        ...
        for (int i2 = 0; i2 < streamKeys.size(); i2++) {
    ...
    private List<B8> A08(SQLiteDatabase sQLiteDatabase) {
        ...
        if (!AbstractC04664a.A19(sQLiteDatabase, this.A04)) {
            return arrayList;
        }
    ...
    public static List<StreamKey> A09(String str) {
        ...
        for (String str2 : AbstractC04664a.A1O(str, A04(TTAdConstant.IMAGE_URL_CODE, 1, 1))) {
            String[] strArrA1O = AbstractC04664a.A1O(str2, A04(466, 2, 2));
    ...
    private void A0A() throws C04774l {
        synchronized (this.A02) {
            ...
            try {
                ...
                int iA00 = AbstractC04804o.A00(readableDatabase, 0, this.A03);
                if (iA00 != 3) {
                    SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
                    writableDatabase.beginTransactionNonExclusive();
                    try {
                        AbstractC04804o.A04(writableDatabase, 0, this.A03, 3);
    ...
    private void A0C(B8 b8, SQLiteDatabase sQLiteDatabase) {
        byte[] bArr = b8.A07.A06 == null ? AbstractC04664a.A07 : b8.A07.A06;
        ContentValues contentValues = new ContentValues();
        contentValues.put(A04(607, 2, Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE), b8.A07.A02);
        contentValues.put(A04(LevelPlayAdError.ERROR_CODE_LOAD_BEFORE_INIT_SUCCESS_CALLBACK, 9, 108), b8.A07.A03);
    ...
    public final B8 A7i(String str) throws C04774l {
        A0A();
        try {
    ...
    @Override // com.instagram.common.viewpoint.core.BL
    public final C2019md A7j(int... iArr) throws C04774l {
        A0A();
        return new C2019md(A00(A07(iArr), null));
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC2009mT
    public final void AGV(B8 b8) throws C04774l {
        A0A();
        try {
            SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC2009mT
    public final void AHh(String str) throws C04774l {
        A0A();
        try {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC2009mT
    public final void AIe() throws C04774l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC2009mT
    public final void AJ5() throws C04774l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC2009mT
    public final void AJ6(int i2) throws C04774l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, 116), Integer.valueOf(i2));
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC2009mT
    public final void AJ7(String str, int i2) throws C04774l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, 116), Integer.valueOf(i2));
