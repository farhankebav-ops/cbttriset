...
public final class XH {
    ...
    private EnumC1185Wq A00() {
        if (this.A0G == null || this.A0F == null) {
            return EnumC1185Wq.A0J;
        }
        View view = this.A0G;
        String[] strArr = A0J;
        if (strArr[6].length() == strArr[4].length()) {
            ...
            strArr2[4] = "";
            if (view != this.A0F) {
                EnumC1185Wq enumC1185Wq = EnumC1185Wq.A0H;
                String[] strArr3 = A0J;
            ...
            Object tag = this.A0G.getTag(EnumC1185Wq.A02);
            if (tag == null) {
                return EnumC1185Wq.A0I;
            }
            if (!(tag instanceof EnumC1185Wq)) {
                EnumC1185Wq enumC1185Wq2 = EnumC1185Wq.A0K;
                if (A0J[2].charAt(2) == 'm') {
                    A0J[0] = "fnwPYOgaVMSkQLAdq2SZMccx8Jl2b0fK";
                    return enumC1185Wq2;
                }
            } else {
                return (EnumC1185Wq) tag;
            }
        }
        throw new RuntimeException();
    }
    ...
    public final Map<String, String> A04() {
        ...
        String radius15 = A01(Sdk.SDKError.Reason.EMPTY_TPAT_ERROR_VALUE, 7, 64);
    ...
    public final void A06(C1477dL c1477dL, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c1477dL.A0F().AK0();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            case 0:
                this.A04 = (int) (iArr[0] / AbstractC1180Wl.A02);
                this.A05 = (int) (iArr[1] / AbstractC1180Wl.A02);
                this.A06 = (int) (view.getWidth() / AbstractC1180Wl.A02);
                this.A03 = (int) (view.getHeight() / AbstractC1180Wl.A02);
                this.A09 = 1;
                this.A0E = System.currentTimeMillis();
                this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC1180Wl.A02);
                int touchStartYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A0B = (int) (touchStartYInPx / AbstractC1180Wl.A02);
            ...
            case 3:
                ...
                this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC1180Wl.A02);
                int touchEndYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A08 = (int) (touchEndYInPx / AbstractC1180Wl.A02);
                this.A0F = view2;
                return;
            case 2:
    ...
    public final boolean A09(Context context) {
        ...
        if (BuildConfigApi.isDebug()) {
            String str = A01(108, 21, 55) + z2 + A01(2, 18, 57) + iA07 + A01(0, 2, 74) + jA03;
        }
        return z2;
    }
}
