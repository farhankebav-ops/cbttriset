...
public final class ImfSpecParser {
    ...
    public static final List<ImfDataTrack> A01(String str) throws JSONException {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            JSONObject imfTrack = jSONArray.getJSONObject(i2).getJSONObject(A00(13, 9, 42));
            ...
            C2168p6.A06(string2);
            C2168p6.A06(string3);
            C1736hd c1736hd = new C1736hd(string2, string3);
            JSONArray jSONArray2 = imfTrack.getJSONArray(A00(1, 12, 63));
            int length2 = jSONArray2.length();
            for (int i8 = 0; i8 < length2; i8++) {
                JSONObject dataTrack = jSONArray2.getJSONObject(i8);
                ...
                String strA002 = A00(160, 9, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE);
                long j = jSONObject2.getLong(strA002);
                long j3 = dataTrack.getJSONObject(strA00).getJSONObject(A00(22, 7, 94)).getLong(strA002);
                JSONObject jSONObject3 = new JSONObject(dataTrack.getString(A00(102, 15, 77)));
                C2168p6.A06(string);
                arrayList.add(new ImfDataTrack(string, j, j3, c1736hd, new C1735hc(jSONObject3.getDouble(A00(69, 9, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
