...
public final class LZ implements InterfaceC1209Xo {
    ...
    public final US A05;
    public final InterfaceC1208Xn A06;
    public final YT A07;
    public final E1 A08;
    ...
    public final DX A09 = new DX() { // from class: com.facebook.ads.redexgen.X.5v
        ...
        public static String A00(int i2, int i8, int i9) {
            ...
            for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
                ...
                bArrCopyOfRange[i10] = (byte) (i11 ^ 70);
            }
            return new String(bArrCopyOfRange);
        }
        ...
        public final void A03(C04433d c04433d) {
            this.A00.A06.A4c(A00(0, 21, 51), c04433d);
        }
    };
    ...
    public LZ(C1477dL c1477dL, YT yt, US us, InterfaceC1208Xn interfaceC1208Xn) {
        this.A04 = c1477dL;
        this.A05 = us;
        this.A07 = yt;
        this.A08 = new E1(c1477dL);
        this.A08.A0i(new C3D(c1477dL));
        this.A08.getEventBus().A03(this.A0C, this.A0B, this.A09, this.A0A);
        this.A06 = interfaceC1208Xn;
        this.A08.setIsFullScreen(true);
        this.A08.setVolume(1.0f);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(15);
        interfaceC1208Xn.A3x(this.A08, layoutParams);
        C1216Xv closeButton = new C1216Xv(c1477dL);
        closeButton.setOnClickListener(new YR(this));
        RelativeLayout.LayoutParams params = closeButton.getDefaultLayoutParams();
        interfaceC1208Xn.A3x(closeButton, params);
    }
    ...
    public final void AAl(Intent intent, Bundle bundle, R0 r02) {
        ...
        if (stringExtra != null && !stringExtra.isEmpty()) {
            C1442cl c1442cl = new C1442cl(this.A04, stringExtra);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            int i2 = (int) (16.0f * AbstractC1180Wl.A02);
            layoutParams.setMargins(i2, i2, i2, i2);
            layoutParams.addRule(10);
            layoutParams.addRule(9);
            c1442cl.setOnClickListener(new YS(this));
            this.A06.A3x(c1442cl, layoutParams);
        }
        this.A00 = intent.getIntExtra(A02(77, 13, Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE), 0);
        this.A02 = new C04483i(this.A04, this.A05, this.A08, this.A03, intent.getBundleExtra(A02(58, 11, 65)), null);
        if (U7.A1v(this.A04)) {
        ...
        if (intent.getBooleanExtra(A02(0, 8, 43), false)) {
            this.A08.A0h(EnumC1493db.A04, 17);
        }
    }
    ...
    public final void AF0(boolean z2) {
        ...
        if (!this.A08.A0r()) {
            this.A08.A0h(EnumC1493db.A04, 18);
        }
    }
