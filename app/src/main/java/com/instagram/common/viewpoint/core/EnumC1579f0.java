...
public abstract class EnumC1579f0 {
    ...
    public static final /* synthetic */ EnumC1579f0[] A02;
    public static final EnumC1579f0 A03;
    public static final EnumC1579f0 A04;
    public static final EnumC1579f0 A05;
    public static final EnumC1579f0 A06;
    public static final EnumC1579f0 A07;
    public static final EnumC1579f0 A08;
    ...
    static {
        ...
        final int i2 = 0;
        A03 = new EnumC1579f0(strA02, i2) { // from class: com.facebook.ads.redexgen.X.C5
            @Override // com.instagram.common.viewpoint.core.EnumC1579f0
            public final boolean A05(JSONArray jSONArray, int i8) {
                return jSONArray.optJSONArray(i8) != null;
            }

            @Override // com.instagram.common.viewpoint.core.EnumC1579f0
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i8) {
                return AbstractC1580f1.A00(jSONArray.optJSONArray(i8), jSONArray2.optJSONArray(i8));
            }
            ...
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC1580f1.A00(jSONObject.optJSONArray(str), jSONObject2.optJSONArray(str));
            }
        };
        final String strA022 = A02(5, 7, 74);
        final int i8 = 1;
        A04 = new EnumC1579f0(strA022, i8) { // from class: com.facebook.ads.redexgen.X.C4
            @Override // com.instagram.common.viewpoint.core.EnumC1579f0
        ...
        final int i9 = 2;
        A05 = new EnumC1579f0(strA023, i9) { // from class: com.facebook.ads.redexgen.X.C3
        ...
        final int i10 = 3;
        A06 = new EnumC1579f0(strA024, i10) { // from class: com.facebook.ads.redexgen.X.C2
            ...
            public final boolean A05(JSONArray jSONArray, int i11) {
                ...
                int iOptInt = jSONArray.optInt(i11, 0);
                if (A00[4].charAt(31) != 'h') {
                    throw new RuntimeException();
                }
                A00[4] = "ESUjQDK13szqjYK8RJAQddjghxYzdQOh";
                return ((double) iOptInt) == jSONArray.optDouble(i11, 0.0d);
            }
        ...
        final int i11 = 4;
        A07 = new EnumC1579f0(strA025, i11) { // from class: com.facebook.ads.redexgen.X.C1
            @Override // com.instagram.common.viewpoint.core.EnumC1579f0
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i12) {
                return AbstractC1580f1.A02(jSONArray.optJSONObject(i12), jSONArray2.optJSONObject(i12));
            }
            ...
            @Override // com.instagram.common.viewpoint.core.EnumC1579f0
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC1580f1.A02(jSONObject.optJSONObject(str), jSONObject2.optJSONObject(str));
            }
        };
        final String strA026 = A02(27, 6, 50);
        final int i12 = 5;
        A08 = new EnumC1579f0(strA026, i12) { // from class: com.facebook.ads.redexgen.X.Bz
            @Override // com.instagram.common.viewpoint.core.EnumC1579f0
    ...
    public EnumC1579f0(String str, int i2) {
    }

    public static EnumC1579f0 A00(JSONArray jSONArray, int i2) {
        for (EnumC1579f0 type : values()) {
    ...
    public static EnumC1579f0 A01(JSONObject jSONObject, String str) {
        for (EnumC1579f0 type : values()) {
            String[] strArr = A01;
    ...
    public static /* synthetic */ EnumC1579f0[] A04() {
        return new EnumC1579f0[]{A03, A04, A05, A06, A07, A08};
    }

    public static EnumC1579f0 valueOf(String str) {
        return (EnumC1579f0) Enum.valueOf(EnumC1579f0.class, str);
    }

    public static EnumC1579f0[] values() {
        return (EnumC1579f0[]) A02.clone();
    }
}
