...
public final class C04955d extends AbstractC0861Jw {
    ...
    public C1477dL A03;
    public C1174Wd A04;
    public AbstractC1207Xm A05;
    public AbstractC1207Xm A06;
    public AbstractC1311ae A07;
    public C1461d4 A08;
    public C1467dA A09;
    public CU A0A;
    public boolean A0B;
    ...
    public final InterfaceC1288aH A0G;
    public final C1289aI A0H;
    public final C1315ai A0I;
    public final E1 A0J;
    ...
    static {
        ...
        A0b = (int) (AbstractC1180Wl.A02 * 12.0f);
        A0N = (int) (AbstractC1180Wl.A02 * 8.0f);
        A0O = (int) (AbstractC1180Wl.A02 * 10.0f);
        A0W = (int) (AbstractC1180Wl.A02 * 20.0f);
        A0X = (int) (AbstractC1180Wl.A02 * 13.0f);
        A0R = (int) (AbstractC1180Wl.A02 * 48.0f);
        A0a = (int) (AbstractC1180Wl.A02 * 14.0f);
        A0Y = (int) (AbstractC1180Wl.A02 * 12.0f);
        A0P = (int) (AbstractC1180Wl.A02 * 8.0f);
        A0Z = OP.A02(-1, 77);
        A0V = (int) (AbstractC1180Wl.A02 * 16.0f);
        A0c = (int) (AbstractC1180Wl.A02 * 12.0f);
        A0S = (int) (AbstractC1180Wl.A02 * 12.0f);
        A0T = (int) (AbstractC1180Wl.A02 * 16.0f);
        A0U = (int) (AbstractC1180Wl.A02 * 48.0f);
    }

    public C04955d(C1315ai c1315ai) {
        super(c1315ai, false);
        this.A0D = new Handler(Looper.getMainLooper());
        this.A0E = new Handler(Looper.getMainLooper());
        this.A0C = false;
        this.A0B = false;
        this.A03 = c1315ai.A06();
        this.A06 = c1315ai.A0C();
        this.A05 = c1315ai.A0B();
        this.A0I = c1315ai;
        ...
        A09();
        this.A0F = c1315ai.A0D();
        AbstractC1298aR.A00(c1315ai.A06(), this, getAdInfo().A0H().A08());
        this.A0J = A01(c1315ai);
        XP.A0I(this.A0J);
        getAdDetailsView().bringToFront();
        if (!A03()) {
            this.A0K = A02(c1315ai);
        } else {
            this.A0K = null;
        }
        ...
        A1R();
        this.A08 = new C1461d4(this.A03, c1315ai.A07(), getAdDataBundle());
        this.A0G = new C0857Js(this);
        this.A0H = new C1289aI(c1315ai, getAdDataBundle(), this.A0J, this.A0K, getAdDetailsView(), this.A0F, this.A0G);
        C1175Wg c1175WgA02 = super.A09.A02(getAdDataBundle());
        this.A03.A0H().A00(c1175WgA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A09);
        if (c1175WgA02.A00) {
            this.A0J.getVideoImplView().setOnClickListener(new ViewOnClickListenerC1318al(this));
        } else if (U7.A1K(getAdContextWrapper())) {
            AbstractC1265Zs.A00(this.A0J.getVideoImplView(), U7.A1L(getAdContextWrapper()), new ViewOnClickListenerC1319am(this));
        }
        if (c1315ai.A05().A1f()) {
            if (this.A0I.A05().A1i()) {
                this.A07 = new JR(c1315ai);
            } else {
                this.A07 = new JS(c1315ai);
            }
            View view = this.A07;
    ...
    private E1 A01(C1315ai c1315ai) {
        RelativeLayout.LayoutParams layoutParams;
        E1 e12 = (E1) c1315ai.A02();
        int iA1O = A1O(c1315ai.A0C());
        this.A02 = (ImageView) c1315ai.A03();
        if (!A03()) {
            ImageView imageView = this.A02;
            int i2 = AbstractC0861Jw.A0M;
            int i8 = AbstractC0861Jw.A0M;
            int toolbarHeight = AbstractC0861Jw.A0M;
            imageView.setPadding(i2, i8, toolbarHeight, AbstractC0861Jw.A0M);
            int toolbarHeight2 = AbstractC0861Jw.A0N;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC0861Jw.A0N);
            int toolbarHeight3 = AbstractC0861Jw.A0L;
            layoutParams.setMargins(0, iA1O, toolbarHeight3, 0);
            layoutParams.addRule(11);
        } else {
            int toolbarHeight4 = AbstractC1311ae.A0J;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight4, AbstractC1311ae.A0J);
            int i9 = A0T;
            int i10 = A0U;
            int toolbarHeight5 = A0T;
            layoutParams.setMargins(i9, i10, toolbarHeight5, A0S);
    ...
    private C0680Cw A02(C1315ai c1315ai) {
        C0680Cw c0680CwA0F = c1315ai.A0F();
        c0680CwA0F.A08(-1, AbstractC0861Jw.A0E, false);
        c0680CwA0F.setPadding(AbstractC0861Jw.A0Q, AbstractC0861Jw.A0Q, AbstractC0861Jw.A0Q, AbstractC0861Jw.A0Q);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0861Jw.A0P);
        progressBarLayoutParams.addRule(12);
        addView(c0680CwA0F, progressBarLayoutParams);
        return c0680CwA0F;
    }
    ...
    private void A05() {
        addView(new C1327au(this.A0I.A06(), getAdDataBundle(), this.A0I.A08(), this.A0E, this.A0I.A0D()).A09(getCtaButton()));
    }

    private void A06() {
        XP.A0Z(this.A02, getCtaButton(), getAdDetailsView(), this.A01, this.A0H, this.A0I.A0C());
        for (InterfaceC1494dc interfaceC1494dc : this.A0J.getPlugins()) {
            if (interfaceC1494dc instanceof C2R) {
                this.A0J.A0j(interfaceC1494dc);
                return;
            }
        }
    }
    ...
    private void A0A() {
        new C1120Ua(getAdDataBundle().A25(), getAdEventManager()).A04(UZ.A0z, null);
        if (!getAdInfo().A0V()) {
            return;
        }
        super.A0A.set(true);
        ...
        XP.A0J(this.A06);
        Pair<EnumC1460d3, View> pairA03 = this.A08.A03(getCtaButton());
        this.A00 = (View) pairA03.second;
        A0E((EnumC1460d3) pairA03.first);
        if (getAdInfo().A0K().A00() >= 0) {
            ...
            this.A04 = new C1174Wd((int) getAdInfo().A0K().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C0855Jq(this));
            this.A04.A07();
        }
    }
    ...
    private void A0D(RelativeLayout relativeLayout) {
        ...
        XP.A0K(c1291aK, 0);
        XP.A0I(c1291aK);
        new KZ(c1291aK, this.A03).A05(A0R, A0R).A07(getAdDataBundle().A23().A01());
        ...
        C1293aM c1293aM = new C1293aM(c1477dL, i2, 5, A0Z, -1);
        c1293aM.setGravity(16);
        ...
        linearLayout.addView(c1293aM, ratingCountParams);
        ...
        iconParams.addRule(1, c1291aK.getId());
        ...
        relativeLayout.addView(c1291aK, layoutParams);
        if (TextUtils.isEmpty(getAdDataBundle().A20().A0I().A0B())) {
            linearLayout.setVisibility(8);
            return;
        }
        linearLayout.setVisibility(0);
        c1293aM.setRating(Float.parseFloat(getAdDataBundle().A20().A0I().A0B()));
        ...
        if (!getAdDataBundle().A1j()) {
            ...
            formattingRatingCount = AbstractC1189Wu.A01(Integer.parseInt(getAdDataBundle().A20().A0I().A08()));
        }
    ...
    private void A0E(EnumC1460d3 enumC1460d3) {
        if (!getAdDataBundle().A20().A0K().A02().isEmpty()) {
            if (getAdDataBundle().A20().A0K().A03()) {
                this.A09 = new C1467dA(this.A03, getAdDataBundle(), this.A0F, getCtaButton(), this.A0E, this.A0I.A08());
    ...
    private void A0F(EnumC1460d3 enumC1460d3) {
        this.A0J.A0k(false);
        this.A0J.setVisibility(8);
        if (this.A06 instanceof C0959Nr) {
            AbstractC1207Xm abstractC1207Xm = this.A05;
        ...
        switch (enumC1460d3) {
            case A03:
                AbstractC1268Zv oldEndCardAdDetailsView = getOldEndCardAdDetailsView();
                if (A0M[4].charAt(31) != 'A') {
                    A0M[2] = "XFfDcp5VJF8GQaNSTNs87nOmJmOzmbPV";
                    if (oldEndCardAdDetailsView == null) {
                        AbstractC1268Zv oldEndCard = getAdDetailsView();
                    ...
                    if (oldEndCardAdDetailsView != null) {
                        ...
                        AbstractC1268Zv oldEndCard2 = getAdDetailsView();
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams.setMargins(AbstractC0861Jw.A0O, AbstractC0861Jw.A0O, AbstractC0861Jw.A0O, AbstractC0861Jw.A0O);
    ...
    public final void A1G(C0931Mp c0931Mp, String str, double d8, Bundle bundle) {
        ...
        if (A03()) {
            boolean z2 = getAdDetailsView() instanceof KL;
            if (A0M[2].charAt(18) == 'X') {
                throw new RuntimeException();
            }
            String[] strArr = A0M;
    ...
    public final void A1H(C04433d c04433d) {
        super.A1H(c04433d);
        if (A03()) {
            AbstractC1268Zv adDetailsView = getAdDetailsView();
            if (A0M[0].length() == 5) {
                throw new RuntimeException();
            }
    ...
    public final void A1I(DO r10) {
        ...
        if (A03()) {
            this.A03.A0F().AJw(AbstractC1171Wa.A00((float) this.A0I.A05().A0h()), getResources().getConfiguration().orientation, true, false, MH.A0C(this.A0I.A04()));
        }
    ...
    public final void A1J(C3Q c3q, int i2) {
        ...
        if ((getAdDetailsView() instanceof KL) && !this.A0I.A05().A1i()) {
            ...
            ((KL) getAdDetailsView()).A0o(((remainingVideoTimeInMillis * i2) + currentPosMs) / 1000);
        }
    }
    ...
    public final AbstractC1268Zv A1P(C1315ai c1315ai, C0931Mp c0931Mp, String str) {
        ...
        return new C0863Jy(c1315ai.A06(), getCtaButton(), AbstractC0861Jw.A0J, c0931Mp.A0I().A00() == EnumC0936Mu.A05, getColors(), c0931Mp.A0J().A06(), str, c1315ai.A07(), c1315ai.A0D(), c1315ai.A0G(), c1315ai.A0A(), c1315ai.A05());
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC0861Jw
    public final C0863Jy A1Q(C1315ai c1315ai, C0931Mp c0931Mp, String str) {
        return new C0863Jy(c1315ai.A06(), getCtaButton(), AbstractC0861Jw.A0J, c0931Mp.A0I().A00() == EnumC0936Mu.A05, getColors(), c0931Mp.A0J().A06(), str, c1315ai.A07(), c1315ai.A0D(), c1315ai.A0G(), c1315ai.A0A(), c1315ai.A05());
    }
    ...
    public final void A1Y() {
        new C1120Ua(this.A0I.A05().A25(), getAdEventManager()).A04(UZ.A0h, null);
        if (this.A0I.A0C() != null) {
            AbstractC1207Xm abstractC1207XmA0C = this.A0I.A0C();
            if (A0M[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
            A0M[2] = "qVUXWES3bTCAG5k5pbCpCu4g17099rEp";
            abstractC1207XmA0C.setVisibility(8);
    ...
    public final void A1Z(int i2) {
        ...
        this.A03.A0F().AJy(i2);
        this.A0J.A0c(i2);
        A1U(i2, this.A0J, (RelativeLayout) this.A0J.getVideoView());
    }

    public final void A1a(C04483i c04483i) {
        if (this.A07 != null) {
            if (this.A07 instanceof JR) {
                ((JR) this.A07).A1O(c04483i);
            }
            if (this.A07 instanceof JS) {
                ((JS) this.A07).A1O(c04483i);
            }
            this.A07.A1B();
            AbstractC1311ae abstractC1311ae = this.A07;
            String[] strArr = A0M;
            if (strArr[3].charAt(21) == strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A07 != null) {
            ...
            if (abstractC1311ae.getVisibility() == 0) {
                getAdDetailsView().setVisibility(8);
                return;
            }
        }
    ...
    public void setVideoAdViewListener(InterfaceC1435ce interfaceC1435ce) {
        if (this.A07 instanceof JR) {
            ((JR) this.A07).setVideoAdViewListener(interfaceC1435ce);
        }
        if (this.A07 instanceof JS) {
            ((JS) this.A07).setVideoAdViewListener(interfaceC1435ce);
        }
    }
}
