...
public class RunnableC1023Qf implements Runnable {
    ...
    public int A02;
    public int A03;
    public final /* synthetic */ C05246g A06;
    public Interpolator A00 = C05246g.A1A;
    ...
    public static String A02(int i2, int i8, int i9) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            ...
            bArrCopyOfRange[i10] = (byte) ((b8 - i9) - 123);
        }
    ...
    public RunnableC1023Qf(C05246g c05246g) {
        this.A06 = c05246g;
        this.A01 = new OverScroller(c05246g.getContext(), C05246g.A1A);
    }
    ...
    private int A01(int i2, int i8, int i9, int i10) {
        int absDx;
        int containerSize = Math.abs(i2);
        int delta = Math.abs(i8);
        int duration = containerSize > delta ? 1 : 0;
        int halfContainerSize = (int) Math.sqrt((i9 * i9) + (i10 * i10));
        int absDx2 = (int) Math.sqrt((i2 * i2) + (i8 * i8));
        C05246g c05246g = this.A06;
        int width = duration != 0 ? c05246g.getWidth() : c05246g.getHeight();
    ...
    private final void A06(int i2, int i8, int i9, int i10) {
        A0B(i2, i8, A01(i2, i8, i9, i10));
    }
    ...
    public final void A09(int i2, int i8) {
        this.A06.setScrollState(2);
        this.A03 = 0;
        this.A02 = 0;
        this.A01.fling(0, 0, i2, i8, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
        A07();
    }
    ...
    public final void A0B(int i2, int i8, int i9) {
        A0C(i2, i8, i9, C05246g.A1A);
    }

    public final void A0C(int i2, int i8, int i9, Interpolator interpolator) {
        ...
        this.A03 = 0;
        this.A02 = 0;
        this.A01.startScroll(0, 0, i2, i8, i9);
    ...
    public final void A0D(int i2, int i8, Interpolator interpolator) {
        int iA01 = A01(i2, i8, 0, 0);
        if (interpolator == null) {
            interpolator = C05246g.A1A;
        }
        A0C(i2, i8, iA01, interpolator);
        if (A08[6].length() == 25) {
            throw new RuntimeException();
        }
    ...
    public final void run() {
        ...
        this.A06.A1K();
        OverScroller overScroller = this.A01;
        AbstractC1019Qb abstractC1019Qb = this.A06.A06.A02;
        if (overScroller.computeScrollOffset()) {
            ...
            if (this.A06.A04 != null) {
                ...
                if (vresult != 0) {
                    QO qo = this.A06.A06;
                    QW qw = this.A06.A0r;
                    C05246g c05246g2 = this.A06;
                    if (A08[4].charAt(19) != '9') {
                        A08[4] = "aF9lT9JucYAVgVWisB0rNkK4be7J2iGb";
                        iA1f = qo.A1f(vresult, qw, c05246g2.A0s);
                        i2 = vresult - iA1f;
                    } else {
                        iA1f = qo.A1f(vresult, qw, c05246g2.A0s);
                        i2 = vresult - iA1f;
                ...
                this.A06.A1N();
                this.A06.A1p(false);
                if (abstractC1019Qb != null && !abstractC1019Qb.A0E() && abstractC1019Qb.A0F()) {
                    int x2 = this.A06.A0s.A03();
                    if (x2 == 0) {
                        abstractC1019Qb.A09();
                    } else if (abstractC1019Qb.A07() >= x2) {
                        abstractC1019Qb.A0A(x2 - 1);
                        abstractC1019Qb.A04(vresult - i2, velX - i8);
                    } else {
                        int y = vresult - i2;
                        if (A08[4].charAt(19) != 57) {
                            String[] strArr4 = A08;
            ...
            if (this.A06.getOverScrollMode() != 2) {
                C05246g c05246g3 = this.A06;
                String[] strArr5 = A08;
                if (strArr5[7].charAt(6) != strArr5[0].charAt(6)) {
                    throw new RuntimeException();
                }
                A08[6] = "k";
                c05246g3.A1b(vresult, velX);
            }
            int dy = iA1f;
            int hresult = iA1g;
            if (!this.A06.A1v(dy, hresult, i2, i8, null, 1) && (i2 != 0 || i8 != 0)) {
                int x7 = (int) overScroller.getCurrVelocity();
                int dx = 0;
                if (i2 != overscrollX) {
                    if (i2 < 0) {
                        dx = -x7;
                ...
                if ((dx != 0 || i2 == overscrollX || overScroller.getFinalX() == 0) && (x7 != 0 || i8 == velY || overScroller.getFinalY() == 0)) {
                    overScroller.abortAnimation();
                }
            }
            if (iA1f != 0 || iA1g != 0) {
                C05246g c05246g4 = this.A06;
                if (A08[6].length() != 25) {
                    A08[3] = "MhQkdHLAPY6K0mrvY0I8ZqPtgRA1J8Gx";
                    c05246g4.A1d(iA1f, iA1g);
                } else {
            ...
            boolean z2 = (vresult == 0 && velX == 0) || (vresult != 0 && this.A06.A06.A22() && iA1f == vresult) || (velX != 0 && this.A06.A06.A23() && iA1g == velX);
        ...
        if (abstractC1019Qb != null) {
            if (abstractC1019Qb.A0E()) {
                abstractC1019Qb.A04(0, 0);
            }
            if (!this.A05) {
                abstractC1019Qb.A09();
            }
