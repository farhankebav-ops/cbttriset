...
public abstract class U9 {
    ...
    public static int A05(Context context) {
        return U7.A0V(context).A2u(A0L(IronSourceError.ERROR_RV_SHOW_CALLED_DURING_SHOW, 21, 35), 10);
    }
    ...
    public static int A0H(Context context, String str, int i2) {
        int iA2u = U7.A0V(context).A2u(str, i2);
        if (iA2u >= 0 && iA2u < 101) {
            return iA2u;
        }
        return i2;
    ...
    public static long A0J(Context context) {
        return ((long) U7.A0V(context).A2u(A0L(IronSourceError.ERROR_IS_ALL_SMASHES_SESSION_CAPPED, 41, 69), MlKitException.LOW_LIGHT_AUTO_EXPOSURE_COMPUTATION_FAILURE)) * 1000;
    }
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            ...
            if (!TextUtils.isEmpty(strOptString)) {
                ...
                if (strOptString.contains(strA0L)) {
                    ...
                    try {
                        int i8 = Integer.parseInt(blackListString2);
    ...
    public static boolean A0V(Context context) {
        return U7.A0V(context).A30(A0L(976, 46, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE), true);
    }
}
