...
public final class C1827jI {
     ...
     */
    public final synchronized void A07() throws C1823jE {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (!this.A00.renameTo(file)) {
            throw new C1823jE(A00(166, 20, 3) + this.A00 + A00(44, 4, 115) + file + A00(14, 16, 47));
        }
        this.A00 = file;
        try {
            this.A01 = new RandomAccessFile(this.A00, A00(256, 1, 61));
        } catch (IOException e) {
            throw new C1823jE(A00(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 14, 50) + this.A00 + A00(0, 14, 69), e);
        }
    }

    public C1827jI(File file, L0 l02) throws C1823jE {
        try {
            if (l02 != null) {
                this.A02 = l02;
            ...
            throw new C1823jE(A00(186, 17, 54) + file + A00(0, 14, 69), e);
        }
    }
    ...
    public final synchronized int A03() throws C1823jE {
        try {
        } catch (IOException e) {
            throw new C1823jE(A00(Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE, 29, 78) + this.A00, e);
        }
    ...
    public final synchronized void A05() throws C1823jE {
        try {
            this.A01.setLength(0L);
        } catch (IOException e) {
            throw new C1823jE(A00(57, 16, 62), e);
        }
    }

    public final synchronized void A06() throws C1823jE {
        try {
            this.A01.close();
            this.A02.AJg(this.A00);
        } catch (IOException e) {
            throw new C1823jE(A00(104, 19, 93) + this.A00, e);
        }
    }

    public final synchronized void A08(byte[] bArr, int i2) throws C1823jE {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i2);
            } else {
                throw new C1823jE(A00(73, 31, 71) + this.A00 + A00(30, 14, 126));
            }
        } catch (IOException e) {
            throw new C1823jE(String.format(Locale.US, A00(203, 53, 72), Integer.valueOf(i2), this.A01, Integer.valueOf(bArr.length)), e);
        }
    }
