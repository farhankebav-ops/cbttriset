...
public final class C0893Lc extends RelativeLayout implements InterfaceC1209Xo {
    ...
    public boolean A0G;
    public boolean A0H;
    public final AbstractC1752hy A0I;
    public final NB A0J;
    public final R6 A0K;
    public final C1477dL A0L;
    public final US A0M;
    public final C1120Ua A0N;
    public final C1174Wd A0O;
    public final XC A0P;
    public final InterfaceC1208Xn A0Q;
    public final YY A0R;
    public final InterfaceC1288aH A0S;
    public final C1289aI A0T;
    public final C1461d4 A0U;
    public final AtomicBoolean A0V;
    public final AtomicBoolean A0W;
    public final boolean A0X;
    public final boolean A0Y;
    public final boolean A0Z;
    public final AbstractC1207Xm A0a;
    ...
    static {
        A0N();
        A0o = (int) (AbstractC1180Wl.A02 * 64.0f);
        A0g = (int) (AbstractC1180Wl.A02 * 16.0f);
        A0p = (int) (AbstractC1180Wl.A02 * 12.0f);
        A0e = (int) (AbstractC1180Wl.A02 * 10.0f);
        A0q = new RelativeLayout.LayoutParams(-1, -1);
        A0h = (int) (AbstractC1180Wl.A02 * 48.0f);
        A0i = (int) (AbstractC1180Wl.A02 * 16.0f);
        A0n = (int) (AbstractC1180Wl.A02 * 14.0f);
        A0l = (int) (AbstractC1180Wl.A02 * 12.0f);
        A0m = OP.A02(-1, 77);
        A0d = (int) (AbstractC1180Wl.A02 * 8.0f);
        A0j = (int) (AbstractC1180Wl.A02 * 20.0f);
        A0k = (int) (AbstractC1180Wl.A02 * 13.0f);
        A0f = (int) (AbstractC1180Wl.A02 * 8.0f);
    }

    public C0893Lc(C1477dL c1477dL, US us, InterfaceC1208Xn interfaceC1208Xn, AbstractC1752hy abstractC1752hy, String str, YY yy, C1456cz c1456cz) {
        this(c1477dL, us, interfaceC1208Xn, abstractC1752hy, str, yy, false, c1456cz);
    }

    public C0893Lc(C1477dL c1477dL, US us, InterfaceC1208Xn interfaceC1208Xn, AbstractC1752hy abstractC1752hy, String str, YY yy, boolean z2, C1456cz c1456cz) {
        int iA08;
        super(c1477dL);
        String strA0D = A0D(0, 0, 113);
        this.A0A = strA0D;
        this.A09 = strA0D;
        this.A0K = new C0911Lu(this);
        ...
        this.A0Z = z2;
        this.A0L = c1477dL;
        this.A0Q = interfaceC1208Xn;
        this.A0M = us;
        this.A0I = abstractC1752hy;
        this.A0J = abstractC1752hy.A20().A0H().A07();
        this.A0N = new C1120Ua(this.A0I.A25(), this.A0M);
        this.A0R = yy;
        this.A08 = new C1474dI(c1477dL, this.A0R, str, this.A0Q);
        if (abstractC1752hy.A20().A0H().A07() != null) {
            this.A0D = abstractC1752hy.A20().A0H().A07().A0N();
            this.A0A = abstractC1752hy.A20().A0H().A07().A0H();
            this.A09 = abstractC1752hy.A20().A0H().A07().A0G();
        }
        ...
        C0911Lu c0911Lu = null;
        this.A0O = new C1174Wd(iA08, new C0895Le(this, c0911Lu));
        this.A0X = U7.A0o(this.A0L);
        this.A0a = A07();
        if (this.A0J.A0P()) {
            this.A0a.A06();
        }
        this.A0U = new C1461d4(this.A0L, this.A0M, this.A0I);
        AbstractC1298aR.A00(c1477dL, this, abstractC1752hy.A20().A0H().A08());
        this.A0P = new XC(this);
        this.A0P.A05(XB.A02);
        if (U7.A2D(this.A0L)) {
            this.A0a.setProgressSpinnerInvisible(true);
        }
        C0894Ld c0894Ld = new C0894Ld(this, c0911Lu);
        if (c1456cz == null) {
            HashMap map = new HashMap();
            map.put(A0D(56, 9, 90), this.A0R.A8d());
            this.A07 = new C1456cz(this.A0L, this.A0I, this.A0J, this.A0M, c0894Ld, map);
        } else {
            this.A07 = c1456cz;
            this.A07.setPlayableAdsViewListener(c0894Ld);
        }
        A0K();
        this.A0Q.A3x(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        this.A0S = new C0908Lr(this);
        this.A0T = new C1289aI(this.A0L, this.A0a, this.A0I, (E1) null, this.A0Q, this.A0S, this.A06, this.A01, this.A07);
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.setToolbarListener(new C0896Lf(this));
    ...
    private C1297aQ A0B() {
        C1477dL c1477dL = this.A0L;
        C0940My c0940MyA01 = this.A0I.A1z().A01();
        ...
        C1297aQ c1297aQ = new C1297aQ(c1477dL, c0940MyA01, true, i2, !z2 ? 14 : 13, 0);
        c1297aQ.A04(this.A0I.A20().A0I().A0F(), this.A0I.A20().A0I().A0E(), null, false, true);
        TextView descriptionTv = c1297aQ.getDescriptionTextView();
        descriptionTv.setAlpha(0.8f);
        descriptionTv.setMaxLines(1);
        descriptionTv.setEllipsize(TextUtils.TruncateAt.END);
        TextView descriptionTv2 = c1297aQ.getTitleTextView();
    ...
    private void A0G() {
        ...
        C1291aK c1291aK = new C1291aK(this.A0L);
        XP.A0K(c1291aK, 0);
        XP.A0I(c1291aK);
        new KZ(c1291aK, this.A0L).A05(A0h, A0h).A07(this.A0I.A23().A01());
        ...
        C1293aM c1293aM = new C1293aM(this.A0L, !this.A0D ? A0n : A0l, 5, A0m, -1);
        ...
        linearLayout.addView(c1293aM, layoutParams2);
        ...
        ratingInfoContainerParams.addRule(1, c1291aK.getId());
        ...
        if (this.A02 != null) {
            ...
            this.A02.addView(c1291aK, layoutParams);
        }
        ...
        c1293aM.setRating(Float.parseFloat(this.A0I.A20().A0I().A0B()));
        ...
        if (!this.A0D) {
            ...
            strA01 = AbstractC1189Wu.A01(Integer.parseInt(this.A0I.A20().A0I().A08()));
        }
        sb.append(strA01);
    ...
    public void A0I() {
        ...
        if (this.A0I.A20().A0S()) {
            this.A08.A05();
            this.A0Q.A4c(this.A0R.A6d(), new C04433d(0, 0));
        }
    }

    private void A0J() {
        C1428cX c1428cXA0F = new C1426cV(this.A0L, this.A0I.A20().A0I(), this.A0I.A23()).A0A(this.A0I.A1z().A01()).A0D(this.A0J.A0J()).A0C(this.A0J.A0E()).A09(2000).A0E(this.A0D).A0B(this.A0A).A0F();
        AbstractC1122Uc.A04(c1428cXA0F, this.A0N, UZ.A0U);
        addView(c1428cXA0F, A0q);
        c1428cXA0F.A04(new C0906Lp(this));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0L() {
        new C1120Ua(this.A0I.A25(), this.A0M).A04(UZ.A0z, null);
        this.A0V.set(true);
        XP.A0R(this);
        XP.A0F(this.A07);
        ...
        XP.A0J(this.A06);
        Pair<EnumC1460d3, View> pairA03 = this.A0U.A03(this.A06);
        this.A00 = (View) pairA03.second;
        switch (YE.A00[((EnumC1460d3) pairA03.first).ordinal()]) {
            case 1:
                ...
                if (!this.A0D) {
                    ...
                    addView(new C1421cQ(this.A0L, this.A0I.A23(), this.A0I.A20().A0I(), A09(), this.A09, new YC(this)), new RelativeLayout.LayoutParams(-1, -1));
                    removeView(this.A0a);
                }
                break;
            case 2:
    ...
    public void A0M() {
        ...
        AbstractC1207Xm abstractC1207Xm = this.A0a;
        if (A0c[3].length() == 2) {
            throw new RuntimeException();
        }
        String[] strArr = A0c;
        ...
        abstractC1207Xm.setVisibility(0);
        this.A07.setVisibility(0);
        if (this.A01 != null) {
            this.A01.setVisibility(0);
        }
        if (this.A06 != null && this.A0I.A1w() > 0 && this.A05 == null) {
            this.A05 = new C1174Wd(this.A0I.A1w(), new C0897Lg(this));
            this.A05.A07();
        }
        this.A0O.A07();
    }
    ...
    public void A0U(boolean z2, String str) {
        this.A0C = true;
        HashMap map = new HashMap();
        map.put(A0D(8, 12, 57), z2 ? A0D(79, 13, 2) : A0D(44, 12, 82));
    ...
    public final void onDestroy() {
        ...
        if (this.A07 != null) {
            if (!TextUtils.isEmpty(this.A0I.A25())) {
                this.A0M.AAt(this.A0I.A25(), new C1262Zp().A03(this.A07.getViewabilityChecker()).A02(this.A07.getTouchDataRecorder()).A05());
            }
            this.A07.A0C();
        }
        this.A0O.A06();
