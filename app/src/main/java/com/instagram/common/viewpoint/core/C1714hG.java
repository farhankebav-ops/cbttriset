...
public final class C1714hG implements InterfaceC0942Na {
    ...
    public final AbstractC1711hD A03;
    ...
    public C1714hG(C1477dL c1477dL, AbstractC1711hD abstractC1711hD) {
        this.A04 = c1477dL;
        this.A03 = abstractC1711hD;
    }
    ...
    private void A02(NZ nz, NZ nz2) {
        ...
        StringBuilder sbAppend = sb.append(errorTitle).append(nz);
        String errorTitle2 = A00(0, 4, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE);
        String string = sbAppend.append(errorTitle2).append(nz2).toString();
        InterfaceC1089Su interfaceC1089SuA08 = this.A04.A08();
        int i2 = AbstractC1090Sv.A0e;
        C1091Sw c1091Sw = new C1091Sw(strA00, string);
        String errorTitle3 = A00(139, 3, 61);
        interfaceC1089SuA08.AAy(errorTitle3, i2, c1091Sw);
    ...
    private void A03(String str, String str2, boolean z2) {
        ...
        if (!z2) {
            Log.e(strA002, str3);
            this.A04.A08().AAy(strA00, AbstractC1090Sv.A0c, new C1091Sw(str3));
        ...
        switch (NY.A00[integrationErrorModeA00.ordinal()]) {
            case 1:
                ...
                throw new C0943Nb(errorMessage);
            case 2:
                this.A03.A08();
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0942Na
    public final boolean A6M() {
        boolean z2 = (this.A01 == NZ.A02 || this.A01 == NZ.A04) && this.A02 != NZ.A07;
        if (z2) {
            this.A01 = NZ.A06;
        } else {
    ...
    public final boolean A6N() {
        ...
        boolean z2 = nz == nz2 && (this.A02 != NZ.A07 || U7.A0i(this.A04));
        if (z2) {
            this.A01 = NZ.A02;
            this.A02 = NZ.A07;
        } else {
