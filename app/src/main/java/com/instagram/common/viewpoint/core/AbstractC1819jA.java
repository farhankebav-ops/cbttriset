...
public abstract class AbstractC1819jA {
    ...
    public static String A06(int i2, int i8, int i9) {
        ...
        for (int i10 = 0; i10 < bArrCopyOfRange.length; i10++) {
            ...
            bArrCopyOfRange[i10] = (byte) ((b8 ^ i9) ^ 108);
        }
    ...
    public static String A07(int start, int end, int size) {
        ...
        return (end < 0 || end > size) ? A09(end, size, A06(105, 9, 59)) : Strings.A02(A06(114, 53, Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE), Integer.valueOf(end), Integer.valueOf(start));
    }
    ...
    public static void A0G(boolean expression, String errorMessageTemplate, int p12, int p2) {
        if (!expression) {
            throw new IllegalArgumentException(Strings.A02(errorMessageTemplate, Integer.valueOf(p12), Integer.valueOf(p2)));
        }
    }
