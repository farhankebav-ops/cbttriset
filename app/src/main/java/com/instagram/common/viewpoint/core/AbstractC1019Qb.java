...
public abstract class AbstractC1019Qb {
    ...
    public abstract void A0H(int i2, int i8, C1021Qd c1021Qd, QZ qz);

    public abstract void A0I(View view, C1021Qd c1021Qd, QZ qz);
    ...
    private final View A01(int i2) {
        return this.A03.A06.A1o(i2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A04(int i2, int i8) {
        C05246g c05246g = this.A03;
        if (!this.A05 || this.A00 == -1 || c05246g == null) {
            A09();
        }
        this.A04 = false;
        if (this.A01 != null) {
            if (A00(this.A01) == this.A00) {
                A0I(this.A01, c05246g.A0s, this.A06);
                this.A06.A05(c05246g);
                A09();
            } else {
        ...
        if (this.A05) {
            A0H(i2, i8, c05246g.A0s, this.A06);
    ...
    public final void A0D(C05246g c05246g, QO qo) {
        this.A03 = c05246g;
        this.A02 = qo;
        if (this.A00 != -1) {
