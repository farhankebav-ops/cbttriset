...
public final class C2Y extends AbstractC0684Da {
    ...
    public final AbstractC1100Tf<DO> A00;

    public C2Y(C1477dL c1477dL) {
        this(c1477dL, null);
    }

    public C2Y(C1477dL c1477dL, AttributeSet attributeSet) {
        this(c1477dL, attributeSet, 0);
    }

    public C2Y(C1477dL c1477dL, AttributeSet attributeSet, int i2) {
        super(c1477dL, attributeSet, i2);
        this.A00 = new C0681Cx(this);
