...
public final class JT {
    ...
    public void A00(C4J c4j, int i2) {
        int totalLength;
        if (i2 < 4) {
            return;
        }
        ...
        if (limit < position && i8 > 0) {
            int iMin = Math.min(i8, position - limit);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A01(C4J c4j, int i2) {
        if (i2 < 19) {
            return;
        }
        this.A05 = c4j.A0M();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A02(C4J c4j, int i2) {
        if (i2 % 5 != 2) {
            return;
        }
        c4j.A0g(2);
        ...
        for (int index = 0; index < i8; index++) {
            ...
            int i9 = (int) (((double) a8) + (((double) entryCount) * 1.402d));
            int g = (int) ((((double) a8) - (((double) (iA0I3 - 128)) * 0.34414d)) - (((double) (iA0I2 - 128)) * 0.71414d));
            int entryCount2 = c4j.A0I() << 24;
            this.A08[iA0I] = entryCount2 | (AbstractC04664a.A07(i9, 0, 255) << 16) | (AbstractC04664a.A07(g, 0, 255) << 8) | AbstractC04664a.A07((int) (((double) a8) + (((double) (iA0I3 - 128)) * 1.772d)), 0, 255);
        }
        this.A06 = true;
    }

    public final C2105o2 A06() {
        int iA0I;
