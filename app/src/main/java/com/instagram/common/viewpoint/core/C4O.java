...
public final class C4O {
    ...
    public C4O(Surface surface, int i2, int i8) {
        this(surface, i2, i8, 0);
    }

    public C4O(Surface surface, int i2, int i8, int i9) {
        C3M.A09(i9 == 0 || i9 == 90 || i9 == 180 || i9 == 270, A00(0, 45, 12));
        this.A03 = surface;
        this.A02 = i2;
        this.A00 = i8;
        this.A01 = i9;
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.A02 == c4o.A02 && this.A00 == c4o.A00) {
            ...
            if (i2 == i8 && this.A03.equals(c4o.A03)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        int result3 = (((i2 + result2) * 31) + this.A00) * 31;
