...
public final class C1854jk implements KJ {
    ...
    public C1854jk(String str) {
        this.A02 = 0;
        this.A09 = new C4J(4);
        this.A09.A0l()[0] = -1;
        this.A0A = new C0773Gl();
    ...
    */
    private void A00(com.instagram.common.viewpoint.core.C4J r10) {
        /*
            r9 = this;
            byte[] r8 = r10.A0l()
            int r4 = r10.A09()
        ...
        L24:
            r9.A08 = r2
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1854jk.A0C
            r0 = 1
            r1 = r2[r0]
            r0 = 4
            r2 = r2[r0]
        ...
        L6c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1854jk.A00(com.facebook.ads.redexgen.X.4J):void");
    }
    ...
    private void A02(C4J c4j) {
        ...
        int bytesToRead = this.A00;
        c4j.A0k(bArrA0l, bytesToRead, iMin);
        ...
        this.A09.A0f(0);
        C0773Gl c0773Gl = this.A0A;
        int bytesToRead4 = this.A09.A0C();
        if (!c0773Gl.A00(bytesToRead4)) {
            this.A00 = 0;
            this.A02 = 1;
            return;
        }
        ...
        if (!this.A07) {
            ...
            C2D c2dA0h = new C2D().A0y(this.A06).A11(this.A0A.A06).A0h(4096);
            int bytesToRead8 = this.A0A.A01;
            C2D c2dA0b = c2dA0h.A0b(bytesToRead8);
            int bytesToRead9 = this.A0A.A03;
            this.A05.A6W(c2dA0b.A0m(bytesToRead9).A10(this.A0B).A14());
            this.A07 = true;
        }
        this.A09.A0f(0);
