...
public final class TM {
    ...
    public static long A01(SQ sq, String str) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                sq.A08().AAy(A02(144, 7, 94), AbstractC1090Sv.A1E, new C1091Sw(e));
            }
            return -1L;
        }
    }
    ...
    public static String A05(SQ sq, String str) {
        ...
        A07(sq, jSONObject, A02(Sdk.SDKError.Reason.OMSDK_JS_WRITE_FAILED_VALUE, 11, 111), A04(sq));
        A07(sq, jSONObject, A02(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 10, 27), A03(sq));
