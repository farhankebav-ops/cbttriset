...
public abstract class AbstractC1660gL {
    public static volatile InterfaceC1653gE A02 = C04061q.A00();
    ...
    public static void A01(@Nullable String str, String str2, Object obj) {
        if (A02.AAP(4)) {
            A00(str, AbstractC1655gG.A0J(str2, obj));
        }
    }
