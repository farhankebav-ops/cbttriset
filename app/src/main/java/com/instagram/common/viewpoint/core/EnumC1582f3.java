...
public enum EnumC1582f3 {
    A09(A00(145, 13, Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE), EnumC1584f5.A03, true),
    A08(A00(128, 17, Sdk.SDKError.Reason.INVALID_LOG_ERROR_ENDPOINT_VALUE), EnumC1584f5.A04, true),
    A07(A00(114, 14, 33), EnumC1584f5.A04, false),
    A0A(A00(171, 23, 15), EnumC1584f5.A04, false),
    A0B(A00(158, 13, 28), EnumC1584f5.A04, true),
    A06(A00(97, 17, 115), EnumC1584f5.A04, false);
    ...
    EnumC1582f3(String str, EnumC1584f5 enumC1584f5, boolean z2) {
        this.A01 = str;
        this.A00 = enumC1584f5;
        this.A02 = z2;
    }

    public final EnumC1584f5 A03() {
        return this.A00;
    }
    ...
    public static EnumC1582f3[] valuesCustom() {
        EnumC1582f3[] enumC1582f3ArrValuesCustom = values();
        String[] strArr = A04;
        ...
        return (EnumC1582f3[]) enumC1582f3ArrValuesCustom.clone();
    }
}
