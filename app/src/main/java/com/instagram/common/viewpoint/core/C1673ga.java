...
public class C1673ga<T> implements OZ<T> {
    ...
    public static String A00(int i2, int i8, int i9) {
        ...
        while (true) {
            ...
            bArrCopyOfRange[i10] = (byte) ((bArrCopyOfRange[i10] - i9) - 94);
            i10++;
        }
    }
    ...
    */
    private boolean A02(T r3) {
        ...
        L10:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1673ga.A02(java.lang.Object):boolean");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ga != com.facebook.ads.internal.androidx.support.v4.util.Pools$SimplePool<T> */
    @Override // com.instagram.common.viewpoint.core.OZ
    @Nullable
    public T A33() {
        if (this.A00 <= 0) {
            return null;
