...
public abstract class AbstractC0961Nt {
    ...
    public static Bundle A01(SQ sq) {
        ...
        bundle.putBoolean(A06(54, 13, 2), C1181Wm.A05(sq));
        return bundle;
    }

    public static Bundle A02(String str, C1694gv c1694gv) {
        Bundle bundle = new Bundle();
        A08(bundle, c1694gv.A05());
        bundle.putString(A06(451, 17, 16), c1694gv.A0A());
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c1694gv.A07());
        bundle.putString(A06(366, 19, 0), c1694gv.A08());
        bundle.putString(A06(404, 22, 98), c1694gv.A09());
        bundle.putString(A06(385, 19, 96), AbstractC0957Np.A01(c1694gv.A0B()));
        RewardData rewardDataA03 = c1694gv.A03();
        if (rewardDataA03 != null) {
            AbstractC0962Nu.A00(bundle, rewardDataA03);
        }
        C1477dL c1477dLA05 = c1694gv.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        ...
        bundle.putBundle(A06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c1477dLA05));
        return bundle;
    }

    public static Bundle A03(String str, C1685gm c1685gm) {
        Bundle bundle = new Bundle();
        A08(bundle, c1685gm.A0B);
        bundle.putString(A06(451, 17, 16), c1685gm.A0D);
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c1685gm.A05);
        bundle.putString(A06(366, 19, 0), c1685gm.A06);
        bundle.putString(A06(404, 22, 98), c1685gm.A07);
        AdExperienceType adExperienceType = c1685gm.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(237, 22, 24), AbstractC0956No.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c1685gm.A08);
        RewardData rewardData = c1685gm.A03;
        if (rewardData != null) {
            AbstractC0962Nu.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c1685gm.A0B));
        return bundle;
    }

    public static C1694gv A04(C1477dL c1477dL, Bundle bundle, String str) {
        ...
        C1694gv c1694gv = new C1694gv(c1477dL, null, string, new C1689gq(str, string4, bundle2));
        c1694gv.A0I(string3);
        c1694gv.A0H(string2);
        c1694gv.A0J(sdkVersion);
        String placement6 = A06(385, 19, 96);
        c1694gv.A0K(AbstractC0957Np.A02(bundle.getString(placement6)));
        RewardData rewardDataA01 = AbstractC0962Nu.A01(bundle);
        if (rewardDataA01 != null) {
            c1694gv.A0F(rewardDataA01);
        }
        return c1694gv;
    }

    public static C1685gm A05(C1477dL c1477dL, Bundle bundle, String str) {
        String string = bundle.getString(A06(451, 17, 16));
        ...
        C1685gm c1685gm = new C1685gm(c1477dL, string, null, new C1689gq(str, string4, bundle2));
        c1685gm.A06 = adExperienceType;
        c1685gm.A05 = string2;
        c1685gm.A08 = z2;
        c1685gm.A02 = AbstractC0956No.A00(string3);
        c1685gm.A07 = mediationData;
        RewardData rewardDataA01 = AbstractC0962Nu.A01(bundle);
        if (rewardDataA01 != null) {
            c1685gm.A03 = rewardDataA01;
        }
        return c1685gm;
    }
    ...
    public static void A08(Bundle bundle, SQ sq) {
        ...
        boolean zAAK = false;
        boolean isForcedFunnelLogging = sq instanceof C1477dL;
        if (isForcedFunnelLogging) {
            zAAK = ((C1477dL) sq).A0F().AAK();
        }
        boolean isForcedFunnelLogging2 = C1084Sp.A0I(sq);
        bundle.putBoolean(A06(33, 21, 55), isForcedFunnelLogging2 || zAAK);
