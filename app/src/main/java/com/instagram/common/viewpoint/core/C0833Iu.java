...
public final class C0833Iu {
    ...
    public int A01;
    public boolean A02;
    public final C0834Iv A04 = new C0834Iv();
    ...
    */
    private int A00(int r5) {
        ...
        L1f:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0833Iu.A00(int):int");
    }
    ...
    public final boolean A05(InterfaceC1943lN interfaceC1943lN) throws IOException {
        C3M.A08(interfaceC1943lN != null);
        if (this.A02) {
            this.A02 = false;
            this.A03.A0d(0);
        }
        while (!this.A02) {
            ...
            if (A05[2].length() == 22) {
                ...
                if (i2 < 0) {
                    if (!this.A04.A03(interfaceC1943lN) || !this.A04.A05(interfaceC1943lN, true)) {
                        return false;
                    }
                    int bytesToSkip = 0;
                    ...
                    if (!GZ.A02(interfaceC1943lN, iA00)) {
                        return false;
                    }
                ...
                if (strArr4[4].charAt(26) != strArr4[5].charAt(26)) {
                    ...
                    if (iA002 > 0) {
                        ...
                        if (!GZ.A03(interfaceC1943lN, this.A03.A0l(), this.A03.A0A(), iA002)) {
                            return false;
                        }
                        this.A03.A0e(this.A03.A0A() + iA002);
                        int i8 = this.A04.A09[segmentIndex - 1];
                        if (A05[2].length() == 22) {
                            String[] strArr5 = A05;
