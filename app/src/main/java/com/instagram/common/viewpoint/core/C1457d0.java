...
public final class C1457d0 {
    ...
    public C1457d0(SQ sq, C1456cz c1456cz, US us, Map<String, String> metricsData, String str) {
        this.A02 = sq;
        this.A05 = c1456cz;
        this.A03 = us;
        this.A07 = metricsData;
        this.A06 = str;
        this.A04 = new C1120Ua(this.A06, this.A03);
        this.A08 = U7.A29(c1456cz.getContext());
    }
    ...
    private void A05(String str) {
        ...
        map2.put(A00(39, 11, 46), AbstractC1186Wr.A01(map));
        A07(map2);
    }

    private void A06(String str, float f4, float f8) {
        HashMap map = new HashMap();
        map.put(A00(12, 11, 103), str);
        map.put(A00(93, 1, 72), String.valueOf(f4));
        map.put(A00(94, 1, 7), String.valueOf(f8));
        HashMap map2 = new HashMap();
    ...
    private void A07(Map<String, String> data) {
        ...
        data.putAll(AbstractC1458d1.A01(this.A02, this.A00, this.A01));
    ...
    @JavascriptInterface
    public void logButtonClick(String str, float f4, float f8) {
        if (!this.A08) {
            return;
        }
        A06(str, f4, f8);
