...
public final class C0982Oq {
    ...
    */
    public static void A00(int[] r43, int r44, int r45, int r46, int r47, int r48, int r49) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0982Oq.A00(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A02(Bitmap bitmap, float f4) {
        ...
        try {
            int[] iArr = new int[w2 * h];
            bitmap.getPixels(iArr, 0, w2, 0, 0, w2, h);
            int i2 = AbstractC1195Xa.A00;
            ArrayList arrayList = new ArrayList(i2);
            ArrayList<JavaBlurProcess.BlurTask> vertical = new ArrayList<>(i2);
            for (int i8 = 0; i8 < i2; i8++) {
                int h3 = h;
                int cores = i8;
                arrayList.add(new XZ(iArr, w2, h3, (int) f4, i2, cores, 1));
                h = h3;
                int cores2 = i8;
                vertical.add(new XZ(iArr, w2, h, (int) f4, i2, cores2, 2));
            }
            try {
                AbstractC1195Xa.A01.invokeAll(arrayList);
                try {
                    AbstractC1195Xa.A01.invokeAll(vertical);
                    try {
                        return Bitmap.createBitmap(iArr, w2, h, Bitmap.Config.ARGB_8888);
