...
public abstract class IZ {
    ...
    public static ApicFrame A01(C4J c4j) {
        ...
        if (iA0C2 == 1684108385) {
            ...
            if (mimeType == null) {
                AnonymousClass44.A07(strA0A, A0A(1955, 30, 80) + flags);
                return null;
            }
            c4j.A0g(4);
        ...
        AnonymousClass44.A07(strA0A, A0A(635, 35, 6));
        return null;
    }

    public static CommentFrame A02(int i2, C4J c4j) {
        int iA0C = c4j.A0C();
        int atomType = c4j.A0C();
        if (atomType == 1684108385) {
            c4j.A0g(8);
            int atomSize = iA0C - 16;
            String strA0V = c4j.A0V(atomSize);
            return new CommentFrame(A0A(2043, 3, 64), strA0V, strA0V);
        }
        AnonymousClass44.A07(A0A(1228, 12, 21), A0A(600, 35, 78) + II.A02(i2));
        return null;
    }

    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static Id3Frame A03(int i2, String str, C4J c4j, boolean z2, boolean z7) {
        int iA00 = A00(c4j);
        if (z7) {
        ...
        AnonymousClass44.A07(A0A(1228, 12, 21), A0A(813, 33, Sdk.SDKError.Reason.INVALID_ADS_ENDPOINT_VALUE) + II.A02(i2));
        return null;
    }
    ...
    public static Id3Frame A04(C4J c4j) {
        ...
        try {
            if (endPosition == 169 || endPosition == 253) {
                ...
                return A07(typeTopByte, A0A(1803, 4, Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE), c4j);
            }
            ...
            if (typeTopByte == 1936679276) {
                TextInformationFrame textInformationFrameA07 = A07(typeTopByte, A0A(1823, 4, 80), c4j);
                c4j.A0f(shortType);
            ...
            if (typeTopByte == 1885823344) {
                return A03(typeTopByte, A0A(IronSourceError.ERROR_RV_INIT_FAILED_TIMEOUT, 13, 104), c4j, false, true);
            }
    ...
    public static InternalFrame A05(C4J c4j, int i2) {
        String value = null;
        String strA0V = null;
        int dataAtomSize = -1;
        int i8 = -1;
    ...
    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static TextInformationFrame A06(int i2, String str, C4J c4j) {
        int iA0C = c4j.A0C();
        int atomType = c4j.A0C();
        ...
        AnonymousClass44.A07(A0A(1228, 12, 21), A0A(670, 39, 29) + II.A02(i2));
        return null;
    }

    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static TextInformationFrame A07(int i2, String str, C4J c4j) {
        int iA0C = c4j.A0C();
        int atomType = c4j.A0C();
        if (atomType == 1684108385) {
            c4j.A0g(8);
            int atomSize = iA0C - 16;
            return new TextInformationFrame(str, null, MetaExoPlayerCustomizedCollections.A03(c4j.A0V(atomSize)));
        }
        AnonymousClass44.A07(A0A(1228, 12, 21), A0A(744, 32, 94) + II.A02(i2));
        return null;
    }
    ...
    */
    public static com.facebook.ads.androidx.media3.extractor.metadata.id3.TextInformationFrame A08(com.instagram.common.viewpoint.core.C4J r4) {
        /*
            int r2 = A00(r4)
            r4 = 0
            if (r2 <= 0) goto L2b
            java.lang.String[] r0 = com.instagram.common.viewpoint.core.IZ.A02
            int r0 = r0.length
            if (r2 > r0) goto L2b
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.IZ.A02
            int r0 = r2 + (-1)
            r0 = r1[r0]
        L12:
            if (r0 == 0) goto L2d
            java.lang.String[] r0 = new java.lang.String[]{r0}
            java.util.List r3 = com.instagram.common.viewpoint.core.MetaExoPlayerCustomizedCollections.A03(r0)
        ...
        L2d:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.IZ.A08(com.facebook.ads.redexgen.X.4J):com.facebook.ads.androidx.media3.extractor.metadata.id3.TextInformationFrame");
    }

    public static MdtaMetadataEntry A09(C4J c4j, int i2, String str) {
        while (true) {
    ...
    public static void A0C(int i2, Metadata metadata, Metadata metadata2, C2D c2d, Metadata... metadataArr) {
        ...
        if (i2 == 1) {
            ...
            while (true) {
                ...
                Metadata.Entry entry = metadata2.A03(i8);
    ...
    public static void A0D(int i2, C0770Gi c0770Gi, C2D c2d) {
        if (i2 == 1 && c0770Gi.A03()) {
            c2d.A0d(c0770Gi.A00).A0e(c0770Gi.A01);
        }
    }
}
