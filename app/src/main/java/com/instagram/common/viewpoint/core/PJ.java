...
public abstract class PJ {
    ...
    static {
        A01();
        A02 = new C1668gT() { // from class: com.facebook.ads.redexgen.X.6n
            public static byte[] A00;
            ...
            @Override // com.instagram.common.viewpoint.core.PI
            public final void A03(ViewParent viewParent, View view, int i2, int i8, int i9, int i10) {
                try {
            ...
            @Override // com.instagram.common.viewpoint.core.PI
            public final void A04(ViewParent viewParent, View view, int i2, int i8, int[] iArr) {
                try {
            ...
            @Override // com.instagram.common.viewpoint.core.PI
            public final void A05(ViewParent viewParent, View view, View view2, int i2) {
                try {
            ...
            @Override // com.instagram.common.viewpoint.core.PI
            public final boolean A06(ViewParent viewParent, View view, float f4, float f8) {
                try {
            ...
            @Override // com.instagram.common.viewpoint.core.PI
            public final boolean A07(ViewParent viewParent, View view, float f4, float f8, boolean z2) {
                try {
            ...
            @Override // com.instagram.common.viewpoint.core.PI
            public final boolean A08(ViewParent viewParent, View view, View view2, int i2) {
                try {
    ...
    public static void A03(ViewParent viewParent, View view, int i2, int i8, int i9, int i10, int i11) {
        if (0 != 0) {
            throw new NullPointerException(A00(17, 14, 15));
        }
        if (i11 == 0) {
            A02.A03(viewParent, view, i2, i8, i9, i10);
        }
    }

    public static void A04(ViewParent viewParent, View view, int i2, int i8, int[] iArr, int i9) {
        if (0 != 0) {
            throw new NullPointerException(A00(0, 17, 84));
        }
        if (i9 == 0) {
            A02.A04(viewParent, view, i2, i8, iArr);
        }
    }

    public static void A05(ViewParent viewParent, View view, View view2, int i2, int i8) {
        if (0 != 0) {
        ...
        if (i8 == 0) {
            ...
            if (A01[1].length() != 12) {
                ...
                pi.A05(viewParent, view, view2, i2);
                return;
            }
            throw new RuntimeException();
        }
    ...
    public static boolean A06(ViewParent viewParent, View view, float f4, float f8) {
        return A02.A06(viewParent, view, f4, f8);
    }

    public static boolean A07(ViewParent viewParent, View view, float f4, float f8, boolean z2) {
        return A02.A07(viewParent, view, f4, f8, z2);
    }

    public static boolean A08(ViewParent viewParent, View view, View view2, int i2, int i8) {
        if (0 != 0) {
            throw new NullPointerException(A00(53, 19, 16));
        }
        if (i8 == 0) {
            boolean zA08 = A02.A08(viewParent, view, view2, i2);
            if (A01[1].length() == 12) {
                throw new RuntimeException();
            }
