...
public final class C1421cQ extends RelativeLayout {
    public KE A00;
    ...
    public static final int A0F = (int) (AbstractC1180Wl.A02 * 16.0f);
    public static final int A0D = (int) (AbstractC1180Wl.A02 * 20.0f);
    public static final int A0E = (int) (AbstractC1180Wl.A02 * 13.0f);
    public static final int A08 = (int) (AbstractC1180Wl.A02 * 72.0f);
    public static final int A0C = (int) (AbstractC1180Wl.A02 * 8.0f);
    public static final int A0A = (int) (AbstractC1180Wl.A02 * 24.0f);
    public static final int A09 = (int) (AbstractC1180Wl.A02 * 16.0f);

    public C1421cQ(C1477dL c1477dL, N9 n9, C0938Mw c0938Mw, KE ke, String str, View.OnClickListener onClickListener) {
        super(c1477dL);
        this.A04 = c1477dL;
        this.A03 = n9;
        this.A02 = c0938Mw;
        ...
        this.A06 = new C1297aQ(this.A04, C0940My.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC1298aR.A00(this.A04, this, this.A03.A01());
