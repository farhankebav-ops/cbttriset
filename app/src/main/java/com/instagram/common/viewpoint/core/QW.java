...
public final class QW {
    ...
    public QV A01;
    public AbstractC1022Qe A04;
    public final /* synthetic */ C05246g A08;
    public final ArrayList<AbstractC1024Qg> A05 = new ArrayList<>();
    public ArrayList<AbstractC1024Qg> A02 = null;
    public final ArrayList<AbstractC1024Qg> A06 = new ArrayList<>();
    public final List<AbstractC1024Qg> A07 = Collections.unmodifiableList(this.A05);
    public int A03 = 2;
    public int A00 = 2;
    ...
    public QW(C05246g c05246g) {
        this.A08 = c05246g;
    }

    private final View A00(int i2, boolean z2) {
        return A0I(i2, z2, LocationRequestCompat.PASSIVE_INTERVAL).A0H;
    }

    private final AbstractC1024Qg A01(int i2) {
        int size;
        int iA04;
        ...
        for (int i8 = 0; i8 < size; i8++) {
            AbstractC1024Qg abstractC1024Qg = this.A02.get(i8);
            if (!abstractC1024Qg.A0m()) {
                int i9 = abstractC1024Qg.A0O();
                if (i9 == i2) {
                    abstractC1024Qg.A0Z(32);
                    return abstractC1024Qg;
                }
            }
        }
        if (this.A08.A04.A0M() && (iA04 = this.A08.A00.A04(i2)) > 0) {
            int offsetPosition = this.A08.A04.A0B();
            if (iA04 < offsetPosition) {
                long jA0D = this.A08.A04.A0D(iA04);
                for (int i10 = 0; i10 < size; i10++) {
                    AbstractC1024Qg abstractC1024Qg2 = this.A02.get(i10);
                    if (!abstractC1024Qg2.A0m() && abstractC1024Qg2.A0Q() == jA0D) {
                        abstractC1024Qg2.A0Z(32);
                        return abstractC1024Qg2;
                    }
                }
            }
        }
    ...
    private final AbstractC1024Qg A02(int i2, boolean z2) {
        View viewA08;
        int size = this.A05.size();
        for (int i8 = 0; i8 < size; i8++) {
            AbstractC1024Qg abstractC1024Qg = this.A05.get(i8);
            if (!abstractC1024Qg.A0m()) {
                int scrapCount = abstractC1024Qg.A0O();
                if (scrapCount == i2 && !abstractC1024Qg.A0f() && (this.A08.A0s.A09 || !abstractC1024Qg.A0g())) {
                    abstractC1024Qg.A0Z(32);
                    return abstractC1024Qg;
                }
            }
        }
        if (!z2 && (viewA08 = this.A08.A01.A08(i2)) != null) {
            AbstractC1024Qg abstractC1024QgA0F = C05246g.A0F(viewA08);
            this.A08.A01.A0G(viewA08);
            int iA07 = this.A08.A01.A07(viewA08);
            if (iA07 != -1) {
                this.A08.A01.A0C(iA07);
                A0S(viewA08);
                abstractC1024QgA0F.A0Z(8224);
                return abstractC1024QgA0F;
            }
            throw new IllegalStateException(A04(565, 52, Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE) + abstractC1024QgA0F + this.A08.A1J());
        }
        int size2 = this.A06.size();
        for (int i9 = 0; i9 < size2; i9++) {
            AbstractC1024Qg holder = this.A06.get(i9);
            String[] strArr = A0A;
            String str = strArr[7];
    ...
    private final AbstractC1024Qg A03(long j, int i2, boolean z2) {
        int count = this.A05.size();
        for (int i8 = count - 1; i8 >= 0; i8--) {
            AbstractC1024Qg abstractC1024Qg = this.A05.get(i8);
            if (abstractC1024Qg.A0Q() == j && !abstractC1024Qg.A0m()) {
                int count2 = abstractC1024Qg.A0N();
                if (i2 == count2) {
                    abstractC1024Qg.A0Z(32);
                    boolean zA0g = abstractC1024Qg.A0g();
                    String[] strArr = A0A;
                    String str = strArr[2];
                    ...
                    if (i10 == count4) {
                        ...
                        c05246g.removeDetachedView(view, false);
                        A0R(abstractC1024Qg.A0H);
                    }
                }
                throw new RuntimeException();
            }
        ...
        for (int i11 = count5 - 1; i11 >= 0; i11--) {
            AbstractC1024Qg abstractC1024Qg2 = this.A06.get(i11);
            if (abstractC1024Qg2.A0Q() == j) {
                int count6 = abstractC1024Qg2.A0N();
                if (i2 == count6) {
                    if (!z2) {
                        this.A06.remove(i11);
                    }
    ...
    private void A09(AbstractC1024Qg abstractC1024Qg) {
        if (this.A08.A1q()) {
            View view = abstractC1024Qg.A0H;
            if (P3.A00(view) == 0) {
                P3.A09(view, 1);
            ...
            abstractC1024Qg.A0Z(16384);
            P3.A0B(view, this.A08.A09.A0A());
        }
    }

    private void A0A(AbstractC1024Qg abstractC1024Qg) {
        if (abstractC1024Qg.A0H instanceof ViewGroup) {
            A08((ViewGroup) abstractC1024Qg.A0H, false);
        }
    }

    private final void A0B(AbstractC1024Qg abstractC1024Qg) {
        if (0 != 0) {
            throw new NullPointerException(A04(IronSourceError.ERROR_BN_BANNER_CONTAINER_IS_NULL, 14, 32));
        }
        if (this.A08.A0s != null) {
            this.A08.A0t.A0B(abstractC1024Qg);
        }
    }

    private final boolean A0C(AbstractC1024Qg abstractC1024Qg) {
        if (abstractC1024Qg.A0g()) {
            return this.A08.A0s.A07();
        }
        if (abstractC1024Qg.A03 >= 0 && abstractC1024Qg.A03 < this.A08.A04.A0B()) {
            if (!this.A08.A0s.A07()) {
                int iA0C = this.A08.A04.A0C(abstractC1024Qg.A03);
                int type = abstractC1024Qg.A0N();
                if (iA0C != type) {
                    return false;
                }
            }
            return !this.A08.A04.A0M() || abstractC1024Qg.A0Q() == this.A08.A04.A0D(abstractC1024Qg.A03);
        }
        throw new IndexOutOfBoundsException(A04(211, 60, 92) + abstractC1024Qg + this.A08.A1J());
    }

    private boolean A0D(AbstractC1024Qg abstractC1024Qg, int i2, int i8, long j) {
        abstractC1024Qg.A08 = this.A08;
        int iA0N = abstractC1024Qg.A0N();
        long nanoTime = this.A08.getNanoTime();
        if (j != LocationRequestCompat.PASSIVE_INTERVAL && !this.A01.A0A(iA0N, nanoTime, j)) {
            return false;
        }
        this.A08.A04.A0J(abstractC1024Qg, i2);
        this.A01.A05(abstractC1024Qg.A0N(), this.A08.getNanoTime() - nanoTime);
        A09(abstractC1024Qg);
        if (this.A08.A0s.A07()) {
            abstractC1024Qg.A04 = i8;
            return true;
        }
        return true;
    }
    ...
    */
    public final com.instagram.common.viewpoint.core.AbstractC1024Qg A0I(int r23, boolean r24, long r25) {
        /*
            Method dump skipped, instruction units count: 730
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.QW.A0I(int, boolean, long):com.facebook.ads.redexgen.X.Qg");
    }

    public final List<AbstractC1024Qg> A0J() {
        return this.A07;
    }
    ...
    public final void A0K() {
        ...
        int i8 = this.A05.size();
        for (int scrapCount = 0; scrapCount < i8; scrapCount++) {
    ...
    public final void A0M() {
        int size = this.A06.size();
        for (int i2 = 0; i2 < size; i2++) {
            QP qp = (QP) this.A06.get(i2).A0H.getLayoutParams();
            if (qp != null) {
                qp.A01 = true;
            }
        }
    ...
    public final void A0N() {
        if (this.A08.A04 != null && this.A08.A04.A0M()) {
            int size = this.A06.size();
            for (int i2 = 0; i2 < size; i2++) {
                AbstractC1024Qg abstractC1024Qg = this.A06.get(i2);
                if (abstractC1024Qg != null) {
                    abstractC1024Qg.A0Z(6);
                    abstractC1024Qg.A0c(null);
                }
            }
            return;
        }
    ...
    public final void A0O() {
        ...
        for (int i8 = extraCache2 - 1; i8 >= 0; i8--) {
            int size = this.A06.size();
            int i9 = this.A00;
            String[] strArr = A0A;
            String str = strArr[5];
    ...
    public final void A0R(View view) {
        ...
        abstractC1024QgA0F.A0F = null;
        abstractC1024QgA0F.A0G = false;
        abstractC1024QgA0F.A0U();
        A0X(abstractC1024QgA0F);
    }

    public final void A0S(View view) {
        AbstractC1024Qg abstractC1024QgA0F = C05246g.A0F(view);
        if (abstractC1024QgA0F.A0o(12) || !abstractC1024QgA0F.A0j() || this.A08.A1y(abstractC1024QgA0F)) {
            if (!abstractC1024QgA0F.A0f() || abstractC1024QgA0F.A0g() || this.A08.A04.A0M()) {
                abstractC1024QgA0F.A0b(this, false);
                this.A05.add(abstractC1024QgA0F);
                return;
            }
        ...
        abstractC1024QgA0F.A0b(this, true);
        this.A02.add(abstractC1024QgA0F);
    }
    ...
    public final void A0T(View view) {
        ...
        } else if (abstractC1024QgA0F.A0m()) {
            abstractC1024QgA0F.A0U();
        }
        A0X(abstractC1024QgA0F);
    }

    public final void A0U(QC qc, QC qc2, boolean z2) {
        A0P();
        A0H().A08(qc, qc2, z2);
    }
    ...
    public final void A0W(AbstractC1022Qe abstractC1022Qe) {
        this.A04 = abstractC1022Qe;
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0X(com.instagram.common.viewpoint.core.AbstractC1024Qg r9) {
        /*
            Method dump skipped, instruction units count: 396
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.QW.A0X(com.facebook.ads.redexgen.X.Qg):void");
    }

    public final void A0Y(AbstractC1024Qg abstractC1024Qg) {
        if (abstractC1024Qg.A0G) {
            ArrayList<AbstractC1024Qg> arrayList = this.A02;
            String[] strArr = A0A;
            ...
            arrayList.remove(abstractC1024Qg);
        } else {
            this.A05.remove(abstractC1024Qg);
        }
        abstractC1024Qg.A0F = null;
        abstractC1024Qg.A0G = false;
        abstractC1024Qg.A0U();
    }

    public final void A0Z(AbstractC1024Qg abstractC1024Qg, boolean z2) {
        C05246g.A0s(abstractC1024Qg);
        if (abstractC1024Qg.A0o(16384)) {
            abstractC1024Qg.A0a(0, 16384);
            P3.A0B(abstractC1024Qg.A0H, null);
        }
        if (z2) {
            A0B(abstractC1024Qg);
        }
        abstractC1024Qg.A08 = null;
        A0H().A09(abstractC1024Qg);
    }
}
