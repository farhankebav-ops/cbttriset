...
public enum EnumC1185Wq {
    ...
    EnumC1185Wq(int i2, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i2;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC1185Wq A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC1185Wq enumC1185Wq : values()) {
            if (enumC1185Wq.A01 == nativeComponentTag) {
                return enumC1185Wq;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1185Wq internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC1185Wq enumC1185Wq) {
        if (view != null && enumC1185Wq != null) {
            view.setTag(A02, enumC1185Wq);
        }
    }
