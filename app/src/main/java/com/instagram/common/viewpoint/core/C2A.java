...
public final class C2A {
    ...
    public final C2A A00(int i2) {
        C3M.A08(!this.A00);
        this.A01.append(i2, true);
        return this;
    }

    public final C2A A01(int i2, boolean z2) {
        if (z2) {
            C2A c2aA00 = A00(i2);
            if (A02[6].length() != 11) {
    ...
    */
    public final com.instagram.common.viewpoint.core.C2A A02(com.instagram.common.viewpoint.core.C2B r3) {
        /*
            r2 = this;
            r1 = 0
        L1:
        ...
        L11:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2A.A02(com.facebook.ads.redexgen.X.2B):com.facebook.ads.redexgen.X.2A");
    }
