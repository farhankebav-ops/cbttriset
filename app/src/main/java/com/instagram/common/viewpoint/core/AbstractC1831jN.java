...
public abstract class AbstractC1831jN implements L0 {
    ...
    public static String A03(int i2, int i8, int i9) {
        ...
        while (true) {
            ...
            byte b8 = (byte) ((bArrCopyOfRange[i10] - i9) - 56);
            if (A02[7].length() == 15) {
                throw new RuntimeException();
            }
    ...
    public abstract boolean A08(File file, long j, int i2);

    static {
        A04();
        A03 = AbstractC1831jN.class.getSimpleName();
    }
