...
public final class C1694gv implements SN {
    public long A00;
    ...
    public C1694gv(C1477dL c1477dL, InterstitialAd interstitialAd, String str) {
        this(c1477dL, interstitialAd, str, new C1709hB());
    }

    public C1694gv(C1477dL c1477dL, InterstitialAd interstitialAd, String str, TL tl) {
        this.A0A = c1477dL;
        this.A0B = str;
