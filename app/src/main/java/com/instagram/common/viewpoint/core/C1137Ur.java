...
public final class C1137Ur implements NativeAdViewAttributesApi {
    public static final int A08 = (int) (AbstractC1180Wl.A02 * 4.0f);
    public static final int A07 = (int) (AbstractC1180Wl.A02 * 1.0f);
    ...
    public final int A04(float f4) {
        int i2 = (this.A01 & ViewCompat.MEASURED_STATE_MASK) | ((~this.A01) & ViewCompat.MEASURED_SIZE_MASK);
        int textColor = this.A01;
        return OP.A05(i2, textColor, f4);
    }
