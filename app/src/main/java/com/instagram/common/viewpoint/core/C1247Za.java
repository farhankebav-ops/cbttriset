...
public class C1247Za extends WebChromeClient {
    ...
    public final WeakReference<C1477dL> A00;
    ...
    public C1247Za(WeakReference<C1477dL> weakReference, WeakReference<ZY> weakReference2, WeakReference<ZT> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        C1477dL c1477dL = this.A00.get();
        if (c1477dL != null && c1477dL.A0E() != null && LJ.A09) {
            if (LJ.A08 != null) {
            ...
            try {
                ...
                c1477dL.A0E().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 84)), 1001);
                return true;
            } catch (Exception e) {
                c1477dL.A08().AAz(A00(80, 8, 33), AbstractC1090Sv.A2d, new C1091Sw(e));
