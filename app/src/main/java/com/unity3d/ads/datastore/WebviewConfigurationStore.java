    ...
    public static final class WebViewConfigurationStore extends GeneratedMessageLite<WebViewConfigurationStore, Builder> implements WebViewConfigurationStoreOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<WebViewConfigurationStore, Builder> implements WebViewConfigurationStoreOrBuilder {
            ...
            public String getAdditionalFiles(int i2) {
                return ((WebViewConfigurationStore) this.instance).getAdditionalFiles(i2);
            }

            @Override // com.unity3d.ads.datastore.WebviewConfigurationStore.WebViewConfigurationStoreOrBuilder
            public ByteString getAdditionalFilesBytes(int i2) {
                return ((WebViewConfigurationStore) this.instance).getAdditionalFilesBytes(i2);
            }
            ...
            public Builder setAdditionalFiles(int i2, String str) {
                copyOnWrite();
                ((WebViewConfigurationStore) this.instance).setAdditionalFiles(i2, str);
                return this;
            }
            ...
            public Builder setVersion(int i2) {
                copyOnWrite();
                ((WebViewConfigurationStore) this.instance).setVersion(i2);
                return this;
            }
