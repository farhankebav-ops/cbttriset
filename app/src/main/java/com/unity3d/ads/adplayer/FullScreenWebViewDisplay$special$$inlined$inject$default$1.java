...
public final class FullScreenWebViewDisplay$special$$inlined$inject$default$1 extends l implements a {
    ...
    public final SendDiagnosticEvent invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, b0.a(SendDiagnosticEvent.class));
    }
}
