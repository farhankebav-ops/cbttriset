...
public final class EglCore {
    ...
    private final void checkEglError(String str) {
        ...
        if (iEglGetError != 12288) {
            throw new RuntimeException(a.i(iEglGetError, a.x(str, ": EGL error: 0x")));
        }
    }

    private final EGLConfig getConfig(int i2, int i8) {
        int[] iArr = {12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, i8 >= 3 ? 68 : 4, 12344, 0, 12344};
        if ((i2 & 1) != 0) {
    ...
    public final EGLSurface createOffscreenSurface(int i2, int i8) {
        EGLSurface eGLSurfaceEglCreatePbufferSurface = EGL14.eglCreatePbufferSurface(this.mEGLDisplay, this.mEGLConfig, new int[]{12375, i2, 12374, i8, 12344}, 0);
    ...
    public /* synthetic */ EglCore(EGLContext eGLContext, int i2, int i8, f fVar) {
        this((i8 & 1) != 0 ? null : eGLContext, (i8 & 2) != 0 ? 0 : i2);
    }
}
