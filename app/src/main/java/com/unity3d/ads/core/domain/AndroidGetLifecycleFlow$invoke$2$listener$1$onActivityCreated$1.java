...
public final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityCreated$1 extends i implements p {
    ...
    public AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityCreated$1(x xVar, Activity activity, Bundle bundle, c<? super AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityCreated$1> cVar) {
        super(2, cVar);
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (((w) xVar).f13759d.c(created, this) == aVar) {
                return aVar;
            }
        } else {
            if (i2 != 1) {
    ...
    public final Object invoke(a0 a0Var, c<? super q5.x> cVar) {
        return ((AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityCreated$1) create(a0Var, cVar)).invokeSuspend(q5.x.f13520a);
    }
}
