...
public final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1 extends i implements p {
    final /* synthetic */ x $$this$channelFlow;
    final /* synthetic */ Activity $activity;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1(x xVar, Activity activity, c<? super AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1> cVar) {
        super(2, cVar);
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (((w) xVar).f13759d.c(stopped, this) == aVar) {
                return aVar;
            }
        } else {
            if (i2 != 1) {
    ...
    public final Object invoke(a0 a0Var, c<? super q5.x> cVar) {
        return ((AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1) create(a0Var, cVar)).invokeSuspend(q5.x.f13520a);
    }
}
