...
public interface SendDiagnosticEvent {
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void invoke$default(SendDiagnosticEvent sendDiagnosticEvent, String str, Double d8, Map map, Map map2, AdObject adObject, Integer num, int i2, Object obj) {
            if (obj != null) {
            ...
            sendDiagnosticEvent.invoke(str, d8, map, map2, adObject, num);
        }
    }

    void invoke(String str, Double d8, Map<String, String> map, Map<String, Integer> map2, AdObject adObject, Integer num);
}
