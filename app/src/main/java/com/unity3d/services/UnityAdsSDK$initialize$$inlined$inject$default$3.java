...
public final class UnityAdsSDK$initialize$$inlined$inject$default$3 extends l implements a {
    ...
    public final InitializeSDK invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, b0.a(InitializeSDK.class));
    }
}
