...
public class WebPlayerView extends WebView {
    ...
    public class WebPlayerChromeClient extends WebChromeClient {
        ...
        public boolean onCreateWindow(WebView webView, boolean z2, boolean z7, Message message) {
            ...
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("onCreateWindow") ? Boolean.valueOf(super.onCreateWindow(webView, z2, z7, message)) : bool;
            if (WebPlayerView.this.shouldSendEvent("onCreateWindow")) {
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.WEBPLAYER, WebPlayerEvent.CREATE_WINDOW, Boolean.valueOf(z2), Boolean.valueOf(z7), message, WebPlayerView.this.viewId);
            }
    ...
    public <T> T getReturnValue(String str, Class<T> cls, T t3) {
        try {
            ...
            return (jSONObject != null && jSONObject.has(str) && this._eventSettings.getJSONObject(str).has("returnValue")) ? cls.cast(this._eventSettings.getJSONObject(str).get("returnValue")) : t3;
        } catch (Exception e) {
    ...
    public class WebPlayerClient extends WebViewClient {
        ...
        public void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
            ...
            if (WebPlayerView.this.shouldSendEvent("onReceivedHttpError")) {
                ...
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.WEBPLAYER, WebPlayerEvent.HTTP_ERROR, string, str, Integer.valueOf(i2), WebPlayerView.this.viewId);
            }
        }
        ...
        public void onScaleChanged(WebView webView, float f4, float f8) {
            ...
            if (WebPlayerView.this.shouldSendEvent("onScaleChanged")) {
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.WEBPLAYER, WebPlayerEvent.SCALE_CHANGED, Float.valueOf(f4), Float.valueOf(f8), WebPlayerView.this.viewId);
            }
        }
