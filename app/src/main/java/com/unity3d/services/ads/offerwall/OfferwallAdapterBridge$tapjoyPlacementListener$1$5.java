...
public final class OfferwallAdapterBridge$tapjoyPlacementListener$1$5 extends i implements p {
    ...
    public final Object invoke(a0 a0Var, c<? super x> cVar) {
        return ((OfferwallAdapterBridge$tapjoyPlacementListener$1$5) create(a0Var, cVar)).invokeSuspend(x.f13520a);
    }
}
