...
public class BannerBridge {
    ...
    public static void resize(String str, int i2, int i8, int i9, int i10, float f4) {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
            currentApp.sendEvent(WebViewEventCategory.BANNER, BannerEvent.BANNER_RESIZED, str, Integer.valueOf(i2), Integer.valueOf(i8), Integer.valueOf(i9), Integer.valueOf(i10), Float.valueOf(f4));
        }
    }
    ...
    public static void load(String str, final String str2, UnityBannerSize unityBannerSize, final UnityAdsLoadOptions unityAdsLoadOptions) {
        ...
        boolean z2 = unityAdsLoadOptions.getObjectId() != null;
        if (zInvoke && !z2) {
