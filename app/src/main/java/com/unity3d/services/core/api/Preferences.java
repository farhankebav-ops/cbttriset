...
public class Preferences {
    ...
    public static void getFloat(String str, String str2, WebViewCallback webViewCallback) {
        Float f4 = AndroidPreferences.getFloat(str, str2);
        if (f4 != null) {
            webViewCallback.invoke(f4);
        } else {
            webViewCallback.error(PreferencesError.COULDNT_GET_VALUE, str, str2);
        }
    }
    ...
    @WebViewExposed
    public static void setFloat(String str, String str2, Double d8, WebViewCallback webViewCallback) {
        AndroidPreferences.setFloat(str, str2, d8);
        webViewCallback.invoke(new Object[0]);
    }
