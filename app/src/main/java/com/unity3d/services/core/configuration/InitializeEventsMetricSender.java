...
public class InitializeEventsMetricSender implements IInitializeEventsMetricSender, IInitializationListener {
    ...
    private Metric getPrivacyRequestMetric(boolean z2) {
        return z2 ? TSIMetric.newPrivacyRequestLatencySuccess(privacyConfigDuration()) : TSIMetric.newPrivacyRequestLatencyFailure(privacyConfigDuration());
    }
    ...
    private void sendTokenAvailabilityMetricWithConfig(boolean z2) {
        ...
        sendMetric(z2 ? TSIMetric.newTokenAvailabilityLatencyConfig(lValueOf, retryTags) : TSIMetric.newTokenAvailabilityLatencyWebview(lValueOf, retryTags));
    }
