...
public class Device {
    ...
    public static String getConnectionType() {
        return isUsingWifi() ? C2228a4.f7946b : isActiveNetworkConnected() ? C2228a4.g : "none";
    }
    ...
    */
    ...
    public static JSONObject getPackageInfo(PackageManager packageManager) throws JSONException, PackageManager.NameNotFoundException {
        ...
        jSONObject.put(C2300e4.i.X, packageInfo.firstInstallTime);
        jSONObject.put(C2300e4.i.V, packageInfo.lastUpdateTime);
