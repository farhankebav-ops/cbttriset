...
public abstract class GenericBridge {
    ...
    private Method getReflectiveMethod(Class<?> cls, String str, Class<?>... clsArr) {
        try {
            ...
            WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.GMA, c.E, new Object[0]);
            return null;
        }
    }
    ...
    public GenericBridge(Map<String, Class<?>[]> map, boolean z2) {
