...
public class JsonStorage implements IJsonStorageReader {
        ...
        for (int i2 = 0; i2 < strArrSplit.length; i2++) {
            if (jSONObject.has(strArrSplit[i2])) {
                ...
                try {
                    ...
                    DeviceLog.exception("Couldn't create new JSONObject", e4);
                }
            }
        }
    }
    ...
    private synchronized Object findObject(String str) {
        ...
        for (int i2 = 0; i2 < strArrSplit.length; i2++) {
            ...
            try {
                ...
                DeviceLog.exception("Couldn't read JSONObject: " + strArrSplit[i2], e);
                return null;
            }
        }
        return jSONObject;
    ...
    public synchronized List<String> getKeys(String str, boolean z2) {
        List<String> keys;
        try {
