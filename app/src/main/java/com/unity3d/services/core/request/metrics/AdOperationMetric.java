...
public class AdOperationMetric {
    ...
    private static HashMap<String, String> getTags(AdOperationError adOperationError, boolean z2, boolean z7, Boolean bool) {
        return new HashMap<String, String>(z2, adOperationError == null ? "unknown" : adOperationError.toString(), z7 ? "banner" : "video", bool) { // from class: com.unity3d.services.core.request.metrics.AdOperationMetric.1
    ...
    public static Metric newAdLoadFailure(AdOperationError adOperationError, Long l, boolean z2, boolean z7) {
        return new Metric(AD_LOAD_FAIL, l, getTags(adOperationError, true, z2, Boolean.valueOf(z7)));
    }

    public static Metric newAdLoadStart(boolean z2, boolean z7) {
        return new Metric("native_load_started", null, getTags(null, false, z2, Boolean.valueOf(z7)));
    }

    public static Metric newAdLoadSuccess(Long l, boolean z2, boolean z7) {
        return new Metric(AD_LOAD_SUCCESS, l, getTags(null, false, z2, Boolean.valueOf(z7)));
    }
    ...
    public static Metric newAdLoadFailure(UnityAds.UnityAdsLoadError unityAdsLoadError, Long l, boolean z2, boolean z7) {
        return newAdLoadFailure(mapUnityAdsLoadError(unityAdsLoadError), l, z2, z7);
    }
