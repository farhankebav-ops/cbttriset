...
public final class UnityAdsSDK$initialize$$inlined$inject$default$1 extends l implements a {
    ...
    public final ShouldAllowInitialization invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, b0.a(ShouldAllowInitialization.class));
    }
}
