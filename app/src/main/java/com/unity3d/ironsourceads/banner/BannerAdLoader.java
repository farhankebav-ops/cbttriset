...
public final class BannerAdLoader {
    ...
    private static final Executor f10870a = V7.f7731a.c();
    ...
    public static final void loadAd(BannerAdRequest adRequest, BannerAdLoaderListener listener) {
        ...
        INSTANCE.internalLoadAd$mediationsdk_release(f10870a, new C2335g3(adRequest, listener, C2415kc.e.a(IronSource.a.BANNER), null, 8, null));
    }
