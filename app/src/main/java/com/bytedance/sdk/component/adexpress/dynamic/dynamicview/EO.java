...
public class EO extends vCE {
    ...
    public EO(Context context, DynamicRootView dynamicRootView, com.bytedance.sdk.component.adexpress.dynamic.tV.lEW lew) {
        super(context, dynamicRootView, lew);
        this.xF = 0;
        this.AXM = false;
        this.oeT = new Runnable() { // from class: com.bytedance.sdk.component.adexpress.dynamic.dynamicview.EO.1
    ...
    public void IlO() {
        ...
        if (i2 + 1 >= getChildCount() || ((ViewGroup) getChildAt(this.xF + 1)).getChildCount() <= 0) {
            this.AXM = true;
            childAt = getChildAt(this.xF - 1);
            this.IlO = ObjectAnimator.ofFloat(childAt2, "translationX", 0.0f, (getChildAt(this.xF).getWidth() + this.Bc) / 2);
        } else {
            childAt = getChildAt(this.xF + 1);
            this.IlO = ObjectAnimator.ofFloat(childAt2, "translationX", 0.0f, (-(getChildAt(this.xF).getWidth() + this.Bc)) / 2);
        }
        ...
        this.IlO.addListener(new Animator.AnimatorListener() { // from class: com.bytedance.sdk.component.adexpress.dynamic.dynamicview.EO.2
        ...
        if (this.AXM) {
            this.MY = ObjectAnimator.ofFloat(childAt, "translationX", (-(childAt.getWidth() + this.Bc)) / 2, 0.0f);
        } else {
            this.MY = ObjectAnimator.ofFloat(childAt, "translationX", (childAt.getWidth() + this.Bc) / 2, 0.0f);
        }
        this.MY.setInterpolator(new LinearInterpolator());
        this.MY.addListener(new Animator.AnimatorListener() { // from class: com.bytedance.sdk.component.adexpress.dynamic.dynamicview.EO.3
            @Override // android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
