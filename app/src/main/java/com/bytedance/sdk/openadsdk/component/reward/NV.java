...
public class NV {
    public static void IlO(String str, int i2, String str2, String str3, String str4) {
        try {
            ...
            if (oetIlO != null) {
                ...
                if (oetIlO.VH() != null) {
                    if (TextUtils.isEmpty(str2)) {
                        oetIlO.VH().IlO((String) null);
                        oetIlO.VH().MY("");
                    } else {
                        oetIlO.VH().IlO(str2);
                        oetIlO.VH().MY("Test the downloaded app");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
                    } else {
            ...
            ilO.IlO(arrayList);
            new bWL(cl.IlO(), ilO).IlO(true);
        } catch (Exception e) {
            com.bytedance.sdk.component.utils.oeT.EO("PlayableVerityHelper", e.getMessage());
        }
    }
}
