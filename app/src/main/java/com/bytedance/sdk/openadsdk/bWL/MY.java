...
public class MY extends NV {
    ...
    public void IlO(Context context) {
        ...
        bc.setId(zPa.vZk);
        bc.setLayoutParams(new LinearLayout.LayoutParams(-2, BS.MY(context, 40.0f)));
        bc.setGravity(17);
        cc2.addView(bc);
        com.bytedance.sdk.openadsdk.core.widget.zPa zpaBc = Bc(context);
        this.EO = zpaBc;
        zpaBc.setId(zPa.OW);
        int iMY3 = BS.MY(context, 35.0f);
        ...
        this.tV = lewMY;
        lewMY.setId(zPa.eeU);
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(-2, iMY * 2);
        int iMY4 = BS.MY(context, 6.0f);
        layoutParams5.leftMargin = iMY4;
        layoutParams5.setMarginStart(iMY4);
        ...
        this.Cc = lewEO;
        lewEO.setId(zPa.BES);
        RelativeLayout.LayoutParams layoutParams6 = new RelativeLayout.LayoutParams(-2, BS.MY(context, 20.0f));
        layoutParams6.addRule(3, this.tV.getId());
        layoutParams6.addRule(8, this.EO.getId());
        layoutParams6.addRule(17, this.EO.getId());
        layoutParams6.addRule(1, this.EO.getId());
        layoutParams6.leftMargin = iMY4;
        layoutParams6.setMarginStart(iMY4);
        this.Cc.setLayoutParams(layoutParams6);
        bc.addView(this.Cc);
        com.bytedance.sdk.openadsdk.core.Cc.lEW lewTV = tV(context);
        this.vCE = lewTV;
        lewTV.setId(zPa.tf);
        LinearLayout.LayoutParams layoutParams7 = new LinearLayout.LayoutParams(-1, BS.MY(context, 22.0f));
    ...
    public com.bytedance.sdk.openadsdk.core.Cc.lEW MY(Context context) {
        ...
        lewMY.setTextSize(2, 13.0f);
        lewMY.setText("Pangle");
        return lewMY;
    }
    ...
    public MY(Context context, AttributeSet attributeSet, int i2) {
