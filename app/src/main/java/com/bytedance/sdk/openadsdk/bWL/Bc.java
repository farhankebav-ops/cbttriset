...
public class Bc extends NV {
    ...
    public void IlO(Context context) {
        ...
        layoutParams3.leftMargin = iMY4;
        layoutParams3.setMarginStart(iMY4);
        ...
        layoutParams4.setMarginStart(iMY2);
        ...
        this.vCE = lewTV;
        lewTV.setId(zPa.tf);
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(BS.MY(context, 70.0f), BS.MY(context, 36.0f));
        layoutParams5.addRule(21);
        layoutParams5.addRule(11);
        layoutParams5.addRule(15);
        layoutParams5.rightMargin = iMY4;
        layoutParams5.setMarginEnd(iMY4);
    ...
    public com.bytedance.sdk.openadsdk.core.Cc.lEW MY(Context context) {
        ...
        lewMY.setGravity(16);
        lewMY.setMaxWidth(BS.MY(context, 150.0f));
        lewMY.setTextColor(Color.parseColor("#B7B7B7"));
        lewMY.setTextSize(2, 15.0f);
