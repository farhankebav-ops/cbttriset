...
public class tV extends ImageView {
    ...
    public tV(Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public tV(Context context, @Nullable AttributeSet attributeSet, int i2) {
