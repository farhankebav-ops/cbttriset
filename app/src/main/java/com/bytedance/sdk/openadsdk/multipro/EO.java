...
public class EO {
    ...
    public static void IlO(Context context) {
        if (context != null && IlO && MY.compareAndSet(false, true)) {
            try {
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    String strMY = vAh.MY(context);
                    try {
                        if (TextUtils.isEmpty(strMY)) {
                            strMY = context.getPackageName() + Process.myPid();
                        }
                        WebView.setDataDirectorySuffix(strMY);
    ...
    */
    private static void MY(android.content.Context r3) throws java.lang.Throwable {
        /*
        ...
        L46:
            ...
            goto L4f
        L4c:
            IlO(r0)     // Catch: java.lang.Throwable -> L44 java.lang.Exception -> L62
        L4f:
            if (r2 == 0) goto L59
        ...
        L6c:
            r1 = r3
        L6d:
            IlO(r0)     // Catch: java.lang.Throwable -> L64
            if (r3 == 0) goto L7a
        ...
        L92:
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.multipro.EO.MY(android.content.Context):void");
    }
    ...
    private static void IlO(File file) {
        IlO(file, file.exists() ? file.delete() : false);
    }
    ...
    private static void IlO(File file, boolean z2) {
        if (!z2 || file.exists()) {
            return;
        }
        try {
            ...
            oeT.EO("TTAD.TTMultiInitHelper", e.getMessage());
        }
    }
}
