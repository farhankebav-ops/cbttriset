...
public class DmF extends NV {
    ...
    public com.bytedance.sdk.openadsdk.core.Cc.lEW EO(Context context) {
        ...
        lewEO.setGravity(16);
        lewEO.setMaxWidth(BS.MY(context, 153.0f));
        lewEO.setTextColor(-1);
        lewEO.setTextSize(2, 13.0f);
        return lewEO;
    }
    ...
    public void IlO(Context context) {
        ...
        this.tV = lewMY;
        lewMY.setId(zPa.eeU);
        LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(BS.MY(context, 130.0f), BS.MY(context, 20.0f));
        layoutParams5.leftMargin = iMY2;
        layoutParams5.setMarginStart(iMY2);
        ...
        this.vCE = lewTV;
        lewTV.setId(zPa.tf);
        RelativeLayout.LayoutParams layoutParams7 = new RelativeLayout.LayoutParams(BS.MY(context, 80.0f), BS.MY(context, 30.0f));
        layoutParams7.addRule(21);
        layoutParams7.addRule(11);
        layoutParams7.addRule(15);
        layoutParams7.rightMargin = iMY;
        layoutParams7.setMarginEnd(iMY);
    ...
    public com.bytedance.sdk.openadsdk.core.Cc.lEW MY(Context context) {
        ...
        lew.setGravity(16);
        lew.setMaxWidth(BS.MY(context, 153.0f));
        lew.setSingleLine();
        lew.setText("Pangle");
        lew.setTextColor(-1);
    ...
    public DmF(Context context, AttributeSet attributeSet, int i2) {
