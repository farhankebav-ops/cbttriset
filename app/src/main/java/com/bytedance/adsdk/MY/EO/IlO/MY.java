...
public class MY extends bWL<Float, Float> {
    public MY(List<com.bytedance.adsdk.MY.Bc.IlO<Float>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.MY.IlO.MY.IlO<Float, Float> IlO() {
        return new com.bytedance.adsdk.MY.IlO.MY.tV(this.IlO);
    }
