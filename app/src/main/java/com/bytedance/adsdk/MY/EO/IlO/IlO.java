...
public class IlO extends bWL<Integer, Integer> {
    public IlO(List<com.bytedance.adsdk.MY.Bc.IlO<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.MY.IlO.MY.IlO<Integer, Integer> IlO() {
        return new com.bytedance.adsdk.MY.IlO.MY.MY(this.IlO);
    }
