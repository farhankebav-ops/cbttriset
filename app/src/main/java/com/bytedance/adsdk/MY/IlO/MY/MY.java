...
public class MY extends Bc<Integer> {
    public MY(List<com.bytedance.adsdk.MY.Bc.IlO<Integer>> list) {
        super(list);
    }
    ...
    public int EO(com.bytedance.adsdk.MY.Bc.IlO<Integer> ilO, float f4) {
        ...
        if (this.EO == null) {
            return com.bytedance.adsdk.MY.vCE.MY.IlO(com.bytedance.adsdk.MY.vCE.Cc.MY(f4, 0.0f, 1.0f), ilO.IlO.intValue(), ilO.MY.intValue());
        }
        ilO.Bc.getClass();
        tV();
        lEW();
