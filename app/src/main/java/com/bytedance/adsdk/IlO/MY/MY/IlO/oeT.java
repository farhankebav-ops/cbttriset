...
public class oeT implements com.bytedance.adsdk.IlO.MY.MY.IlO {
    private com.bytedance.adsdk.IlO.MY.tV.tV IlO;

    public oeT(com.bytedance.adsdk.IlO.MY.tV.tV tVVar) {
        this.IlO = tVVar;
    }
