...
public class EO extends com.bytedance.adsdk.ugeno.tV.MY.IlO {
    public EO(com.bytedance.adsdk.ugeno.MY.EO eo, String str, vCE.IlO ilO) {
        super(eo, str, ilO);
    }

    @Override // com.bytedance.adsdk.ugeno.tV.MY.IlO
    public void IlO() {
        com.bytedance.adsdk.ugeno.MY.EO eoMY;
        com.bytedance.adsdk.ugeno.MY.EO eo = this.EO;
        if (eo == null || (eoMY = eo.MY(eo)) == null) {
            return;
        }
        com.bytedance.adsdk.ugeno.MY.EO eoTV = eoMY.tV("SwiperView");
        if (eoTV instanceof com.bytedance.adsdk.ugeno.MY) {
            ((com.bytedance.adsdk.ugeno.MY) eoTV).tV();
        }
    }
}
