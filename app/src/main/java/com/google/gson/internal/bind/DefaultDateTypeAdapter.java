...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public static abstract class DateType<T extends Date> {
        ...
        public final TypeAdapterFactory createAdapterFactory(int i2, int i8) {
            return createFactory(new DefaultDateTypeAdapter<>(this, i2, i8));
        }
    }
        ...
        synchronized (this.dateFormats) {
            try {
                ...
                try {
                    ...
                    StringBuilder sbY = a.y("Failed parsing '", strNextString, "' as Date; at path ");
    ...
    private DefaultDateTypeAdapter(DateType<T> dateType, int i2, int i8) {
        ArrayList arrayList = new ArrayList();
        this.dateFormats = arrayList;
        Objects.requireNonNull(dateType);
        this.dateType = dateType;
        ...
        if (JavaVersion.isJava9OrLater()) {
            arrayList.add(PreJava9DateFormatProvider.getUsDateTimeFormat(i2, i8));
        }
    }
}
