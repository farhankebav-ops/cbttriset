...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM220clone = m220clone();
        excluderM220clone.serializeInnerClasses = false;
        return excluderM220clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM220clone = m220clone();
        excluderM220clone.requireExpose = true;
        return excluderM220clone;
    }

    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z2, boolean z7) {
        Excluder excluderM220clone = m220clone();
        if (z2) {
            ArrayList arrayList = new ArrayList(this.serializationStrategies);
            excluderM220clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z7) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM220clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM220clone = m220clone();
        excluderM220clone.modifiers = 0;
        for (int i2 : iArr) {
            excluderM220clone.modifiers = i2 | excluderM220clone.modifiers;
        }
        return excluderM220clone;
    }
    ...
    public Excluder withVersion(double d8) {
        Excluder excluderM220clone = m220clone();
        excluderM220clone.version = d8;
        return excluderM220clone;
    }

    /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
    public Excluder m220clone() {
        try {
