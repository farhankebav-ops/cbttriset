...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter, boolean z2) {
        ...
        if (objCreateAdapter instanceof TypeAdapter) {
            ...
            boolean z7 = objCreateAdapter instanceof JsonSerializer;
            if (!z7 && !(objCreateAdapter instanceof JsonDeserializer)) {
            ...
            TreeTypeAdapter treeTypeAdapter = new TreeTypeAdapter(z7 ? (JsonSerializer) objCreateAdapter : null, objCreateAdapter instanceof JsonDeserializer ? (JsonDeserializer) objCreateAdapter : null, gson, typeToken, z2 ? TREE_TYPE_CLASS_DUMMY_FACTORY : TREE_TYPE_FIELD_DUMMY_FACTORY, zNullSafe);
            zNullSafe = false;
