...
public final class GsonBuilder {
    ...
    private static void addTypeAdaptersForDate(String str, int i2, int i8, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !str.trim().isEmpty()) {
            ...
            TypeAdapterFactory typeAdapterFactoryCreateAdapterFactory4 = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(i2, i8);
            if (z2) {
                typeAdapterFactoryCreateAdapterFactory3 = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(i2, i8);
                TypeAdapterFactory typeAdapterFactoryCreateAdapterFactory5 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(i2, i8);
    ...
    private static int checkDateFormatStyle(int i2) {
        if (i2 < 0 || i2 > 3) {
            throw new IllegalArgumentException(a1.a.g(i2, "Invalid style: "));
        }
        return i2;
    }
    ...
    public GsonBuilder registerTypeAdapter(Type type, Object obj) {
        ...
        GsonPreconditions.checkArgument(z2 || (obj instanceof JsonDeserializer) || (obj instanceof InstanceCreator) || (obj instanceof TypeAdapter));
    ...
    public GsonBuilder registerTypeHierarchyAdapter(Class<?> cls, Object obj) {
        ...
        boolean z2 = obj instanceof JsonSerializer;
        GsonPreconditions.checkArgument(z2 || (obj instanceof JsonDeserializer) || (obj instanceof TypeAdapter));
    ...
    public GsonBuilder setDateFormat(String str) {
        if (str != null) {
            try {
                ...
                throw new IllegalArgumentException(a1.a.m("The date pattern '", str, "' is not valid"), e);
            }
        }
    ...
    public GsonBuilder setDateFormat(int i2, int i8) {
        this.dateStyle = checkDateFormatStyle(i2);
        this.timeStyle = checkDateFormatStyle(i8);
        this.datePattern = null;
        return this;
    }
