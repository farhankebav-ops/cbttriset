...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public FirebaseInstallations(FirebaseApp firebaseApp, @NonNull Provider<HeartBeatController> provider, @NonNull ExecutorService executorService, @NonNull Executor executor) {
        this(executorService, executor, firebaseApp, new FirebaseInstallationServiceClient(firebaseApp.getApplicationContext(), provider), new PersistedInstallation(firebaseApp), Utils.getInstance(), new Lazy((Provider) new c(firebaseApp, 1)), new RandomFidGenerator());
    }
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new androidx.webkit.internal.c(this, 6));
    }
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new b(this, 20));
