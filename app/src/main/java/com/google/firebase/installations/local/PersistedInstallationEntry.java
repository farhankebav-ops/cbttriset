...
public abstract class PersistedInstallationEntry {
    ...
    @NonNull
    public PersistedInstallationEntry withAuthToken(@NonNull String str, long j, long j3) {
        return toBuilder().setAuthToken(str).setExpiresInSecs(j).setTokenCreationEpochInSecs(j3).build();
    }
    ...
    @NonNull
    public PersistedInstallationEntry withRegisteredFid(@NonNull String str, @NonNull String str2, long j, @Nullable String str3, long j3) {
        return toBuilder().setFirebaseInstallationId(str).setRegistrationStatus(PersistedInstallation.RegistrationStatus.REGISTERED).setAuthToken(str3).setRefreshToken(str2).setExpiresInSecs(j3).setTokenCreationEpochInSecs(j).build();
    }
