...
final class AutoValue_InstallationTokenResult extends InstallationTokenResult {
    ...
    public static final class Builder extends InstallationTokenResult.Builder {
        ...
        public InstallationTokenResult build() {
            String strC = this.token == null ? " token" : "";
            if (this.tokenExpirationTimestamp == null) {
                strC = a1.a.C(strC, " tokenExpirationTimestamp");
            }
            if (this.tokenCreationTimestamp == null) {
                strC = a1.a.C(strC, " tokenCreationTimestamp");
            }
            if (strC.isEmpty()) {
    ...
    public String toString() {
        ...
        return a1.a.p(sb, this.tokenCreationTimestamp, "}");
    }

    private AutoValue_InstallationTokenResult(String str, long j, long j3) {
        this.token = str;
