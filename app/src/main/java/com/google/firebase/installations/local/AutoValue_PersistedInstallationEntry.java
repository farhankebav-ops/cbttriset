...
final class AutoValue_PersistedInstallationEntry extends PersistedInstallationEntry {
    ...
    public String toString() {
        ...
        sb.append(", fisError=");
        return a1.a.r(sb, this.fisError, "}");
    }

    private AutoValue_PersistedInstallationEntry(@Nullable String str, PersistedInstallation.RegistrationStatus registrationStatus, @Nullable String str2, @Nullable String str3, long j, long j3, @Nullable String str4) {
        this.firebaseInstallationId = str;
        this.registrationStatus = registrationStatus;
        this.authToken = str2;
