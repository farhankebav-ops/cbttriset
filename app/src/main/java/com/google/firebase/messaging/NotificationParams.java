...
public class NotificationParams {
    ...
    public Integer getInteger(String str) {
        ...
        try {
            ...
            Log.w(TAG, androidx.camera.core.processing.util.a.n(new StringBuilder("Couldn't parse value of "), userFriendlyKey(str), "(", string, ") into an int"));
            return null;
        }
    }
    ...
    public JSONArray getJSONArray(String str) {
        ...
        try {
            ...
            Log.w(TAG, androidx.camera.core.processing.util.a.n(new StringBuilder("Malformed JSON for key "), userFriendlyKey(str), ": ", string, ", falling back to default"));
            return null;
        }
    }
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            Log.w(TAG, androidx.camera.core.processing.util.a.n(new StringBuilder(), userFriendlyKey(a1.a.C(str2, Constants.MessageNotificationKeys.TEXT_RESOURCE_SUFFIX)), " resource not found: ", str2, " Default value will be used."));
            return null;
        }
    ...
    public Long getLong(String str) {
        ...
        try {
            ...
            Log.w(TAG, androidx.camera.core.processing.util.a.n(new StringBuilder("Couldn't parse value of "), userFriendlyKey(str), "(", string, ") into a long"));
            return null;
        }
    }
