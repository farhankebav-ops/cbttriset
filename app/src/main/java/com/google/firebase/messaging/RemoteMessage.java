    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            if (TextUtils.isEmpty(str)) {
                throw new IllegalArgumentException(a1.a.l("Invalid to: ", str));
            }
        ...
        @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG, to = SessionListener.SECONDS_IN_A_DAY)
        public int getTtl() {
        ...
        @NonNull
        public Builder setTtl(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG, to = SessionListener.SECONDS_IN_A_DAY) int i2) {
