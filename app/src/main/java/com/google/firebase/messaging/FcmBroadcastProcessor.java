...
public class FcmBroadcastProcessor {
    ...
    public FcmBroadcastProcessor(Context context) {
        ...
        this.executor = new androidx.arch.core.executor.a(2);
    }
    ...
    private static Task<Integer> bindToMessagingService(Context context, Intent intent, boolean z2) {
        ...
        if (!z2) {
            return serviceConnection.sendIntent(intent).continueWith(new androidx.arch.core.executor.a(2), new com.google.firebase.inappmessaging.internal.j(14));
        }
    ...
    public static /* synthetic */ Task lambda$startMessagingService$2(Context context, Intent intent, boolean z2, Task task) throws Exception {
        return (PlatformVersion.isAtLeastO() && ((Integer) task.getResult()).intValue() == 402) ? bindToMessagingService(context, intent, z2).continueWith(new androidx.arch.core.executor.a(2), new com.google.firebase.inappmessaging.internal.j(13)) : task;
    }
    ...
    public Task<Integer> startMessagingService(final Context context, final Intent intent) {
        ...
        return (!z2 || z7) ? Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.messaging.b
            ...
            public final Object then(Task task) {
                return FcmBroadcastProcessor.lambda$startMessagingService$2(context, intent, z7, task);
            }
        }) : bindToMessagingService(context, intent, z7);
    }
