...
public class MessagingAnalytics {
    ...
    public static long getProjectNumber(Bundle bundle) {
        ...
        if (applicationId.startsWith("1:")) {
            ...
            try {
                ...
                Log.w(Constants.TAG, "error parsing app ID", e8);
            }
        } else {
            try {
                return Long.parseLong(applicationId);
            } catch (NumberFormatException e9) {
                Log.w(Constants.TAG, "error parsing app ID", e9);
            }
        }
        return 0L;
    }
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, @Nullable m0.h hVar) {
        if (hVar == null) {
        ...
        try {
            t tVar = (t) hVar;
            tVar.a(Constants.FirelogAnalytics.FCM_LOG_SOURCE, new m0.c("proto"), new com.google.firebase.inappmessaging.internal.j(15)).a(new m0.a(MessagingClientEventExtension.newBuilder().setMessagingClientEvent(messagingClientEventEventToProto).build(), m0.e.f12921a, new m0.b(Integer.valueOf(intent.getIntExtra(Constants.MessagePayloadKeys.PRODUCT_ID, DEFAULT_PRODUCT_ID)))), new com.mimikridev.utilmanager.config.b(10));
