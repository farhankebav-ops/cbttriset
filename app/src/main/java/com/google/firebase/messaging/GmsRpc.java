...
class GmsRpc {
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new androidx.arch.core.executor.a(2), new l(this, 0));
    }
    ...
    public Task<?> deleteToken() {
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.app), "*", androidx.camera.core.processing.util.a.c(EXTRA_DELETE, "1")));
    }
