...
final class TopicOperation {
    ...
    private TopicOperation(String str, String str2) {
        ...
        this.operation = str;
        this.serializedString = a1.a.D(str, OPERATION_PAIR_DIVIDER, str2);
    }
    ...
    private static String normalizeTopicOrThrow(String str, String str2) {
        ...
        if (str == null || !TOPIC_NAME_REGEXP.matcher(str).matches()) {
            throw new IllegalArgumentException(a1.a.m("Invalid topic name: ", str, " does not match the allowed format [a-zA-Z0-9-_.~%]{1,900}."));
        }
        return str;
    }
