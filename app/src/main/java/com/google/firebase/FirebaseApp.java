...
public class FirebaseApp {
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.a
            ...
            public final Object get() {
                return this.f5514a.lambda$new$0(context);
            }
        });
        componentRuntimeBuild.getClass();
        this.defaultHeartBeatController = com.google.firebase.components.b.d(componentRuntimeBuild, DefaultHeartBeatController.class);
    ...
    public /* synthetic */ DataCollectionConfigStorage lambda$new$0(Context context) {
        ...
        return new DataCollectionConfigStorage(context, persistenceKey, (Publisher) com.google.firebase.components.b.b(componentRuntime, Publisher.class));
    }
    ...
    public <T> T get(Class<T> cls) {
        ...
        ComponentRuntime componentRuntime = this.componentRuntime;
        componentRuntime.getClass();
        return (T) com.google.firebase.components.b.b(componentRuntime, cls);
    }
