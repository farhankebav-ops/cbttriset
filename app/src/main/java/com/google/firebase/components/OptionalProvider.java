...
class OptionalProvider<T> implements Provider<T>, Deferred<T> {
    ...
    private static final Deferred.DeferredHandler<Object> NOOP_HANDLER = new g();
    private static final Provider<Object> EMPTY_PROVIDER = new h(0);
    ...
    public void whenAvailable(@NonNull final Deferred.DeferredHandler<T> deferredHandler) {
        ...
        synchronized (this) {
            ...
            if (provider != provider4) {
                ...
                this.handler = new Deferred.DeferredHandler() { // from class: com.google.firebase.components.i
