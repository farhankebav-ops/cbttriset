...
final class AutoValue_StaticSessionData_DeviceData extends StaticSessionData.DeviceData {
    ...
    public AutoValue_StaticSessionData_DeviceData(int i2, String str, int i8, long j, long j3, boolean z2, int i9, String str2, String str3) {
        this.arch = i2;
        if (str == null) {
