...
public class CrashlyticsCore {
    ...
    private void checkForPreviousCrash() {
        try {
            this.didCrashOnPreviousExecution = Boolean.TRUE.equals((Boolean) this.crashlyticsWorkers.common.getExecutor().submit(new androidx.webkit.internal.c(this, 3)).get(3L, TimeUnit.SECONDS));
    ...
    private void finishInitSynchronously(SettingsProvider settingsProvider) {
        Future<?> futureSubmit = this.crashlyticsWorkers.common.getExecutor().submit(new d(this, settingsProvider, 1));
        ...
        try {
            ...
            Logger.getLogger().e("Crashlytics timed out during initialization.", e8);
        }
    }
    ...
    public /* synthetic */ void lambda$log$3(long j, String str) {
        this.crashlyticsWorkers.diskWrite.submit(new g(this, j, str, 0));
    }
    ...
    public void logException(@NonNull Throwable th, @NonNull Map<String, String> map) {
        this.crashlyticsWorkers.common.submit(new androidx.camera.core.processing.c(this, th, map, 9));
    }
