...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    public int hashCode() {
        ...
        int i2 = (((iHashCode ^ iHashCode2) * 1000003) ^ ((int) (j ^ (j >>> 32)))) * 1000003;
        Long l = this.endedAt;
        int iHashCode3 = (((((i2 ^ (l == null ? 0 : l.hashCode())) * 1000003) ^ (this.crashed ? 1231 : 1237)) * 1000003) ^ this.app.hashCode()) * 1000003;
    ...
    public String toString() {
        ...
        sb.append(", generatorType=");
        return a1.a.q(sb, "}", this.generatorType);
    }

    private AutoValue_CrashlyticsReport_Session(String str, String str2, @Nullable String str3, long j, @Nullable Long l, boolean z2, CrashlyticsReport.Session.Application application, @Nullable CrashlyticsReport.Session.User user, @Nullable CrashlyticsReport.Session.OperatingSystem operatingSystem, @Nullable CrashlyticsReport.Session.Device device, @Nullable List<CrashlyticsReport.Session.Event> list, int i2) {
        this.generator = str;
