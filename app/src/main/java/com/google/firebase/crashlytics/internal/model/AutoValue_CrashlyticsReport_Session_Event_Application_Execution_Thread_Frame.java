...
final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Thread_Frame extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    ...
    public int hashCode() {
        ...
        long j3 = this.offset;
        return ((iHashCode2 ^ ((int) (j3 ^ (j3 >>> 32)))) * 1000003) ^ this.importance;
    }
    ...
    public String toString() {
        ...
        sb.append(", importance=");
        return a1.a.q(sb, "}", this.importance);
    }

    private AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Thread_Frame(long j, String str, @Nullable String str2, long j3, int i2) {
        this.pc = j;
        this.symbol = str;
        this.file = str2;
        this.offset = j3;
