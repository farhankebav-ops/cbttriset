...
final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution_BinaryImage extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage {
    ...
    public int hashCode() {
        ...
        long j3 = this.size;
        int iHashCode = (((((((int) (j ^ (j >>> 32))) ^ 1000003) * 1000003) ^ ((int) (j3 ^ (j3 >>> 32)))) * 1000003) ^ this.name.hashCode()) * 1000003;
    ...
    public String toString() {
        ...
        sb.append(this.name);
        sb.append(", uuid=");
        return a1.a.r(sb, this.uuid, "}");
    }

    private AutoValue_CrashlyticsReport_Session_Event_Application_Execution_BinaryImage(long j, long j3, String str, @Nullable String str2) {
        this.baseAddress = j;
        this.size = j3;
        this.name = str;
        this.uuid = str2;
