...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "buildIdMappingForArch":
                    builder.setBuildIdMappingForArch(parseArray(jsonReader, new a(i2)));
                    break;
                case "pid":
    ...
    public static CrashlyticsReport.CustomAttribute parseCustomAttribute(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            String strNextName = jsonReader.nextName();
            strNextName.getClass();
            if (strNextName.equals(C2300e4.h.W)) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "appProcessDetails":
                    builder.setAppProcessDetails(parseArray(jsonReader, new a(i2)));
                    break;
                case "background":
                ...
                case "execution":
                    ...
                    break;
                case "internalKeys":
                    builder.setInternalKeys(parseArray(jsonReader, new a(i8)));
                    break;
                case "customAttributes":
                    builder.setCustomAttributes(parseArray(jsonReader, new a(i8)));
                    break;
                case "uiOrientation":
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "frames":
                    builder.setFrames(parseArray(jsonReader, new a(i2)));
                    break;
                case "reason":
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                ...
                case "device":
                    ...
                    break;
                case "events":
                    builder.setEvents(parseArray(jsonReader, new a(i2)));
                    break;
                case "os":
