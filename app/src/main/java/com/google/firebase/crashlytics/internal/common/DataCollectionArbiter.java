...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z2) {
        Logger.getLogger().d(a1.a.o("Crashlytics automatic data collection ", z2 ? "ENABLED" : "DISABLED", " by ", this.crashlyticsDataCollectionEnabled == null ? "global Firebase setting" : this.setInManifest ? "firebase_crashlytics_collection_enabled manifest flag" : "API", "."));
    }
