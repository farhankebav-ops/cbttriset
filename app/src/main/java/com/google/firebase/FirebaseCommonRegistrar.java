...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.create(FIREBASE_COMMON, "22.0.1"));
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new c(13)));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new c(14)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new c(15)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new c(16)));
