...
public class ProtoMarshallerClient {
    ...
    public static InAppMessage decode(@NonNull MessagesProto.Content content, @NonNull String str, @NonNull String str2, boolean z2, @Nullable Map<String, String> map) {
        q.D(content, "FirebaseInAppMessaging content cannot be null.");
        q.D(str, "FirebaseInAppMessaging campaign id cannot be null.");
        q.D(str2, "FirebaseInAppMessaging campaign name cannot be null.");
        Logging.logd("Decoding message: " + content.toString());
        CampaignMetadata campaignMetadata = new CampaignMetadata(str, str2, z2);
        int i2 = AnonymousClass2.$SwitchMap$com$google$firebase$inappmessaging$MessagesProto$Content$MessageDetailsCase[content.getMessageDetailsCase().ordinal()];
        if (i2 == 1) {
