...
public final class SchedulerModule_ProvidesComputeSchedulerFactory implements Factory<p> {
    ...
    public static p providesComputeScheduler(SchedulerModule schedulerModule) {
        return (p) Preconditions.checkNotNullFromProvides(schedulerModule.providesComputeScheduler());
    }
