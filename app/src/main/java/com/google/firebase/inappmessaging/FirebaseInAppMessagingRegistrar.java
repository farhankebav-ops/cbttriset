...
public class FirebaseInAppMessagingRegistrar implements ComponentRegistrar {
    ...
    private Qualified<h> legacyTransportFactory = Qualified.qualified(LegacyTransportBackend.class, h.class);
