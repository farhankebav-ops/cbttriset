...
public class MetricsLoggerClient {
    ...
    private boolean impressionCountsAsConversion(InAppMessage inAppMessage) {
        ...
        int i2 = AnonymousClass1.$SwitchMap$com$google$firebase$inappmessaging$model$MessageType[inAppMessage.getMessageType().ordinal()];
        if (i2 == 1) {
    ...
    private void logEventAsync(InAppMessage inAppMessage, String str, boolean z2) {
    ...
    public void logDismiss(InAppMessage inAppMessage, FirebaseInAppMessagingDisplayCallbacks.InAppMessagingDismissType inAppMessagingDismissType) {
        if (!isTestCampaign(inAppMessage)) {
            this.firebaseInstallations.getId().addOnSuccessListener(this.blockingExecutor, new r(this, inAppMessage, inAppMessagingDismissType, 2));
    ...
    public void logImpression(InAppMessage inAppMessage) {
        if (!isTestCampaign(inAppMessage)) {
            this.firebaseInstallations.getId().addOnSuccessListener(this.blockingExecutor, new p(this, inAppMessage, 0));
    ...
    public void logMessageClick(InAppMessage inAppMessage, Action action) {
        if (!isTestCampaign(inAppMessage)) {
            this.firebaseInstallations.getId().addOnSuccessListener(this.blockingExecutor, new p(this, inAppMessage, 1));
    ...
    public void logRenderError(InAppMessage inAppMessage, FirebaseInAppMessagingDisplayCallbacks.InAppMessagingErrorReason inAppMessagingErrorReason) {
        if (!isTestCampaign(inAppMessage)) {
            this.firebaseInstallations.getId().addOnSuccessListener(this.blockingExecutor, new r(this, inAppMessage, inAppMessagingErrorReason, 1));
        }
