...
public final class Strings {
    ...
    public static String A01(@CheckForNull Object o2) {
        ...
        try {
            ...
            Logger.getLogger(A00(64, 30, 71)).log(Level.WARNING, A00(29, 35, Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE) + str, (Throwable) e);
            return A00(27, 1, 44) + str + A00(2, 7, Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE) + e.getClass().getName() + A00(28, 1, 70);
        }
    }
