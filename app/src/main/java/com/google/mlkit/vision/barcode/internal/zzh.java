...
public final class zzh extends MobileVisionBase implements BarcodeScanner {
    ...
    private final Task zzf(@NonNull Task task, final int i2, final int i8) {
        return task.onSuccessTask(new SuccessContinuation() { // from class: com.google.mlkit.vision.barcode.internal.zzf
            ...
            public final Task then(Object obj) {
                return this.zza.zzd(i2, i8, (List) obj);
            }
        });
    }
    ...
    @NonNull
    public final Task<List<Barcode>> process(@NonNull a aVar) {
        super.processBase(aVar);
        throw null;
    }

    public final /* synthetic */ Task zzd(int i2, int i8, List list) throws Exception {
        if (this.zzb == null) {
        ...
        if (arrayList.isEmpty()) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                Point[] cornerPoints = ((Barcode) arrayList2.get(i9)).getCornerPoints();
                if (cornerPoints != null) {
                    this.zzb.zzi(this.zzg, zzxn.zzg(Arrays.asList(cornerPoints), i2, i8, 0.0f));
                }
            }
        } else {
            this.zzh = true;
