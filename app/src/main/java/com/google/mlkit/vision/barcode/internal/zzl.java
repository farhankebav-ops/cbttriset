...
public final class zzl extends MLTask {
    ...
    public final /* synthetic */ zzwe zzc(long j, zzrb zzrbVar, zzcp zzcpVar, zzcp zzcpVar2, InputImage inputImage) {
        zzrp zzrpVar = new zzrp();
    ...
    public final /* synthetic */ zzwe zzd(zzft zzftVar, int i2, zzqd zzqdVar) {
        zzrd zzrdVar = new zzrd();
        zzrdVar.zze(this.zzh ? zzra.TYPE_THICK : zzra.TYPE_THIN);
