...
public abstract class CodedInputStream {
    ...
    public static final class a extends CodedInputStream {
        ...
        public String readStringRequireUtf8() throws IOException {
            ...
            if (rawVarint32 > 0) {
                ...
                int i8 = this.pos;
                if (rawVarint32 <= i2 - i8) {
                    String strDecodeUtf8 = s2.decodeUtf8(this.buffer, i8, rawVarint32);
                    this.pos += rawVarint32;
        ...
        private a(byte[] bArr, int i2, int i8, boolean z2) {
            super();
    ...
    public static final class b extends CodedInputStream {
        ...
        private void readRawBytesTo(byte[] bArr, int i2, int i8) throws IOException {
            ...
            while (i9 > 0) {
                ...
                long j = iMin;
                r2.copyMemory(this.currentByteBufferPos, bArr, (i8 - i9) + i2, j);
                i9 -= iMin;
        ...
        private void tryGetNextByteBuffer() {
            ...
            long jAddressOffset = r2.addressOffset(this.currentByteBuffer);
            ...
            if (rawVarint32 > 0) {
                ...
                if (j <= currentRemaining()) {
                    if (this.immutable || !this.enableAliasing) {
                        ...
                        r2.copyMemory(this.currentByteBufferPos, bArr, 0L, j);
                        this.currentByteBufferPos += j;
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return ((r2.getByte(j + 3) & 255) << 24) | (r2.getByte(j) & 255) | ((r2.getByte(1 + j) & 255) << 8) | ((r2.getByte(2 + j) & 255) << 16);
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            if (currentRemaining() >= 8) {
                ...
                c7 = '8';
                rawByte = (((long) r2.getByte(j)) & 255) | ((((long) r2.getByte(1 + j)) & 255) << 8) | ((((long) r2.getByte(2 + j)) & 255) << 16) | ((((long) r2.getByte(3 + j)) & 255) << 24) | ((((long) r2.getByte(4 + j)) & 255) << 32) | ((((long) r2.getByte(5 + j)) & 255) << 40) | ((((long) r2.getByte(6 + j)) & 255) << 48);
                rawByte2 = r2.getByte(j + 7);
            } else {
                c7 = '8';
        ...
        public int readRawVarint32() throws IOException {
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j8 = 2 + j;
                    int i8 = (r2.getByte(j3) << 7) ^ b8;
                    if (i8 < 0) {
                        i2 = i8 ^ (-128);
                    } else {
                        long j9 = 3 + j;
                        int i9 = (r2.getByte(j8) << 14) ^ i8;
                        if (i9 >= 0) {
                            i2 = i9 ^ 16256;
                        } else {
                            long j10 = 4 + j;
                            int i10 = i9 ^ (r2.getByte(j9) << 21);
                            if (i10 < 0) {
                                i2 = (-2080896) ^ i10;
                            } else {
                                j9 = 5 + j;
                                byte b9 = r2.getByte(j10);
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j9) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j11 = 2 + j9;
                    int i2 = (r2.getByte(j10) << 7) ^ b8;
                    if (i2 < 0) {
                        j = i2 ^ (-128);
                    } else {
                        long j12 = 3 + j9;
                        int i8 = (r2.getByte(j11) << 14) ^ i2;
                        if (i8 >= 0) {
                            j = i8 ^ 16256;
                            j11 = j12;
                        } else {
                            long j13 = 4 + j9;
                            int i9 = i8 ^ (r2.getByte(j12) << 21);
                            if (i9 < 0) {
                                j = (-2080896) ^ i9;
                                j11 = j13;
                            } else {
                                long j14 = 5 + j9;
                                long j15 = (((long) r2.getByte(j13)) << 28) ^ ((long) i9);
                                if (j15 >= 0) {
                                    j8 = 266354560;
                                } else {
                                    long j16 = 6 + j9;
                                    long j17 = j15 ^ (((long) r2.getByte(j14)) << 35);
                                    if (j17 < 0) {
                                        j3 = -34093383808L;
                                    } else {
                                        j14 = 7 + j9;
                                        j15 = j17 ^ (((long) r2.getByte(j16)) << 42);
                                        if (j15 >= 0) {
                                            j8 = 4363953127296L;
                                        } else {
                                            j16 = 8 + j9;
                                            j17 = j15 ^ (((long) r2.getByte(j14)) << 49);
                                            if (j17 < 0) {
                                                j3 = -558586000294016L;
                                            } else {
                                                j14 = 9 + j9;
                                                long j18 = (j17 ^ (((long) r2.getByte(j16)) << 56)) ^ 71499008037633920L;
                                                if (j18 < 0) {
                                                    long j19 = j9 + 10;
                                                    if (r2.getByte(j14) >= 0) {
                                                        j11 = j19;
        ...
        public String readStringRequireUtf8() throws IOException {
            ...
            if (rawVarint32 > 0) {
                ...
                long j8 = this.currentByteBufferPos;
                if (j <= j3 - j8) {
                    String strDecodeUtf8 = s2.decodeUtf8(this.currentByteBuffer, (int) (j8 - this.currentByteBufferStartPos), rawVarint32);
                    this.currentByteBufferPos += j;
                    return strDecodeUtf8;
                }
            }
            if (rawVarint32 >= 0 && rawVarint32 <= remaining()) {
                ...
                return s2.decodeUtf8(bArr, 0, rawVarint32);
            }
            if (rawVarint32 == 0) {
                return "";
            }
    ...
    public static final class c extends CodedInputStream {
        ...
        private boolean tryRefillBuffer(int i2) throws IOException {
            ...
            if (i2 > (i11 - i12) - i8 || i12 + i8 + i2 > this.currentLimit) {
                return false;
            }
            if (i8 > 0) {
                if (i10 > i8) {
        ...
        public String readStringRequireUtf8() throws IOException {
            ...
            return s2.decodeUtf8(rawBytesSlowPath, i2, rawVarint32);
        }
    ...
    public static final class d extends CodedInputStream {
        ...
        public ByteBuffer readByteBuffer() throws IOException {
            ...
            if (this.immutable || !this.enableAliasing) {
                byte[] bArr = new byte[rawVarint32];
                long j = rawVarint32;
                r2.copyMemory(this.pos, bArr, 0L, j);
                this.pos += j;
                return ByteBuffer.wrap(bArr);
            }
            long j3 = this.pos;
        ...
        public ByteString readBytes() throws IOException {
            ...
            byte[] bArr = new byte[rawVarint32];
            long j8 = rawVarint32;
            r2.copyMemory(this.pos, bArr, 0L, j8);
            this.pos += j8;
            return ByteString.wrap(bArr);
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            this.pos = 8 + j;
            return ((((long) r2.getByte(j + 7)) & 255) << 56) | (((long) r2.getByte(j)) & 255) | ((((long) r2.getByte(1 + j)) & 255) << 8) | ((((long) r2.getByte(2 + j)) & 255) << 16) | ((((long) r2.getByte(3 + j)) & 255) << 24) | ((((long) r2.getByte(4 + j)) & 255) << 32) | ((((long) r2.getByte(5 + j)) & 255) << 40) | ((((long) r2.getByte(6 + j)) & 255) << 48);
        }

        /* JADX WARN: Code restructure failed: missing block: B:33:0x008c, code lost:
        
            if (com.google.protobuf.r2.getByte(r3) < 0) goto L34;
         */
        @Override // com.google.protobuf.CodedInputStream
        /*
        ...
        */
        public int readRawVarint32() throws java.io.IOException {
            ...
            La:
                r2 = 1
                long r2 = r2 + r0
                byte r4 = com.google.protobuf.r2.getByte(r0)
                if (r4 < 0) goto L16
                r9.pos = r2
                return r4
            L16:
            ...
            L21:
                r5 = 2
                long r5 = r5 + r0
                byte r2 = com.google.protobuf.r2.getByte(r2)
                int r2 = r2 << 7
                r2 = r2 ^ r4
                if (r2 >= 0) goto L31
            ...
            L31:
                r3 = 3
                long r3 = r3 + r0
                byte r5 = com.google.protobuf.r2.getByte(r5)
                int r5 = r5 << 14
                r2 = r2 ^ r5
                if (r2 < 0) goto L41
            ...
            L41:
                r5 = 4
                long r5 = r5 + r0
                byte r3 = com.google.protobuf.r2.getByte(r3)
                int r3 = r3 << 21
                r2 = r2 ^ r3
                if (r2 >= 0) goto L52
            ...
            L52:
                ...
                r5 = 10
                long r5 = r5 + r0
                byte r0 = com.google.protobuf.r2.getByte(r3)
                if (r0 >= 0) goto L94
            L8e:
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j9) {
                ...
                if (this.limit - j10 >= 9) {
                    long j11 = 2 + j9;
                    int i8 = (r2.getByte(j10) << 7) ^ b8;
                    if (i8 >= 0) {
                        long j12 = 3 + j9;
                        int i9 = i8 ^ (r2.getByte(j11) << 14);
                        if (i9 >= 0) {
                            j = i9 ^ 16256;
                            j11 = j12;
                        } else {
                            j11 = 4 + j9;
                            int i10 = i9 ^ (r2.getByte(j12) << 21);
                            if (i10 < 0) {
                                i2 = (-2080896) ^ i10;
                            } else {
                                long j13 = 5 + j9;
                                long j14 = ((long) i10) ^ (((long) r2.getByte(j11)) << 28);
                                if (j14 >= 0) {
                                    j8 = 266354560;
                                } else {
                                    long j15 = 6 + j9;
                                    long j16 = j14 ^ (((long) r2.getByte(j13)) << 35);
                                    if (j16 < 0) {
                                        j3 = -34093383808L;
                                    } else {
                                        j13 = 7 + j9;
                                        j14 = j16 ^ (((long) r2.getByte(j15)) << 42);
                                        if (j14 >= 0) {
                                            j8 = 4363953127296L;
                                        } else {
                                            j15 = 8 + j9;
                                            j16 = j14 ^ (((long) r2.getByte(j13)) << 49);
                                            if (j16 < 0) {
                                                j3 = -558586000294016L;
                                            } else {
                                                long j17 = 9 + j9;
                                                long j18 = (j16 ^ (((long) r2.getByte(j15)) << 56)) ^ 71499008037633920L;
                                                if (j18 < 0) {
                                                    long j19 = j9 + 10;
                                                    if (r2.getByte(j17) >= 0) {
                                                        j11 = j19;
        ...
        public String readStringRequireUtf8() throws IOException {
            int rawVarint32 = readRawVarint32();
            if (rawVarint32 > 0 && rawVarint32 <= remaining()) {
                String strDecodeUtf8 = s2.decodeUtf8(this.buffer, bufferPos(this.pos), rawVarint32);
    ...
    public static CodedInputStream newInstance(InputStream inputStream, int i2) {
        if (i2 > 0) {
            return inputStream == null ? newInstance(Internal.EMPTY_BYTE_ARRAY) : new c(inputStream, i2);
        }
    ...
    public static CodedInputStream newInstance(Iterable<ByteBuffer> iterable) {
        if (!d.isSupported()) {
            return newInstance(new v0(iterable));
        }
    ...
    public static CodedInputStream newInstance(Iterable<ByteBuffer> iterable, boolean z2) {
        ...
        if (i2 == 2) {
            return new b(iterable, iRemaining, z2);
        }
        return newInstance(new v0(iterable));
    }
