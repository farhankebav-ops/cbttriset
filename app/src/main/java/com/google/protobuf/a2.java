...
public interface a2 {
    ...
    <T> void mergeGroupField(T t3, c2 c2Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t3, c2 c2Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;
    ...
    @Deprecated
    <T> T readGroupBySchemaWithCheck(c2 c2Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    @Deprecated
    <T> void readGroupList(List<T> list, c2 c2Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;
    ...
    <K, V> void readMap(Map<K, V> map, MapEntryLite.a aVar, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> T readMessage(Class<T> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> T readMessageBySchemaWithCheck(c2 c2Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void readMessageList(List<T> list, c2 c2Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;
