...
public final class j0 extends a implements Internal.FloatList, RandomAccess, w1 {
    private static final j0 EMPTY_LIST = new j0(new float[0], 0, false);
    private float[] array;
    private int size;
    ...
    public boolean addAll(Collection<? extends Float> collection) {
        ...
        System.arraycopy(j0Var.array, 0, this.array, this.size, j0Var.size);
        this.size = i9;
    ...
    public boolean equals(Object obj) {
        ...
        j0 j0Var = (j0) obj;
        if (this.size != j0Var.size) {
            return false;
        }
        float[] fArr = j0Var.array;
    ...
    private j0(float[] fArr, int i2, boolean z2) {
        super(z2);
        this.array = fArr;
        this.size = i2;
    }
    ...
    public Internal.ProtobufList<Float> mutableCopyWithCapacity2(int i2) {
        if (i2 >= this.size) {
            return new j0(Arrays.copyOf(this.array, i2), this.size, true);
        }
