...
public class LazyFieldLite {
    ...
    public void writeTo(v2 v2Var, int i2) throws IOException {
        if (this.memoizedBytes != null) {
            v2Var.writeBytes(i2, this.memoizedBytes);
            return;
        }
        ByteString byteString = this.delayedBytes;
        if (byteString != null) {
            ...
            v2Var.writeMessage(i2, this.value);
        } else {
            v2Var.writeBytes(i2, ByteString.EMPTY);
        }
    }
