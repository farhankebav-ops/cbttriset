...
public final class Method extends GeneratedMessageLite<Method, Builder> implements MethodOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Method, Builder> implements MethodOrBuilder {
        public /* synthetic */ Builder(o1 o1Var) {
            this();
        }
        ...
        public Builder setOptions(int i2, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).setOptions(i2, builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i2, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).addOptions(i2, builder.build());
            return this;
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        o1 o1Var = null;
        switch (o1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            case 1:
                return new Method();
            case 2:
                return new Builder(o1Var);
            case 3:
