...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        public /* synthetic */ Builder(m2 m2Var) {
            this();
        }
        ...
        public Builder setFields(int i2, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setFields(i2, builder.build());
            return this;
        }

        public Builder setOptions(int i2, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i2, builder.build());
            return this;
        }
        ...
        public Builder addFields(int i2, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addFields(i2, builder.build());
            return this;
        }

        public Builder addOptions(int i2, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i2, builder.build());
            return this;
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        m2 m2Var = null;
        switch (m2.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            case 1:
                return new Type();
            case 2:
                return new Builder(m2Var);
            case 3:
