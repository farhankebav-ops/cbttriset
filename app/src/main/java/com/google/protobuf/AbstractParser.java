...
public abstract class AbstractParser<MessageType extends MessageLite> implements Parser<MessageType> {
    ...
    public MessageType parsePartialDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
            ...
            return (MessageType) parsePartialFrom((InputStream) new AbstractMessageLite.Builder.a(inputStream, CodedInputStream.readRawVarint32(i2, inputStream)), extensionRegistryLite);
        } catch (IOException e) {
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parsePartialFrom(byte[] bArr, int i2, int i8, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parsePartialFrom(byte[] bArr, int i2, int i8) throws InvalidProtocolBufferException {
        return (MessageType) parsePartialFrom(bArr, i2, i8, EMPTY_REGISTRY);
    }
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parseFrom(byte[] bArr, int i2, int i8, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return (MessageType) checkMessageInitialized(parsePartialFrom(bArr, i2, i8, extensionRegistryLite));
    }
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parseFrom(byte[] bArr, int i2, int i8) throws InvalidProtocolBufferException {
        return (MessageType) parseFrom(bArr, i2, i8, EMPTY_REGISTRY);
    }
