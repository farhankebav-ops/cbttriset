...
public final class Enum extends GeneratedMessageLite<Enum, Builder> implements EnumOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Enum, Builder> implements EnumOrBuilder {
        public /* synthetic */ Builder(x xVar) {
            this();
        }
        ...
        public Builder setEnumvalue(int i2, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setEnumvalue(i2, builder.build());
            return this;
        }

        public Builder setOptions(int i2, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setOptions(i2, builder.build());
            return this;
        }
        ...
        public Builder addEnumvalue(int i2, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addEnumvalue(i2, builder.build());
            return this;
        }

        public Builder addOptions(int i2, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addOptions(i2, builder.build());
            return this;
        }
    }
