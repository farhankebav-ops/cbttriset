...
public class ExtensionRegistryLite {
        ...
        synchronized (ExtensionRegistryLite.class) {
            try {
                ...
                if (extensionRegistryLiteCreateEmpty == null) {
                    extensionRegistryLiteCreateEmpty = z.createEmpty();
    ...
    public static ExtensionRegistryLite newInstance() {
        return doFullRuntimeInheritanceCheck ? z.create() : new ExtensionRegistryLite();
    }
    ...
    public final void add(ExtensionLite<?, ?> extensionLite) {
        ...
        if (doFullRuntimeInheritanceCheck && z.isFullRegistry(this)) {
            try {
