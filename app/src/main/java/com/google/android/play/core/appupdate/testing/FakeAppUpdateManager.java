...
public class FakeAppUpdateManager implements AppUpdateManager {
    ...
    @Override // com.google.android.play.core.appupdate.AppUpdateManager
    public boolean startUpdateFlowForResult(AppUpdateInfo appUpdateInfo, @AppUpdateType int i2, Activity activity, int i8) {
    ...
    @Override // com.google.android.play.core.appupdate.AppUpdateManager
    public boolean startUpdateFlowForResult(AppUpdateInfo appUpdateInfo, @AppUpdateType int i2, IntentSenderForResultStarter intentSenderForResultStarter, int i8) {
        return zzd(appUpdateInfo, AppUpdateOptions.newBuilder(i2).build());
    }

    public void setUpdateAvailable(int i2, @AppUpdateType int i8) {
        this.zzf = true;
        this.zzc.clear();
        this.zzc.add(Integer.valueOf(i8));
        this.zzg = i2;
    }
