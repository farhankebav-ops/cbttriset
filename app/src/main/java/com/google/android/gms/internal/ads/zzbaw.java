...
public final class zzbaw implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    private static final long zzc = ((Long) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbeu.zzbE)).longValue();
    ...
    public zzbaw(Context context, View view) {
        ...
        if (applicationContext instanceof Application) {
            ...
            this.zzj = new zzbbi((Application) applicationContext, this);
        }
    ...
    private final void zzh() {
        com.google.android.gms.ads.internal.util.zzs.zza.post(new Runnable() { // from class: com.google.android.gms.internal.ads.zzbav
    ...
    */
    private final void zzj(int r35) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbaw.zzj(int):void");
    }
    ...
    private final void zzm(View view) {
        ...
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzg("Error while unregistering listeners from the ViewTreeObserver.", e4);
        }
        if (this.zza != null) {
            try {
                ...
                com.google.android.gms.ads.internal.util.client.zzo.zzg("Failed trying to unregister the receiver", e8);
            } catch (Exception e9) {
                com.google.android.gms.ads.internal.zzt.zzh().zzg(e9, "ActiveViewUnit.stopScreenStatusMonitoring");
            }
            this.zza = null;
        }
        Application application = this.zze;
    ...
    public final void zza(zzbau zzbauVar) {
        this.zzn.add(zzbauVar);
        zzj(3);
    }

    public final void zzb(zzbau zzbauVar) {
        this.zzn.remove(zzbauVar);
    }
