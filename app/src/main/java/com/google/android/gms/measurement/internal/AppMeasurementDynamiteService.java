...
public class AppMeasurementDynamiteService extends com.google.android.gms.internal.measurement.zzcq {
    ...
    public void initialize(IObjectWrapper iObjectWrapper, com.google.android.gms.internal.measurement.zzdd zzddVar, long j) throws RemoteException {
        ...
        if (zzicVar == null) {
            ...
            com.google.android.gms.ads.internal.client.a.B(zzicVar, "Attempting to initialize multiple times");
        }
    }
    ...
    public void logEvent(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle, boolean z2, boolean z7, long j) throws RemoteException {
        zzb();
        this.zza.zzj().zzC(str, str2, bundle, z2, z7, j);
    }
    ...
    public void logHealthData(int i2, @NonNull String str, @NonNull IObjectWrapper iObjectWrapper, @NonNull IObjectWrapper iObjectWrapper2, @NonNull IObjectWrapper iObjectWrapper3) throws RemoteException {
        zzb();
        this.zza.zzaV().zzm(i2, true, false, str, iObjectWrapper == null ? null : ObjectWrapper.unwrap(iObjectWrapper), iObjectWrapper2 == null ? null : ObjectWrapper.unwrap(iObjectWrapper2), iObjectWrapper3 != null ? ObjectWrapper.unwrap(iObjectWrapper3) : null);
    }
    ...
    public void setConditionalUserProperty(@NonNull Bundle bundle, long j) throws RemoteException {
        zzb();
        if (bundle == null) {
            com.google.android.gms.ads.internal.client.a.n(this.zza, "Conditional user property must not be null");
        } else {
    ...
    public void setDataCollectionEnabled(boolean z2) throws RemoteException {
        ...
        zzlj zzljVarZzj = this.zza.zzj();
        zzljVarZzj.zzb();
        zzljVarZzj.zzu.zzaW().zzj(new zzjy(zzljVarZzj, z2));
    }
    ...
    public void setUserId(@NonNull final String str, long j) throws RemoteException {
        ...
        if (str != null && TextUtils.isEmpty(str)) {
            com.google.android.gms.ads.internal.client.a.B(zzljVarZzj.zzu, "User ID must be non-empty or null");
        } else {
    ...
    public void setUserProperty(@NonNull String str, @NonNull String str2, @NonNull IObjectWrapper iObjectWrapper, boolean z2, long j) throws RemoteException {
        zzb();
        this.zza.zzj().zzL(str, str2, ObjectWrapper.unwrap(iObjectWrapper), z2, j);
    }
