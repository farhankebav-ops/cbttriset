...
public final class zzwp {
    ...
    @VisibleForTesting
    public static long zza(List list, double d8) {
        return ((Long) list.get(Math.max(((int) Math.ceil((d8 / 100.0d) * ((double) list.size()))) - 1, 0))).longValue();
    }
    ...
    @WorkerThread
    private final boolean zzk(zzrc zzrcVar, long j, long j3) {
