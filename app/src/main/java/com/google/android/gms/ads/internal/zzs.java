...
public final class zzs extends zzbw {
    ...
    public final String zzN() {
        ...
        builder.scheme("https://").appendEncodedPath((String) zzbgg.zzd.zze());
        zzr zzrVar = this.zzd;
        ...
        return a.s(new StringBuilder(strZzO.length() + 1 + String.valueOf(encodedQuery).length()), strZzO, "#", encodedQuery);
    }
    ...
    public final String zzO() {
        ...
        return a.s(new StringBuilder(String.valueOf(strZza).length() + 8 + String.valueOf(str).length()), "https://", strZza, str);
    }
