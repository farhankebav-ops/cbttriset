...
public class zzmb<MessageType extends zzmf<MessageType, BuilderType>, BuilderType extends zzmb<MessageType, BuilderType>> extends zzkr<MessageType, BuilderType> {
    ...
    public final /* bridge */ /* synthetic */ zzkr zzaS(byte[] bArr, int i2, int i8) throws zzmr {
        int i9 = zzlr.zzb;
        int i10 = zznu.zza;
        zzbe(bArr, 0, i8, zzlr.zza);
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzkr
    public final /* bridge */ /* synthetic */ zzkr zzaT(byte[] bArr, int i2, int i8, zzlr zzlrVar) throws zzmr {
        zzbe(bArr, 0, i8, zzlrVar);
        return this;
    }
    ...
    public final zzmb zzbe(byte[] bArr, int i2, int i8, zzlr zzlrVar) throws zzmr {
        if (!this.zza.zzcf()) {
            zzaY();
        }
        try {
            zznu.zza().zzb(this.zza.getClass()).zzi(this.zza, bArr, 0, i8, new zzkw(zzlrVar));
            return this;
        } catch (zzmr e) {
            throw e;
