...
public final class zzah {
    ...
    public static Intent zza(Context context, zzn zznVar) throws zzaf {
        ...
        Intent intent = null;
        if (zznVar.zzd()) {
            Bundle bundleC = a.c("serviceActionBundleKey", strZza);
            try {
            ...
            try {
                bundleCall = contentProviderClientAcquireUnstableContentProviderClient.call("serviceIntentCall", null, bundleC);
