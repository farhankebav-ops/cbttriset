...
public final class zzali implements zzaki {
    ...
    */
    private static com.google.android.gms.internal.ads.zzall zzd(org.xmlpull.v1.XmlPullParser r17, com.google.android.gms.internal.ads.zzall r18) {
        /*
    ...
    private static long zzg(String str, zzalg zzalgVar) throws zzake {
        double d8;
        double d9;
        ...
        if (matcher.matches()) {
            ...
            double d13 = d10 + d11;
            return (long) ((d13 + d12 + (matcher.group(5) != null ? Long.parseLong(r12) / zzalgVar.zza : 0.0d) + (matcher.group(6) != null ? (Long.parseLong(r12) / ((double) zzalgVar.zzb)) / ((double) zzalgVar.zza) : 0.0d)) * 1000000.0d);
        }
        ...
        strGroup5.getClass();
        double d14 = Double.parseDouble(strGroup5);
    ...
    public final void zza(byte[] bArr, int i2, int i8, zzakh zzakhVar, zzdg zzdgVar) {
        zzakc.zza(zzb(bArr, i2, i8), zzakhVar, zzdgVar);
    }
    ...
    /* JADX WARN: Type inference failed for: r0v64, types: [com.google.android.gms.internal.ads.zzalj, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r0v66 */
    /* JADX WARN: Type inference failed for: r10v5, types: [com.google.android.gms.internal.ads.zzalh] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.google.android.gms.internal.ads.zzakd zzb(byte[] r45, int r46, int r47) {
        /*
