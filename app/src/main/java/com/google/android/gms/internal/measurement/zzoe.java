...
class zzoe extends AbstractMap {
    ...
    public final Object zzg(int i2) {
        zzh();
        Object value = ((zzob) this.zza[i2]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i8] = new zzob(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i9 = 0;
        if (i8 >= 0) {
            int iCompareTo = comparable.compareTo(((zzob) this.zza[i8]).zza());
            if (iCompareTo > 0) {
                return -(i2 + 1);
            }
            if (iCompareTo == 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i8 = 0; i8 < i2; i8++) {
            if (!zzd(i8).equals(zzoeVar.zzd(i8))) {
                return false;
            }
        }
        if (i2 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i2] = new zzob(this, comparable, obj);
        this.zzb++;
        return null;
    }
