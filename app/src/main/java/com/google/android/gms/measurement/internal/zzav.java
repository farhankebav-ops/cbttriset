...
final class zzav extends zzos {
    ...
    */
    ...
    private final zzpj zzaF(String str, long j, byte[] bArr, String str2, String str3, int i2, int i8, long j3, long j8, long j9) {
        ...
        try {
            ...
            zzls zzlsVarZzb = zzls.zzb(i2);
            if (zzlsVarZzb != zzls.GOOGLE_SIGNAL && zzlsVarZzb != zzls.GOOGLE_SIGNAL_PENDING && i8 > 0) {
            ...
            if (str3 != null) {
                ...
                while (true) {
                    ...
                    String[] strArrSplit2 = str4.split(C2300e4.i.f8399b, 2);
    ...
    private final String zzaG() {
        ...
        StringBuilder sb = new StringBuilder(a1.a.b(str.length(), 5, str2.length(), 1));
        androidx.camera.core.processing.util.a.A(sb, "(", str, " OR ", str2);
        sb.append(")");
        return sb.toString();
    }

    private static final String zzaH(List list) {
        return list.isEmpty() ? "" : a1.a.m(" AND (upload_type IN (", TextUtils.join(", ", list), "))");
    }
    ...
    public final long zzA(String str, com.google.android.gms.internal.measurement.zzib zzibVar, String str2, Map map, zzls zzlsVar, Long l) {
        ...
        try {
            ...
            this.zzu.zzaV().zzb().zzc("Error storing MeasurementBatch to upload_queue. appId", str, e4);
            return -1L;
        }
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.util.List zzC(java.lang.String r19, com.google.android.gms.measurement.internal.zzoo r20, int r21) throws java.lang.Throwable {
        /*
    ...
    public final boolean zzD(String str) {
        ...
        String strZzaG = zzaG();
        return zzay(androidx.camera.core.processing.util.a.n(new StringBuilder((String.valueOf(strZzaH).length() + 61) + strZzaG.length()), "SELECT COUNT(1) > 0 FROM upload_queue WHERE app_id=?", strZzaH, " AND NOT ", strZzaG), new String[]{str}) != 0;
    }
    ...
    */
    ...
    public final void zzJ(List list) {
        ...
        if (zzag()) {
            ...
            String strS = a1.a.s(new StringBuilder(String.valueOf(strJoin).length() + 2), "(", strJoin, ")");
            if (zzay(a1.a.s(new StringBuilder(strS.length() + 80), "SELECT COUNT(1) FROM queue WHERE rowid IN ", strS, " AND retry_count =  2147483647 LIMIT 1"), null) > 0) {
                com.google.android.gms.ads.internal.client.a.B(this.zzu, "The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                SQLiteDatabase sQLiteDatabaseZze = zze();
                StringBuilder sb = new StringBuilder(strS.length() + 127);
    ...
    @VisibleForTesting
    @WorkerThread
    public final Object zzL(Cursor cursor, int i2) {
        int type = cursor.getType(i2);
        if (type == 0) {
            com.google.android.gms.ads.internal.client.a.n(this.zzu, "Loaded invalid null value from database");
            return null;
        }
        if (type == 1) {
        ...
        com.google.android.gms.ads.internal.client.a.n(this.zzu, "Loaded invalid blob type value, ignoring it");
        return null;
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void zzW(java.lang.String r25, java.lang.Long r26, java.lang.String r27, android.os.Bundle r28) throws java.lang.Throwable {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.google.android.gms.measurement.internal.zzjl zzX(java.lang.String r5) throws java.lang.Throwable {
        /*
            r4 = this;
    ...
    */
    ...
    public final zzbc zzaf(String str, com.google.android.gms.internal.measurement.zzhs zzhsVar, String str2) {
        ...
        long j3 = zzbcVarZzaC.zzd + 1;
        return new zzbc(zzbcVarZzaC.zza, zzbcVarZzaC.zzb, zzbcVarZzaC.zzc + 1, j3, j, zzbcVarZzaC.zzf, zzbcVarZzaC.zzg, zzbcVarZzaC.zzh, zzbcVarZzaC.zzi, zzbcVarZzaC.zzj, zzbcVarZzaC.zzk);
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.google.android.gms.measurement.internal.zzpn zzm(java.lang.String r11, java.lang.String r12) throws java.lang.Throwable {
        /*
            r10 = this;
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.google.android.gms.measurement.internal.zzh zzu(java.lang.String r52) throws java.lang.Throwable {
        /*
    ...
    @WorkerThread
    public final void zzv(zzh zzhVar, boolean z2, boolean z7) {
    ...
    @WorkerThread
    public final zzar zzw(long j, String str, boolean z2, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12) {
        return zzx(j, str, 1L, false, false, z8, false, z10, z11, z12);
    }

    @WorkerThread
    public final zzar zzx(long j, String str, long j3, boolean z2, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12) {
        Preconditions.checkNotEmpty(str);
        zzg();
        zzaw();
        String[] strArr = {str};
