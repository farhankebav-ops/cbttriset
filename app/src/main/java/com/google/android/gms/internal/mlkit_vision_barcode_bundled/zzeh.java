...
public abstract class zzeh<MessageType extends zzeh<MessageType, BuilderType>, BuilderType extends zzeb<MessageType, BuilderType>> extends zzcq<MessageType, BuilderType> {
    ...
    public static final boolean zzX(zzeh zzehVar, boolean z2) {
    ...
    private static zzeh zze(zzeh zzehVar, byte[] bArr, int i2, int i8, zzds zzdsVar) throws zzer {
        if (i8 == 0) {
            return zzehVar;
        }
        ...
        try {
            ...
            zzgeVarZzb.zzh(zzehVarZzK, bArr, 0, i8, new zzcu(zzdsVar));
            ...
            if (e8.getCause() instanceof zzer) {
                throw ((zzer) e8.getCause());
            }
            throw new zzer(e8);
    ...
    public final int zzF() {
        if (zzY()) {
            ...
            throw new IllegalStateException(a.g(iZzc, "serialized size must be non-negative, was "));
        }
        int i2 = this.zzd & Integer.MAX_VALUE;
        if (i2 != Integer.MAX_VALUE) {
            return i2;
        ...
        int iZzc2 = zzc(null);
        if (iZzc2 < 0) {
            throw new IllegalStateException(a.g(iZzc2, "serialized size must be non-negative, was "));
        }
    ...
    public abstract Object zzg(int i2, Object obj, Object obj2);
}
