...
public final class zzic implements zzjg {
    ...
    */
    ...
    public final /* synthetic */ void zzJ(String str, int i2, Throwable th, byte[] bArr, Map map) {
        int i8;
        if (i2 != 200 && i2 != 204) {
            i8 = 304;
            if (i2 != 304) {
            ...
            zzP(zzguVar);
            zzguVar.zze().zzc("Network Request for Deferred Deep Link failed. response, exception", Integer.valueOf(i8), th);
        }
        i8 = i2;
        if (th == null) {
            zzhh zzhhVar = this.zzg;
            ...
            try {
                ...
                zzP(zzguVar6);
                zzguVar6.zzb().zzb("Failed to parse the Deferred Deep Link response. exception", e4);
                return;
            }
        }
        zzgu zzguVar7 = this.zzh;
        zzP(zzguVar7);
        zzguVar7.zze().zzc("Network Request for Deferred Deep Link failed. response, exception", Integer.valueOf(i8), th);
    }
