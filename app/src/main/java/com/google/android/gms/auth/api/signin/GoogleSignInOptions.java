...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    */
    ...
    public GoogleSignInOptions(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) ArrayList arrayList, @Nullable @SafeParcelable.Param(id = 3) Account account, @SafeParcelable.Param(id = 4) boolean z2, @SafeParcelable.Param(id = 5) boolean z7, @SafeParcelable.Param(id = 6) boolean z8, @Nullable @SafeParcelable.Param(id = 7) String str, @Nullable @SafeParcelable.Param(id = 8) String str2, @SafeParcelable.Param(id = 9) ArrayList arrayList2, @Nullable @SafeParcelable.Param(id = 10) String str3) {
        this(i2, arrayList, account, z2, z7, z8, str, str2, zam(arrayList2), str3);
    }

    private GoogleSignInOptions(int i2, ArrayList arrayList, @Nullable Account account, boolean z2, boolean z7, boolean z8, @Nullable String str, @Nullable String str2, Map map, @Nullable String str3) {
        this.zaf = i2;
        this.zah = arrayList;
        this.zai = account;
        this.zaj = z2;
