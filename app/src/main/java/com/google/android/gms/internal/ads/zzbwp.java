...
public final class zzbwp extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(id = Sdk.SDKMetric.SDKMetricType.AD_VISIBILITY_VALUE)
    public final int zzX;

    @SafeParcelable.Field(id = Sdk.SDKMetric.SDKMetricType.INIT_TO_SUCCESS_CALLBACK_DURATION_MS_VALUE)
    public final boolean zzY;

    @SafeParcelable.Field(id = Sdk.SDKMetric.SDKMetricType.INIT_TO_FAIL_CALLBACK_DURATION_MS_VALUE)
    public final boolean zzZ;

    @SafeParcelable.Field(id = 1)
    public final int zza;

    @SafeParcelable.Field(id = Sdk.SDKMetric.SDKMetricType.AD_START_TO_BACKGROUND_DURATION_MS_VALUE)
    public final boolean zzaa;

    @SafeParcelable.Field(id = 60)
    public final ArrayList zzab;

    @SafeParcelable.Field(id = Sdk.SDKMetric.SDKMetricType.APP_BACKGROUND_DURING_AD_LOAD_VALUE)
    ...
    @SafeParcelable.Field(id = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_HEIGHT)
    ...
    public zzbwp(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) Bundle bundle, @SafeParcelable.Param(id = 3) com.google.android.gms.ads.internal.client.zzm zzmVar, @SafeParcelable.Param(id = 4) com.google.android.gms.ads.internal.client.zzr zzrVar, @SafeParcelable.Param(id = 5) String str, @SafeParcelable.Param(id = 6) ApplicationInfo applicationInfo, @SafeParcelable.Param(id = 7) PackageInfo packageInfo, @SafeParcelable.Param(id = 8) String str2, @SafeParcelable.Param(id = 9) String str3, @SafeParcelable.Param(id = 10) String str4, @SafeParcelable.Param(id = 11) VersionInfoParcel versionInfoParcel, @SafeParcelable.Param(id = 12) Bundle bundle2, @SafeParcelable.Param(id = 13) int i8, @SafeParcelable.Param(id = 14) List list, @SafeParcelable.Param(id = 15) Bundle bundle3, @SafeParcelable.Param(id = 16) boolean z2, @SafeParcelable.Param(id = 18) int i9, @SafeParcelable.Param(id = 19) int i10, @SafeParcelable.Param(id = 20) float f4, @SafeParcelable.Param(id = 21) String str5, @SafeParcelable.Param(id = 25) long j, @SafeParcelable.Param(id = 26) String str6, @SafeParcelable.Param(id = 27) List list2, @SafeParcelable.Param(id = 28) String str7, @SafeParcelable.Param(id = 29) zzbhx zzbhxVar, @SafeParcelable.Param(id = 30) List list3, @SafeParcelable.Param(id = 31) long j3, @SafeParcelable.Param(id = 33) String str8, @SafeParcelable.Param(id = 34) float f8, @SafeParcelable.Param(id = 40) boolean z7, @SafeParcelable.Param(id = 35) int i11, @SafeParcelable.Param(id = 36) int i12, @SafeParcelable.Param(id = 37) boolean z8, @SafeParcelable.Param(id = 39) String str9, @SafeParcelable.Param(id = 41) String str10, @SafeParcelable.Param(id = 42) boolean z9, @SafeParcelable.Param(id = 43) int i13, @SafeParcelable.Param(id = 44) Bundle bundle4, @SafeParcelable.Param(id = 45) String str11, @SafeParcelable.Param(id = 46) com.google.android.gms.ads.internal.client.zzeh zzehVar, @SafeParcelable.Param(id = 47) boolean z10, @SafeParcelable.Param(id = 48) Bundle bundle5, @Nullable @SafeParcelable.Param(id = 49) String str12, @Nullable @SafeParcelable.Param(id = 50) String str13, @Nullable @SafeParcelable.Param(id = 51) String str14, @SafeParcelable.Param(id = 52) boolean z11, @SafeParcelable.Param(id = 53) List list4, @SafeParcelable.Param(id = 54) String str15, @SafeParcelable.Param(id = 55) List list5, @SafeParcelable.Param(id = Sdk.SDKMetric.SDKMetricType.AD_VISIBILITY_VALUE) int i14, @SafeParcelable.Param(id = Sdk.SDKMetric.SDKMetricType.INIT_TO_SUCCESS_CALLBACK_DURATION_MS_VALUE) boolean z12, @SafeParcelable.Param(id = Sdk.SDKMetric.SDKMetricType.INIT_TO_FAIL_CALLBACK_DURATION_MS_VALUE) boolean z13, @SafeParcelable.Param(id = Sdk.SDKMetric.SDKMetricType.AD_START_TO_BACKGROUND_DURATION_MS_VALUE) boolean z14, @SafeParcelable.Param(id = 60) ArrayList arrayList, @SafeParcelable.Param(id = Sdk.SDKMetric.SDKMetricType.APP_BACKGROUND_DURING_AD_LOAD_VALUE) String str16, @SafeParcelable.Param(id = 63) zzboi zzboiVar, @Nullable @SafeParcelable.Param(id = 64) String str17, @SafeParcelable.Param(id = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_HEIGHT) Bundle bundle6) {
        this.zza = i2;
        this.zzb = bundle;
        this.zzc = zzmVar;
        this.zzd = zzrVar;
