...
public final class zzpm implements Parcelable.Creator {
    public static void zza(zzpl zzplVar, Parcel parcel, int i2) {
        int i8 = zzplVar.zza;
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        return new zzpl(i2, strCreateString, j, longObject, floatObject, strCreateString2, strCreateString3, doubleObject);
    }
