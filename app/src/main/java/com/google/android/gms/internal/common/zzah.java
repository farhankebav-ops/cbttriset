...
public abstract class zzah extends zzac implements List, RandomAccess {
    ...
    public static zzah zzq(Object[] objArr, int i2) {
    ...
    public zzah subList(int i2, int i8) {
        zzr.zzd(i2, i8, size());
        int i9 = i8 - i2;
        return i9 == size() ? this : i9 == 0 ? zzaj.zza : new zzag(this, i2, i9);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzr, reason: merged with bridge method [inline-methods] */
    public final zzal listIterator(int i2) {
        zzr.zzc(i2, size(), FirebaseAnalytics.Param.INDEX);
