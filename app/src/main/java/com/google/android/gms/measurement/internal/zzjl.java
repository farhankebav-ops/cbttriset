...
public final class zzjl {
    ...
    public zzjl(Boolean bool, Boolean bool2, int i2) {
    ...
    public static zzjl zza(zzji zzjiVar, zzji zzjiVar2, int i2) {
        EnumMap enumMap = new EnumMap(zzjk.class);
    ...
    public static zzjl zze(Bundle bundle, int i2) {
        if (bundle == null) {
            return new zzjl(null, null, i2);
        }
        EnumMap enumMap = new EnumMap(zzjk.class);
        for (zzjk zzjkVar : zzjj.STORAGE.zzb()) {
            enumMap.put(zzjkVar, zzg(bundle.getString(zzjkVar.zze)));
        }
        return new zzjl(enumMap, i2);
    }

    public static zzjl zzf(String str, int i2) {
        EnumMap enumMap = new EnumMap(zzjk.class);
        zzjk[] zzjkVarArrZza = zzjj.STORAGE.zza();
        for (int i8 = 0; i8 < zzjkVarArrZza.length; i8++) {
            String str2 = str == null ? "" : str;
            zzjk zzjkVar = zzjkVarArrZza[i8];
            int i9 = i8 + 2;
            if (i9 < str2.length()) {
                enumMap.put(zzjkVar, zzj(str2.charAt(i9)));
            } else {
    ...
    public static zzji zzj(char c7) {
        return c7 != '+' ? c7 != '0' ? c7 != '1' ? zzji.UNINITIALIZED : zzji.GRANTED : zzji.DENIED : zzji.POLICY;
    }
    ...
    public static boolean zzu(int i2, int i8) {
        int i9 = -30;
        if (i2 == -20) {
            if (i8 == -30) {
                return true;
    ...
    */
    ...
    private zzjl(EnumMap enumMap, int i2) {
