...
final class zzgle {
    ...
    private final IBinder.DeathRecipient zzh = new IBinder.DeathRecipient() { // from class: com.google.android.gms.internal.ads.zzgkz
    ...
    public zzgle(Context context, zzglf zzglfVar, String str, Intent intent, zzgkv zzgkvVar) {
        this.zzb = context;
        this.zzc = zzglfVar;
        final String str2 = "OverlayDisplayService";
        this.zzg = intent;
        this.zza = zzgmz.zza(new zzgmv(str2) { // from class: com.google.android.gms.internal.ads.zzgld
    ...
    public final void zzh(final Runnable runnable) {
        ((Handler) this.zza.zza()).post(new Runnable() { // from class: com.google.android.gms.internal.ads.zzglc
    ...
    public final void zza(final Runnable runnable) {
        zzh(new Runnable() { // from class: com.google.android.gms.internal.ads.zzgla
            @Override // java.lang.Runnable
            public final /* synthetic */ void run() {
    ...
    public final void zzb() {
        zzh(new Runnable() { // from class: com.google.android.gms.internal.ads.zzglb
            @Override // java.lang.Runnable
            public final /* synthetic */ void run() {
                this.zza.zzf();
            }
    ...
    public final /* synthetic */ void zze(Runnable runnable) {
        ...
        zzgky zzgkyVar = new zzgky(this, null);
        this.zzi = zzgkyVar;
        this.zzf = true;
        if (this.zzb.bindService(this.zzg, zzgkyVar, 1)) {
            return;
        }
    ...
    public final /* synthetic */ zzglf zzi() {
        return this.zzc;
    }
