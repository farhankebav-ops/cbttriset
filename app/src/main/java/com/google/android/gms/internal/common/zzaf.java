...
final class zzaf extends zzah {
    ...
    public final Object get(int i2) {
        ...
        zzr.zzb(i2, zzahVar.size(), FirebaseAnalytics.Param.INDEX);
    ...
    public final zzah subList(int i2, int i8) {
        zzah zzahVar = this.zza;
        zzr.zzd(i2, i8, zzahVar.size());
        return zzahVar.subList(zzahVar.size() - i8, zzahVar.size() - i2).zzh();
    }
}
