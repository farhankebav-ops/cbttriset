        ...
        switch (str.hashCode()) {
            ...
            case -895859076:
                if (str.equals("splice")) {
                    ...
                    if (list.size() > 1) {
                        ...
                        if (iMax > 0) {
                            for (int i8 = iZzi; i8 < Math.min(iZzh2, iZzi + iMax); i8++) {
                        ...
                        if (list.size() > 2) {
                            for (int i9 = 2; i9 < list.size(); i9++) {
                                zzao zzaoVarZza3 = zzgVar.zza((zzao) list.get(i9));
                                if (zzaoVarZza3 instanceof zzag) {
                                    throw new IllegalArgumentException("Failed to parse elements to add");
                                }
                                zzaeVar.zzq((iZzi + i9) - 2, zzaoVarZza3);
                            }
                        }
                    } else {
                        while (iZzi < iZzh2) {
            ...
            case 111185:
                if (str.equals("pop")) {
                    ...
                    int i10 = iZzh5 - 1;
                    zzao zzaoVarZzl = zzaeVar.zzl(i10);
                    zzaeVar.zzr(i10);
                    return zzaoVarZzl;
                }
                throw new IllegalArgumentException("Command not supported");
            ...
            case 109526418:
                if (str.equals("slice")) {
                    ...
                    for (int i11 = (int) dMax; i11 < dZzh3; i11++) {
                        zzaeVar8.zzn(zzaeVar8.zzh(), zzaeVar.zzl(i11));
                    }
                    return zzaeVar8;
                }
                throw new IllegalArgumentException("Command not supported");
            ...
            case 1099846370:
                if (str.equals("reverse")) {
                    ...
                    if (iZzh6 != 0) {
                        while (i2 < iZzh6 / 2) {
                            if (zzaeVar.zzo(i2)) {
                                zzao zzaoVarZzl3 = zzaeVar.zzl(i2);
                                zzaeVar.zzn(i2, null);
                                int i12 = (iZzh6 - 1) - i2;
                                if (zzaeVar.zzo(i12)) {
                                    zzaeVar.zzn(i2, zzaeVar.zzl(i12));
                                }
                                zzaeVar.zzn(i12, zzaoVarZzl3);
                            }
                            i2++;
                        }
                    }
            ...
            case 1943291465:
                if (str.equals("indexOf")) {
                    ...
                    while (itZzg6.hasNext()) {
                        ...
                        if (d8 >= dZzh2 && zzh.zzf(zzaeVar.zzl(iIntValue2), zzaoVarZza13)) {
                            return new zzah(Double.valueOf(d8));
                        }
                    }
                    return new zzah(dValueOf);
                }
