...
public class GoogleApiAvailabilityLight {
    ...
    public PendingIntent getErrorResolutionPendingIntent(@NonNull Context context, int i2, int i8) {
        return getErrorResolutionPendingIntent(context, i2, i8, null);
    }
    ...
    @ShowFirstParty
    @KeepForSdk
    public PendingIntent getErrorResolutionPendingIntent(@NonNull Context context, int i2, int i8, @Nullable String str) {
        Intent errorResolutionIntent = getErrorResolutionIntent(context, i2, str);
        if (errorResolutionIntent == null) {
            return null;
        }
        return PendingIntentCompat.getActivity(context, i8, errorResolutionIntent, 134217728, false);
    }
