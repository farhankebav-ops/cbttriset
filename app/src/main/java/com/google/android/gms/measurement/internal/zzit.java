        ...
        if (zzhVarZzu != null) {
            if (zzhVarZzu.zzD()) {
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < listZzn.size(); i2++) {
                        ...
                        zzpgVar4.zzp().zzc(zzitVarZzm, ((zzpn) listZzn.get(i2)).zze);
                        zziuVarArr[i2] = (com.google.android.gms.internal.measurement.zziu) zzitVarZzm.zzbc();
                    }
                    ...
                    try {
                        zzbb zzbbVar = new zzbb(zzicVar6, str, str2, str5, j8, j, bundle);
                        ...
                        try {
                            ...
                            zzlpVarZzn.zzu.zzaV().zzb().zzc("Data loss. Failed to bundle and serialize. appId", zzgu.zzl(str2), e4);
                            return obj;
                        }
                    } catch (Throwable th2) {
                        th = th2;
                    ...
                    zzlpVar = zzlpVarZzn;
                    try {
                        zzlpVar.zzu.zzaV().zzj().zzb("app instance id encryption failed", e8.getMessage());
                        bArr = new byte[0];
                        zzpgVar = zzlpVar.zzg;
                        zzpgVar.zzj().zzd();
                        return bArr;
