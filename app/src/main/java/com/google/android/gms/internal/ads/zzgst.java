...
public final class zzgst extends zzgsu {
    public static int zza(long j) {
        int i2 = (int) j;
        zzgmd.zze(((long) i2) == j, "Out of range: %s", j);
        return i2;
    }
    ...
    public static int zzc(int i2, int i8, int i9) {
        zzgmd.zzg(true, "min (%s) must be less than or equal to max (%s)", i8, 1073741823);
    ...
    */
    ...
    public static /* synthetic */ int zzi(int[] iArr, int i2, int i8, int i9) {
        while (i8 < i9) {
            if (iArr[i8] == i2) {
                return i8;
            }
