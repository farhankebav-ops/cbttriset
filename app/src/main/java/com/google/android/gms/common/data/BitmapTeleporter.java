...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public BitmapTeleporter(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(id = 3) int i8) {
        this.zaa = i2;
        ...
        if (!this.zae) {
            ...
            try {
                try {
                    ...
                    Bitmap bitmapCreateBitmap = Bitmap.createBitmap(i2, i8, configValueOf);
