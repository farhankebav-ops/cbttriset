...
public final class zzgu extends zzjf {
    ...
    public static String zzo(boolean z2, String str, Object obj, Object obj2, Object obj3) {
    ...
    @VisibleForTesting
    public static String zzp(boolean z2, Object obj) {
        String className;
        if (obj == null) {
            return "";
        }
        ...
        if (obj instanceof Long) {
            ...
            String str = cCharAt == '-' ? "-" : "";
            StringBuilder sb = new StringBuilder(androidx.camera.core.processing.util.a.D(str.length() + length + 3, String.valueOf(jRound2).length(), str));
            androidx.camera.core.processing.util.a.y(sb, str, jRound, "...");
            sb.append(str);
            sb.append(jRound2);
            return sb.toString();
        }
        ...
        if (!(obj instanceof Throwable)) {
            return obj instanceof zzgt ? ((zzgt) obj).zza() : z2 ? "-" : obj.toString();
        }
    ...
    public final void zzm(int i2, boolean z2, boolean z7, String str, Object obj, Object obj2, Object obj3) {
        ...
        if (zzhzVarZzi == null) {
            ...
            zzhzVarZzi.zzj(new zzgr(this, i2, str, obj, obj2, obj3));
        }
    }
    ...
    public final /* synthetic */ void zzs(char c7) {
        this.zza = c7;
    }
