...
interface zzhym {
    ...
    void zzG(List list, zzhyr zzhyrVar, zzhvy zzhvyVar) throws IOException;

    @Deprecated
    void zzH(List list, zzhyr zzhyrVar, zzhvy zzhvyVar) throws IOException;
    ...
    void zzP(Map map, zzhxr zzhxrVar, zzhvy zzhvyVar) throws IOException;
    ...
    void zzo(Object obj, zzhyr zzhyrVar, zzhvy zzhvyVar) throws IOException;

    void zzp(Object obj, zzhyr zzhyrVar, zzhvy zzhvyVar) throws IOException;

    zzhvi zzq() throws IOException;
