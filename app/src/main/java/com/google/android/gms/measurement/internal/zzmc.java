...
final class zzmc implements Runnable {
    ...
    public zzmc(zznl zznlVar, String str, String str2, zzr zzrVar, boolean z2, com.google.android.gms.internal.measurement.zzcu zzcuVar) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = zzrVar;
        this.zzd = z2;
                ...
                for (zzpl zzplVar : listZzp) {
                    ...
                    if (str != null) {
                        ...
                        if (l != null) {
                            ...
                            Double d8 = zzplVar.zzg;
                            if (d8 != null) {
                                bundle.putDouble(zzplVar.zzb, d8.doubleValue());
                            }
                        }
                    }
                }
