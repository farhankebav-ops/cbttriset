...
public final class zav extends AbstractSafeParcelable {
    ...
    public zav(@SafeParcelable.Param(id = 1) int i2, @Nullable @SafeParcelable.Param(id = 2) IBinder iBinder, @SafeParcelable.Param(id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(id = 4) boolean z2, @SafeParcelable.Param(id = 5) boolean z7) {
        this.zaa = i2;
        this.zab = iBinder;
