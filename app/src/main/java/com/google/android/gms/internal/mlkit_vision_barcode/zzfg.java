...
final class zzfg implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.y(1, FieldDescriptor.builder(C2300e4.h.W));
    ...
    public final zzfg zzd(@NonNull FieldDescriptor fieldDescriptor, int i2, boolean z2) throws IOException {
        if (!z2 || i2 != 0) {
    ...
    public final zzfg zze(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z2) throws IOException {
        if (!z2 || j != 0) {
            zzfe zzfeVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzfeVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
