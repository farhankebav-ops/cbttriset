...
public final class zzxk {
    ...
    private final float zzp(float f4) {
        ...
        return (f8 <= 0.0f || f4 <= f8) ? f4 : f8;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void zzq(zzrc zzrcVar, float f4, float f8, zzxn zzxnVar) {
        long jConvert;
        if (this.zzd != null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:72:0x025a A[Catch: all -> 0x01ad, Merged into TryCatch #1 {all -> 0x000e, all -> 0x01ad, blocks: (B:4:0x0007, B:6:0x000c, B:10:0x0011, B:12:0x0017, B:14:0x0020, B:17:0x002c, B:19:0x0031, B:20:0x003a, B:22:0x00a3, B:23:0x00a9, B:25:0x00af, B:28:0x00bd, B:29:0x00de, B:30:0x00ed, B:32:0x00f3, B:34:0x0107, B:36:0x0113, B:39:0x011c, B:40:0x0166, B:42:0x0170, B:43:0x017b, B:45:0x0187, B:47:0x018f, B:74:0x0278, B:49:0x0199, B:50:0x019b, B:77:0x027b, B:78:0x027c, B:51:0x019c, B:53:0x01aa, B:57:0x01b0, B:58:0x01db, B:60:0x01e1, B:63:0x020a, B:65:0x0219, B:67:0x0228, B:69:0x0233, B:70:0x0258, B:72:0x025a, B:73:0x0277), top: B:83:0x0007 }] */
    /*
    ...
    */
    ...
    @VisibleForTesting
    public final void zzl(float f4, zzrc zzrcVar, zzxn zzxnVar) {
        synchronized (this.zzh) {
            try {
