...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzf = zzkgVarZzb.zzc("measurement.config.cache_time", SignalManager.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzA = zzkgVarZzb.zzc("measurement.monitoring.sample_period_millis", SignalManager.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzQ = zzkgVarZzb.zzc("measurement.sgtm.upload.min_delay_after_background", TTAdConstant.AD_MAX_EVENT_TIME);
        ...
        zzT = zzkgVarZzb.zzc("measurement.sgtm.upload.retry_interval", TTAdConstant.AD_MAX_EVENT_TIME);
        zzU = zzkgVarZzb.zzc("measurement.sgtm.upload.retry_max_wait", 21600000L);
        zzV = zzkgVarZzb.zzc("measurement.upload.stale_data_deletion_interval", SignalManager.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzao = zzkgVarZzb.zzc("measurement.upload.max_public_events_per_day", ServiceProvider.SCAR_SIGNALS_FETCH_TIMEOUT);
