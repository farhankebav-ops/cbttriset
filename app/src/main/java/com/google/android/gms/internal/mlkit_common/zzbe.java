...
final class zzbe implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.g(1, FieldDescriptor.builder(C2300e4.h.W));
    ...
    public final zzbe zzd(@NonNull FieldDescriptor fieldDescriptor, int i2, boolean z2) throws IOException {
        if (!z2 || i2 != 0) {
    ...
    public final zzbe zze(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z2) throws IOException {
        if (!z2 || j != 0) {
            zzbc zzbcVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzbcVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
