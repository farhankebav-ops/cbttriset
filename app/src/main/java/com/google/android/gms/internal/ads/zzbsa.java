...
public final class zzbsa implements MediationBannerAdCallback, MediationInterstitialAdCallback, MediationNativeAdCallback, MediationAppOpenAdCallback {
    private final zzbrp zza;

    public zzbsa(zzbrp zzbrpVar) {
        this.zza = zzbrpVar;
    }
