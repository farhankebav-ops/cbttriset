...
final class zzabb {
    ...
    public zzabb(@FloatRange(from = 0.0d, fromInclusive = false) float f4) {
    ...
    */
    ...
    public final void zzc(@FloatRange(from = 0.0d, fromInclusive = false) float f4) {
        zzgmd.zza(f4 > 0.0f);
        this.zzd = new Range(Double.valueOf(0.0d), Double.valueOf(1.0d / ((double) f4)));
        zzd();
    }
