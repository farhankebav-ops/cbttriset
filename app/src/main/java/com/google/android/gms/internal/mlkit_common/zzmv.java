...
public enum zzmv implements zzba {
    ...
    CLOUD_TEXT_CLOSE(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE),
    ...
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(Sdk.SDKError.Reason.MRAID_JS_DOES_NOT_EXIST_VALUE),
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(Sdk.SDKError.Reason.MRAID_JS_COPY_FAILED_VALUE),
    AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(Sdk.SDKError.Reason.AD_RESPONSE_RETRY_AFTER_VALUE),
    ...
    OPTIONAL_MODULE_DOCUMENT_CROP_INIT(TTAdConstant.STYLE_SIZE_RADIO_9_16),
    ...
    ON_DEVICE_SHADOW_REMOVAL_PROCESS(IronSourceError.ERROR_NT_LOAD_WHILE_LONG_INITIATION),
    ON_DEVICE_SHADOW_REMOVAL_CLOSE(704),
    OPTIONAL_MODULE_SHADOW_REMOVAL_CREATE(IronSourceError.ERROR_NT_INSTANCE_LOAD_EMPTY_ADAPTER),
    OPTIONAL_MODULE_SHADOW_REMOVAL_INIT(IronSourceError.ERROR_NT_INSTANCE_INIT_EXCEPTION),
