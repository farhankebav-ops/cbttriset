...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) int i8, @SafeParcelable.Param(id = 3) Bundle bundle) {
        this.zaa = i2;
        this.zab = i8;
        this.zac = bundle;
    }
