...
public final class zzp extends AbstractSafeParcelable {
    ...
    public zzp(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) boolean z2, @SafeParcelable.Param(id = 3) boolean z7, @SafeParcelable.Param(id = 4) IBinder iBinder, @SafeParcelable.Param(id = 5) boolean z8, @SafeParcelable.Param(id = 6) boolean z9, @SafeParcelable.Param(id = 8) boolean z10) {
        this.zza = str;
        this.zzb = z2;
        this.zzc = z7;
