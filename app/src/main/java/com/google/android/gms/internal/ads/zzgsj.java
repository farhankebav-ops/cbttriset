...
public final class zzgsj {
    ...
    */
    ...
    public static boolean zzb(double d8) {
        if (d8 > 0.0d && zzgsk.zzb(d8)) {
            long jZza = zzgsk.zza(d8);
            if ((jZza & ((-1) + jZza)) == 0) {
                return true;
            }
        }
    ...
    */
    ...
    public static boolean zzd(double d8) {
        if (zzgsk.zzb(d8)) {
            return d8 == 0.0d || 52 - Long.numberOfTrailingZeros(zzgsk.zza(d8)) <= Math.getExponent(d8);
        }
        return false;
    }
}
