...
final class zzo {
    ...
    public static zzy zzc(zzw zzwVar) {
        ...
        try {
            ...
            try {
                ...
                zzyVarZzd = zzy.zzd("module init: ".concat(String.valueOf(e4.getMessage())), e4);
            }
    ...
    @Deprecated
    public static zzy zzd(String str, zzj zzjVar, boolean z2, boolean z7) {
        StrictMode.ThreadPolicy threadPolicyAllowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            return zzf(str, zzjVar, z2, z7);
        } finally {
            StrictMode.setThreadPolicy(threadPolicyAllowThreadDiskReads);
        }
    }

    public static /* synthetic */ String zze(boolean z2, String str, zzj zzjVar) {
        ...
        return str2 + ": pkg=" + str + ", sha256=" + Hex.bytesToStringLowercase(messageDigestZza.digest(zzjVar.zzc())) + ", atk=" + z2 + ", ver=12451000.false";
    }

    @Deprecated
    private static zzy zzf(final String str, final zzj zzjVar, final boolean z2, boolean z7) {
        try {
            zzb();
            Preconditions.checkNotNull(zzj);
            try {
                return zzg.zze(new zzt(str, zzjVar, z2, z7), ObjectWrapper.wrap(zzj.getPackageManager())) ? zzy.zzb() : new zzx(new Callable() { // from class: com.google.android.gms.common.zzl
            ...
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e4);
            return zzy.zzd("module init: ".concat(String.valueOf(e4.getMessage())), e4);
        }
    }
}
