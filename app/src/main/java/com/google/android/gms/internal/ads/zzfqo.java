...
public final class zzfqo {
    ...
    public static JSONObject zzb(int i2, int i8, int i9, int i10) {
        ...
        try {
            ...
            zzfqp.zza("Error with creating viewStateObject", e);
            return jSONObject;
        }
    }
    ...
    public static void zzd(JSONObject jSONObject, String str) {
        try {
            ...
            zzfqp.zza("Error with setting ad session id", e);
        }
    }
