...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public ConnectionResult(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) int i8, @Nullable @SafeParcelable.Param(id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(id = 4) String str, @Nullable @SafeParcelable.Param(id = 5) Integer num) {
        this.zza = i2;
        this.zzb = i8;
        ...
        switch (i2) {
            ...
            default:
                switch (i2) {
                    ...
                    default:
                        return a.j(new StringBuilder(String.valueOf(i2).length() + 20), "UNKNOWN_ERROR_CODE(", i2, ")");
                }
        }
    }
