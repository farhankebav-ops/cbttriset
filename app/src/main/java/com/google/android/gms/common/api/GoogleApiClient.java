        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                if (clientBuildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(a.D(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z2) {
                    throw new IllegalStateException(a.m("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
