...
public class GoogleApiManager implements Handler.Callback {
    ...
    public static Status zaF(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, a.n("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    public final boolean handleMessage(@NonNull Message message) {
        ...
        switch (i2) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    Log.wtf("GoogleApiManager", a.h(i8, "Could not find API instance ", " while trying to fail enqueued calls."), new Exception());
                } else if (connectionResult.getErrorCode() == 13) {
                    zabqVar.zaE(new Status(17, a.n("Error resolution was canceled by the user, original error message: ", this.zaj.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                } else {
    ...
    public final void zaw(MethodInvocation methodInvocation, int i2, long j, int i8) {
        this.zar.sendMessage(this.zar.obtainMessage(18, new zace(methodInvocation, i2, j, i8)));
    }
