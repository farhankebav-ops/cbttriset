...
final class zzgz {
    ...
    public static void zzD(Object obj, long j, byte b8) {
        ...
        int i8 = ((~((int) j)) & 3) << 3;
        zzgyVar.zza.putInt(obj, j3, ((255 & b8) << i8) | (i2 & (~(255 << i8))));
    }
    ...
    public static void zzE(Object obj, long j, byte b8) {
        ...
        long j3 = (-4) & j;
        int i2 = (((int) j) & 3) << 3;
        zzgyVar.zza.putInt(obj, j3, ((255 & b8) << i2) | (zzgyVar.zza.getInt(obj, j3) & (~(255 << i2))));
    }
    ...
    public static void zzo(Object obj, long j, double d8) {
        zzf.zze(obj, j, d8);
    }
    ...
    public static void zzq(Object obj, long j, int i2) {
