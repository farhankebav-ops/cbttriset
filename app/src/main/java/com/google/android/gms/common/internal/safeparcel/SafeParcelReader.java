...
public class SafeParcelReader {
    ...
    public static SparseArray<byte[]> createByteArraySparseArray(@NonNull Parcel parcel, int i2) {
        ...
        int i8 = parcel.readInt();
        SparseArray<byte[]> sparseArray = new SparseArray<>(i8);
        for (int i9 = 0; i9 < i8; i9++) {
    ...
    public static SparseArray<IBinder> createIBinderSparseArray(@NonNull Parcel parcel, int i2) {
        ...
        int i8 = parcel.readInt();
        SparseArray<IBinder> sparseArray = new SparseArray<>(i8);
        for (int i9 = 0; i9 < i8; i9++) {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i2) {
        if (parcel.dataPosition() != i2) {
            throw new ParseException(a.m(new StringBuilder(String.valueOf(i2).length() + 26), "Overread allowed size end=", i2), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        throw new ParseException(a1.a.f(iDataPosition, i2, "Size read is invalid start=", " end=", new StringBuilder(String.valueOf(iDataPosition).length() + 32 + String.valueOf(i2).length())), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i2, int i8) {
        ...
        com.google.android.gms.ads.internal.client.a.k(i8, size, "Expected size ", " got ", sb);
        throw new ParseException(a1.a.s(sb, " (0x", hexString, ")"), parcel);
    }

    private static void zzb(Parcel parcel, int i2, int i8, int i9) {
        if (i8 == i9) {
            return;
        }
        String hexString = Integer.toHexString(i8);
        int length = String.valueOf(i9).length();
        StringBuilder sb = new StringBuilder(String.valueOf(hexString).length() + length + 19 + String.valueOf(i8).length() + 4 + 1);
        com.google.android.gms.ads.internal.client.a.k(i9, i8, "Expected size ", " got ", sb);
        throw new ParseException(a1.a.s(sb, " (0x", hexString, ")"), parcel);
    }
}
