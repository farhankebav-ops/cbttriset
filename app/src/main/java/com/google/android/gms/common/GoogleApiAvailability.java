...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i2, int i8) {
        return getErrorDialog(activity, i2, i8, (DialogInterface.OnCancelListener) null);
    }
    ...
    @Override // com.google.android.gms.common.GoogleApiAvailabilityLight
    @Nullable
    public PendingIntent getErrorResolutionPendingIntent(@NonNull Context context, int i2, int i8) {
        return super.getErrorResolutionPendingIntent(context, i2, i8);
    }
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i2, int i8) {
        return showErrorDialogFragment(activity, i2, i8, (DialogInterface.OnCancelListener) null);
    }
    ...
    public final Dialog zaa(@NonNull Context context, int i2, @Nullable zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable DialogInterface.OnClickListener onClickListener) {
        ...
        Log.w("GoogleApiAvailability", a.g(i2, "Creating dialog for Google Play services availability issue. ConnectionResult="), new IllegalArgumentException());
    ...
    public final void zae(Context context, int i2, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        int i8;
        String str2;
        Log.w("GoogleApiAvailability", a.h(i2, "GMS core API Availability. ConnectionResult=", ", tag=null"), new IllegalArgumentException());
        if (i2 == 18) {
            zaf(context);
            return;
        }
        ...
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(com.facebook.ads.internal.dynamicloading.a.f(string));
        ...
        notificationManager.notify(i8, notificationBuild);
    }
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zag(@NonNull Activity activity, @NonNull LifecycleFragment lifecycleFragment, int i2, int i8, @Nullable DialogInterface.OnCancelListener onCancelListener) {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i2, int i8, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i2, zag.zab(activity, getErrorResolutionIntent(activity, i2, "d"), i8), onCancelListener, null);
    }
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i2, int i8, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog errorDialog = getErrorDialog(activity, i2, i8, onCancelListener);
        if (errorDialog == null) {
            return false;
        }
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i2, int i8) {
        return getErrorDialog(fragment, i2, i8, (DialogInterface.OnCancelListener) null);
    }
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i2, int i8, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i2, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i2, "d"), i8), onCancelListener, null);
    }
}
