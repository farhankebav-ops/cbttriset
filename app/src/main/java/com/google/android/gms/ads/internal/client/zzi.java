...
public final class zzi extends RemoteCreator {
    ...
    @Nullable
    public final zzbt zza(Context context, String str, zzbrj zzbrjVar) {
        try {
            IBinder iBinderZze = ((zzbu) getRemoteCreatorInstance(context)).zze(ObjectWrapper.wrap(context), str, zzbrjVar, ModuleDescriptor.MODULE_VERSION);
            if (iBinderZze == null) {
                return null;
            }
