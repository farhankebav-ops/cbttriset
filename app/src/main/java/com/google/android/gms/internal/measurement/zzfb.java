...
public final class zzfb {
    ...
    public final void zzN(Exception exc, boolean z2, boolean z7) {
        zzfb zzfbVar;
        Exception exc2;
        this.zzh |= z2;
        if (z2) {
    ...
    private final void zzU(String str, String str2, Bundle bundle, boolean z2, boolean z7, Long l) {
        zzM(new zzep(this, l, str, str2, bundle, z2, z7));
    }
    ...
    public final zzcr zzc(Context context, boolean z2) {
        try {
    ...
    public final void zzf(com.google.android.gms.measurement.internal.zzjq zzjqVar) {
        ...
        synchronized (list) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                try {
                    if (zzjqVar.equals(((Pair) list.get(i2)).first)) {
