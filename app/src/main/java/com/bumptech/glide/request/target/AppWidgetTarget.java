...
public class AppWidgetTarget extends CustomTarget<Bitmap> {
    ...
    public AppWidgetTarget(Context context, int i2, int i8, int i9, RemoteViews remoteViews, int... iArr) {
        super(i2, i8);
        if (iArr.length == 0) {
    ...
    public AppWidgetTarget(Context context, int i2, int i8, int i9, RemoteViews remoteViews, ComponentName componentName) {
        super(i2, i8);
        this.context = (Context) Preconditions.checkNotNull(context, "Context can not be null!");
        this.remoteViews = (RemoteViews) Preconditions.checkNotNull(remoteViews, "RemoteViews object can not be null!");
