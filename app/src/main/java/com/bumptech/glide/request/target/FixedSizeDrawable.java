...
public class FixedSizeDrawable extends Drawable {
    ...
    public static final class State extends Drawable.ConstantState {
        ...
        public State(Drawable.ConstantState constantState, int i2, int i8) {
    ...
    public FixedSizeDrawable(Drawable drawable, int i2, int i8) {
        this(new State(drawable.getConstantState(), i2, i8), drawable);
    }
    ...
    public boolean setVisible(boolean z2, boolean z7) {
        return this.wrapped.setVisible(z2, z7);
    }
