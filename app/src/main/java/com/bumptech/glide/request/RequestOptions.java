...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions encodeQualityOf(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG, to = 100) int i2) {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions frameOf(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) long j) {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions overrideOf(int i2, int i8) {
        return new RequestOptions().override(i2, i8);
    }
    ...
    @NonNull
    @CheckResult
    public static RequestOptions timeoutOf(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
