...
public abstract class BitmapContainerTransitionFactory<R> implements TransitionFactory<R> {
    ...
    public final class BitmapGlideAnimation implements Transition<R> {
        ...
        public boolean transition(R r7, Transition.ViewAdapter viewAdapter) {
            return this.transition.transition(new BitmapDrawable(viewAdapter.getView().getResources(), BitmapContainerTransitionFactory.this.getBitmap(r7)), viewAdapter);
        }
    }
    ...
    public abstract Bitmap getBitmap(R r7);
}
