...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
    ...
    public static final class SizeDeterminer {
        ...
        private int getTargetDimen(int i2, int i8, int i9) {
            int i10 = i8 - i9;
            if (i10 > 0) {
                return i10;
            }
            ...
            if (this.view.isLayoutRequested() || i8 != -2) {
                return 0;
            }
        ...
        private boolean isViewStateAndSizeValid(int i2, int i8) {
            return isDimensionValid(i2) && isDimensionValid(i8);
        }

        private void notifyCbs(int i2, int i8) {
            ...
            while (i9 < size) {
                ...
                i9++;
                ((SizeReadyCallback) obj).onSizeReady(i2, i8);
            }
        }
    ...
    @Deprecated
    public ViewTarget(@NonNull T t3, boolean z2) {
        this(t3);
        if (z2) {
            waitForLayout();
        }
