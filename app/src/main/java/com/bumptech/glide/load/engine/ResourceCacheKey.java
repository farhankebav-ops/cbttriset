...
final class ResourceCacheKey implements Key {
    ...
    public ResourceCacheKey(ArrayPool arrayPool, Key key, Key key2, int i2, int i8, Transformation<?> transformation, Class<?> cls, Options options) {
    ...
    public int hashCode() {
        ...
        return this.options.hashCode() + ((this.decodedResourceClass.hashCode() + (iHashCode * 31)) * 31);
    }
