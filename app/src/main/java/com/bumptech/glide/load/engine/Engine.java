...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    public static class DecodeJobFactory {
        ...
        public <R> DecodeJob<R> build(GlideContext glideContext, Object obj, EngineKey engineKey, Key key, int i2, int i8, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z2, boolean z7, boolean z8, Options options, DecodeJob.Callback<R> callback) {
            ...
            return decodeJob.init(glideContext, obj, engineKey, key, i2, i8, cls, cls2, priority, diskCacheStrategy, map, z2, z7, z8, options, callback, i9);
        }
    }
    ...
    public static class EngineJobFactory {
        ...
        public <R> EngineJob<R> build(Key key, boolean z2, boolean z7, boolean z8, boolean z9) {
            return ((EngineJob) Preconditions.checkNotNull(this.pool.acquire())).init(key, z2, z7, z8, z9);
        }
    ...
    private static void logWithTimeAndKey(String str, long j, Key key) {
        StringBuilder sbX = a.x(str, " in ");
        sbX.append(LogTime.getElapsedMillis(j));
        sbX.append("ms, key: ");
        sbX.append(key);
        Log.v(TAG, sbX.toString());
    }

    private <R> LoadStatus waitForExistingOrStartNewJob(GlideContext glideContext, Object obj, Key key, int i2, int i8, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z2, boolean z7, Options options, boolean z8, boolean z9, boolean z10, boolean z11, ResourceCallback resourceCallback, Executor executor, EngineKey engineKey, long j) {
        EngineJob<?> engineJob = this.jobs.get(engineKey, z11);
        if (engineJob != null) {
        ...
        EngineJob<R> engineJobBuild = this.engineJobFactory.build(engineKey, z8, z9, z10, z11);
        DecodeJob<R> decodeJobBuild = this.decodeJobFactory.build(glideContext, obj, engineKey, key, i2, i8, cls, cls2, priority, diskCacheStrategy, map, z2, z7, z11, options, engineJobBuild);
    ...
    public <R> LoadStatus load(GlideContext glideContext, Object obj, Key key, int i2, int i8, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z2, boolean z7, Options options, boolean z8, boolean z9, boolean z10, boolean z11, ResourceCallback resourceCallback, Executor executor) {
        long logTime = VERBOSE_IS_LOGGABLE ? LogTime.getLogTime() : 0L;
        EngineKey engineKeyBuildKey = this.keyFactory.buildKey(obj, key, i2, i8, map, cls, cls2, options);
        synchronized (this) {
            try {
                EngineResource<?> engineResourceLoadFromMemory = loadFromMemory(engineKeyBuildKey, z8, logTime);
                if (engineResourceLoadFromMemory == null) {
                    return waitForExistingOrStartNewJob(glideContext, obj, key, i2, i8, cls, cls2, priority, diskCacheStrategy, map, z2, z7, options, z8, z9, z10, z11, resourceCallback, executor, engineKeyBuildKey, logTime);
                }
