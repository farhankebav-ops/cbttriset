...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    public static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        public QMediaStoreUriFetcher(Context context, ModelLoader<File, DataT> modelLoader, ModelLoader<Uri, DataT> modelLoader2, Uri uri, int i2, int i8, Options options, Class<DataT> cls) {
    ...
    public ModelLoader.LoadData<DataT> buildLoadData(@NonNull Uri uri, int i2, int i8, @NonNull Options options) {
        return new ModelLoader.LoadData<>(new ObjectKey(uri), new QMediaStoreUriFetcher(this.context, this.fileDelegate, this.uriDelegate, uri, i2, i8, options, this.dataClass));
    }
