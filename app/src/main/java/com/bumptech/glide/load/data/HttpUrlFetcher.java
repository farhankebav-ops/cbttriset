    ...
    private InputStream loadDataWithRedirects(URL url, int i2, URL url2, Map<String, String> map) throws HttpException {
        ...
        try {
            ...
            try {
                ...
                throw new HttpException(a.l("Bad redirect url: ", headerField), httpStatusCodeOrInvalid, e4);
            }
        } catch (IOException e8) {
            throw new HttpException("Failed to connect or obtain data", getHttpStatusCodeOrInvalid(this.urlConnection), e8);
        }
    }
