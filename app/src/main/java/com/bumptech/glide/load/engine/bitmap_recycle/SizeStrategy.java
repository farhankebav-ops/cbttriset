...
final class SizeStrategy implements LruPoolStrategy {
    ...
    public Bitmap get(int i2, int i8, Bitmap.Config config) {
        int bitmapByteSize = Util.getBitmapByteSize(i2, i8, config);
    ...
    public String logBitmap(int i2, int i8, Bitmap.Config config) {
        return getBitmapString(Util.getBitmapByteSize(i2, i8, config));
    }

    public static String getBitmapString(int i2) {
        return a.h(i2, C2300e4.i.f8403d, C2300e4.i.e);
    }
}
