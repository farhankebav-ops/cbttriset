...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    private void decodeFromRetrievedData() {
        ...
        if (this.experiments.isEnabled(GlideBuilder.OverrideGlideThreadPriority.class) && (supplier = this.glideThreadPriorityOverride) != null && supplier.get() != null) {
            try {
                Process.setThreadPriority(Process.myTid(), ((Integer) this.glideThreadPriorityOverride.get()).intValue());
    ...
    public DecodeJob<R> init(GlideContext glideContext, Object obj, EngineKey engineKey, Key key, int i2, int i8, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z2, boolean z7, boolean z8, Options options, Callback<R> callback, int i9) {
        this.decodeHelper.init(glideContext, obj, key, i2, i8, diskCacheStrategy, cls, cls2, priority, options, map, z2, z7, this.diskCacheProvider);
        ...
        this.glideThreadPriorityOverride = a.k(options.get(GLIDE_THREAD_PRIORITY_OVERRIDE));
        return this;
    }
    ...
    private void logWithTimeAndKey(String str, long j, String str2) {
        StringBuilder sbX = a1.a.x(str, " in ");
        sbX.append(LogTime.getElapsedMillis(j));
        sbX.append(", load key: ");
        sbX.append(this.loadKey);
