...
final class DrawableToBitmapConverter {
    ...
    @Nullable
    public static Resource<Bitmap> convert(BitmapPool bitmapPool, Drawable drawable, int i2, int i8) {
        ...
        if (current instanceof BitmapDrawable) {
            ...
            bitmapDrawToBitmap = drawToBitmap(bitmapPool, current, i2, i8);
            z2 = true;
        }
        if (!z2) {
    ...
    @Nullable
    private static Bitmap drawToBitmap(BitmapPool bitmapPool, Drawable drawable, int i2, int i8) {
        ...
        Bitmap bitmap = bitmapPool.get(i2, i8, Bitmap.Config.ARGB_8888);
        try {
