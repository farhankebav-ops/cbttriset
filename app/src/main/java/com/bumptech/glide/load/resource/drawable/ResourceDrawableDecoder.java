...
public class ResourceDrawableDecoder implements ResourceDecoder<Uri, Drawable> {
    ...
    private Context findContextForPackage(Uri uri, @NonNull String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(a.k("Failed to obtain context or unrecognized Uri format for: ", uri), e);
        }
    }
    ...
    private int findResourceIdFromResourceIdUri(Uri uri) {
        try {
            ...
            throw new IllegalArgumentException(a.k("Unrecognized Uri format: ", uri), e);
        }
    }
    ...
    private int findResourceIdFromTypeAndNameResourceUri(Context context, Uri uri) {
        ...
        throw new IllegalArgumentException(a.k("Failed to find resource id for: ", uri));
    }
    ...
    @Nullable
    public Resource<Drawable> decode(@NonNull Uri uri, int i2, int i8, @NonNull Options options) {
        String authority = uri.getAuthority();
