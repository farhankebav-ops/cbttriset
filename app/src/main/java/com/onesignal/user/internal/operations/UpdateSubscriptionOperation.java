...
public final class UpdateSubscriptionOperation extends Operation {
    ...
    public UpdateSubscriptionOperation(String appId, String onesignalId, String subscriptionId, SubscriptionType type, boolean z2, String address, SubscriptionStatus status) {
        this();
        k.e(appId, "appId");
