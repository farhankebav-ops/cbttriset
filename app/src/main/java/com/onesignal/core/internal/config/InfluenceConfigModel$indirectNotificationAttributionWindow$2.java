...
public final class InfluenceConfigModel$indirectNotificationAttributionWindow$2 extends l implements a {
    ...
    public InfluenceConfigModel$indirectNotificationAttributionWindow$2() {
        super(0);
    }
