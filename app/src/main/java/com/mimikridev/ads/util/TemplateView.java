...
public class TemplateView extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attributeSet) {
        ...
        try {
            this.templateType = typedArrayObtainStyledAttributes.getResourceId(R.styleable.TemplateView_gnt_template_type, R.layout.gnt_admob_medium_template_view);
    ...
    @RequiresApi(api = 21)
    public TemplateView(Context context, AttributeSet attributeSet, int i2, int i8) {
