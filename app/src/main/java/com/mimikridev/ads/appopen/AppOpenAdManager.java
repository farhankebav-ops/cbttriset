...
public class AppOpenAdManager {
    ...
    public void loadAd(Context context, String str) {
        ...
        com.google.android.gms.ads.appopen.AppOpenAd.load(context, str, new AdManagerAdRequest.Builder().build(), new AppOpenAd.AppOpenAdLoadCallback() { // from class: com.mimikridev.ads.appopen.AppOpenAdManager.1
    ...
    public void showAdIfAvailable(@NonNull Activity activity, String str) {
        showAdIfAvailable(activity, str, new b(0));
    }
    ...
    public void showAdIfAvailable(@NonNull final Activity activity, final String str, @NonNull final OnShowAdCompleteListener onShowAdCompleteListener) {
        ...
        if (!isAdAvailable()) {
            ...
            this.appOpenAd.setFullScreenContentCallback(new FullScreenContentCallback() { // from class: com.mimikridev.ads.appopen.AppOpenAdManager.2
                ...
                public void onAdDismissedFullScreenContent() {
                    ...
                    onShowAdCompleteListener.onShowAdComplete();
                    AppOpenAdManager.this.loadAd(activity, str);
                }
