...
public final class NativeAd$registerViewForInteraction$$inlined$inject$1 extends l implements e6.a {
    final /* synthetic */ Context $context;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NativeAd$registerViewForInteraction$$inlined$inject$1(Context context) {
        super(0);
