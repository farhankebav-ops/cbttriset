...
public final class WebViewRenderProcessUnresponsive extends VungleError {
    ...
    public /* synthetic */ WebViewRenderProcessUnresponsive(String str, int i2, f fVar) {
        this((i2 & 1) != 0 ? null : str);
    }

    public WebViewRenderProcessUnresponsive(String str) {
        super(Sdk.SDKError.Reason.WEBVIEW_ERROR, a1.a.l("WebRenderProcessUnresponsive: ", str), null);
    }
}
