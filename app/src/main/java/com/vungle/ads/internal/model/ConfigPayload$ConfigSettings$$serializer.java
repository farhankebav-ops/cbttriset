...
public final class ConfigPayload$ConfigSettings$$serializer implements e0 {
    ...
    public ConfigPayload.ConfigSettings deserialize(e decoder) {
        ...
        if (cVarBeginStructure.decodeSequentially()) {
            objDecodeNullableSerializableElement = cVarBeginStructure.decodeNullableSerializableElement(descriptor2, 0, q0.f11499a, null);
        } else {
            boolean z2 = true;
            int i8 = 0;
            ...
            while (z2) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement = cVarBeginStructure.decodeNullableSerializableElement(descriptor2, 0, q0.f11499a, objDecodeNullableSerializableElement);
                    i8 = 1;
                }
            }
            i2 = i8;
        ...
        return new ConfigPayload.ConfigSettings(i2, (Long) objDecodeNullableSerializableElement, m1Var);
    }
    ...
    public void serialize(f encoder, ConfigPayload.ConfigSettings value) {
        ...
        ConfigPayload.ConfigSettings.write$Self(value, dVarBeginStructure, descriptor2);
