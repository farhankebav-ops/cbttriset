...
public final class CommonRequestBody$RequestExt$$serializer implements e0 {
    ...
    static {
        ...
        e1 e1Var = new e1("com.vungle.ads.internal.model.CommonRequestBody.RequestExt", commonRequestBody$RequestExt$$serializer, 3);
    ...
    public c[] childSerializers() {
        q1 q1Var = q1.f11501a;
        return new c[]{q.Y(q1Var), q.Y(q1Var), q.Y(q0.f11499a)};
    }
    ...
    public CommonRequestBody.RequestExt deserialize(e decoder) {
        ...
        if (cVarBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement2 = cVarBeginStructure.decodeNullableSerializableElement(descriptor2, 2, q0.f11499a, null);
            ...
            while (z2) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement6 = cVarBeginStructure.decodeNullableSerializableElement(descriptor2, 2, q0.f11499a, objDecodeNullableSerializableElement6);
                    i8 |= 4;
                }
            }
            i2 = i8;
        ...
        return new CommonRequestBody.RequestExt(i2, (String) objDecodeNullableSerializableElement3, (String) objDecodeNullableSerializableElement, (Long) objDecodeNullableSerializableElement2, (m1) null);
    }
    ...
    public void serialize(f encoder, CommonRequestBody.RequestExt value) {
        ...
        CommonRequestBody.RequestExt.write$Self(value, dVarBeginStructure, descriptor2);
