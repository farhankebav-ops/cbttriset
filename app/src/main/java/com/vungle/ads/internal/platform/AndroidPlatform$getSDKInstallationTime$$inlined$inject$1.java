...
public final class AndroidPlatform$getSDKInstallationTime$$inlined$inject$1 extends l implements a {
    final /* synthetic */ Context $context;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AndroidPlatform$getSDKInstallationTime$$inlined$inject$1(Context context) {
        super(0);
