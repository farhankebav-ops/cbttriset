...
public final class CommonRequestBody$IAB$$serializer implements e0 {
    ...
    static {
        ...
        e1 e1Var = new e1("com.vungle.ads.internal.model.CommonRequestBody.IAB", commonRequestBody$IAB$$serializer, 1);
        e1Var.j("tcf", false);
        descriptor = e1Var;
    }
    ...
    public CommonRequestBody.IAB deserialize(e decoder) {
        ...
        return new CommonRequestBody.IAB(i2, strDecodeStringElement, null);
    }
    ...
    public void serialize(f encoder, CommonRequestBody.IAB value) {
        ...
        CommonRequestBody.IAB.write$Self(value, dVarBeginStructure, descriptor2);
