...
public final class ConfigPayload$LogMetricsSettings$$serializer implements e0 {
    ...
    static {
        ...
        e1Var.j("error_log_level", true);
        e1Var.j("metrics_is_enabled", true);
        descriptor = e1Var;
    }
    ...
    public c[] childSerializers() {
        return new c[]{q.Y(l0.f11478a), q.Y(f7.g.f11455a)};
    }
    ...
    public ConfigPayload.LogMetricsSettings deserialize(e decoder) {
        ...
        if (cVarBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement2 = cVarBeginStructure.decodeNullableSerializableElement(descriptor2, 1, f7.g.f11455a, null);
            i2 = 3;
        } else {
            boolean z2 = true;
            int i8 = 0;
            ...
            while (z2) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement3 = cVarBeginStructure.decodeNullableSerializableElement(descriptor2, 1, f7.g.f11455a, objDecodeNullableSerializableElement3);
                    i8 |= 2;
                }
            }
        ...
        return new ConfigPayload.LogMetricsSettings(i2, (Integer) objDecodeNullableSerializableElement, (Boolean) objDecodeNullableSerializableElement2, m1Var);
    }
    ...
    @Override // b7.j
    public void serialize(f encoder, ConfigPayload.LogMetricsSettings value) {
        k.e(encoder, "encoder");
        k.e(value, "value");
        g descriptor2 = getDescriptor();
        d dVarBeginStructure = encoder.beginStructure(descriptor2);
        ConfigPayload.LogMetricsSettings.write$Self(value, dVarBeginStructure, descriptor2);
