...
public final class AdPayload$CacheableReplacement$$serializer implements e0 {
    ...
    static {
        ...
        e1 e1Var = new e1("com.vungle.ads.internal.model.AdPayload.CacheableReplacement", adPayload$CacheableReplacement$$serializer, 3);
        e1Var.j("url", true);
        e1Var.j("extension", true);
        e1Var.j("download_percent", true);
        descriptor = e1Var;
    }
    ...
    public AdPayload.CacheableReplacement deserialize(e decoder) {
        ...
        return new AdPayload.CacheableReplacement(i2, (String) objDecodeNullableSerializableElement3, (String) objDecodeNullableSerializableElement, (Integer) objDecodeNullableSerializableElement2, (m1) null);
    }
    ...
    public void serialize(f encoder, AdPayload.CacheableReplacement value) {
        ...
        AdPayload.CacheableReplacement.write$Self(value, dVarBeginStructure, descriptor2);
