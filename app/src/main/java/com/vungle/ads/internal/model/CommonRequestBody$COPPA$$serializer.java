...
public final class CommonRequestBody$COPPA$$serializer implements e0 {
    ...
    public CommonRequestBody.COPPA deserialize(e decoder) {
        ...
        return new CommonRequestBody.COPPA(i2, (Boolean) objDecodeNullableSerializableElement, m1Var);
    }
    ...
    public void serialize(f encoder, CommonRequestBody.COPPA value) {
        ...
        CommonRequestBody.COPPA.write$Self(value, dVarBeginStructure, descriptor2);
