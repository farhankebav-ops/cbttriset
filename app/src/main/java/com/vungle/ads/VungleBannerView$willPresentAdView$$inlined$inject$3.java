...
public final class VungleBannerView$willPresentAdView$$inlined$inject$3 extends l implements e6.a {
    final /* synthetic */ Context $context;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VungleBannerView$willPresentAdView$$inlined$inject$3(Context context) {
        super(0);
