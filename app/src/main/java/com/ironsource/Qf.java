...
public final class Qf implements Gf {
    ...
    private final Handler f7526a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private WebView f7527b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final WebView f7528c;
    ...
    public static final class a extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            if (!Qf.this.e && str != null && n6.t.n0(str, String.valueOf(this.f7532b), false)) {
                Qf qf = Qf.this;
                qf.a(qf.a("onDataReady", r2.q.j0(qf.f7529d)));
                Bf.f6395a.d();
                Qf.this.e = true;
            }
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            Bf.f6395a.a(error.toString());
            Kf.f7064a.b("got error during TestSuite web controller loading " + error);
    ...
    public static final class b implements V8 {
        ...
        public void onClosed() {
            this.f7534b.onClosed();
        }

        @Override // com.ironsource.V8
        public void onUIReady() {
            if (Qf.this.f7530f) {
                this.f7534b.onUIReady();
            } else {
                Qf.this.f7526a.postDelayed(new ch(this, 7), 500L);
            }
        }
    }

    public Qf(TestSuiteActivity activity, V8 uiLifeCycleListener, JSONObject jsonData, String str) {
        kotlin.jvm.internal.k.e(activity, "activity");
        kotlin.jvm.internal.k.e(uiLifeCycleListener, "uiLifeCycleListener");
        kotlin.jvm.internal.k.e(jsonData, "jsonData");
        this.f7526a = new Handler(activity.getMainLooper());
        this.f7527b = new WebView(activity);
        this.f7528c = new WebView(activity);
        this.f7529d = jsonData;
        a(activity, uiLifeCycleListener, str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void e(Qf this$0) {
        kotlin.jvm.internal.k.e(this$0, "this$0");
        this$0.f7530f = true;
    }
    ...
    private final void a(TestSuiteActivity testSuiteActivity, V8 v8, String str) {
        WebView webView = this.f7527b;
        WebSettings settings = webView != null ? webView.getSettings() : null;
        if (settings != null) {
            settings.setJavaScriptEnabled(true);
        }
        this.f7528c.getSettings().setJavaScriptEnabled(true);
        this.f7528c.addJavascriptInterface(new Ff(new C2678zf(testSuiteActivity, this.f7526a), new b(v8), this), "TestSuiteBridge");
        this.f7528c.setWebViewClient(new a(str));
        if (str != null && str.length() != 0) {
            this.f7528c.loadUrl(str);
        }
        WebView webView2 = this.f7527b;
        if (webView2 != null) {
        ...
        this.f7526a.postDelayed(new ch(this, 5), 2000L);
        this.f7526a.postDelayed(new ch(v8, 6), 5000L);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(V8 uiLifeCycleListener) {
        kotlin.jvm.internal.k.e(uiLifeCycleListener, "$uiLifeCycleListener");
    ...
    public void a(String callbackName, LevelPlay.AdFormat adFormat, List<? extends Object> args) {
        ...
        if (this.e) {
            a(a("onCallbackReceived", r5.m.H0(callbackName, adFormat.getValue(), args)));
        }
    }

    public final void a(String script) {
        kotlin.jvm.internal.k.e(script, "script");
        this.f7526a.post(new ti(9, this, script));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(Qf this$0, String script) {
        kotlin.jvm.internal.k.e(this$0, "this$0");
        kotlin.jvm.internal.k.e(script, "$script");
        this$0.f7528c.loadUrl("javascript:".concat(script));
    }
    ...
    public final String a(String methodName, List<? extends Object> methodArgs) {
        ...
        String strB = Pf.f7396a.b(methodArgs);
        if (strB.length() > 0) {
            return androidx.camera.core.processing.util.a.l(strConcat, "(", strB, ")");
        }
        return a1.a.C(strConcat, "()");
    }
