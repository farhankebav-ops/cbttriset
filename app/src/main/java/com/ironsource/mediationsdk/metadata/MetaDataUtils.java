...
public class MetaDataUtils {
    ...
    public static MetaData.MetaDataValueTypes getValueTypeForKey(String str) {
        return (str.equalsIgnoreCase(a.f9237a) || str.equalsIgnoreCase(a.f9238b) || str.equalsIgnoreCase(a.f9239c) || str.equalsIgnoreCase(a.f9240d)) ? MetaData.MetaDataValueTypes.META_DATA_VALUE_BOOLEAN : MetaData.MetaDataValueTypes.META_DATA_VALUE_STRING;
    }
    ...
    public static boolean isValidCCPAMetaData(String str, String str2) {
        return isValidMetaData(str, a.f9237a, str2);
    }
