...
import com.instagram.common.viewpoint.core.AbstractC1090Sv;
import com.instagram.common.viewpoint.core.C1091Sw;
import com.instagram.common.viewpoint.core.C1451cu;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
     ...
     */
    public static synchronized void A04(C1451cu c1451cu, Class<? extends Activity> cls) {
        A02 = c1451cu;
        A01 = c1451cu.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c1451cu.A08().AAy(A01(Sdk.SDKError.Reason.INVALID_BID_PAYLOAD_VALUE, 8, 61), AbstractC1090Sv.A02, new C1091Sw(A01(72, 80, 65)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c1451cu);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c1451cu.A08().AAy(A01(Sdk.SDKError.Reason.AD_RESPONSE_INVALID_TEMPLATE_TYPE_VALUE, 3, 3), AbstractC1090Sv.A0d, new C1091Sw(A01(42, 30, 126)));
        }
    }
    ...
    public static synchronized Activity A00() {
        ...
        boolean z2 = key == null || Build.VERSION.SDK_INT < 28;
        if (z2) {
            activityA00 = WA.A00();
        }
        if (A02 != null && z2 && key != activityA00) {
            C1091Sw c1091Sw = new C1091Sw(A01(19, 23, 76), A01(203, 5, 97) + key + A01(12, 7, 1) + activityA00);
            c1091Sw.A05(1);
            A02.A08().AAy(A01(Sdk.SDKError.Reason.INVALID_BID_PAYLOAD_VALUE, 8, 61), AbstractC1090Sv.A03, c1091Sw);
        }
        return key != null ? key : activityA00;
    }

    public static void A03(C1477dL c1477dL) {
        if (!U7.A1k(c1477dL) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        WC wc = new WC(c1477dL);
        synchronized (A07) {
            A07.add(wc);
        }
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C1091Sw c1091Sw = new C1091Sw(A01(172, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c1091Sw.A05(0);
            A02.A08().AAy(A01(Sdk.SDKError.Reason.INVALID_BID_PAYLOAD_VALUE, 8, 61), AbstractC1090Sv.A03, c1091Sw);
        }
        A08.put(activity, 4);
