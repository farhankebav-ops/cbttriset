...
public final class ChapterTocFrame extends Id3Frame {
    ...
    public ChapterTocFrame(Parcel parcel) {
        ...
        this.A03 = (String[]) AbstractC04664a.A0f(parcel.createStringArray());
        int i2 = parcel.readInt();
        this.A04 = new Id3Frame[i2];
        for (int i8 = 0; i8 < i2; i8++) {
            this.A04[i8] = (Id3Frame) parcel.readParcelable(Id3Frame.class.getClassLoader());
        }
    }

    public ChapterTocFrame(String str, boolean z2, boolean z7, String[] strArr, Id3Frame[] id3FrameArr) {
        super(A00(0, 4, 110));
        this.A00 = str;
        this.A02 = z2;
        this.A01 = z7;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            ...
            if (cls == obj.getClass()) {
                ...
                if (this.A02 == chapterTocFrame.A02 && this.A01 == chapterTocFrame.A01 && AbstractC04664a.A1E(this.A00, chapterTocFrame.A00) && Arrays.equals(this.A03, chapterTocFrame.A03) && Arrays.equals(this.A04, chapterTocFrame.A04)) {
                    return true;
                }
                return false;
            }
