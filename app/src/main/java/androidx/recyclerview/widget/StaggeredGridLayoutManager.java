...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromEnd(int i2) {
        ...
        for (int i8 = 0; i8 < this.mSpanCount; i8++) {
            fullSpanItem.mGapPerSpan[i8] = i2 - this.mSpans[i8].getEndLine(i2);
        }
        return fullSpanItem;
    }
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromStart(int i2) {
        ...
        fullSpanItem.mGapPerSpan = new int[this.mSpanCount];
        for (int i8 = 0; i8 < this.mSpanCount; i8++) {
            fullSpanItem.mGapPerSpan[i8] = this.mSpans[i8].getStartLine(i2) - i2;
        }
        return fullSpanItem;
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        int i2 = staggeredGridLayoutManager.mLayoutState.mInfinite ? layoutState.mLayoutDirection == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : layoutState.mLayoutDirection == 1 ? layoutState.mEndLine + layoutState.mAvailable : layoutState.mStartLine - layoutState.mAvailable;
        ...
        while (layoutState.hasMore(state) && (r03.mLayoutState.mInfinite || !r03.mRemainingSpans.isEmpty())) {
            ...
            int i8 = decoratedMeasurement2;
            int i9 = startAfterPadding;
            if (r03.mOrientation == 1) {
                r03.layoutDecoratedWithMargins(next, i9, decoratedMeasurement, i8, minStart);
                r02 = this;
            } else {
                r03.layoutDecoratedWithMargins(next, decoratedMeasurement, i9, minStart, i8);
                r02 = r03;
            }
            if (layoutParams.mFullSpan) {
                r02.updateAllRemainingSpans(r02.mLayoutState.mLayoutDirection, i2);
            } else {
                r02.updateRemainingSpans(span2, r02.mLayoutState.mLayoutDirection, i2);
            }
    ...
    private int getMaxEnd(int i2) {
        ...
        for (int i8 = 1; i8 < this.mSpanCount; i8++) {
            int endLine2 = this.mSpans[i8].getEndLine(i2);
            if (endLine2 > endLine) {
                endLine = endLine2;
            }
        }
    ...
    private int getMaxStart(int i2) {
        ...
        for (int i8 = 1; i8 < this.mSpanCount; i8++) {
            int startLine2 = this.mSpans[i8].getStartLine(i2);
    ...
    */
    ...
    private void updateAllRemainingSpans(int i2, int i8) {
        for (int i9 = 0; i9 < this.mSpanCount; i9++) {
            if (!this.mSpans[i9].mViews.isEmpty()) {
                updateRemainingSpans(this.mSpans[i9], i2, i8);
            }
        }
    }
    ...
    private void updateRemainingSpans(Span span, int i2, int i8) {
    ...
    private int updateSpecWithExtra(int i2, int i8, int i9) {
        int mode;
    ...
    public boolean checkForGaps() {
        ...
        LazySpanLookup.FullSpanItem firstFullSpanItemInRange = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, i8, i2, true);
    ...
    */
    ...
    public class Span {
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int i2, int i8, boolean z2, boolean z7, boolean z8) {
        ...
        public int findOnePartiallyVisibleChild(int i2, int i8, boolean z2) {
            return findOnePartiallyOrCompletelyVisibleChild(i2, i8, false, false, z2);
        }

        public int findOneVisibleChild(int i2, int i8, boolean z2) {
            return findOnePartiallyOrCompletelyVisibleChild(i2, i8, z2, true, false);
        }
        ...
        public View getFocusableViewAfter(int i2, int i8) {
            View view = null;
            if (i8 != -1) {
        ...
        public void onOffset(int i2) {
            int i8 = this.mCachedStart;
            if (i8 != Integer.MIN_VALUE) {
                this.mCachedStart = i8 + i2;
            }
            int i9 = this.mCachedEnd;
            if (i9 != Integer.MIN_VALUE) {
                this.mCachedEnd = i9 + i2;
            }
        }
    ...
    public static class LazySpanLookup {
        ...
        private int invalidateFullSpansAfter(int i2) {
            ...
            while (true) {
                ...
                if (this.mFullSpanItems.get(i8).mPosition >= i2) {
                    break;
                }
                i8++;
            }
        ...
        private void offsetFullSpansForAddition(int i2, int i8) {
        ...
        private void offsetFullSpansForRemoval(int i2, int i8) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return;
            }
        ...
        public FullSpanItem getFirstFullSpanItemInRange(int i2, int i8, int i9, boolean z2) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return null;
            }
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (i11 >= i2 && (i9 == 0 || fullSpanItem.mGapDir == i9 || (z2 && fullSpanItem.mHasUnwantedGapAfter))) {
                    return fullSpanItem;
                }
            }
            return null;
        ...
        public void offsetForAddition(int i2, int i8) {
            int[] iArr = this.mData;
            if (iArr == null || i2 >= iArr.length) {
                return;
            }
            ...
            ensureSize(i9);
            int[] iArr2 = this.mData;
            System.arraycopy(iArr2, i2, iArr2, i9, (iArr2.length - i2) - i8);
            Arrays.fill(this.mData, i2, i9, -1);
            offsetFullSpansForAddition(i2, i8);
        }

        public void offsetForRemoval(int i2, int i8) {
            int[] iArr = this.mData;
            if (iArr == null || i2 >= iArr.length) {
                return;
            }
            ...
            ensureSize(i9);
            int[] iArr2 = this.mData;
            System.arraycopy(iArr2, i9, iArr2, i2, (iArr2.length - i2) - i8);
            int[] iArr3 = this.mData;
            Arrays.fill(iArr3, iArr3.length - i8, iArr3.length, -1);
            offsetFullSpansForRemoval(i2, i8);
        }
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i2, int i8, boolean z2) {
        ...
        int iUpdateSpecWithExtra = updateSpecWithExtra(i2, i9 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
