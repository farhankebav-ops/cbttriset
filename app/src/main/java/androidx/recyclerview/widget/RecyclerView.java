...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void notifyItemMoved(int i2, int i8) {
            this.mObservable.notifyItemMoved(i2, i8);
        }

        public final void notifyItemRangeChanged(int i2, int i8) {
            this.mObservable.notifyItemRangeChanged(i2, i8);
        }

        public final void notifyItemRangeInserted(int i2, int i8) {
            this.mObservable.notifyItemRangeInserted(i2, i8);
        }

        public final void notifyItemRangeRemoved(int i2, int i8) {
            this.mObservable.notifyItemRangeRemoved(i2, i8);
        }
        ...
        public final void notifyItemRangeChanged(int i2, int i8, @Nullable Object obj) {
            this.mObservable.notifyItemRangeChanged(i2, i8, obj);
        }
    ...
    public static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyItemMoved(int i2, int i8) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeMoved(i2, i8, 1);
            }
        }

        public void notifyItemRangeChanged(int i2, int i8) {
            notifyItemRangeChanged(i2, i8, null);
        }

        public void notifyItemRangeInserted(int i2, int i8) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeInserted(i2, i8);
            }
        }

        public void notifyItemRangeRemoved(int i2, int i8) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeRemoved(i2, i8);
            }
        }
        ...
        public void notifyItemRangeChanged(int i2, int i8, @Nullable Object obj) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeChanged(i2, i8, obj);
            }
        }
    }
    ...
    public interface ChildDrawingOrderCallback {
        int onGetChildDrawingOrder(int i2, int i8);
    }
    ...
    public static abstract class LayoutManager {
        ...
        public interface LayoutPrefetchRegistry {
            void addPosition(int i2, int i8);
        }
        ...
        public static int chooseSize(int i2, int i8, int i9) {
  ...
  0x000c: PHI (r3v5 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:7:0x0010, B:11:0x0016, B:4:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i8) {
            Properties properties = new Properties();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.recyclerview.R.styleable.RecyclerView, i2, i8);
        ...
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerView recyclerView, int i2, int i8) {
            ...
            return rect.left - i2 < width && rect.right - i2 > paddingLeft && rect.top - i8 < height && rect.bottom - i8 > paddingTop;
        }

        private static boolean isMeasurementUpToDate(int i2, int i8, int i9) {
        ...
        public boolean isViewPartiallyVisible(@NonNull View view, boolean z2, boolean z7) {
        ...
        public void layoutDecorated(@NonNull View view, int i2, int i8, int i9, int i10) {
            Rect rect = ((LayoutParams) view.getLayoutParams()).mDecorInsets;
            view.layout(i2 + rect.left, i8 + rect.top, i9 - rect.right, i10 - rect.bottom);
        }

        public void layoutDecoratedWithMargins(@NonNull View view, int i2, int i8, int i9, int i10) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect rect = layoutParams.mDecorInsets;
            view.layout(i2 + rect.left + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i8 + rect.top + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, (i9 - rect.right) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, (i10 - rect.bottom) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
        }

        public void measureChild(@NonNull View view, int i2, int i8) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect itemDecorInsetsForChild = this.mRecyclerView.getItemDecorInsetsForChild(view);
            int i9 = itemDecorInsetsForChild.left + itemDecorInsetsForChild.right + i2;
        ...
        public boolean onAddFocusables(@NonNull RecyclerView recyclerView, @NonNull ArrayList<View> arrayList, int i2, int i8) {
            return false;
        }
        ...
        public void onItemsUpdated(@NonNull RecyclerView recyclerView, int i2, int i8) {
        }
        ...
        public void onMeasure(@NonNull Recycler recycler, @NonNull State state, int i2, int i8) {
            this.mRecyclerView.defaultOnMeasure(i2, i8);
        }
        ...
        public void setMeasureSpecs(int i2, int i8) {
        ...
        public void setMeasuredDimension(Rect rect, int i2, int i8) {
            setMeasuredDimension(chooseSize(i2, getPaddingRight() + getPaddingLeft() + rect.width(), getMinimumWidth()), chooseSize(i8, getPaddingBottom() + getPaddingTop() + rect.height(), getMinimumHeight()));
        }

        public void setMeasuredDimensionFromChildren(int i2, int i8) {
            int childCount = getChildCount();
            if (childCount == 0) {
                this.mRecyclerView.defaultOnMeasure(i2, i8);
                return;
            ...
            setMeasuredDimension(this.mRecyclerView.mTempRect, i2, i8);
        }
        ...
        public boolean shouldMeasureChild(View view, int i2, int i8, LayoutParams layoutParams) {
            return (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getWidth(), i2, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getHeight(), i8, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public boolean shouldReMeasureChild(View view, int i2, int i8, LayoutParams layoutParams) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getMeasuredWidth(), i2, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getMeasuredHeight(), i8, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public void onItemsUpdated(@NonNull RecyclerView recyclerView, int i2, int i8, @Nullable Object obj) {
        ...
        public boolean requestChildRectangleOnScreen(@NonNull RecyclerView recyclerView, @NonNull View view, @NonNull Rect rect, boolean z2, boolean z7) {
            ...
            if ((z7 && !isFocusedChildVisibleAfterScrolling(recyclerView, i2, i8)) || (i2 == 0 && i8 == 0)) {
                return false;
            }
            if (z2) {
                recyclerView.scrollBy(i2, i8);
            } else {
                recyclerView.smoothScrollBy(i2, i8);
            }
            return true;
        }
        ...
        */
        ...
        public void setMeasuredDimension(int i2, int i8) {
            this.mRecyclerView.setMeasuredDimension(i2, i8);
        }
        ...
        public void onItemsAdded(@NonNull RecyclerView recyclerView, int i2, int i8) {
        }

        public void onItemsRemoved(@NonNull RecyclerView recyclerView, int i2, int i8) {
        }

        public void collectAdjacentPrefetchPositions(int i2, int i8, State state, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        }

        public void onItemsMoved(@NonNull RecyclerView recyclerView, int i2, int i8, int i9) {
        }
    }
    ...
    public static abstract class OnFlingListener {
        public abstract boolean onFling(int i2, int i8);
    }
    ...
    public static class RecycledViewPool {
        ...
        public long runningAverage(long j, long j3) {
            if (j == 0) {
                return j3;
            }
            return (j3 / 4) + ((j / 4) * 3);
        ...
        public void setMaxRecycledViews(int i2, int i8) {
            ScrapData scrapDataForType = getScrapDataForType(i2);
        ...
        public boolean willBindInTime(int i2, long j, long j3) {
            long j8 = getScrapDataForType(i2).mBindRunningAverageNs;
            return j8 == 0 || j + j8 < j3;
        }

        public boolean willCreateInTime(int i2, long j, long j3) {
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(@NonNull ViewHolder viewHolder, int i2, int i8, long j) {
        ...
        public void bindViewToPosition(@NonNull View view, int i2) {
            ...
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(a.h(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
            ...
            if (iFindPositionOffset < 0 || iFindPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                StringBuilder sbW = a1.a.w(i2, "Inconsistency detected. Invalid item position ", "(offset:", iFindPositionOffset, ").state:");
                sbW.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(a.h(RecyclerView.this, sbW));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i2) {
            ...
            StringBuilder sbV = a1.a.v(i2, "invalid position ", ". State item count is ");
            sbV.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(a.h(RecyclerView.this, sbV));
        }
        ...
        public void offsetPositionRecordsForInsert(int i2, int i8) {
            int size = this.mCachedViews.size();
            for (int i9 = 0; i9 < size; i9++) {
        ...
        public void offsetPositionRecordsForMove(int i2, int i8) {
            int i9;
            int i10;
            int i11;
            int i12;
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (viewHolder != null && (i12 = viewHolder.mPosition) >= i11 && i12 <= i10) {
                    if (i12 == i2) {
                        viewHolder.offsetPosition(i8 - i2, false);
                    } else {
        ...
        public void offsetPositionRecordsForRemove(int i2, int i8, boolean z2) {
            int i9 = i2 + i8;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ...
                if (viewHolder != null) {
                    ...
                    if (i10 >= i9) {
                        viewHolder.offsetPosition(-i8, z2);
                    } else if (i10 >= i2) {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isTmpDetached()) {
                ...
                throw new IllegalArgumentException(a.h(RecyclerView.this, sb2));
            }
            if (viewHolder.shouldIgnore()) {
                throw new IllegalArgumentException(a.h(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(a.h(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        */
        ...
        public void viewRangeUpdate(int i2, int i8) {
            int i9;
            int i10 = i8 + i2;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
                if (viewHolder != null && (i9 = viewHolder.mPosition) >= i2 && i9 < i10) {
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onItemRangeChanged(int i2, int i8, Object obj) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeChanged(i2, i8, obj)) {
        ...
        public void onItemRangeInserted(int i2, int i8) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeInserted(i2, i8)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int i2, int i8, int i9) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeMoved(i2, i8, i9)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int i2, int i8) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeRemoved(i2, i8)) {
                triggerUpdateProcessor();
            }
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@Px int i2, @Px int i8) {
                this(i2, i8, Integer.MIN_VALUE, null);
            }
            ...
            public void update(@Px int i2, @Px int i8, int i9, @Nullable Interpolator interpolator) {
                this.mDx = i2;
                this.mDy = i8;
                this.mDuration = i9;
                this.mInterpolator = interpolator;
            ...
            public Action(@Px int i2, @Px int i8, int i9) {
                this(i2, i8, i9, null);
            }

            public Action(@Px int i2, @Px int i8, int i9, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i2;
        ...
        public void normalize(@NonNull PointF pointF) {
            float f4 = pointF.x;
            float f8 = pointF.y;
            float fSqrt = (float) Math.sqrt((f8 * f8) + (f4 * f4));
            pointF.x /= fSqrt;
            pointF.y /= fSqrt;
        }

        public void onAnimation(int i2, int i8) {
            ...
            if (this.mRunning) {
                onSeekTargetStep(i2, i8, recyclerView.mState, this.mRecyclingAction);
        ...
        public abstract void onSeekTargetStep(@Px int i2, @Px int i8, @NonNull State state, @NonNull Action action);
    ...
    public static class State {
        ...
        public String toString() {
            ...
            return a1.a.t(sb, this.mRunPredictiveAnimations, '}');
        }
    ...
    public static abstract class ViewCacheExtension {
        @Nullable
        public abstract View getViewForPositionAndType(@NonNull Recycler recycler, int i2, int i8);
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i2, int i8) {
        ...
        public void fling(int i2, int i8) {
            ...
            this.mOverScroller.fling(0, 0, i2, i8, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i2, i8, i13, i14, null, 1, iArr5);
                RecyclerView recyclerView6 = RecyclerView.this;
                int[] iArr6 = recyclerView6.mReusableIntPair;
                int i15 = i13 - iArr6[0];
                int i16 = i14 - iArr6[1];
                if (i2 != 0 || i8 != 0) {
                    recyclerView6.dispatchOnScrolled(i2, i8);
                }
                ...
                if ((smoothScroller2 == null || !smoothScroller2.isPendingInitialRun()) && z2) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i2, i8);
                    }
                }
            }
        ...
        public void smoothScrollBy(int i2, int i8, int i9, @Nullable Interpolator interpolator) {
            if (i9 == Integer.MIN_VALUE) {
                i9 = computeScrollDuration(i2, i8);
            }
            int i10 = i9;
            ...
            this.mLastFlingX = 0;
            RecyclerView.this.setScrollState(2);
            this.mOverScroller.startScroll(0, 0, i2, i8, i10);
            postOnAnimation();
        }
    ...
    public static abstract class ViewHolder {
        ...
        public void flagRemovedAndOffsetPosition(int i2, int i8, boolean z2) {
            addFlags(8);
            offsetPosition(i8, z2);
            this.mPosition = i2;
        }
        ...
        public void setFlags(int i2, int i8) {
            this.mFlags = (i2 & i8) | (this.mFlags & (~i8));
        }
        ...
        public String toString() {
            StringBuilder sbX = a1.a.x(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
    ...
    private void animateChange(@NonNull ViewHolder viewHolder, @NonNull ViewHolder viewHolder2, @NonNull ItemAnimator.ItemHolderInfo itemHolderInfo, @NonNull ItemAnimator.ItemHolderInfo itemHolderInfo2, boolean z2, boolean z7) {
    ...
    private void createLayoutManager(Context context, String str, AttributeSet attributeSet, int i2, int i8) {
        Object[] objArr;
        ...
        if (str != null) {
            ...
            try {
                ...
                try {
                    ...
                    objArr = new Object[]{context, attributeSet, Integer.valueOf(i2), Integer.valueOf(i8)};
    ...
    private boolean didChildRangeChange(int i2, int i8) {
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        int[] iArr = this.mMinMaxLayoutPositions;
        return (iArr[0] == i2 && iArr[1] == i8) ? false : true;
    }
    ...
    private void nestedScrollByInternal(int i2, int i8, @Nullable MotionEvent motionEvent, int i9) {
        ...
        startNestedScroll(zCanScrollVertically ? (zCanScrollHorizontally ? 1 : 0) | 2 : zCanScrollHorizontally ? 1 : 0, i9);
        if (dispatchNestedPreScroll(zCanScrollHorizontally ? i2 : 0, zCanScrollVertically ? i8 : 0, this.mReusableIntPair, this.mScrollOffset, i9)) {
            int[] iArr2 = this.mReusableIntPair;
            i2 -= iArr2[0];
            i8 -= iArr2[1];
        }
        scrollByInternal(zCanScrollHorizontally ? i2 : 0, zCanScrollVertically ? i8 : 0, motionEvent, i9);
        GapWorker gapWorker = this.mGapWorker;
        if (gapWorker != null && (i2 != 0 || i8 != 0)) {
            gapWorker.postFromTraversal(this, i2, i8);
        }
        stopNestedScroll(i9);
    }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.mRunSimpleAnimations = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z2 = this.mDataSetHasChangedAfterLayout) || z7 || this.mLayout.mRequestedSimpleAnimations) && (!z2 || this.mAdapter.hasStableIds());
        State state = this.mState;
    ...
    */
    ...
    private void setAdapterInternal(@Nullable Adapter adapter, boolean z2, boolean z7) {
    ...
    public void absorbGlows(int i2, int i8) {
        if (i2 < 0) {
            ensureLeftGlow();
    ...
    public void addFocusables(ArrayList<View> arrayList, int i2, int i8) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null || !layoutManager.onAddFocusables(this, arrayList, i2, i8)) {
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(a.h(this, a.r(str)));
        }
    ...
    public void considerReleasingGlowsOnScroll(int i2, int i8) {
        boolean zIsFinished;
        EdgeEffect edgeEffect = this.mLeftGlow;
    ...
    public void defaultOnMeasure(int i2, int i8) {
        setMeasuredDimension(LayoutManager.chooseSize(i2, getPaddingRight() + getPaddingLeft(), ViewCompat.getMinimumWidth(this)), LayoutManager.chooseSize(i8, getPaddingBottom() + getPaddingTop(), ViewCompat.getMinimumHeight(this)));
    }
    ...
    public boolean dispatchNestedFling(float f4, float f8, boolean z2) {
        return getScrollingChildHelper().dispatchNestedFling(f4, f8, z2);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedPreFling(float f4, float f8) {
        return getScrollingChildHelper().dispatchNestedPreFling(f4, f8);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedPreScroll(int i2, int i8, int[] iArr, int[] iArr2) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i2, i8, iArr, iArr2);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedScroll(int i2, int i8, int i9, int i10, int[] iArr) {
        return getScrollingChildHelper().dispatchNestedScroll(i2, i8, i9, i10, iArr);
    }
    ...
    public void dispatchOnScrolled(int i2, int i8) {
        ...
        OnScrollListener onScrollListener = this.mScrollListener;
        if (onScrollListener != null) {
            onScrollListener.onScrolled(this, i2, i8);
        }
        List<OnScrollListener> list = this.mScrollListeners;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.mScrollListeners.get(size).onScrolled(this, i2, i8);
            }
        }
        this.mDispatchScrollCounter--;
    }
    ...
    public View findChildViewUnder(float f4, float f8) {
        for (int childCount = this.mChildHelper.getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (f4 >= childAt.getLeft() + translationX && f4 <= childAt.getRight() + translationX && f8 >= childAt.getTop() + translationY && f8 <= childAt.getBottom() + translationY) {
                return childAt;
            }
        }
        return null;
    ...
    public boolean fling(int i2, int i8) {
        ...
        float f4 = i2;
        float f8 = i8;
        if (!dispatchNestedPreFling(f4, f8)) {
            boolean z2 = iCanScrollHorizontally != 0 || zCanScrollVertically;
            dispatchNestedFling(f4, f8, z2);
            OnFlingListener onFlingListener = this.mOnFlingListener;
            if (onFlingListener != null && onFlingListener.onFling(i2, i8)) {
                return true;
            }
            if (z2) {
                ...
                int iMax = Math.max(-i9, Math.min(i2, i9));
    ...
    public View focusSearch(View view, int i2) {
        ...
        if (z7 && (i2 == 2 || i2 == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i8 = i2 == 2 ? Sdk.SDKError.Reason.MRAID_DOWNLOAD_JS_ERROR_VALUE : 33;
            ...
            if (!z2 && this.mLayout.canScrollHorizontally()) {
                int i9 = (this.mLayout.getLayoutDirection() == 1) ^ (i2 == 2) ? 66 : 17;
    ...
    public int getChildDrawingOrder(int i2, int i8) {
        ...
        return childDrawingOrderCallback == null ? super.getChildDrawingOrder(i2, i8) : childDrawingOrderCallback.onGetChildDrawingOrder(i2, i8);
    }
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.6
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void markViewHoldersUpdated(int i2, int i8, Object obj) {
                RecyclerView.this.viewRangeUpdate(i2, i8, obj);
                RecyclerView.this.mItemsChanged = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForAdd(int i2, int i8) {
                RecyclerView.this.offsetPositionRecordsForInsert(i2, i8);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForMove(int i2, int i8) {
                RecyclerView.this.offsetPositionRecordsForMove(i2, i8);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingInvisible(int i2, int i8) {
                RecyclerView.this.offsetPositionRecordsForRemove(i2, i8, true);
                RecyclerView recyclerView = RecyclerView.this;
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingLaidOutOrNewView(int i2, int i8) {
                RecyclerView.this.offsetPositionRecordsForRemove(i2, i8, false);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }
    ...
    public void nestedScrollBy(int i2, int i8) {
        nestedScrollByInternal(i2, i8, null, 1);
    }

    public void offsetChildrenHorizontal(@Px int i2) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i8 = 0; i8 < childCount; i8++) {
            this.mChildHelper.getChildAt(i8).offsetLeftAndRight(i2);
        }
    }
    ...
    public void offsetChildrenVertical(@Px int i2) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i8 = 0; i8 < childCount; i8++) {
            this.mChildHelper.getChildAt(i8).offsetTopAndBottom(i2);
        }
    }
    ...
    public void offsetPositionRecordsForInsert(int i2, int i8) {
        ...
        this.mRecycler.offsetPositionRecordsForInsert(i2, i8);
        requestLayout();
    }
    ...
    public void offsetPositionRecordsForMove(int i2, int i8) {
        ...
        for (int i13 = 0; i13 < unfilteredChildCount; i13++) {
            ...
            if (childViewHolderInt != null && (i12 = childViewHolderInt.mPosition) >= i10 && i12 <= i9) {
                if (i12 == i2) {
                    childViewHolderInt.offsetPosition(i8 - i2, false);
                } else {
        ...
        this.mRecycler.offsetPositionRecordsForMove(i2, i8);
        requestLayout();
    }
        ...
        for (int i10 = 0; i10 < unfilteredChildCount; i10++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore()) {
                ...
                if (i11 >= i9) {
                    ...
                    childViewHolderInt.flagRemovedAndOffsetPosition(i2 - 1, -i8, z2);
                    this.mState.mStructureChanged = true;
                }
            }
        }
        this.mRecycler.offsetPositionRecordsForRemove(i2, i8, z2);
        requestLayout();
    }
    ...
    */
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState != 1) {
                ...
                int i9 = y2 - this.mInitialTouchY;
                if (!zCanScrollHorizontally || Math.abs(i8) <= this.mTouchSlop) {
                    z2 = false;
                } else {
                    this.mLastTouchX = x7;
                    z2 = true;
    ...
    public void onMeasure(int i2, int i8) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            int mode = View.MeasureSpec.getMode(i2);
            int mode2 = View.MeasureSpec.getMode(i8);
            this.mLayout.onMeasure(this.mRecycler, this.mState, i2, i8);
            ...
            this.mLayout.setMeasureSpecs(i2, i8);
            this.mState.mIsMeasuring = true;
            dispatchLayoutStep2();
            this.mLayout.setMeasuredDimensionFromChildren(i2, i8);
  ...
  0x00dc: PHI (r1v45 int) = (r1v26 int), (r1v49 int) binds: [B:41:0x00c5, B:45:0x00d8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    @Override // android.view.View
    public void scrollBy(int i2, int i8) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return;
        ...
        if (zCanScrollHorizontally || zCanScrollVertically) {
            ...
            scrollByInternal(i2, i8, null, 0);
        }
    }

    public boolean scrollByInternal(int i2, int i8, MotionEvent motionEvent, int i9) {
        int i10;
        int i11;
        int i12;
        int i13;
        ...
        if (getOverScrollMode() != 2) {
            ...
            considerReleasingGlowsOnScroll(i2, i8);
        }
        if (i10 != 0 || i11 != 0) {
        ...
        return (!z2 && i10 == 0 && i11 == 0) ? false : true;
    }

    public void scrollStep(int i2, int i8, @Nullable int[] iArr) {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
    ...
    public void smoothScrollBy(@Px int i2, @Px int i8) {
        smoothScrollBy(i2, i8, null);
    }
    ...
    public void viewRangeUpdate(int i2, int i8, Object obj) {
        int i9;
        int unfilteredChildCount = this.mChildHelper.getUnfilteredChildCount();
        int i10 = i2 + i8;
        for (int i11 = 0; i11 < unfilteredChildCount; i11++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && (i9 = childViewHolderInt.mPosition) >= i2 && i9 < i10) {
                childViewHolderInt.addFlags(2);
                childViewHolderInt.addChangePayload(obj);
                ((LayoutParams) unfilteredChildAt.getLayoutParams()).mInsetsDirty = true;
            }
        }
        this.mRecycler.viewRangeUpdate(i2, i8);
    }
    ...
    public boolean dispatchNestedPreScroll(int i2, int i8, int[] iArr, int[] iArr2, int i9) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i2, i8, iArr, iArr2, i9);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean dispatchNestedScroll(int i2, int i8, int i9, int i10, int[] iArr, int i11) {
        return getScrollingChildHelper().dispatchNestedScroll(i2, i8, i9, i10, iArr, i11);
    }
    ...
    */
    ...
    public void smoothScrollBy(@Px int i2, @Px int i8, @Nullable Interpolator interpolator) {
        smoothScrollBy(i2, i8, interpolator, Integer.MIN_VALUE);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean startNestedScroll(int i2, int i8) {
        return getScrollingChildHelper().startNestedScroll(i2, i8);
    }
    ...
    public final void dispatchNestedScroll(int i2, int i8, int i9, int i10, int[] iArr, int i11, @NonNull int[] iArr2) {
        getScrollingChildHelper().dispatchNestedScroll(i2, i8, i9, i10, iArr, i11, iArr2);
    }

    public void smoothScrollBy(@Px int i2, @Px int i8, @Nullable Interpolator interpolator, int i9) {
        smoothScrollBy(i2, i8, interpolator, i9, false);
    }
    ...
    public void smoothScrollBy(@Px int i2, @Px int i8, @Nullable Interpolator interpolator, int i9, boolean z2) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return;
        ...
        this.mViewFlinger.smoothScrollBy(i2, i8, i9, interpolator);
    }
    ...
    public static abstract class OnScrollListener {
        ...
        public void onScrolled(@NonNull RecyclerView recyclerView, int i2, int i8) {
        }
    }

    public void onScrolled(@Px int i2, @Px int i8) {
    }
}
