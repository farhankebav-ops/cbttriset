...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public FastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i2, int i8, int i9) {
    ...
    private int scrollTo(float f4, float f8, int[] iArr, int i2, int i8, int i9) {
    ...
    @VisibleForTesting
    public boolean isPointInsideHorizontalThumb(float f4, float f8) {
        ...
        return f4 >= ((float) (i2 - (i8 / 2))) && f4 <= ((float) ((i8 / 2) + i2));
    }

    @VisibleForTesting
    public boolean isPointInsideVerticalThumb(float f4, float f8) {
        if (isLayoutRTL()) {
            if (f4 > this.mVerticalThumbWidth) {
                return false;
            }
        } else if (f4 < this.mRecyclerViewWidth - this.mVerticalThumbWidth) {
            return false;
        }
        int i2 = this.mVerticalThumbCenterY;
        int i8 = this.mVerticalThumbHeight;
        return f8 >= ((float) (i2 - (i8 / 2))) && f8 <= ((float) ((i8 / 2) + i2));
    }
    ...
    public void updateScrollPosition(int i2, int i8) {
        ...
        boolean z2 = iComputeHorizontalScrollRange - i10 > 0 && i10 >= this.mScrollbarMinimumRange;
        ...
        if (z7) {
            float f4 = i9;
            this.mVerticalThumbCenterY = (int) ((((f4 / 2.0f) + i8) * f4) / iComputeVerticalScrollRange);
            this.mVerticalThumbHeight = Math.min(i9, (i9 * i9) / iComputeVerticalScrollRange);
        }
        if (this.mNeedHorizontalScrollbar) {
            float f8 = i10;
            this.mHorizontalThumbCenterX = (int) ((((f8 / 2.0f) + i2) * f8) / iComputeHorizontalScrollRange);
