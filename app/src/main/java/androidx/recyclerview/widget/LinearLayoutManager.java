...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler, RecyclerView.State state, int i2, int i8) {
    ...
    private void recycleByLayoutState(RecyclerView.Recycler recycler, LayoutState layoutState) {
        ...
        int i8 = layoutState.mNoRecycleSpace;
        if (layoutState.mLayoutDirection == -1) {
            recycleViewsFromEnd(recycler, i2, i8);
        } else {
            recycleViewsFromStart(recycler, i2, i8);
        }
    }

    private void recycleChildren(RecyclerView.Recycler recycler, int i2, int i8) {
        if (i2 == i8) {
            return;
        }
        if (i8 <= i2) {
    ...
    private void recycleViewsFromEnd(RecyclerView.Recycler recycler, int i2, int i8) {
    ...
    private void recycleViewsFromStart(RecyclerView.Recycler recycler, int i2, int i8) {
        if (i2 < 0) {
            return;
        }
        int i9 = i2 - i8;
    ...
    private void updateLayoutState(int i2, int i8, boolean z2, RecyclerView.State state) {
        int startAfterPadding;
        ...
        layoutState.mExtraFillSpace = i9;
        if (!z7) {
            iMax = iMax2;
        }
        layoutState.mNoRecycleSpace = iMax;
        if (z7) {
            layoutState.mExtraFillSpace = this.mOrientationHelper.getEndPadding() + i9;
    ...
    public int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state, boolean z2) {
        ...
        if (i8 != Integer.MIN_VALUE) {
            if (i2 < 0) {
                layoutState.mScrollingOffset = i8 + i2;
            }
            recycleByLayoutState(recycler, layoutState);
        }
        int i9 = layoutState.mAvailable + layoutState.mExtraFillSpace;
    ...
    public View findOnePartiallyOrCompletelyInvisibleChild(int i2, int i8) {
        ...
        return this.mOrientation == 0 ? this.mHorizontalBoundCheck.findOneViewWithinBoundFlags(i2, i8, i9, i10) : this.mVerticalBoundCheck.findOneViewWithinBoundFlags(i2, i8, i9, i10);
    }
    ...
    public View findOneVisibleChild(int i2, int i8, boolean z2, boolean z7) {
        ...
        return this.mOrientation == 0 ? this.mHorizontalBoundCheck.findOneViewWithinBoundFlags(i2, i8, i10, i9) : this.mVerticalBoundCheck.findOneViewWithinBoundFlags(i2, i8, i10, i9);
    }
    ...
    */
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (this.mOrientation == 1) {
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                i2 = layoutChunkResult.mConsumed + i15;
                i8 = decoratedMeasurementInOther2;
                i9 = i15;
            }
            i10 = paddingTop;
        }
        layoutDecoratedWithMargins(next, i9, i10, i2, i8);
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (anchorInfo4.mLayoutFromEnd) {
            ...
            if (i16 > 0) {
                updateLayoutStateToFillStart(i14, i8);
                LayoutState layoutState6 = this.mLayoutState;
        ...
        if (getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
                ...
                i9 = i8 + iFixLayoutEndGap2;
                i10 = i2 + iFixLayoutEndGap2;
                iFixLayoutEndGap = fixLayoutStartGap(i9, recycler, state, false);
            } else {
                int iFixLayoutStartGap = fixLayoutStartGap(i8, recycler, state, true);
                i9 = i8 + iFixLayoutStartGap;
                i10 = i2 + iFixLayoutStartGap;
                iFixLayoutEndGap = fixLayoutEndGap(i10, recycler, state, false);
            }
            i8 = i9 + iFixLayoutEndGap;
            i2 = i10 + iFixLayoutEndGap;
        }
        layoutForPredictiveAnimations(recycler, state, i8, i2);
