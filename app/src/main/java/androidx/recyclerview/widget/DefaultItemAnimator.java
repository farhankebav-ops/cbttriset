...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        public MoveInfo(RecyclerView.ViewHolder viewHolder, int i2, int i8, int i9, int i10) {
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i2, int i8, int i9, int i10) {
        if (viewHolder == viewHolder2) {
            return animateMove(viewHolder, i2, i8, i9, i10);
        }
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i2, i8, i9, i10));
        return true;
    }
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i2, int i8, int i9, int i10) {
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i2, int i8, int i9, int i10) {
        final View view = viewHolder.itemView;
        final int i11 = i9 - i2;
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            ...
            sb.append(this.toX);
            sb.append(", toY=");
            return a0.c(sb, this.toY, '}');
        }

        public ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i2, int i8, int i9, int i10) {
