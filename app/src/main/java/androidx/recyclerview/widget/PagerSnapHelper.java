...
public class PagerSnapHelper extends SnapHelper {
    ...
    private boolean isForwardFling(RecyclerView.LayoutManager layoutManager, int i2, int i8) {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i2, int i8) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null) {
                ...
                if (iDistanceToCenter >= 0 && iDistanceToCenter < i9) {
                    view = childAt;
                    i9 = iDistanceToCenter;
                }
            }
        }
        boolean zIsForwardFling = isForwardFling(layoutManager, i2, i8);
