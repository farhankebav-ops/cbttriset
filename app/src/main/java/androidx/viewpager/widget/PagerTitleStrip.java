...
public class PagerTitleStrip extends ViewGroup {
    ...
    public class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void onPageScrolled(int i2, float f4, int i8) {
            ...
            PagerTitleStrip.this.updateTextPositions(i2, f4, false);
        }
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, to = 1.0d) float f4) {
        ...
        int i8 = (i2 << 24) | (this.mTextColor & ViewCompat.MEASURED_SIZE_MASK);
    ...
    public void setTextSize(int i2, float f4) {
        this.mPrevText.setTextSize(i2, f4);
        this.mCurrText.setTextSize(i2, f4);
        this.mNextText.setTextSize(i2, f4);
    }
    ...
    public void updateTextPositions(int i2, float f4, boolean z2) {
        int i8;
        int i9;
        int i10;
        int i11;
        ...
        } else if (!z2 && f4 == this.mLastKnownPositionOffset) {
            return;
        }
        ...
        if (i20 == 16) {
            ...
            if (i20 != 80) {
                ...
                textView2.layout(iMin, i9, iMin + measuredWidth, textView2.getMeasuredHeight() + i9);
        ...
        textView22.layout(iMin2, i9, iMin2 + measuredWidth, textView22.getMeasuredHeight() + i9);
