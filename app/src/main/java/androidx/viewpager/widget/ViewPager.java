...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i2, float f4, @Px int i8);
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i2, ItemInfo itemInfo2) {
            ...
            if (i10 < i11) {
                ...
                while (i12 <= itemInfo.position && i13 < this.mItems.size()) {
                    ...
                    while (i12 < itemInfo4.position) {
                        pageWidth += this.mAdapter.getPageWidth(i12) + f4;
                        i12++;
                    }
                ...
                while (true) {
                    ...
                    while (i10 > itemInfo3.position) {
                        pageWidth2 -= this.mAdapter.getPageWidth(i10) + f4;
                        i10--;
                    }
        ...
        while (i17 >= 0) {
            ...
            while (true) {
                ...
                pageWidth3 -= this.mAdapter.getPageWidth(i15) + f4;
                i15--;
            }
        ...
        while (i19 < size2) {
            ...
            while (true) {
                ...
                pageWidth4 += this.mAdapter.getPageWidth(i18) + f4;
                i18++;
            }
            if (i8 == i16) {
    ...
    private int determineTargetPage(int i2, float f4, int i8, int i9) {
    ...
    private void dispatchOnPageScrolled(int i2, float f4, int i8) {
        OnPageChangeListener onPageChangeListener = this.mOnPageChangeListener;
        if (onPageChangeListener != null) {
            onPageChangeListener.onPageScrolled(i2, f4, i8);
        }
        ...
        if (list != null) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                ...
                if (onPageChangeListener2 != null) {
                    onPageChangeListener2.onPageScrolled(i2, f4, i8);
                }
            }
        }
        OnPageChangeListener onPageChangeListener3 = this.mInternalPageChangeListener;
        if (onPageChangeListener3 != null) {
            onPageChangeListener3.onPageScrolled(i2, f4, i8);
        }
    }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i8 < this.mItems.size()) {
            ...
            if (!z2 && itemInfo2.position != (i2 = i9 + 1)) {
                itemInfo2 = this.mTempItem;
                itemInfo2.offset = f4 + f9 + f8;
            ...
            f4 = itemInfo3.offset;
            float f10 = itemInfo3.widthFactor + f4 + f8;
            if (!z2 && scrollX < f4) {
                break;
            }
            if (scrollX < f10 || i8 == this.mItems.size() - 1) {
                return itemInfo3;
            }
    ...
    private boolean isGutterDrag(float f4, float f8) {
        if (f4 >= this.mGutterSize || f8 <= 0.0f) {
            return f4 > ((float) (getWidth() - this.mGutterSize)) && f8 < 0.0f;
        }
        return true;
    }
    ...
    private boolean pageScrolled(int i2) {
        ...
        float f8 = ((i2 / f4) - itemInfoInfoForCurrentScrollPosition.offset) / (itemInfoInfoForCurrentScrollPosition.widthFactor + (i8 / f4));
        this.mCalledSuper = false;
    ...
    private void recomputeScrollPosition(int i2, int i8, int i9, int i10) {
    ...
    private void scrollToItem(int i2, boolean z2, int i8, boolean z7) {
        int iMax;
    ...
    public ItemInfo addNewItem(int i2, int i8) {
    ...
    */
    ...
    public boolean canScroll(View view, boolean z2, int i2, int i8, int i9) {
        int i10;
        if (view instanceof ViewGroup) {
            ...
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                ...
                int i11 = i8 + scrollX;
                if (i11 >= childAt.getLeft() && i11 < childAt.getRight() && (i10 = i9 + scrollY) >= childAt.getTop() && i10 < childAt.getBottom() && canScroll(childAt, true, i2, i11 - childAt.getLeft(), i10 - childAt.getTop())) {
                    return true;
                }
            }
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f8 = this.mPageMargin / width;
        int i9 = 0;
        ItemInfo itemInfo = this.mItems.get(0);
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i2 != -1) {
                ...
                float f4 = x7 - this.mLastMotionX;
                float fAbs = Math.abs(f4);
                float y2 = motionEvent.getY(iFindPointerIndex);
                float fAbs2 = Math.abs(y2 - this.mInitialMotionY);
                if (f4 != 0.0f && !isGutterDrag(this.mLastMotionX, f4) && canScroll(this, false, (int) f4, (int) x7, (int) y2)) {
                ...
                if (fAbs > i8 && fAbs * 0.5f > fAbs2) {
                    ...
                    this.mLastMotionX = f4 > 0.0f ? f8 + f9 : f8 - f9;
                    this.mLastMotionY = y2;
    ...
    */
    ...
    public void onSizeChanged(int i2, int i8, int i9, int i10) {
        ...
        if (i2 != i9) {
            ...
            recomputeScrollPosition(i2, i9, i11, i11);
        }
    }
    ...
    */
    ...
    public void setCurrentItemInternal(int i2, boolean z2, boolean z7) {
        setCurrentItemInternal(i2, z2, z7, 0);
    }
    ...
    public void setPageMargin(int i2) {
        ...
        this.mPageMargin = i2;
        int width = getWidth();
        recomputeScrollPosition(width, width, i2, i8);
        requestLayout();
    }
    ...
    public void smoothScrollTo(int i2, int i8) {
        smoothScrollTo(i2, i8, 0);
    }
  ...
  0x00cc: PHI (r14v6 float) = (r14v4 float), (r14v5 float), (r14v3 float) binds: [B:64:0x00f0, B:61:0x00da, B:53:0x00c1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void setCurrentItemInternal(int i2, boolean z2, boolean z7, int i8) {
        PagerAdapter pagerAdapter = this.mAdapter;
        if (pagerAdapter == null || pagerAdapter.getCount() <= 0) {
            setScrollingCacheEnabled(false);
            return;
        }
        if (!z7 && this.mCurItem == i2 && this.mItems.size() != 0) {
            setScrollingCacheEnabled(false);
            return;
        }
        if (i2 < 0) {
        ...
        boolean z8 = this.mCurItem != i2;
        if (!this.mFirstLayout) {
            populate(i2);
            scrollToItem(i2, z2, i8, z8);
        } else {
            this.mCurItem = i2;
            if (z8) {
                dispatchOnPageSelected(i2);
    ...
    public void smoothScrollTo(int i2, int i8, int i9) {
        int scrollX;
        if (getChildCount() == 0) {
            setScrollingCacheEnabled(false);
            return;
        ...
        float f4 = clientWidth;
        float f8 = i13;
        float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (Math.abs(i11) * 1.0f) / f4)) * f8) + f8;
        int iAbs = Math.abs(i9);
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / iAbs) * 1000.0f) * 4 : (int) (((Math.abs(i11) / ((this.mAdapter.getPageWidth(this.mCurItem) * f4) + this.mPageMargin)) + 1.0f) * 100.0f), 600);
