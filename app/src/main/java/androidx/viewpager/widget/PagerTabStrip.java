...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f4 = height;
        canvas.drawRect(left, i2, right, f4, this.mTabPaint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2 && (Math.abs(x2 - this.mInitialMotionX) > this.mTouchSlop || Math.abs(y - this.mInitialMotionY) > this.mTouchSlop)) {
    ...
    public void updateTextPositions(int i2, float f4, boolean z2) {
        ...
        super.updateTextPositions(i2, f4, z2);
