...
public class CardView extends FrameLayout {
    ...
    public void onMeasure(int i2, int i8) {
        ...
        if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
            i8 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(r0.getMinHeight(this.mCardViewDelegate)), View.MeasureSpec.getSize(i8)), mode2);
        }
        super.onMeasure(i2, i8);
    }
    ...
    public void setContentPadding(@Px int i2, @Px int i8, @Px int i9, @Px int i10) {
        this.mContentPadding.set(i2, i8, i9, i10);
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        CardViewDelegate cardViewDelegate = new CardViewDelegate() { // from class: androidx.cardview.widget.CardView.1
            ...
            public void setShadowPadding(int i8, int i9, int i10, int i11) {
                CardView.this.mShadowBounds.set(i8, i9, i10, i11);
                CardView cardView = CardView.this;
                Rect rect2 = cardView.mContentPadding;
                CardView.super.setPadding(i8 + rect2.left, i9 + rect2.top, i10 + rect2.right, i11 + rect2.bottom);
            }
        };
    ...
    @Override // android.view.View
    public void setPaddingRelative(int i2, int i8, int i9, int i10) {
    }
}
