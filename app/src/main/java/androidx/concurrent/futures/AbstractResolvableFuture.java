...
public abstract class AbstractResolvableFuture<V> implements q {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, q qVar) {
    ...
    public static Object getFutureValue(q qVar) {
        if (qVar instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) qVar).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
        ...
        try {
            ...
            return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + qVar, e));
        } catch (ExecutionException e4) {
    ...
    public final boolean cancel(boolean z2) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                q qVar = ((SetFuture) obj).future;
                if (!(qVar instanceof AbstractResolvableFuture)) {
                    qVar.cancel(z2);
                    break;
                }
                abstractResolvableFuture = (AbstractResolvableFuture) qVar;
    ...
    public final V get(long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        if (nanos + 1000 < 0) {
            ...
            if (z2) {
                strC = strC + nanos2 + " nanoseconds ";
            }
            string3 = a1.a.C(strC, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(a1.a.C(string3, " but future completed as timeout expired"));
        }
        throw new TimeoutException(a1.a.D(string3, " for ", string));
    }
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return a1.a.r(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), C2300e4.i.e);
        }
    ...
    public boolean setFuture(q qVar) {
        ...
        if (obj == null) {
            if (qVar.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(qVar))) {
                    return false;
                }
                complete(this);
                return true;
            ...
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    qVar.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            qVar.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        if (isCancelled()) {
            ...
            if (strPendingToString != null && !strPendingToString.isEmpty()) {
                a.z(sb, "PENDING, info=[", strPendingToString, C2300e4.i.e);
            } else if (isDone()) {
                addDoneString(sb);
            } else {
                sb.append("PENDING");
