...
public final class CustomTabsSession {
    ...
    public class AnonymousClass1 extends h {
        ...
        public void onGreatestScrollPercentageIncreased(int i2, Bundle bundle) {
            this.mHandler.post(new c(this.val$callback, i2, bundle, 0));
        }

        @Override // android.support.customtabs.i
        public void onSessionEnded(boolean z2, Bundle bundle) {
            this.mHandler.post(new b(this.val$callback, z2, bundle, 0));
        }

        @Override // android.support.customtabs.i
        public void onVerticalScrollEvent(boolean z2, Bundle bundle) {
            this.mHandler.post(new b(this.val$callback, z2, bundle, 1));
        }
    }
    ...
    public class AnonymousClass2 extends h {
        ...
        public void onGreatestScrollPercentageIncreased(int i2, Bundle bundle) {
            ...
            try {
                this.mExecutor.execute(new c(this.val$callback, i2, bundle, 1));
            } finally {
        ...
        public void onSessionEnded(boolean z2, Bundle bundle) {
            long jClearCallingIdentity = Binder.clearCallingIdentity();
            try {
                this.mExecutor.execute(new b(this.val$callback, z2, bundle, 3));
            } finally {
                Binder.restoreCallingIdentity(jClearCallingIdentity);
            }
        }
        ...
        public void onVerticalScrollEvent(boolean z2, Bundle bundle) {
            long jClearCallingIdentity = Binder.clearCallingIdentity();
            try {
                this.mExecutor.execute(new b(this.val$callback, z2, bundle, 2));
            } finally {
                Binder.restoreCallingIdentity(jClearCallingIdentity);
            }
        }
    ...
    public static class MockSession extends e {
        ...
        @Override // android.support.customtabs.f
        public boolean receiveFile(android.support.customtabs.c cVar, Uri uri, int i2, Bundle bundle) throws RemoteException {
            return false;
        }
        ...
        @Override // android.support.customtabs.f
        public boolean validateRelationship(android.support.customtabs.c cVar, int i2, Uri uri, Bundle bundle) throws RemoteException {
            return false;
        }
