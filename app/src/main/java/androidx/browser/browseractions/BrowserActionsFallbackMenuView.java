...
public class BrowserActionsFallbackMenuView extends LinearLayout {
    ...
    public void onMeasure(int i2, int i8) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(getResources().getDisplayMetrics().widthPixels - (this.mBrowserActionsMenuMinPaddingPx * 2), this.mBrowserActionsMenuMaxWidthPx), BasicMeasure.EXACTLY), i8);
    }
}
