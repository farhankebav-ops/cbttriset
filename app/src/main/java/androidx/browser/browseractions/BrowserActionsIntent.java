...
public class BrowserActionsIntent {
    ...
    public static List<BrowserActionItem> parseBrowserActionItems(@NonNull ArrayList<Bundle> arrayList) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            int i8 = bundle.getInt(KEY_ICON_ID);
            Uri uri = (Uri) bundle.getParcelable(KEY_ICON_URI);
            if (TextUtils.isEmpty(string) || pendingIntent == null) {
                throw new IllegalArgumentException("Custom item should contain a non-empty title and non-null intent.");
            }
            arrayList2.add(i8 != 0 ? new BrowserActionItem(string, pendingIntent, i8) : new BrowserActionItem(string, pendingIntent, uri));
        }
        return arrayList2;
    }
    ...
    public static void openBrowserAction(@NonNull Context context, @NonNull Uri uri, int i2, @NonNull ArrayList<BrowserActionItem> arrayList, @NonNull PendingIntent pendingIntent) {
    ...
    public static final class Builder {
        ...
        public Builder setCustomItems(@NonNull ArrayList<BrowserActionItem> arrayList) {
            ...
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                ...
                if (arrayList.get(i2).getIconUri() != null) {
                    this.mImageUris.add(arrayList.get(i2).getIconUri());
                }
            }
            return this;
        }
