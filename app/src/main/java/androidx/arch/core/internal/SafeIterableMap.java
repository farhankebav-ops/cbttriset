...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public static class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public Entry(@NonNull K k, @NonNull V v2) {
            this.mKey = k;
            this.mValue = v2;
        }
        ...
        public String toString() {
            return this.mKey + C2300e4.i.f8399b + this.mValue;
        }
    }
    ...
    public Entry<K, V> put(@NonNull K k, @NonNull V v2) {
        Entry<K, V> entry = new Entry<>(k, v2);
        this.mSize++;
