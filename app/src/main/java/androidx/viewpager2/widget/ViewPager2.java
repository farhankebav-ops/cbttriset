...
public final class ViewPager2 extends ViewGroup {
    ...
    public static abstract class DataSetChangeObserver extends RecyclerView.AdapterDataObserver {
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public final void onItemRangeChanged(int i2, int i8, @Nullable Object obj) {
            onChanged();
        }
    }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        public void updatePageAccessibilityActions() {
            ...
            int i8 = zIsRtl ? 16908360 : 16908361;
            if (zIsRtl) {
                i2 = 16908361;
            }
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
    ...
    public boolean fakeDragBy(@Px float f4) {
    ...
    public void onLayout(boolean z2, int i2, int i8, int i9, int i10) {
        ...
        this.mTmpContainerRect.right = (i9 - i2) - getPaddingRight();
    ...
    public void onMeasure(int i2, int i8) {
        measureChild(this.mRecyclerView, i2, i8);
        int measuredWidth = this.mRecyclerView.getMeasuredWidth();
        int measuredHeight = this.mRecyclerView.getMeasuredHeight();
    ...
    public void requestTransform() {
        ...
        float f4 = (float) (relativeScrollPosition - ((double) i2));
        this.mPageTransformerAdapter.onPageScrolled(i2, f4, Math.round(getPageSize() * f4));
    }
    ...
    public void setCurrentItemInternal(int i2, boolean z2) {
        ...
        double relativeScrollPosition = i8;
        ...
        double d8 = iMin;
        if (Math.abs(d8 - relativeScrollPosition) <= 3.0d) {
            this.mRecyclerView.smoothScrollToPosition(iMin);
            return;
        }
        this.mRecyclerView.scrollToPosition(d8 > relativeScrollPosition ? iMin - 3 : iMin + 3);
        RecyclerView recyclerView = this.mRecyclerView;
    ...
    public static abstract class OnPageChangeCallback {
        ...
        public void onPageScrolled(int i2, float f4, @Px int i8) {
        }
    }
    ...
    @RequiresApi(21)
    public ViewPager2(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i8) {
