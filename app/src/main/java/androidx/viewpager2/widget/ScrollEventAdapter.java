...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private void dispatchScrolled(int i2, float f4, int i8) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageScrolled(i2, f4, i8);
        }
    }
    ...
    private void updateScrollEventValues() {
        ...
        if (i2 >= 0) {
            ...
            throw new IllegalStateException(a.g(scrollEventValues.mOffsetPx, "Page can only be offset by a positive amount, not by "));
        }
    }
        ...
        if (isInAnyDraggingState() && i2 == 0) {
            ...
            if (this.mScrollHappened) {
                ...
                if (scrollEventValues.mOffsetPx == 0) {
                    ...
                    int i9 = scrollEventValues.mPosition;
                    if (i8 != i9) {
                        dispatchSelected(i9);
                    }
                }
