...
class FragmentAnim {
    ...
    @AnimRes
    private static int getNextAnim(Fragment fragment, boolean z2, boolean z7) {
        return z7 ? z2 ? fragment.getPopEnterAnim() : fragment.getPopExitAnim() : z2 ? fragment.getEnterAnim() : fragment.getExitAnim();
    }
    ...
    */
    ...
    @AnimRes
    private static int toActivityTransitResId(@NonNull Context context, int i2) {
    ...
    private static int transitToAnimResourceId(@NonNull Context context, int i2, boolean z2) {
        if (i2 == 4097) {
            return z2 ? androidx.fragment.R.animator.fragment_open_enter : androidx.fragment.R.animator.fragment_open_exit;
        }
        if (i2 == 8194) {
            return z2 ? androidx.fragment.R.animator.fragment_close_enter : androidx.fragment.R.animator.fragment_close_exit;
        }
        if (i2 == 8197) {
            return z2 ? toActivityTransitResId(context, R.attr.activityCloseEnterAnimation) : toActivityTransitResId(context, R.attr.activityCloseExitAnimation);
        }
        if (i2 == 4099) {
            return z2 ? androidx.fragment.R.animator.fragment_fade_enter : androidx.fragment.R.animator.fragment_fade_exit;
        }
        if (i2 != 4100) {
            return -1;
        }
        return z2 ? toActivityTransitResId(context, R.attr.activityOpenEnterAnimation) : toActivityTransitResId(context, R.attr.activityOpenExitAnimation);
    }
    ...
    public static class EndViewTransitionAnimation extends AnimationSet implements Runnable {
        ...
        public boolean getTransformation(long j, @NonNull Transformation transformation, float f4) {
            this.mAnimating = true;
            if (this.mEnded) {
                return !this.mTransitionEnded;
            }
