...
class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(a1.a.r(sb, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbV = a1.a.v(iMin, "computeExpectedState() of ", " for ");
    ...
    public void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb.append(" ");
                sb.append(zRequestFocus ? "succeeded" : C2300e4.h.f8385t);
