...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private void dismissInternal(boolean z2, boolean z7, boolean z8) {
        if (this.mDismissed) {
            return;
        }
    ...
    public void setStyle(int i2, @StyleRes int i8) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.d(FragmentManager.TAG, "Setting style and theme for DialogFragment " + this + " to " + i2 + ", " + i8);
        }
        this.mStyle = i2;
        if (i2 == 2 || i2 == 3) {
