...
public abstract class FragmentTransaction {
    ...
    public FragmentTransaction addSharedElement(@NonNull View view, @NonNull String str) {
        ...
        if (this.mSharedElementSourceNames == null) {
            ...
            if (this.mSharedElementTargetNames.contains(str)) {
                throw new IllegalArgumentException(a1.a.m("A shared element with the target name '", str, "' has already been added to the transaction."));
            }
            if (this.mSharedElementSourceNames.contains(transitionName)) {
                throw new IllegalArgumentException(a1.a.m("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
            }
        }
    ...
    public void doAddOp(int i2, Fragment fragment, @Nullable String str, int i8) {
        ...
        if (str != null) {
            ...
            if (str3 != null && !str.equals(str3)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(a1.a.s(sb, fragment.mTag, " now ", str));
            }
            fragment.mTag = str;
        }
        if (i2 != 0) {
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i2, @AnimRes @AnimatorRes int i8) {
        return setCustomAnimations(i2, i8, 0, 0);
    }
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i2, @AnimRes @AnimatorRes int i8, @AnimRes @AnimatorRes int i9, @AnimRes @AnimatorRes int i10) {
        this.mEnterAnim = i2;
        this.mExitAnim = i8;
