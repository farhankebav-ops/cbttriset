...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
        }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(a1.a.C(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Can't access the Fragment View's LifecycleOwner for ", this, " when getView() is null i.e., before onCreateView() or after onDestroyView()"));
    }
    ...
    public void onActivityResult(int i2, int i8, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i2 + " resultCode: " + i8 + " data: " + intent);
        }
    }
    ...
    @Nullable
    @MainThread
    public Animator onCreateAnimator(int i2, boolean z2, int i8) {
        return null;
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new a3.b(this, 12));
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i2) {
        if (this.mHost == null) {
            throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " not attached to Activity"));
        }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.camera.core.processing.util.a.k("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setAnimations(@AnimRes int i2, @AnimRes int i8, @AnimRes int i9, @AnimRes int i10) {
        if (this.mAnimationInfo == null && i2 == 0 && i8 == 0 && i9 == 0 && i10 == 0) {
            return;
        }
        ensureAnimationInfo().mEnterAnim = i2;
        ensureAnimationInfo().mExitAnim = i8;
        ensureAnimationInfo().mPopEnterAnim = i9;
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i2) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            throw new IllegalArgumentException(androidx.camera.core.processing.util.a.k("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
        }
    ...
    @Deprecated
    public void startIntentSenderForResult(@NonNull IntentSender intentSender, int i2, @Nullable Intent intent, int i8, int i9, int i10, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        Bundle bundle2;
        if (this.mHost == null) {
            throw new IllegalStateException(androidx.camera.core.processing.util.a.k("Fragment ", this, " not attached to Activity"));
        }
        ...
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i2, intent, i8, i9, i10, bundle2);
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(a1.a.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (java.lang.InstantiationException e4) {
            throw new InstantiationException(a1.a.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e4);
        } catch (NoSuchMethodException e8) {
            throw new InstantiationException(a1.a.m("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e8);
        } catch (InvocationTargetException e9) {
            throw new InstantiationException(a1.a.m("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e9);
        }
    }
