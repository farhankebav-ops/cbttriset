...
final class BackStackRecordState implements Parcelable {
    ...
    public BackStackRecordState(BackStackRecord backStackRecord) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            int[] iArr = this.mOps;
            iArr[i9] = op.mFromExpandedOp ? 1 : 0;
    ...
    private void fillInBackStackRecord(@NonNull BackStackRecord backStackRecord) {
        ...
        while (true) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Instantiate " + backStackRecord + " op #" + i8 + " base fragment #" + this.mOps[i9]);
            }
            op.mOldMaxState = Lifecycle.State.values()[this.mOldMaxLifecycleStates[i8]];
            op.mCurrentMaxState = Lifecycle.State.values()[this.mCurrentMaxLifecycleStates[i8]];
            int[] iArr = this.mOps;
            int i10 = i2 + 2;
            if (iArr[i9] == 0) {
                z2 = false;
        ...
        for (int i2 = 0; i2 < this.mFragmentWhos.size(); i2++) {
            ...
            if (str != null) {
                ...
                if (fragment != null) {
                    ...
                    throw new IllegalStateException(androidx.camera.core.processing.util.a.n(new StringBuilder("Restoring FragmentTransaction "), this.mName, " failed due to missing saved state for Fragment (", str, ")"));
                }
            }
        }
        return backStackRecord;
