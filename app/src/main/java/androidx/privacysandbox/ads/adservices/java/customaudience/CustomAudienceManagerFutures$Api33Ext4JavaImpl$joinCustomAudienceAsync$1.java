...
public final class CustomAudienceManagerFutures$Api33Ext4JavaImpl$joinCustomAudienceAsync$1 extends i implements p {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (customAudienceManager.joinCustomAudience(joinCustomAudienceRequest, this) == aVar) {
                return aVar;
            }
        } else {
            if (i2 != 1) {
    ...
    public final Object invoke(a0 a0Var, c<? super x> cVar) {
        return ((CustomAudienceManagerFutures$Api33Ext4JavaImpl$joinCustomAudienceAsync$1) create(a0Var, cVar)).invokeSuspend(x.f13520a);
    }
}
