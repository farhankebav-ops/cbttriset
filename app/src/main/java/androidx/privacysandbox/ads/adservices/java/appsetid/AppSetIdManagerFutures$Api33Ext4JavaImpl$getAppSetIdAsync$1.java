...
public final class AppSetIdManagerFutures$Api33Ext4JavaImpl$getAppSetIdAsync$1 extends i implements p {
    ...
    @Override // e6.p
    public final Object invoke(a0 a0Var, c<? super AppSetId> cVar) {
        return ((AppSetIdManagerFutures$Api33Ext4JavaImpl$getAppSetIdAsync$1) create(a0Var, cVar)).invokeSuspend(x.f13520a);
    }
}
