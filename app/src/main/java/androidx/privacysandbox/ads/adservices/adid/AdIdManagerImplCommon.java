...
public class AdIdManagerImplCommon extends AdIdManager {
    ...
    */
    public static java.lang.Object getAdId$suspendImpl(androidx.privacysandbox.ads.adservices.adid.AdIdManagerImplCommon r4, v5.c<? super androidx.privacysandbox.ads.adservices.adid.AdId> r5) throws java.lang.Throwable {
        /*
        ...
        L33:
            ...
            return r1
        L41:
            android.adservices.adid.AdId r5 = androidx.camera.camera2.internal.w0.a(r5)
            androidx.privacysandbox.ads.adservices.adid.AdId r4 = r4.convertResponse(r5)
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.privacysandbox.ads.adservices.adid.AdIdManagerImplCommon.getAdId$suspendImpl(androidx.privacysandbox.ads.adservices.adid.AdIdManagerImplCommon, v5.c):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    @RequiresPermission("android.permission.ACCESS_ADSERVICES_AD_ID")
    public final Object getAdIdAsyncInternal(v5.c<? super android.adservices.adid.AdId> cVar) {
        l lVar = new l(1, a.I(cVar));
        lVar.r();
        this.mAdIdManager.getAdId(new androidx.arch.core.executor.a(2), OutcomeReceiverKt.asOutcomeReceiver(lVar));
        Object objP = lVar.p();
    ...
    @RequiresPermission("android.permission.ACCESS_ADSERVICES_AD_ID")
    @DoNotInline
    public Object getAdId(v5.c<? super AdId> cVar) {
