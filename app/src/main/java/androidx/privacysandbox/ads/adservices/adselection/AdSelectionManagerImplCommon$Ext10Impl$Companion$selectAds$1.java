...
public final class AdSelectionManagerImplCommon$Ext10Impl$Companion$selectAds$1 extends c {
    ...
    public AdSelectionManagerImplCommon$Ext10Impl$Companion$selectAds$1(AdSelectionManagerImplCommon.Ext10Impl.Companion companion, v5.c<? super AdSelectionManagerImplCommon$Ext10Impl$Companion$selectAds$1> cVar) {
        super(cVar);
