...
public abstract class VersionedParcel {
    ...
    private Class findParcelClass(Class<? extends VersionedParcelable> cls) throws ClassNotFoundException {
        ...
        Class<?> cls3 = Class.forName(a.l(cls.getPackage().getName(), ".", cls.getSimpleName(), "Parcelizer"), false, cls.getClassLoader());
    ...
    public byte readByte(byte b8, int i2) {
        return !readField(i2) ? b8 : (byte) (readInt() & 255);
    }
    ...
    public double readDouble(double d8, int i2) {
        return !readField(i2) ? d8 : readDouble();
    }
    ...
    public int readInt(int i2, int i8) {
        return !readField(i8) ? i2 : readInt();
    }
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(a1.a.m("VersionedParcelable encountered IOException reading a Serializable object (name = ", string, ")"), e);
        } catch (ClassNotFoundException e4) {
            throw new RuntimeException(a1.a.m("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", string, ")"), e4);
        }
    }
    ...
    public SparseBooleanArray readSparseBooleanArray(SparseBooleanArray sparseBooleanArray, int i2) {
        ...
        SparseBooleanArray sparseBooleanArray2 = new SparseBooleanArray(i8);
        for (int i9 = 0; i9 < i8; i9++) {
    ...
    public <T extends VersionedParcelable> T readVersionedParcelable(T t3, int i2) {
        return !readField(i2) ? t3 : (T) readVersionedParcelable();
    }
    ...
    public void writeByte(byte b8, int i2) {
        setOutputField(i2);
        writeInt(b8);
    }
    ...
    public abstract void writeByteArray(byte[] bArr, int i2, int i8);
    ...
    public void writeDouble(double d8, int i2) {
        setOutputField(i2);
        writeDouble(d8);
    }
    ...
    public void writeInt(int i2, int i8) {
        setOutputField(i8);
        writeInt(i2);
    }
    ...
    public void writeSparseBooleanArray(SparseBooleanArray sparseBooleanArray, int i2) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            writeInt(sparseBooleanArray.keyAt(i8));
            writeBoolean(sparseBooleanArray.valueAt(i8));
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(a1.a.m("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }
    ...
    public void writeByteArray(byte[] bArr, int i2, int i8, int i9) {
        setOutputField(i9);
        writeByteArray(bArr, i2, i8);
    }
    ...
    public void setSerializationFlags(boolean z2, boolean z7) {
    }
}
