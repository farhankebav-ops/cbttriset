...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    private RoomSQLiteQuery getSQLiteQuery(int i2, int i8) {
        ...
        roomSQLiteQueryAcquire.bindLong(roomSQLiteQueryAcquire.getArgCount() - 1, i8);
    ...
    public void loadInitial(@NonNull PositionalDataSource.LoadInitialParams loadInitialParams, @NonNull PositionalDataSource.LoadInitialCallback<T> loadInitialCallback) throws Throwable {
        ...
        try {
            ...
            loadInitialCallback.onResult(list, i2, iCountItems);
        } catch (Throwable th2) {
            th = th2;
            sQLiteQuery = null;
        }
    ...
    public LimitOffsetDataSource(@NonNull RoomDatabase roomDatabase, @NonNull SupportSQLiteQuery supportSQLiteQuery, boolean z2, boolean z7, @NonNull String... strArr) {
        this(roomDatabase, RoomSQLiteQuery.copyFrom(supportSQLiteQuery), z2, z7, strArr);
    }

    @NonNull
    public List<T> loadRange(int i2, int i8) {
        RoomSQLiteQuery sQLiteQuery = getSQLiteQuery(i2, i8);
    ...
    public LimitOffsetDataSource(@NonNull RoomDatabase roomDatabase, @NonNull RoomSQLiteQuery roomSQLiteQuery, boolean z2, boolean z7, @NonNull String... strArr) {
