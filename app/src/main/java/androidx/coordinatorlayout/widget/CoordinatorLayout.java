...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, int i2, int i8, int i9, int i10) {
            return false;
        }

        public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, float f4, float f8, boolean z2) {
            return false;
        }

        public boolean onNestedPreFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, float f4, float f8) {
            return false;
        }

        @Deprecated
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i8, @NonNull int[] iArr) {
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i8, int i9, int i10) {
        }
        ...
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i8, @NonNull int[] iArr, int i9) {
            if (i9 == 0) {
                onNestedPreScroll(coordinatorLayout, v2, view, i2, i8, iArr);
            }
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i8, int i9, int i10, int i11) {
            if (i11 == 0) {
                onNestedScroll(coordinatorLayout, v2, view, i2, i8, i9, i10);
            }
        }

        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i2, int i8) {
            if (i8 == 0) {
                onNestedScrollAccepted(coordinatorLayout, v2, view, view2, i2);
            }
        }

        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i2, int i8) {
            if (i8 == 0) {
        ...
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i8, int i9, int i10, int i11, @NonNull int[] iArr) {
            iArr[0] = iArr[0] + i9;
            iArr[1] = iArr[1] + i10;
            onNestedScroll(coordinatorLayout, v2, view, i2, i8, i9, i10, i11);
        }
    ...
    private void constrainChildRect(LayoutParams layoutParams, Rect rect, int i2, int i8) {
        int width = getWidth();
        ...
        rect.set(iMax, iMax2, i2 + iMax, i8 + iMax2);
    }
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i2, Rect rect, Rect rect2, LayoutParams layoutParams, int i8, int i9) {
    ...
    private void layoutChildWithKeyline(View view, int i2, int i8) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(a.l("Could not inflate Behavior subclass ", str), e);
        }
    }
    ...
    private void setInsetOffsetX(View view, int i2) {
        ...
        if (i8 != i2) {
            ViewCompat.offsetLeftAndRight(view, i2 - i8);
    ...
    private void setInsetOffsetY(View view, int i2) {
        ...
        if (i8 != i2) {
            ViewCompat.offsetTopAndBottom(view, i2 - i8);
    ...
    */
    ...
    public boolean isPointInChildBounds(@NonNull View view, int i2, int i8) {
        Rect rectAcquireTempRect = acquireTempRect();
        getDescendantRect(view, rectAcquireTempRect);
        try {
            return rectAcquireTempRect.contains(i2, i8);
        } finally {
            releaseTempRect(rectAcquireTempRect);
        }
    }
    ...
    */
    ...
    public void onLayoutChild(@NonNull View view, int i2) {
        ...
        if (i8 >= 0) {
            layoutChildWithKeyline(view, i8, i2);
        } else {
            layoutChild(view, i2);
        }
    }
    ...
    */
    ...
    public void onMeasureChild(View view, int i2, int i8, int i9, int i10) {
        measureChildWithMargins(view, i2, i8, i9, i10);
    }
  ...
  0x0015: PHI (r3v4 boolean) = (r3v2 boolean), (r3v5 boolean) binds: [B:10:0x0024, B:5:0x0012] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i9) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedPreScroll(this, childAt, view, i2, i8, iArr2, i9);
    ...
    @Override // androidx.core.view.NestedScrollingParent2
    public void onNestedScroll(View view, int i2, int i8, int i9, int i10, int i11) {
        onNestedScroll(view, i2, i8, i9, i10, 0, this.mNestedScrollingV2ConsumedCompat);
    }
    ...
    public void onNestedScrollAccepted(View view, View view2, int i2, int i8) {
        ...
        int i9;
        int i10;
        this.mNestedScrollingParentHelper.onNestedScrollAccepted(view, view2, i2, i8);
        ...
        while (i11 < childCount) {
            ...
            if (layoutParams.isNestedScrollAccepted(i8) && (behavior = layoutParams.getBehavior()) != null) {
                ...
                i9 = i2;
                i10 = i8;
                behavior.onNestedScrollAccepted(this, childAt, view3, view4, i9, i10);
            } else {
                view3 = view;
                view4 = view2;
                i9 = i2;
    ...
    public boolean onStartNestedScroll(View view, View view2, int i2, int i8) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                Behavior behavior = layoutParams.getBehavior();
                if (behavior != null) {
                    boolean zOnStartNestedScroll = behavior.onStartNestedScroll(this, childAt, view, view2, i2, i8);
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i2) {
        ...
        if (resourceId != 0) {
            ...
            for (int i8 = 0; i8 < length; i8++) {
                coordinatorLayout.mKeylines[i8] = (int) (r11[i8] * f4);
            }
        }
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i11) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedScroll(this, childAt, view, i2, i8, i9, i10, i11, iArr2);
                    int[] iArr3 = this.mBehaviorConsumed;
