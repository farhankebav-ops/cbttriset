...
final class ProcessingCaptureSession implements CaptureSessionInterface {
    ...
    public static class CaptureCallbackAdapter implements SessionProcessor.CaptureCallback {
        ...
        public void onCaptureCompleted(long j, int i2, CameraCaptureResult cameraCaptureResult) {
        ...
        @Override // androidx.camera.core.impl.SessionProcessor.CaptureCallback
        public final /* synthetic */ void onCaptureProcessStarted(int i2) {
            androidx.camera.core.impl.a0.d(this, i2);
        }

        @Override // androidx.camera.core.impl.SessionProcessor.CaptureCallback
        public final /* synthetic */ void onCaptureSequenceAborted(int i2) {
            androidx.camera.core.impl.a0.e(this, i2);
        }
    ...
    public ProcessingCaptureSession(SessionProcessor sessionProcessor, Camera2CameraInfoImpl camera2CameraInfoImpl, DynamicRangesCompat dynamicRangesCompat, Executor executor, ScheduledExecutorService scheduledExecutorService, Camera2CaptureRequestConfigurator camera2CaptureRequestConfigurator) {
        this.mInstanceId = 0;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ j2.q lambda$open$2(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSession.Opener opener, List list) throws Exception {
        ...
        try {
            ...
            try {
                ...
                sessionConfigInitSession.getSurfaces().get(0).getTerminationFuture().addListener(new j(5, this, surface), CameraXExecutors.directExecutor());
                for (DeferrableSurface deferrableSurface2 : this.mProcessorSessionConfig.getSurfaces()) {
                    ...
                    deferrableSurface2.getTerminationFuture().addListener(new u(deferrableSurface2, 5), this.mExecutor);
                }
                ...
                j2.q qVarOpen = this.mCaptureSession.open(validatingBuilder.build(), (CameraDevice) Preconditions.checkNotNull(cameraDevice), opener);
                Futures.addCallback(qVarOpen, new FutureCallback<Void>() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession.1
    ...
    public void issueTriggerRequest(CaptureConfig captureConfig) {
        ...
        Iterator it = androidx.camera.core.impl.w.e(captureRequestOptionsBuild).iterator();
        while (it.hasNext()) {
    ...
    @Override // androidx.camera.camera2.internal.CaptureSessionInterface
    public j2.q open(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSession.Opener opener) {
        ...
        return FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(surfaces, false, 5000L, this.mExecutor, this.mScheduledExecutorService)).transformAsync(new v0(this, sessionConfig, cameraDevice, opener), this.mExecutor).transform(new v(this, 6), this.mExecutor);
    }

    @Override // androidx.camera.camera2.internal.CaptureSessionInterface
    public j2.q release(boolean z2) {
        Logger.d(TAG, "release (id=" + this.mInstanceId + ") mProcessorState=" + this.mProcessorState);
        j2.q qVarRelease = this.mCaptureSession.release(z2);
        int iOrdinal = this.mProcessorState.ordinal();
        if (iOrdinal == 1 || iOrdinal == 3) {
            qVarRelease.addListener(new u(this, 4), CameraXExecutors.directExecutor());
        }
    ...
    public static class SessionProcessorCaptureCallback implements SessionProcessor.CaptureCallback {
        ...
        public final /* synthetic */ void onCaptureProcessProgressed(int i2) {
            androidx.camera.core.impl.a0.c(this, i2);
        }
