...
public class TemplateTypeUtil {
    ...
    public static int getCaptureConfigTemplateType(UseCaseConfigFactory.CaptureType captureType, int i2) {
        ...
        return i8 != 1 ? (i8 == 2 && DeviceQuirks.get(PreviewUnderExposureQuirk.class) == null) ? 3 : 1 : i2 == 2 ? 5 : 2;
    }

    @OptIn(markerClass = {ExperimentalZeroShutterLag.class})
    public static int getSessionConfigTemplateType(UseCaseConfigFactory.CaptureType captureType, int i2) {
        int i8 = AnonymousClass1.$SwitchMap$androidx$camera$core$impl$UseCaseConfigFactory$CaptureType[captureType.ordinal()];
        return i8 != 1 ? (i8 == 2 && DeviceQuirks.get(PreviewUnderExposureQuirk.class) == null) ? 3 : 1 : i2 == 2 ? 5 : 1;
    }
}
