...
final class Image2JpegBytes implements Operation<In, Packet<byte[]>> {
    ...
    public static abstract class In {
        public static In of(Packet<ImageProxy> packet, int i2) {
    ...
    private Packet<byte[]> processJpegImage(In in, int i2) {
        ...
        return Packet.of(bArrJpegImageToJpegByteArray, exif, i2, packet.getSize(), packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
