...
final class ExifAttribute {
    ...
    public ExifAttribute(int i2, int i8, byte[] bArr) {
        this(i2, i8, -1L, bArr);
    }
    ...
    */
    ...
    public String toString() {
        ...
        return a1.a.q(sb, ")", this.bytes.length);
    }

    public ExifAttribute(int i2, int i8, long j, byte[] bArr) {
        this.format = i2;
        this.numberOfComponents = i8;
        this.bytesOffset = j;
        this.bytes = bArr;
    }
