...
public final class Exif {
    ...
    public static final class Speed {
        ...
        public static Converter fromKilometersPerHour(double d8) {
            return new Converter(d8 * 0.621371d);
        }

        public static Converter fromKnots(double d8) {
            return new Converter(d8 * 1.15078d);
        }

        public static Converter fromMilesPerHour(double d8) {
    ...
    private long parseTimestamp(String str, String str2) {
        ...
        if (str != null) {
            return parseTimestamp(a1.a.D(str, " ", str2));
        }
        try {
    ...
    public void rotate(int i2) {
        if (i2 % 90 != 0) {
            ...
            Logger.w(str, "Can only rotate in right angles (eg. 0, 90, 180, 270). " + i2 + " is unsupported.");
