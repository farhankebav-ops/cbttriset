...
public final class SpringAnimation extends DynamicAnimation<SpringAnimation> {
    ...
    public float getAcceleration(float f4, float f8) {
        return this.mSpring.getAcceleration(f4, f8);
    }
    ...
    public boolean isAtEquilibrium(float f4, float f8) {
        return this.mSpring.isAtEquilibrium(f4, f8);
    }
    ...
    public SpringAnimation(FloatValueHolder floatValueHolder, float f4) {
        super(floatValueHolder);
        this.mSpring = null;
        this.mPendingPosition = Float.MAX_VALUE;
        this.mEndRequested = false;
    ...
    public <K> SpringAnimation(K k, FloatPropertyCompat<K> floatPropertyCompat, float f4) {
        super(k, floatPropertyCompat);
        this.mSpring = null;
        this.mPendingPosition = Float.MAX_VALUE;
        this.mEndRequested = false;
