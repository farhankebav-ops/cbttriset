...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, @DrawableRes int i2, @StringRes int i8, @StringRes int i9) {
        this(activity, drawerLayout, !assumeMaterial(activity), i2, i8, i9);
    }
    ...
    public void onDrawerSlide(View view, float f4) {
        ...
        this.mSlider.setPosition(f4 > 0.5f ? Math.max(position, Math.max(0.0f, f4 - 0.5f) * 2.0f) : Math.min(position, f4 * 2.0f));
    }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z2, @DrawableRes int i2, @StringRes int i8, @StringRes int i9) {
