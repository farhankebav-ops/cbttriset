...
public final class CharSequenceListSerializer implements c {
    ...
    private static final g descriptor = q.q("kotlin.collections.List<kotlin.CharSequence>", new g[0]);
    ...
    public List<CharSequence> deserialize(e decoder) {
        ...
        return SavedStateReader.m103getCharSequenceListimpl(SavedStateReader.m83constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
    ...
    public void serialize(f encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m181putCharSequenceListimpl(SavedStateWriter.m169constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
}
