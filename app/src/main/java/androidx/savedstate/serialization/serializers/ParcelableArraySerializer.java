...
public final class ParcelableArraySerializer implements c {
    ...
    private static final g descriptor = q.q("kotlin.Array<android.os.Parcelable>", new g[0]);
    ...
    public Parcelable[] deserialize(e decoder) {
        ...
        return SavedStateReader.m131getParcelableArrayimpl(SavedStateReader.m83constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), b0.a(Parcelable.class));
    }
    ...
    public void serialize(f encoder, Parcelable[] value) {
        ...
        SavedStateWriter.m194putParcelableArrayimpl(SavedStateWriter.m169constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
}
