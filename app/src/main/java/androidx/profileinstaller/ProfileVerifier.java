...
public final class ProfileVerifier {
    ...
    public static class Cache {
        ...
        public Cache(int i2, int i8, long j, long j3) {
            this.mSchema = i2;
            this.mResultCode = i8;
    ...
    public static class CompilationStatus {
        ...
        public CompilationStatus(int i2, boolean z2, boolean z7, boolean z8) {
            this.mResultCode = i2;
    ...
    @NonNull
    public static q getCompilationStatusAsync() {
        return sFuture;
    }
    ...
    private static CompilationStatus setCompilationStatus(int i2, boolean z2, boolean z7, boolean z8) {
        CompilationStatus compilationStatus = new CompilationStatus(i2, z2, z7, z8);
