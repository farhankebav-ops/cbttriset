...
class ProfileTranscoder {
    ...
    private static int getMethodBitmapStorageSizeForS(int i2, int i8) {
        return roundUpToByte(Integer.bitCount(i2 & (-2)) * i8) / 8;
    }

    private static int methodFlagBitmapIndex(int i2, int i8, int i9) {
        if (i2 == 1) {
        ...
        throw Encoding.error(a1.a.g(i2, "Unexpected flag: "));
    }
    ...
    private static int readFlagsFromBitmap(@NonNull BitSet bitSet, int i2, int i8) {
        int i9 = bitSet.get(methodFlagBitmapIndex(2, i2, i8)) ? 2 : 0;
        return bitSet.get(methodFlagBitmapIndex(4, i2, i8)) ? i9 | 4 : i9;
    }
    ...
    private static DexProfileData[] readMetadataForNBody(@NonNull InputStream inputStream, int i2, DexProfileData[] dexProfileDataArr) throws IOException {
        ...
        for (int i8 = 0; i8 < i2; i8++) {
            ...
            strArr[i8] = Encoding.readString(inputStream, uInt16);
        }
        for (int i9 = 0; i9 < i2; i9++) {
            DexProfileData dexProfileData = dexProfileDataArr[i9];
            if (!dexProfileData.dexName.equals(strArr[i9])) {
    ...
    private static DexProfileData[] readMetadataV002Body(@NonNull InputStream inputStream, @NonNull byte[] bArr, int i2, DexProfileData[] dexProfileDataArr) throws IOException {
        ...
        for (int i8 = 0; i8 < i2; i8++) {
            ...
            if (dexProfileDataFindByDexName == null) {
                throw Encoding.error(a1.a.l("Missing profile key: ", string));
            }
    ...
    private static void readMethodBitmap(@NonNull InputStream inputStream, @NonNull DexProfileData dexProfileData) throws IOException {
        ...
        int i2 = 0;
        while (true) {
            int i8 = dexProfileData.numMethodIds;
            if (i2 >= i8) {
                return;
            }
            int flagsFromBitmap = readFlagsFromBitmap(bitSetValueOf, i2, i8);
    ...
    private static DexProfileData[] readUncompressedBody(@NonNull InputStream inputStream, @NonNull String str, int i2) throws IOException {
        ...
        for (int i8 = 0; i8 < i2; i8++) {
            ...
            dexProfileDataArr[i8] = new DexProfileData(str, Encoding.readString(inputStream, uInt16), Encoding.readUInt32(inputStream), 0L, uInt162, (int) Encoding.readUInt32(inputStream), (int) Encoding.readUInt32(inputStream), new int[uInt162], new TreeMap());
        }
        for (int i9 = 0; i9 < i2; i9++) {
            DexProfileData dexProfileData = dexProfileDataArr[i9];
    ...
    private static void setMethodBitmapBit(@NonNull byte[] bArr, int i2, int i8, @NonNull DexProfileData dexProfileData) {
        int iMethodFlagBitmapIndex = methodFlagBitmapIndex(i2, i8, dexProfileData.numMethodIds);
        int i9 = iMethodFlagBitmapIndex / 8;
        bArr[i9] = (byte) ((1 << (iMethodFlagBitmapIndex % 8)) | bArr[i9]);
    }
    ...
    private static void writeClasses(@NonNull OutputStream outputStream, @NonNull DexProfileData dexProfileData) throws IOException {
        ...
        while (i2 < length) {
            int i9 = iArr[i2];
            Encoding.writeUInt16(outputStream, i9 - i8);
            i2++;
            i8 = i9;
        }
    }
    ...
    private static void writeMethodBitmapForS(@NonNull OutputStream outputStream, int i2, @NonNull DexProfileData dexProfileData) throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : dexProfileData.methods.entrySet()) {
            ...
            for (int i9 = 1; i9 <= 4; i9 <<= 1) {
                if (i9 != 1 && (i9 & i2) != 0) {
                    if ((i9 & iIntValue2) == i9) {
                        int i10 = (dexProfileData.numMethodIds * i8) + iIntValue;
                        int i11 = i10 / 8;
