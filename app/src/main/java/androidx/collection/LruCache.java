...
public class LruCache<K, V> {
    ...
    private final int safeSizeOf(K k, V v2) {
        int iSizeOf = sizeOf(k, v2);
        if (iSizeOf >= 0) {
            return iSizeOf;
        }
        throw new IllegalStateException(("Negative size: " + k + G5.T + v2).toString());
    }
    ...
    public String toString() {
        ...
        synchronized (this.lock) {
            try {
                ...
                int i8 = this.missCount + i2;
                str = "LruCache[maxSize=" + this.maxSize + ",hits=" + this.hitCount + ",misses=" + this.missCount + ",hitRate=" + (i8 != 0 ? (i2 * 100) / i8 : 0) + "%]";
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    */
    public void trimToSize(int r7) {
        ...
        L24:
            ...
            kotlin.jvm.internal.k.e(r1, r2)     // Catch: java.lang.Throwable -> L14
