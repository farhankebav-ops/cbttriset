...
public final class MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1 extends h implements p {
    ...
    public MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap, c<? super MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1> cVar) {
        super(2, cVar);
    ...
    */
    ...
    public final Object invoke(j jVar, c<? super x> cVar) {
        return ((MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1) create(jVar, cVar)).invokeSuspend(x.f13520a);
    }
}
