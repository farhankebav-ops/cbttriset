...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final void put(int i2, float f4) {
        set(i2, f4);
    }
    ...
    public /* synthetic */ MutableIntFloatMap(int i2, int i8, f fVar) {
        this((i8 & 1) != 0 ? 6 : i2);
    }
    ...
    public final float put(int i2, float f4, float f8) {
        int iFindInsertIndex = findInsertIndex(i2);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(int i2, float f4) {
        int iFindKeyIndex = findKeyIndex(i2);
