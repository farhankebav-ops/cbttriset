...
public final class ScatterSet$SetWrapper$iterator$1 extends h implements p {
    ...
    public ScatterSet$SetWrapper$iterator$1(ScatterSet<E> scatterSet, c<? super ScatterSet$SetWrapper$iterator$1> cVar) {
        super(2, cVar);
    ...
    */
    ...
    public final Object invoke(j jVar, c<? super x> cVar) {
        return ((ScatterSet$SetWrapper$iterator$1) create(jVar, cVar)).invokeSuspend(x.f13520a);
    }
}
