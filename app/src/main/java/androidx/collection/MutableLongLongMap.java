...
public final class MutableLongLongMap extends LongLongMap {
    ...
    private final void resizeStorage(int i2) {
        ...
        int i8 = mutableLongLongMap._capacity;
    ...
    public final void put(long j, long j3) {
        set(j, j3);
    }
    ...
    public final void set(long j, long j3) {
    ...
    public /* synthetic */ MutableLongLongMap(int i2, int i8, f fVar) {
        this((i8 & 1) != 0 ? 6 : i2);
    }
    ...
    public final long put(long j, long j3, long j8) {
        int iFindInsertIndex = findInsertIndex(j);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(long j, long j3) {
        int iFindKeyIndex = findKeyIndex(j);
