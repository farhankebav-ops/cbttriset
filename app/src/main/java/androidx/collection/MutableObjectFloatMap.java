...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k, a defaultValue) {
    ...
    public final void put(K k, float f4) {
        set(k, f4);
    }
    ...
    public /* synthetic */ MutableObjectFloatMap(int i2, int i8, f fVar) {
        this((i8 & 1) != 0 ? 6 : i2);
    }
    ...
    public final float put(K k, float f4, float f8) {
        int iFindIndex = findIndex(k);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        } else {
            f8 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = k;
        this.values[iFindIndex] = f4;
        return f8;
    ...
    public final boolean remove(K k, float f4) {
        int iFindKeyIndex = findKeyIndex(k);
        if (iFindKeyIndex < 0 || this.values[iFindKeyIndex] != f4) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
