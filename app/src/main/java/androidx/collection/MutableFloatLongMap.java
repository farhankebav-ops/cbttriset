...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i9 < i8) {
            if (((jArr2[i9 >> 3] >> ((i9 & 7) << 3)) & 255) < 128) {
                ...
                jArr4[iFindFirstAvailableSlot] = jArr3[i9];
            } else {
                jArr = jArr2;
            }
            i9++;
    ...
    public final long getOrPut(float f4, a defaultValue) {
    ...
    public final void put(float f4, long j) {
        set(f4, j);
    }
    ...
    public final void set(float f4, long j) {
    ...
    public /* synthetic */ MutableFloatLongMap(int i2, int i8, f fVar) {
        this((i8 & 1) != 0 ? 6 : i2);
    }
    ...
    public final long put(float f4, long j, long j3) {
        int iFindInsertIndex = findInsertIndex(f4);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(float f4, long j) {
        int iFindKeyIndex = findKeyIndex(f4);
