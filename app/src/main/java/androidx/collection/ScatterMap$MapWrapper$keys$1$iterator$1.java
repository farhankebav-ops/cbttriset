...
public final class ScatterMap$MapWrapper$keys$1$iterator$1 extends h implements p {
    ...
    public ScatterMap$MapWrapper$keys$1$iterator$1(ScatterMap<K, V> scatterMap, c<? super ScatterMap$MapWrapper$keys$1$iterator$1> cVar) {
        super(2, cVar);
    ...
    */
    ...
    public final Object invoke(j jVar, c<? super x> cVar) {
        return ((ScatterMap$MapWrapper$keys$1$iterator$1) create(jVar, cVar)).invokeSuspend(x.f13520a);
    }
}
