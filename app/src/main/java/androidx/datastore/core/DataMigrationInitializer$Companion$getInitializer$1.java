...
public final class DataMigrationInitializer$Companion$getInitializer$1 extends i implements p {
    ...
    @Override // e6.p
    public final Object invoke(InitializerApi<T> initializerApi, c<? super x> cVar) {
        return ((DataMigrationInitializer$Companion$getInitializer$1) create(initializerApi, cVar)).invokeSuspend(x.f13520a);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (companion.runMigrations(list, initializerApi, this) == aVar) {
                return aVar;
            }
        } else {
            if (i2 != 1) {
