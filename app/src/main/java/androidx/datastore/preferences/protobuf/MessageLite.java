...
public interface MessageLite extends MessageLiteOrBuilder {
    ...
    public interface Builder extends MessageLiteOrBuilder, Cloneable {
        ...
        @CanIgnoreReturnValue
        Builder mergeFrom(byte[] bArr, int i2, int i8) throws InvalidProtocolBufferException;

        @CanIgnoreReturnValue
        Builder mergeFrom(byte[] bArr, int i2, int i8, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
