...
final class UnsafeUtil {
    ...
    public static final class Android32MemoryAccessor extends MemoryAccessor {
        ...
        public void putBoolean(Object obj, long j, boolean z2) {
            if (UnsafeUtil.IS_BIG_ENDIAN) {
                UnsafeUtil.putBooleanBigEndian(obj, j, z2);
            } else {
                UnsafeUtil.putBooleanLittleEndian(obj, j, z2);
            }
        }
    ...
    public static final class JvmMemoryAccessor extends MemoryAccessor {
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void copyMemory(long j, byte[] bArr, long j3, long j8) {
            this.unsafe.copyMemory((Object) null, j, bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j3, j8);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.UnsafeUtil.MemoryAccessor
        public void copyMemory(byte[] bArr, long j, long j3, long j8) {
            this.unsafe.copyMemory(bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j, (Object) null, j3, j8);
        }
