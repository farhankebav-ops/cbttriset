...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i2) {
            ...
            while ((i2 & (-128)) != 0) {
                ...
                this.position = i10 + 1;
                UnsafeUtil.putByte(bArr3, i10, (byte) ((i2 | 128) & 255));
                i2 >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i11 = this.position;
            this.position = i11 + 1;
            UnsafeUtil.putByte(bArr4, i11, (byte) i2);
        ...
        public final void bufferUInt64NoTag(long j) {
            ...
            while ((j & (-128)) != 0) {
                ...
                int i9 = this.position;
                this.position = i9 + 1;
                UnsafeUtil.putByte(bArr3, i9, (byte) ((((int) j) | 128) & 255));
                j >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i10 = this.position;
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public ArrayEncoder(byte[] bArr, int i2, int i8) {
            super();
            if (bArr == null) {
        ...
        public final void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                this.position = i8;
                int iEncode = Utf8.encode(str, this.buffer, i8, spaceLeft());
                this.position = i2;
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                ...
                int i8 = this.position;
                this.position = i8 + 1;
                UnsafeUtil.putByte(bArr2, i8, (byte) j);
                return;
            }
            while ((j & (-128)) != 0) {
                try {
    ...
    public static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i2) throws IOException {
            while ((i2 & (-128)) != 0) {
                try {
                    this.buffer.put((byte) ((i2 | 128) & 255));
                    i2 >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
    ...
    public static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i2) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((i2 & (-128)) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((i2 | 128) & 255));
                    i2 >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
            ...
            while (true) {
                ...
                if ((i2 & (-128)) == 0) {
                    this.position = 1 + j8;
                    UnsafeUtil.putByte(j8, (byte) i2);
                    return;
                } else {
                    this.position = j8 + 1;
                    UnsafeUtil.putByte(j8, (byte) ((i2 | 128) & 255));
                    i2 >>>= 7;
                }
            }
        }
        ...
        public void write(byte[] bArr, int i2, int i8) throws IOException {
            if (bArr != null && i2 >= 0 && i8 >= 0 && bArr.length - i8 >= i2) {
                ...
                long j8 = this.position;
                if (j3 >= j8) {
                    UnsafeUtil.copyMemory(bArr, i2, j8, j);
                    this.position += j;
                    return;
                }
            }
    ...
    public static int computeInt32SizeNoTag(int i2) {
        return computeUInt64SizeNoTag(i2);
    }
    ...
    public static CodedOutputStream newInstance(byte[] bArr, int i2, int i8) {
        return new ArrayEncoder(bArr, i2, i8);
    }
