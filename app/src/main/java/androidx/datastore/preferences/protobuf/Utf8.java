...
final class Utf8 {
    ...
    public static abstract class Processor {
        ...
        public final String decodeUtf8Default(ByteBuffer byteBuffer, int i2, int i8) throws InvalidProtocolBufferException {
            ...
            while (i2 < i9) {
                ...
                if (DecodeUtil.isOneByte(b9)) {
                    ...
                    i2 += 2;
                    DecodeUtil.handleTwoBytes(b9, byteBuffer.get(i12), cArr, i11);
                    i11++;
                    ...
                    int i14 = i2 + 2;
                    i2 += 3;
                    DecodeUtil.handleThreeBytes(b9, byteBuffer.get(i12), byteBuffer.get(i14), cArr, i11);
                    i11++;
                } else {
                    if (i12 >= i9 - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    i2 += 4;
                    DecodeUtil.handleFourBytes(b9, b11, b12, byteBuffer.get(i15), cArr, i11);
                    i11 += 2;
                }
            }
        ...
        public abstract int encodeUtf8(String str, byte[] bArr, int i2, int i8);
        ...
        */
        ...
        private static int partialIsValidUtf8(ByteBuffer byteBuffer, int i2, int i8) {
            int iEstimateConsecutiveAscii = i2 + Utf8.estimateConsecutiveAscii(byteBuffer, i2, i8);
            while (iEstimateConsecutiveAscii < i8) {
                ...
                if (b8 >= 0) {
                    ...
                    if (b8 >= -16) {
                        if (i9 >= i8 - 2) {
                            return Utf8.incompleteStateFor(byteBuffer, b8, i9, i8 - i9);
                        }
    ...
    public static int encode(String str, byte[] bArr, int i2, int i8) {
        return processor.encodeUtf8(str, bArr, i2, i8);
    }
    ...
    public static int encodedLength(String str) {
        ...
        while (true) {
            if (i2 < length) {
                char cCharAt = str.charAt(i2);
                if (cCharAt >= 2048) {
                    iEncodedLengthGeneral += encodedLengthGeneral(str, i2);
                    break;
                }
    ...
    private static int encodedLengthGeneral(String str, int i2) {
        int length = str.length();
        int i8 = 0;
        while (i2 < length) {
            char cCharAt = str.charAt(i2);
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        private static int unsafeEstimateConsecutiveAscii(byte[] bArr, long j, int i2) {
            ...
            while (true) {
                int i10 = i8 + 8;
                if (i10 > i2 || (UnsafeUtil.getLong((Object) bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j += 8;
                i8 = i10;
        ...
        public String decodeUtf8(byte[] bArr, int i2, int i8) throws InvalidProtocolBufferException {
            ...
            if (str.indexOf(65533) >= 0 && !Arrays.equals(str.getBytes(charset), Arrays.copyOfRange(bArr, i2, i8 + i2))) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
            return str;
        }
        ...
        public String decodeUtf8Direct(ByteBuffer byteBuffer, int i2, int i8) throws InvalidProtocolBufferException {
            ...
            while (jAddressOffset < j) {
                ...
                if (DecodeUtil.isOneByte(b9)) {
                    ...
                    DecodeUtil.handleOneByte(b9, cArr, i11);
                    while (j3 < j) {
                        byte b10 = UnsafeUtil.getByte(j3);
                        if (!DecodeUtil.isOneByte(b10)) {
                            break;
                        }
                        j3++;
                        DecodeUtil.handleOneByte(b10, cArr, i9);
                        i9++;
                    }
                    jAddressOffset = j3;
                } else if (DecodeUtil.isTwoBytes(b9)) {
                    ...
                    jAddressOffset += 2;
                    DecodeUtil.handleTwoBytes(b9, UnsafeUtil.getByte(j3), cArr, i11);
                    i11++;
                } else if (DecodeUtil.isThreeBytes(b9)) {
                    if (j3 >= j - 1) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    jAddressOffset += 3;
                    i9 = i11 + 1;
                    DecodeUtil.handleThreeBytes(b9, UnsafeUtil.getByte(j3), UnsafeUtil.getByte(j8), cArr, i11);
                } else {
                    if (j3 >= j - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
                    byte b11 = UnsafeUtil.getByte(j3);
                    long j9 = jAddressOffset + 3;
                    byte b12 = UnsafeUtil.getByte(2 + jAddressOffset);
                    jAddressOffset += 4;
                    DecodeUtil.handleFourBytes(b9, b11, b12, UnsafeUtil.getByte(j9), cArr, i11);
                    i11 += 2;
                }
                i11 = i9;
            }
        ...
        @Override // androidx.datastore.preferences.protobuf.Utf8.Processor
        public int encodeUtf8(String str, byte[] bArr, int i2, int i8) {
            long j;
            long j3;
            long j8;
            int i9;
            ...
            if (length > i8 || bArr.length - i8 < i2) {
                throw new ArrayIndexOutOfBoundsException("Failed writing " + str.charAt(length - 1) + " at index " + (i2 + i8));
            }
            int i10 = 0;
            while (true) {
                j = 1;
            ...
            while (i10 < length) {
                ...
                if (cCharAt2 < 128 && j9 < j10) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j9 > j10 - 3) {
                        ...
                        if (i11 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                ...
                                UnsafeUtil.putByte(bArr, j9 + j3, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j11 = j9 + 3;
                    ...
                    j8 = j10;
                    long j12 = j9 + 2;
                    UnsafeUtil.putByte(bArr, j9 + j3, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                    j9 += 3;
                ...
                if (cCharAt2 >= c7 || jPosition >= jLimit) {
                    ...
                    if (cCharAt2 < 2048 && jPosition <= jLimit - 2) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || jPosition > jLimit - 3) {
                            ...
                            j9 = jLimit;
                            if (jPosition > j9 - 4) {
                                if (55296 <= cCharAt2 && cCharAt2 <= 57343 && ((i2 = i8 + 1) == length || !Character.isSurrogatePair(cCharAt2, str.charAt(i2)))) {
                            ...
                            if (i9 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    ...
                                    c8 = 128;
                                    UnsafeUtil.putByte(jPosition + j3, (byte) (((codePoint >>> 12) & 63) | 128));
                        ...
                        j9 = jLimit;
                        UnsafeUtil.putByte(jPosition + j3, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        jPosition += 3;
    ...
    public static final class SafeProcessor extends Processor {
        ...
        public String decodeUtf8(byte[] bArr, int i2, int i8) throws InvalidProtocolBufferException {
            ...
            while (i2 < i9) {
                ...
                if (DecodeUtil.isOneByte(b9)) {
                    ...
                    i2 += 2;
                    DecodeUtil.handleTwoBytes(b9, bArr[i12], cArr, i11);
                    i11++;
                } else if (DecodeUtil.isThreeBytes(b9)) {
                    if (i12 >= i9 - 1) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    int i14 = i2 + 2;
                    i2 += 3;
                    DecodeUtil.handleThreeBytes(b9, bArr[i12], bArr[i14], cArr, i11);
                    i11++;
                } else {
                    if (i12 >= i9 - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    byte b12 = bArr[i2 + 2];
                    i2 += 4;
                    DecodeUtil.handleFourBytes(b9, b11, b12, bArr[i15], cArr, i11);
                    i11 += 2;
                }
            }
            return new String(cArr, 0, i11);
        ...
        public int encodeUtf8(String str, byte[] bArr, int i2, int i8) {
            ...
            int i11 = i8 + i2;
            int i12 = 0;
            while (i12 < length && (i10 = i12 + i2) < i11 && (cCharAt = str.charAt(i12)) < 128) {
