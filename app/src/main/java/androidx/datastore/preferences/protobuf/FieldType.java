...
public final class FieldType {
    ...
    private FieldType(String str, int i2, int i8, Collection collection, JavaType javaType) {
        int i9;
        this.id = i8;
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i9 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i9 == 2 || i9 == 3) ? false : true;
    }
