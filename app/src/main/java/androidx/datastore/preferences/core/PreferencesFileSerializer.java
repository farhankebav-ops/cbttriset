...
public final class PreferencesFileSerializer implements Serializer<Preferences> {
    ...
    public Object readFrom(InputStream inputStream, c<? super Preferences> cVar) throws IOException {
    ...
    public /* bridge */ /* synthetic */ Object writeTo(Preferences preferences, OutputStream outputStream, c cVar) {
        return writeTo2(preferences, outputStream, (c<? super x>) cVar);
    }
    ...
    public Object writeTo2(Preferences preferences, OutputStream outputStream, c<? super x> cVar) throws IOException {
