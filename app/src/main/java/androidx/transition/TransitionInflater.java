...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        if (attributeValue == null) {
            throw new InflateException(a1.a.C(str, " tag must have a 'class' attribute"));
        }
        try {
    ...
    */
                            ...
                            if (namedString2 != null) {
                                ...
                                if (namedString3 != null) {
                                    try {
                                        ...
                                        throw new RuntimeException(a1.a.l("Could not create ", namedString3), e);
                                    }
                                } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, @NonNull ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        if (namedResourceId >= 0 && (transitionInflateTransition = inflateTransition(namedResourceId)) != null) {
            if (sceneForLayout2 == null) {
                throw new RuntimeException(a1.a.g(namedResourceId, "No toScene for transition ID "));
            }
    ...
    @Nullable
    public TransitionManager inflateTransitionManager(int i2, @NonNull ViewGroup viewGroup) {
        XmlResourceParser xml = this.mContext.getResources().getXml(i2);
        try {
            try {
