...
public class ChangeTransform extends Transition {
    ...
    public static class Listener extends AnimatorListenerAdapter {
        ...
        public Listener(View view, Transforms transforms, PathAnimatorMatrix pathAnimatorMatrix, Matrix matrix, boolean z2, boolean z7) {
    ...
    public static class Transforms {
        ...
        public int hashCode() {
            ...
            int iFloatToIntBits2 = (iFloatToIntBits + (f8 != 0.0f ? Float.floatToIntBits(f8) : 0)) * 31;
    ...
    public static void setTransforms(View view, float f4, float f8, float f9, float f10, float f11, float f12, float f13, float f14) {
