...
public class ChangeBounds extends Transition {
    ...
    public static class ClipListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public ClipListener(View view, Rect rect, boolean z2, Rect rect2, boolean z7, int i2, int i8, int i9, int i10, int i11, int i12, int i13, int i14) {
            this.mView = view;
        ...
        public void onAnimationStart(Animator animator, boolean z2) {
            ...
            int i8 = z2 ? this.mEndTop : this.mStartTop;
            ViewUtils.setLeftTopRightBottom(this.mView, i2, i8, iMax + i2, iMax2 + i8);
    ...
    static {
        ...
        POSITION_PROPERTY = new Property<View, PointF>(cls, C2300e4.h.L) { // from class: androidx.transition.ChangeBounds.5
            @Override // android.util.Property
            public PointF get(View view) {
                return null;
            }
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (this.mResizeClip) {
            ViewUtils.setLeftTopRightBottom(view, i12, i14, i12 + Math.max(i20, i22), i14 + Math.max(i21, i23));
            if (i12 == i13 && i14 == i15) {
                ...
                i9 = i17;
                i10 = i13;
                objectAnimatorOfPointF = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i12, i14, i13, i15));
            }
            ...
            if (rect.equals(rect6)) {
                ...
                ClipListener clipListener = new ClipListener(view, rect, z2, rect6, i25, i12, i14, i16, i18, i10, i15, i9, i8);
            ...
            if (i24 != 2) {
                animatorMergeAnimators = (i12 == i13 && i14 == i15) ? ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(i16, i18, i17, i19)) : ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(i12, i14, i13, i15));
            } else if (i20 == i22 && i21 == i23) {
                animatorMergeAnimators = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i12, i14, i13, i15));
            } else {
                ViewBounds viewBounds = new ViewBounds(view);
                ObjectAnimator objectAnimatorOfPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(i12, i14, i13, i15));
                ObjectAnimator objectAnimatorOfPointF3 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(i16, i18, i17, i19));
