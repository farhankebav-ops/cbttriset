...
public class Fade extends Visibility {
    ...
    private Animator createAnimation(View view, float f4, float f8) {
        if (f4 == f8) {
            return null;
        }
        ViewUtils.setTransitionAlpha(view, f4);
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, ViewUtils.TRANSITION_ALPHA, f8);
    ...
    private static float getStartAlpha(TransitionValues transitionValues, float f4) {
        Float f8;
        return (transitionValues == null || (f8 = (Float) transitionValues.values.get(PROPNAME_TRANSITION_ALPHA)) == null) ? f4 : f8.floatValue();
    }
