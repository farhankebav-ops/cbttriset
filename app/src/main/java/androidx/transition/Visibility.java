...
public abstract class Visibility extends Transition {
    ...
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            int i8 = visibilityInfo.mEndVisibility;
            if (i2 != i8 || visibilityInfo.mStartParent != visibilityInfo.mEndParent) {
                if (i2 != i8) {
                    if (i2 == 0) {
                        visibilityInfo.mFadeIn = false;
    ...
    @Nullable
    public Animator onAppear(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, int i2, @Nullable TransitionValues transitionValues2, int i8) {
 ...
 binds: [B:26:0x003e, B:31:0x004d, B:37:0x0076, B:39:0x0079, B:41:0x007f, B:43:0x0083, B:34:0x0065] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public android.animation.Animator onDisappear(@androidx.annotation.NonNull android.view.ViewGroup r10, @androidx.annotation.Nullable androidx.transition.TransitionValues r11, int r12, @androidx.annotation.Nullable androidx.transition.TransitionValues r13, int r14) {
        /*
