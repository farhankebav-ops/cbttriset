...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int toVolumeStreamType(boolean z2, AudioAttributesCompat audioAttributesCompat) {
    ...
    public static int toVolumeStreamType(boolean z2, int i2, int i8) {
        if ((i2 & 1) == 1) {
            return z2 ? 1 : 7;
        }
        if ((i2 & 4) == 4) {
        ...
        switch (i8) {
            ...
            default:
                if (z2) {
                    throw new IllegalArgumentException(a.h(i8, "Unknown usage value ", " in audio attributes"));
                }
                return 3;
        }
    }
