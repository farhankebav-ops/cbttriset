...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    public class MyNodeProvider extends AccessibilityNodeProviderCompat {
        ...
        public AccessibilityNodeInfoCompat findFocus(int i2) {
            int i8 = i2 == 2 ? ExploreByTouchHelper.this.mAccessibilityFocusedVirtualViewId : ExploreByTouchHelper.this.mKeyboardFocusedVirtualViewId;
        ...
        public boolean performAction(int i2, int i8, Bundle bundle) {
            return ExploreByTouchHelper.this.performAction(i2, i8, bundle);
        }
    }
    ...
    private AccessibilityEvent createEvent(int i2, int i8) {
        return i2 != -1 ? createEventForChild(i2, i8) : createEventForHost(i8);
    }

    private AccessibilityEvent createEventForChild(int i2, int i8) {
    ...
    private boolean performActionForChild(int i2, int i8, Bundle bundle) {
        return i8 != 1 ? i8 != 2 ? i8 != 64 ? i8 != 128 ? onPerformActionForVirtualView(i2, i8, bundle) : clearAccessibilityFocus(i2) : requestAccessibilityFocus(i2) : clearKeyboardFocusForVirtualView(i2) : requestKeyboardFocusForVirtualView(i2);
    }
    ...
    private boolean requestAccessibilityFocus(int i2) {
        int i8;
        if (!this.mManager.isEnabled() || !this.mManager.isTouchExplorationEnabled() || (i8 = this.mAccessibilityFocusedVirtualViewId) == i2) {
            return false;
        }
        if (i8 != Integer.MIN_VALUE) {
    ...
    */
    ...
    public abstract int getVirtualViewAt(float f4, float f8);
    ...
    public abstract boolean onPerformActionForVirtualView(int i2, int i8, @Nullable Bundle bundle);

    public abstract void onPopulateNodeForVirtualView(int i2, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat);

    public boolean performAction(int i2, int i8, Bundle bundle) {
        return i2 != -1 ? performActionForChild(i2, i8, bundle) : performActionForHost(i8, bundle);
    }

    public final boolean requestKeyboardFocusForVirtualView(int i2) {
        int i8;
        if ((!this.mHost.isFocused() && !this.mHost.requestFocus()) || (i8 = this.mKeyboardFocusedVirtualViewId) == i2) {
            return false;
        }
        if (i8 != Integer.MIN_VALUE) {
            clearKeyboardFocusForVirtualView(i8);
    ...
    public final boolean sendEventForVirtualView(int i2, int i8) {
        ViewParent parent;
        if (i2 == Integer.MIN_VALUE || !this.mManager.isEnabled() || (parent = this.mHost.getParent()) == null) {
            return false;
        }
        return parent.requestSendAccessibilityEvent(this.mHost, createEvent(i2, i8));
    }

    public final void invalidateVirtualView(int i2, int i8) {
        ViewParent parent;
        if (i2 == Integer.MIN_VALUE || !this.mManager.isEnabled() || (parent = this.mHost.getParent()) == null) {
            return;
        }
