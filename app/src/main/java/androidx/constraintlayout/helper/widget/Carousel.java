...
public class Carousel extends MotionHelper {
    ...
    public Carousel(Context context) {
        ...
        this.mUpdateRunnable = new Runnable() { // from class: androidx.constraintlayout.helper.widget.Carousel.1
            ...
            public void run() {
                ...
                final float f4 = Carousel.this.mDampening * velocity;
                if (Carousel.this.mIndex != 0 || Carousel.this.mPreviousIndex <= Carousel.this.mIndex) {
                    if (Carousel.this.mIndex != Carousel.this.mAdapter.count() - 1 || Carousel.this.mPreviousIndex >= Carousel.this.mIndex) {
                        Carousel.this.mMotionLayout.post(new Runnable() { // from class: androidx.constraintlayout.helper.widget.Carousel.1.1
                            @Override // java.lang.Runnable
                            public void run() {
                                Carousel.this.mMotionLayout.touchAnimateTo(5, 1.0f, f4);
                            }
                        });
                    }
                }
    ...
    public void updateItems() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (this.mInfiniteCarousel) {
                if (iCount < 0) {
                    ...
                    int i9 = this.mEmptyViewBehavior;
                    if (i9 != 4) {
        ...
        if (i10 != -1 && i10 != this.mIndex) {
            this.mMotionLayout.post(new b(this, 10));
    ...
    private boolean updateViewVisibility(View view, int i2) {
        ...
        for (int i8 : motionLayout.getConstraintSetIds()) {
            zUpdateViewVisibility |= updateViewVisibility(i8, view, i2);
        }
    ...
    public void onAttachedToWindow() {
        ...
        if (getParent() instanceof MotionLayout) {
            ...
            for (int i2 = 0; i2 < this.mCount; i2++) {
                ...
                if (this.mFirstViewReference == i8) {
                    this.mStartIndex = i2;
                }
    ...
    public void transitionToIndex(int i2, int i8) {
    ...
    private boolean updateViewVisibility(int i2, View view, int i8) {
