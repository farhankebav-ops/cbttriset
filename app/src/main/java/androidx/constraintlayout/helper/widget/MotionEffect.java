        ...
        if (attributeSet != null) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == R.styleable.MotionEffect_motionEffect_start) {
                    int i8 = typedArrayObtainStyledAttributes.getInt(index, this.mMotionEffectStart);
                    this.mMotionEffectStart = i8;
                    this.mMotionEffectStart = Math.max(Math.min(i8, 99), 0);
                } else if (index == R.styleable.MotionEffect_motionEffect_end) {
                    int i9 = typedArrayObtainStyledAttributes.getInt(index, this.mMotionEffectEnd);
                    this.mMotionEffectEnd = i9;
                    this.mMotionEffectEnd = Math.max(Math.min(i9, 99), 0);
            ...
            int i10 = this.mMotionEffectStart;
            int i11 = this.mMotionEffectEnd;
            if (i10 == i11) {
                if (i10 > 0) {
                    this.mMotionEffectStart = i10 - 1;
                } else {
                    this.mMotionEffectEnd = i11 + 1;
                }
            }
