...
public class MockView extends View {
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f8 = height;
            canvas2 = canvas;
            canvas2.drawLine(0.0f, 0.0f, f4, f8, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f8, f4, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, 0.0f, f4, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(f4, 0.0f, f4, f8, this.mPaintDiagonals);
            canvas2.drawLine(f4, f8, 0.0f, f8, this.mPaintDiagonals);
        ...
        int i2 = rect.left;
        int i8 = this.mMargin;
        rect.set(i2 - i8, rect.top - i8, rect.right + i8, rect.bottom + i8);
