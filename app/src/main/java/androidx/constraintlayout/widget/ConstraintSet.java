...
public class ConstraintSet {
        ...
        public static class Delta {
            ...
            public void applyDelta(Constraint constraint) {
                ...
                for (int i8 = 0; i8 < this.mCountFloat; i8++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeFloat[i8], this.mValueFloat[i8]);
                }
                for (int i9 = 0; i9 < this.mCountString; i9++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeString[i9], this.mValueString[i9]);
                }
            ...
            public void printDelta(String str) {
                ...
                for (int i8 = 0; i8 < this.mCountFloat; i8++) {
                    Log.v(str, this.mTypeFloat[i8] + " = " + this.mValueFloat[i8]);
                }
                Log.v(str, "strings");
                for (int i9 = 0; i9 < this.mCountString; i9++) {
                    Log.v(str, this.mTypeString[i9] + " = " + this.mValueString[i9]);
                }
    ...
    public static class Layout {
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                int i8 = sMapToConstant.get(index);
                switch (i8) {
                    case 1:
    ...
    public class WriteXmlEngine {
        ...
        public WriteXmlEngine(Writer writer, ConstraintLayout constraintLayout, int i2) throws IOException {
            this.mWriter = writer;
        ...
        private void writeBaseDimension(String str, int i2, int i8) throws IOException {
            if (i2 != i8) {
                if (i2 == -2) {
        ...
        private void writeBoolen(String str, boolean z2, boolean z7) throws IOException {
            if (z2 != z7) {
                this.mWriter.write(SPACE + str + "=\"" + z2 + "dp\"");
            }
        }

        private void writeDimension(String str, int i2, int i8) throws IOException {
            if (i2 != i8) {
                this.mWriter.write(SPACE + str + "=\"" + i2 + "dp\"");
            }
        }

        private void writeEnum(String str, int i2, String[] strArr, int i8) throws IOException {
            if (i2 != i8) {
                Writer writer = this.mWriter;
                StringBuilder sbY = a.y(SPACE, str, "=\"");
                sbY.append(strArr[i2]);
                sbY.append("\"");
        ...
        public String getName(int i2) {
            if (this.mIdMap.containsKey(Integer.valueOf(i2))) {
                return a.r(new StringBuilder("@+id/"), this.mIdMap.get(Integer.valueOf(i2)), "");
            }
            if (i2 == 0) {
        ...
        public String lookup(int i2) {
            try {
                ...
                int i8 = this.mUnknownCount + 1;
                this.mUnknownCount = i8;
                sb.append(i8);
                return sb.toString();
        ...
        public void writeCircle(int i2, float f4, int i8) throws IOException {
            if (i2 == -1) {
                return;
            }
            ...
            this.mWriter.write(", " + f4);
            this.mWriter.write(i8 + C2300e4.i.e);
        }

        public void writeConstraint(String str, int i2, String str2, int i8, int i9) throws IOException {
            if (i2 == -1) {
                return;
            }
        ...
        public void writeVariable(String str, float f4, float f8) throws IOException {
            if (f4 == f8) {
                return;
            }
            this.mWriter.write(SPACE + str);
        ...
        public void writeVariable(String str, int[] iArr) throws IOException {
            ...
            while (i2 < iArr.length) {
                ...
                sb.append(i2 == 0 ? C2300e4.i.f8403d : ", ");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int lookupID(TypedArray typedArray, int i2, int i8) {
    ...
    */
        ...
        if (strSubstring2.length() > 0) {
            ...
            try {
                if ("weight".equalsIgnoreCase(strTrim)) {
                    float f4 = Float.parseFloat(strTrim2);
                    if (obj instanceof ConstraintLayout.LayoutParams) {
                        ...
                        if (i2 == 0) {
                            ...
                            layoutParams2.verticalWeight = f4;
                            return;
                        }
                    }
                    if (obj instanceof Layout) {
                        ...
                        if (i2 == 0) {
                            layout.mWidth = 0;
                            layout.horizontalWeight = f4;
                            return;
                        } else {
                            layout.mHeight = 0;
                            layout.verticalWeight = f4;
                            return;
                        }
                    }
                    if (obj instanceof Constraint.Delta) {
        ...
        if (str != null) {
            ...
            try {
                if (iIndexOf2 < 0 || iIndexOf2 >= length - 1) {
                    String strSubstring2 = str.substring(i8);
                    if (strSubstring2.length() > 0) {
                        fAbs = Float.parseFloat(strSubstring2);
                    }
                } else {
                    String strSubstring3 = str.substring(i8, iIndexOf2);
                    String strSubstring4 = str.substring(iIndexOf2 + 1);
                    if (strSubstring3.length() > 0 && strSubstring4.length() > 0) {
                        float f4 = Float.parseFloat(strSubstring3);
                        float f8 = Float.parseFloat(strSubstring4);
                        if (f4 > 0.0f && f8 > 0.0f) {
                            fAbs = i2 == 1 ? Math.abs(f8 / f4) : Math.abs(f4 / f8);
                        }
                    }
                }
            } catch (NumberFormatException unused) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i2, float f4) {
        if (i2 == 19) {
    ...
    private static String[] splitString(String str) {
        ...
        for (int i8 = 0; i8 < charArray.length; i8++) {
            ...
            if (c7 == ',' && !z2) {
                arrayList.add(new String(charArray, i2, i8 - i2));
                i2 = i8 + 1;
            } else if (c7 == '\"') {
                z2 = !z2;
            }
    ...
    public void addToHorizontalChain(int i2, int i8, int i9) {
        connect(i2, 1, i8, i8 == 0 ? 1 : 2, 0);
        connect(i2, 2, i9, i9 == 0 ? 2 : 1, 0);
        if (i8 != 0) {
            connect(i8, 2, i2, 1, 0);
        }
        if (i9 != 0) {
    ...
    public void addToHorizontalChainRTL(int i2, int i8, int i9) {
        connect(i2, 6, i8, i8 == 0 ? 6 : 7, 0);
        connect(i2, 7, i9, i9 == 0 ? 7 : 6, 0);
        if (i8 != 0) {
            connect(i8, 7, i2, 6, 0);
        }
        if (i9 != 0) {
    ...
    public void addToVerticalChain(int i2, int i8, int i9) {
        connect(i2, 3, i8, i8 == 0 ? 3 : 4, 0);
        connect(i2, 4, i9, i9 == 0 ? 4 : 3, 0);
        if (i8 != 0) {
            connect(i8, 4, i2, 3, 0);
        }
        if (i9 != 0) {
    ...
    public void center(int i2, int i8, int i9, int i10, int i11, int i12, int i13, float f4) {
        if (i10 < 0) {
        ...
        if (i9 == 1 || i9 == 2) {
            connect(i2, 1, i8, i9, i10);
            connect(i2, 2, i11, i12, i13);
        ...
        if (i9 == 6 || i9 == 7) {
            connect(i2, 6, i8, i9, i10);
            connect(i2, 7, i11, i12, i13);
            Constraint constraint2 = this.mConstraints.get(Integer.valueOf(i2));
            if (constraint2 != null) {
                constraint2.layout.horizontalBias = f4;
                return;
            }
            return;
        }
        connect(i2, 3, i8, i9, i10);
        connect(i2, 4, i11, i12, i13);
        Constraint constraint3 = this.mConstraints.get(Integer.valueOf(i2));
        if (constraint3 != null) {
            constraint3.layout.verticalBias = f4;
        }
    }

    public void centerHorizontally(int i2, int i8, int i9, int i10, int i11, int i12, int i13, float f4) {
        connect(i2, 1, i8, i9, i10);
        connect(i2, 2, i11, i12, i13);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i2));
        if (constraint != null) {
    ...
    public void centerHorizontallyRtl(int i2, int i8, int i9, int i10, int i11, int i12, int i13, float f4) {
        connect(i2, 6, i8, i9, i10);
        connect(i2, 7, i11, i12, i13);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i2));
        if (constraint != null) {
    ...
    public void centerVertically(int i2, int i8, int i9, int i10, int i11, int i12, int i13, float f4) {
        connect(i2, 3, i8, i9, i10);
        connect(i2, 4, i11, i12, i13);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i2));
        if (constraint != null) {
    ...
    public void connect(int i2, int i8, int i9, int i10, int i11) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i2))) {
            this.mConstraints.put(Integer.valueOf(i2), new Constraint());
        }
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i2));
        ...
        switch (i8) {
            case 1:
                if (i10 == 1) {
                    ...
                    if (i10 != 2) {
                        throw new IllegalArgumentException(a.r(new StringBuilder("Left to "), sideToString(i10), " undefined"));
                    }
                    Layout layout2 = constraint.layout;
            ...
            case 2:
                if (i10 == 1) {
                    ...
                    if (i10 != 2) {
                        throw new IllegalArgumentException(a.r(new StringBuilder("right to "), sideToString(i10), " undefined"));
                    }
                    Layout layout4 = constraint.layout;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(a.r(sb, sideToString(i10), " unknown"));
        }
    }

    public void constrainCircle(int i2, int i8, int i9, float f4) {
    ...
    public void constrainDefaultHeight(int i2, int i8) {
        get(i2).layout.heightDefault = i8;
    }

    public void constrainDefaultWidth(int i2, int i8) {
        get(i2).layout.widthDefault = i8;
    }

    public void constrainHeight(int i2, int i8) {
        get(i2).layout.mHeight = i8;
    }

    public void constrainMaxHeight(int i2, int i8) {
        get(i2).layout.heightMax = i8;
    }

    public void constrainMaxWidth(int i2, int i8) {
        get(i2).layout.widthMax = i8;
    }

    public void constrainMinHeight(int i2, int i8) {
        get(i2).layout.heightMin = i8;
    }

    public void constrainMinWidth(int i2, int i8) {
        get(i2).layout.widthMin = i8;
    }

    public void constrainPercentHeight(int i2, float f4) {
        get(i2).layout.heightPercent = f4;
    }

    public void constrainPercentWidth(int i2, float f4) {
        get(i2).layout.widthPercent = f4;
    }

    public void constrainWidth(int i2, int i8) {
        get(i2).layout.mWidth = i8;
    }
    ...
    public void create(int i2, int i8) {
        Layout layout = get(i2).layout;
        layout.mIsGuideline = true;
        layout.orientation = i8;
    }

    public void createBarrier(int i2, int i8, int i9, int... iArr) {
        Layout layout = get(i2).layout;
        layout.mHelperType = 1;
    ...
    public void createHorizontalChain(int i2, int i8, int i9, int i10, int[] iArr, float[] fArr, int i11) {
        createHorizontalChain(i2, i8, i9, i10, iArr, fArr, i11, 1, 2);
    }

    public void createHorizontalChainRtl(int i2, int i8, int i9, int i10, int[] iArr, float[] fArr, int i11) {
        createHorizontalChain(i2, i8, i9, i10, iArr, fArr, i11, 6, 7);
    }

    public void createVerticalChain(int i2, int i8, int i9, int i10, int[] iArr, float[] fArr, int i11) {
        if (iArr.length < 2) {
    ...
    public void load(Context context, int i2) {
        ...
        try {
            ...
            Log.e(TAG, "Error parsing resource: " + i2, e);
        } catch (XmlPullParserException e4) {
            Log.e(TAG, "Error parsing resource: " + i2, e4);
        }
    }
    ...
    */
    ...
    public void parseColorAttributes(Constraint constraint, String str) {
        ...
        for (int i2 = 0; i2 < strArrSplit.length; i2++) {
            String[] strArrSplit2 = strArrSplit[i2].split(C2300e4.i.f8399b);
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i2 = 0; i2 < strArrSplitString.length; i2++) {
            String[] strArrSplit = strArrSplitString[i2].split(C2300e4.i.f8399b);
    ...
    */
    ...
    public void setAlpha(int i2, float f4) {
        get(i2).propertySet.alpha = f4;
    }
    ...
    public void setBarrierType(int i2, int i8) {
        get(i2).layout.mHelperType = i8;
    }

    public void setColorValue(int i2, String str, int i8) {
        get(i2).setColorValue(str, i8);
    }
    ...
    public void setEditorAbsoluteX(int i2, int i8) {
        get(i2).layout.editorAbsoluteX = i8;
    }

    public void setEditorAbsoluteY(int i2, int i8) {
        get(i2).layout.editorAbsoluteY = i8;
    }

    public void setElevation(int i2, float f4) {
        get(i2).transform.elevation = f4;
        get(i2).transform.applyElevation = true;
    }

    public void setFloatValue(int i2, String str, float f4) {
        get(i2).setFloatValue(str, f4);
    }
    ...
    public void setGoneMargin(int i2, int i8, int i9) {
    ...
    public void setGuidelineBegin(int i2, int i8) {
        get(i2).layout.guideBegin = i8;
        get(i2).layout.guideEnd = -1;
        get(i2).layout.guidePercent = -1.0f;
    }

    public void setGuidelineEnd(int i2, int i8) {
        get(i2).layout.guideEnd = i8;
        get(i2).layout.guideBegin = -1;
        get(i2).layout.guidePercent = -1.0f;
    }

    public void setGuidelinePercent(int i2, float f4) {
        get(i2).layout.guidePercent = f4;
        get(i2).layout.guideEnd = -1;
        get(i2).layout.guideBegin = -1;
    }

    public void setHorizontalBias(int i2, float f4) {
        get(i2).layout.horizontalBias = f4;
    }

    public void setHorizontalChainStyle(int i2, int i8) {
        get(i2).layout.horizontalChainStyle = i8;
    }

    public void setHorizontalWeight(int i2, float f4) {
        get(i2).layout.horizontalWeight = f4;
    }

    public void setIntValue(int i2, String str, int i8) {
        get(i2).setIntValue(str, i8);
    }

    public void setLayoutWrapBehavior(int i2, int i8) {
        if (i8 < 0 || i8 > 3) {
            return;
        }
        get(i2).layout.mWrapBehavior = i8;
    }

    public void setMargin(int i2, int i8, int i9) {
        Constraint constraint = get(i2);
        switch (i8) {
            case 1:
    ...
    public void setRotation(int i2, float f4) {
        get(i2).transform.rotation = f4;
    }

    public void setRotationX(int i2, float f4) {
        get(i2).transform.rotationX = f4;
    }

    public void setRotationY(int i2, float f4) {
        get(i2).transform.rotationY = f4;
    }

    public void setScaleX(int i2, float f4) {
        get(i2).transform.scaleX = f4;
    }

    public void setScaleY(int i2, float f4) {
        get(i2).transform.scaleY = f4;
    }
    ...
    public void setTransformPivot(int i2, float f4, float f8) {
        Transform transform = get(i2).transform;
        transform.transformPivotY = f8;
        transform.transformPivotX = f4;
    }

    public void setTransformPivotX(int i2, float f4) {
        get(i2).transform.transformPivotX = f4;
    }

    public void setTransformPivotY(int i2, float f4) {
        get(i2).transform.transformPivotY = f4;
    }

    public void setTranslation(int i2, float f4, float f8) {
        Transform transform = get(i2).transform;
        transform.translationX = f4;
        transform.translationY = f8;
    }

    public void setTranslationX(int i2, float f4) {
        get(i2).transform.translationX = f4;
    }

    public void setTranslationY(int i2, float f4) {
        get(i2).transform.translationY = f4;
    }

    public void setTranslationZ(int i2, float f4) {
        get(i2).transform.translationZ = f4;
    }
    ...
    public void setVerticalBias(int i2, float f4) {
        get(i2).layout.verticalBias = f4;
    }

    public void setVerticalChainStyle(int i2, int i8) {
        get(i2).layout.verticalChainStyle = i8;
    }

    public void setVerticalWeight(int i2, float f4) {
        get(i2).layout.verticalWeight = f4;
    }

    public void setVisibility(int i2, int i8) {
        get(i2).propertySet.visibility = i8;
    }

    public void setVisibilityMode(int i2, int i8) {
        get(i2).propertySet.mVisibilityMode = i8;
    }
    ...
    private void createHorizontalChain(int i2, int i8, int i9, int i10, int[] iArr, float[] fArr, int i11, int i12, int i13) {
        if (iArr.length < 2) {
            throw new IllegalArgumentException("must have 2 or more widgets in a chain");
        }
        if (fArr != null && fArr.length != iArr.length) {
    ...
    public void clear(int i2, int i8) {
        Constraint constraint;
        if (!this.mConstraints.containsKey(Integer.valueOf(i2)) || (constraint = this.mConstraints.get(Integer.valueOf(i2))) == null) {
            return;
        }
    ...
    public class WriteJsonEngine {
        ...
        public WriteJsonEngine(Writer writer, ConstraintLayout constraintLayout, int i2) throws IOException {
            this.mWriter = writer;
            this.mLayout = constraintLayout;
            this.mContext = constraintLayout.getContext();
            this.mFlags = i2;
        ...
        private void writeDimension(String str, int i2, int i8, float f4, int i9, int i10, boolean z2) throws IOException {
            if (i2 != 0) {
                if (i2 == -2) {
            ...
            if (i10 == -1 && i9 == -1) {
                ...
                this.mWriter.write(SPACE + str + ": '" + f4 + "%',\n");
                return;
            }
            if (i8 == 0) {
                Writer writer = this.mWriter;
                StringBuilder sbS = androidx.camera.core.processing.util.a.s(SPACE, i9, str, ": {'spread' ,", ", ");
                sbS.append(i10);
                sbS.append("}\n");
            ...
            if (i8 == 1) {
                ...
                StringBuilder sbS2 = androidx.camera.core.processing.util.a.s(SPACE, i9, str, ": {'wrap' ,", ", ");
                sbS2.append(i10);
                sbS2.append("}\n");
                writer2.write(sbS2.toString());
                return;
            }
            if (i8 != 2) {
                return;
            }
            this.mWriter.write(SPACE + str + ": {'" + f4 + "'% ," + i9 + ", " + i10 + "}\n");
        }

        private void writeGuideline(int i2, int i8, int i9, float f4) throws IOException {
            writeVariable("'orientation'", i2);
            writeVariable("'guideBegin'", i8);
            writeVariable("'guideEnd'", i9);
            writeVariable("'guidePercent'", f4);
        }

        public String getName(int i2) {
            if (this.mIdMap.containsKey(Integer.valueOf(i2))) {
                return a.r(new StringBuilder("'"), this.mIdMap.get(Integer.valueOf(i2)), "'");
            }
            if (i2 == 0) {
                return "'parent'";
            }
        ...
        public void writeVariable(String str, boolean z2, boolean z7) throws IOException {
            if (z2 == z7) {
                return;
            }
            this.mWriter.write(SPACE + str);
    ...
    public void centerHorizontally(int i2, int i8) {
        if (i8 == 0) {
            center(i2, 0, 1, 0, 0, 2, 0, 0.5f);
        } else {
            center(i2, i8, 2, 0, i8, 1, 0, 0.5f);
        }
    }

    public void centerHorizontallyRtl(int i2, int i8) {
        if (i8 == 0) {
            center(i2, 0, 6, 0, 0, 7, 0, 0.5f);
        } else {
            center(i2, i8, 7, 0, i8, 6, 0, 0.5f);
        }
    }

    public void centerVertically(int i2, int i8) {
        if (i8 == 0) {
            center(i2, 0, 3, 0, 0, 4, 0, 0.5f);
        } else {
            center(i2, i8, 4, 0, i8, 3, 0, 0.5f);
        }
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i2, int i8) {
        if (i2 == 6) {
            constraint.layout.editorAbsoluteX = i8;
            return;
        }
        if (i2 == 7) {
            constraint.layout.editorAbsoluteY = i8;
            return;
        }
        if (i2 == 8) {
        ...
        if (i2 == 27) {
            constraint.layout.orientation = i8;
            return;
        }
        if (i2 == 28) {
        ...
        if (i2 == 41) {
            constraint.layout.horizontalChainStyle = i8;
            return;
        }
        if (i2 == 42) {
            constraint.layout.verticalChainStyle = i8;
            return;
        }
        if (i2 == 61) {
            constraint.layout.circleConstraint = i8;
            return;
        }
        if (i2 == 62) {
            constraint.layout.circleRadius = i8;
            return;
        }
        if (i2 == BARRIER_DIRECTION) {
            constraint.layout.mBarrierDirection = i8;
            return;
        }
        if (i2 != BARRIER_MARGIN) {
            switch (i2) {
                case 2:
                    constraint.layout.bottomMargin = i8;
                    break;
                case 11:
                    constraint.layout.goneBottomMargin = i8;
                    break;
                case 12:
                    constraint.layout.goneEndMargin = i8;
                    break;
                case 13:
                    constraint.layout.goneLeftMargin = i8;
                    break;
                case 14:
                    constraint.layout.goneRightMargin = i8;
                    break;
                case 15:
                    constraint.layout.goneStartMargin = i8;
                    break;
                case 16:
                    constraint.layout.goneTopMargin = i8;
                    break;
                case 17:
                    constraint.layout.guideBegin = i8;
                    break;
                case 18:
                    constraint.layout.guideEnd = i8;
                    break;
                case 31:
                ...
                case 34:
                    ...
                    break;
                case 38:
                    constraint.mViewId = i8;
                    break;
                case 64:
                    constraint.motion.mAnimateRelativeTo = i8;
                    break;
                case 66:
                    constraint.motion.mDrawPath = i8;
                    break;
                case PATH_MOTION_ARC /* 76 */:
                    constraint.motion.mPathMotionArc = i8;
                    break;
                case VISIBILITY_MODE /* 78 */:
                    constraint.propertySet.mVisibilityMode = i8;
                    break;
                case BASELINE_MARGIN /* 93 */:
                    constraint.layout.baselineMargin = i8;
                    break;
                case GONE_BASELINE_MARGIN /* 94 */:
                    constraint.layout.goneBaselineMargin = i8;
                    break;
                case LAYOUT_WRAP_BEHAVIOR /* 97 */:
                    constraint.layout.mWrapBehavior = i8;
                    break;
                default:
                    switch (i2) {
                        case 21:
                            constraint.layout.mHeight = i8;
                            break;
                        case 22:
                            constraint.propertySet.visibility = i8;
                            break;
                        case 23:
                            constraint.layout.mWidth = i8;
                            break;
                        case 24:
                        ...
                        default:
                            switch (i2) {
                                case 54:
                                    constraint.layout.widthDefault = i8;
                                    break;
                                case 55:
                                    constraint.layout.heightDefault = i8;
                                    break;
                                case 56:
                                    constraint.layout.widthMax = i8;
                                    break;
                                case 57:
                                    constraint.layout.heightMax = i8;
                                    break;
                                case 58:
                                    constraint.layout.widthMin = i8;
                                    break;
                                case 59:
                                    constraint.layout.heightMin = i8;
                                    break;
                                default:
                                    switch (i2) {
                                        case ANIMATE_CIRCLE_ANGLE_TO /* 82 */:
                                            constraint.motion.mAnimateCircleAngleTo = i8;
                                            break;
                                        case TRANSFORM_PIVOT_TARGET /* 83 */:
                                            constraint.transform.transformPivotTarget = i8;
                                            break;
                                        case QUANTIZE_MOTION_STEPS /* 84 */:
                                            constraint.motion.mQuantizeMotionSteps = i8;
                                            break;
                                        default:
                                            switch (i2) {
                                                case UNUSED /* 87 */:
                                                    break;
                                                case QUANTIZE_MOTION_INTERPOLATOR_TYPE /* 88 */:
                                                    constraint.motion.mQuantizeInterpolatorType = i8;
                                                    break;
                                                case QUANTIZE_MOTION_INTERPOLATOR_ID /* 89 */:
                                                    constraint.motion.mQuantizeInterpolatorID = i8;
                                                    break;
                                                default:
                                                    Log.w(TAG, "Unknown attribute 0x");
                                                    break;
        ...
        constraint.layout.mBarrierMargin = i8;
    }
    ...
    public static void setDeltaValue(Constraint constraint, int i2, String str) {
        ...
        } else if (i2 == CONSTRAINT_TAG) {
            constraint.layout.mConstraintTag = str;
        } else if (i2 != UNUSED) {
            if (i2 != QUANTIZE_MOTION_INTERPOLATOR_STR) {
                Log.w(TAG, "Unknown attribute 0x");
            } else {
    ...
    public void connect(int i2, int i8, int i9, int i10) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i2))) {
            this.mConstraints.put(Integer.valueOf(i2), new Constraint());
        }
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i2));
