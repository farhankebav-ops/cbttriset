...
public class ConstraintLayoutStates {
    ...
    public void updateConstraints(int i2, float f4, float f8) {
        int iFindMatch;
        int i8 = this.mCurrentStateId;
        if (i8 == i2) {
            State stateValueAt = i2 == -1 ? this.mStateList.valueAt(0) : this.mStateList.get(i8);
            int i9 = this.mCurrentConstraintNumber;
            if ((i9 == -1 || !stateValueAt.mVariants.get(i9).match(f4, f8)) && this.mCurrentConstraintNumber != (iFindMatch = stateValueAt.findMatch(f4, f8))) {
        ...
        if (constraintSet2 == null) {
            Log.v("ConstraintLayoutStates", "NO Constraint set found ! id=" + i2 + ", dim =" + f4 + ", " + f8);
            return;
        }
        this.mCurrentConstraintNumber = iFindMatch2;
        ConstraintsChangedListener constraintsChangedListener3 = this.mConstraintsChangedListener;
        if (constraintsChangedListener3 != null) {
            constraintsChangedListener3.preLayoutChange(i2, i11);
        }
        constraintSet2.applyTo(this.mConstraintLayout);
        ConstraintsChangedListener constraintsChangedListener4 = this.mConstraintsChangedListener;
        if (constraintsChangedListener4 != null) {
            constraintsChangedListener4.postLayoutChange(i2, i11);
        }
    }
}
