...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        private boolean isSimilarSpec(int i2, int i8, int i9) {
            if (i2 == i8) {
                return true;
            }
        ...
        public void captureLayoutInfo(int i2, int i8, int i9, int i10, int i11, int i12) {
            this.mPaddingTop = i9;
            this.mPaddingBottom = i10;
            this.mPaddingWidth = i11;
            this.mPaddingHeight = i12;
            this.mLayoutWidthSpec = i2;
            this.mLayoutHeightSpec = i8;
        }
        ...
        public final void didMeasures() {
            ...
            if (size > 0) {
                for (int i8 = 0; i8 < size; i8++) {
                    ((ConstraintHelper) this.mLayout.mConstraintHelpers.get(i8)).updatePostMeasure(this.mLayout);
                }
            }
        }
    ...
    public interface ValueModifier {
        boolean update(int i2, int i8, int i9, View view, LayoutParams layoutParams);
    }
    ...
    private void init(AttributeSet attributeSet, int i2, int i8) {
        this.mLayoutWidget.setCompanionWidget(this);
        this.mLayoutWidget.setMeasurer(this.mMeasurer);
        this.mChildrenByIds.put(getId(), this);
        this.mConstraintSet = null;
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ConstraintLayout_Layout, i2, i8);
    ...
    */
            ...
            for (int i8 = 0; i8 < childCount; i8++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    ...
                    if (strArrSplit.length == 4) {
                        ...
                        canvas.drawLine(f9, f10, f4, f10, paint);
                        canvas.drawLine(f4, f10, f4, f8, paint);
                        paint.setColor(-16711936);
                        canvas.drawLine(f4, f8, f9, f10, paint);
                        canvas.drawLine(f4, f10, f9, f8, paint);
                    }
                }
            }
        }
    ...
    public boolean dynamicUpdateConstraints(int i2, int i8) {
        if (this.mModifiers == null) {
            return false;
        }
        ...
        while (i9 < size3) {
            int i10 = i9 + 1;
            ValueModifier valueModifier = arrayList.get(i9);
            ArrayList<ConstraintWidget> children = this.mLayoutWidget.getChildren();
            int size4 = children.size();
            for (int i11 = 0; i11 < size4; i11++) {
                View view = (View) children.get(i11).getCompanionWidget();
    ...
    public void onLayout(boolean z2, int i2, int i8, int i9, int i10) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.mIsGuideline || layoutParams.mIsHelper || layoutParams.mIsVirtualGroup || zIsInEditMode) && !layoutParams.mIsInPlaceholder) {
                ...
                childAt.layout(x2, y, width, height);
                if ((childAt instanceof Placeholder) && (content = ((Placeholder) childAt).getContent()) != null) {
                    content.setVisibility(0);
                    content.layout(x2, y, width, height);
                }
            }
        }
        int size = this.mConstraintHelpers.size();
    ...
    public void onMeasure(int i2, int i8) {
        ...
        boolean zDynamicUpdateConstraints = this.mDirtyHierarchy | dynamicUpdateConstraints(i2, i8);
        ...
        resolveSystem(this.mLayoutWidget, this.mOptimizationLevel, i2, i8);
        resolveMeasuredDimension(i2, i8, this.mLayoutWidget.getWidth(), this.mLayoutWidget.getHeight(), this.mLayoutWidget.isWidthMeasuredTooSmall(), this.mLayoutWidget.isHeightMeasuredTooSmall());
        Metrics metrics = this.mMetrics;
        if (metrics != null) {
    ...
    public void resolveMeasuredDimension(int i2, int i8, int i9, int i10, boolean z2, boolean z7) {
        Measurer measurer = this.mMeasurer;
        int i11 = measurer.mPaddingHeight;
        int iResolveSizeAndState = View.resolveSizeAndState(i9 + measurer.mPaddingWidth, i2, 0);
        int iResolveSizeAndState2 = View.resolveSizeAndState(i10 + i11, i8, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i2, int i8, int i9) {
        int i10;
        ...
        this.mMeasurer.captureLayoutInfo(i8, i9, iMax, iMax2, paddingWidth, i11);
        ...
        if (iMax3 > 0 || iMax4 > 0) {
            ...
            constraintWidgetContainer.measure(i2, mode, i12, mode2, i13, this.mLastMeasureWidth, this.mLastMeasureHeight, i10, iMax);
        }
        ...
        constraintWidgetContainer.measure(i2, mode, i122, mode2, i132, this.mLastMeasureWidth, this.mLastMeasureHeight, i10, iMax);
    }
 ...
 binds: [B:21:0x004a, B:17:0x003c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public ConstraintLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i8) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                switch (i8) {
                    ...
                    case 31:
                        ...
                        this.matchConstraintDefaultWidth = i9;
                        if (i9 == 1) {
