...
public class ConstraintProperties {
    ...
    public ConstraintProperties addToHorizontalChain(int i2, int i8) {
    ...
    public ConstraintProperties addToHorizontalChainRTL(int i2, int i8) {
    ...
    public ConstraintProperties addToVerticalChain(int i2, int i8) {
    ...
    public ConstraintProperties center(int i2, int i8, int i9, int i10, int i11, int i12, float f4) {
        if (i9 < 0) {
    ...
    public ConstraintProperties centerHorizontally(int i2, int i8, int i9, int i10, int i11, int i12, float f4) {
        connect(1, i2, i8, i9);
        connect(2, i10, i11, i12);
        this.mParams.horizontalBias = f4;
        return this;
    ...
    public ConstraintProperties centerHorizontallyRtl(int i2, int i8, int i9, int i10, int i11, int i12, float f4) {
        connect(6, i2, i8, i9);
        connect(7, i10, i11, i12);
        this.mParams.horizontalBias = f4;
        return this;
    ...
    public ConstraintProperties centerVertically(int i2, int i8, int i9, int i10, int i11, int i12, float f4) {
        connect(3, i2, i8, i9);
        connect(4, i10, i11, i12);
        this.mParams.verticalBias = f4;
        return this;
    ...
    public ConstraintProperties connect(int i2, int i8, int i9, int i10) {
        switch (i2) {
            case 1:
                if (i9 == 1) {
                    ...
                    if (i9 != 2) {
                        throw new IllegalArgumentException(a.r(new StringBuilder("Left to "), sideToString(i9), " undefined"));
                    }
            ...
            case 2:
                if (i9 == 1) {
                    ...
                    if (i9 != 2) {
                        throw new IllegalArgumentException(a.r(new StringBuilder("right to "), sideToString(i9), " undefined"));
                    }
            ...
            case 5:
                if (i9 == 5) {
                    ...
                    layoutParams10.baselineToTop = i8;
                    ...
                    layoutParams11.baselineToBottom = i8;
            ...
            case 6:
                if (i9 == 6) {
                    ...
                    layoutParams12.startToStart = i8;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(a.r(sb, sideToString(i9), " unknown"));
        }
    }
    ...
    public ConstraintProperties goneMargin(int i2, int i8) {
        switch (i2) {
            case 1:
    ...
    public ConstraintProperties margin(int i2, int i8) {
        switch (i2) {
            case 1:
    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (i2 != -1 || i8 != -1) {
            ...
            ConstraintLayout.LayoutParams layoutParams2 = this.mParams;
            if (i2 != -1 && i8 != -1) {
                constraintProperties.connect(2, i8, 1, 0);
                constraintProperties2.connect(1, i2, 2, 0);
            } else if (i2 != -1 || i8 != -1) {
                int i9 = layoutParams2.rightToRight;
                if (i9 != -1) {
                    constraintProperties.connect(2, i9, 2, 0);
                } else {
    ...
    public ConstraintProperties transformPivot(float f4, float f8) {
    ...
    public ConstraintProperties translation(float f4, float f8) {
