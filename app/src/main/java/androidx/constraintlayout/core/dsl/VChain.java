...
public class VChain extends Chain {
    ...
    public void linkToBaseline(Constraint.VAnchor vAnchor, int i2, int i8) {
    ...
    public void linkToBottom(Constraint.VAnchor vAnchor, int i2, int i8) {
    ...
    public void linkToTop(Constraint.VAnchor vAnchor, int i2, int i8) {
