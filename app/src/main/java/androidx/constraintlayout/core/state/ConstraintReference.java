...
public class ConstraintReference implements Reference {
    ...
    public void apply() {
        ...
        float f8 = this.mVerticalChainWeight;
        if (f8 != -1.0f) {
            this.mConstraintWidget.setVerticalWeight(f8);
        }
        ...
        widgetFrame.visibility = i9;
        constraintWidget.setVisibility(i9);
    ...
    public ConstraintReference circularConstraint(Object obj, float f4, float f8) {
        this.mCircularConstraint = get(obj);
        this.mCircularAngle = f4;
        this.mCircularDistance = f8;
