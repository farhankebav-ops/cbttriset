...
public class TransitionBuilder {
    ...
    public static MotionScene.Transition buildTransition(MotionScene motionScene, int i2, int i8, ConstraintSet constraintSet, int i9, ConstraintSet constraintSet2) {
        MotionScene.Transition transition = new MotionScene.Transition(i2, motionScene, i8, i9);
