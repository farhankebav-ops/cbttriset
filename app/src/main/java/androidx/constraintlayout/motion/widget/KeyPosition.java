...
public class KeyPosition extends KeyPositionBase {
    ...
    @Override // androidx.constraintlayout.motion.widget.KeyPositionBase
    public boolean intersects(int i2, int i8, RectF rectF, RectF rectF2, float f4, float f8) {
        calcPosition(i2, i8, rectF.centerX(), rectF.centerY(), rectF2.centerX(), rectF2.centerY());
        return Math.abs(f4 - this.mCalculatedPositionX) < 20.0f && Math.abs(f8 - this.mCalculatedPositionY) < 20.0f;
    }
    ...
    @Override // androidx.constraintlayout.motion.widget.KeyPositionBase
    public void positionAttributes(View view, RectF rectF, RectF rectF2, float f4, float f8, String[] strArr, float[] fArr) {
        int i2 = this.mPositionType;
        if (i2 == 1) {
            positionPathAttributes(rectF, rectF2, f4, f8, strArr, fArr);
            return;
        }
        if (i2 == 2) {
            positionScreenAttributes(view, rectF, rectF2, f4, f8, strArr, fArr);
        } else if (i2 != 3) {
            positionCartAttributes(rectF, rectF2, f4, f8, strArr, fArr);
        } else {
            positionAxisAttributes(rectF, rectF2, f4, f8, strArr, fArr);
        }
    }

    public void positionAxisAttributes(RectF rectF, RectF rectF2, float f4, float f8, String[] strArr, float[] fArr) {
        ...
        float f9 = fCenterX2 - fCenterX;
        float f10 = fCenterY - fCenterY2;
        String str = strArr[0];
        if (str == null) {
            strArr[0] = "percentX";
            fArr[0] = (f4 - fCenterX) / f9;
            strArr[1] = "percentY";
            fArr[1] = (f8 - fCenterY2) / f10;
            return;
        }
        if ("percentX".equals(str)) {
            ...
            fArr[1] = (f4 - fCenterX) / f9;
            fArr[0] = (f8 - fCenterY2) / f10;
        }
    }

    public void positionCartAttributes(RectF rectF, RectF rectF2, float f4, float f8, String[] strArr, float[] fArr) {
        float fCenterX = rectF.centerX();
        float fCenterY = rectF.centerY();
    ...
    public void positionPathAttributes(RectF rectF, RectF rectF2, float f4, float f8, String[] strArr, float[] fArr) {
        float fCenterX = rectF.centerX();
        float fCenterY = rectF.centerY();
        float fCenterX2 = rectF2.centerX() - fCenterX;
        float fCenterY2 = rectF2.centerY() - fCenterY;
    ...
    public void positionScreenAttributes(View view, RectF rectF, RectF rectF2, float f4, float f8, String[] strArr, float[] fArr) {
        rectF.centerX();
        rectF.centerY();
        rectF2.centerX();
        rectF2.centerY();
