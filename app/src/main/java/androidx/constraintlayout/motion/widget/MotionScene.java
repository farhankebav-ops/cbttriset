...
public class MotionScene {
    ...
    private int getIndex(Transition transition) {
        ...
        for (int i8 = 0; i8 < this.mTransitionList.size(); i8++) {
            if (this.mTransitionList.get(i8).mId == i2) {
                return i8;
            }
        }
        return -1;
    ...
    private void load(Context context, int i2) {
        ...
        try {
            ...
            Log.e(TypedValues.MotionScene.NAME, "Error parsing resource: " + i2, e);
        } catch (XmlPullParserException e4) {
            Log.e(TypedValues.MotionScene.NAME, "Error parsing resource: " + i2, e4);
        }
    }
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i2 = 0; i2 < indexCount; i2++) {
            ...
            if (index == R.styleable.MotionScene_defaultDuration) {
                int i8 = typedArrayObtainStyledAttributes.getInt(index, this.mDefaultDuration);
    ...
    private void readConstraintChain(int i2, MotionLayout motionLayout) {
        ...
        int i8 = this.mDeriveMap.get(i2);
        if (i8 > 0) {
            readConstraintChain(i8, motionLayout);
            ConstraintSet constraintSet2 = this.mConstraintSetMap.get(i8);
            if (constraintSet2 == null) {
                Log.e(TypedValues.MotionScene.NAME, "ERROR! invalid deriveConstraintsFrom: @id/" + Debug.getName(this.mMotionLayout.getContext(), i8));
                return;
            } else {
            ...
            constraintSet.derivedState = a.r(new StringBuilder(), constraintSet.derivedState, "  layout");
    ...
    public void addOnClickListeners(MotionLayout motionLayout, int i2) {
        ...
        int i10 = 0;
        while (i10 < size3) {
            Transition transition3 = arrayList3.get(i10);
            i10++;
        ...
        int i12 = 0;
        while (i12 < size5) {
            Transition transition5 = arrayList5.get(i12);
            i12++;
        ...
        int i14 = 0;
        while (i14 < size7) {
            Transition transition7 = arrayList7.get(i14);
            i14++;
            ...
            if (transition8.mOnClicks.size() > 0) {
                ...
                int i15 = 0;
                while (i15 < size8) {
                    Object obj4 = arrayList8.get(i15);
                    i15++;
    ...
    public boolean autoTransition(MotionLayout motionLayout, int i2) {
        ...
        int i8 = 0;
        while (i8 < size) {
            Transition transition2 = arrayList.get(i8);
            i8++;
    ...
    public Transition bestTransitionFor(int i2, float f4, float f8, MotionEvent motionEvent) {
        if (i2 == -1) {
            ...
            if (!transition2.mDisable && transition2.mTouchResponse != null) {
                ...
                if (touchRegion == null || motionEvent == null || touchRegion.contains(motionEvent.getX(), motionEvent.getY())) {
                    ...
                    if (limitBoundsTo == null || motionEvent == null || limitBoundsTo.contains(motionEvent.getX(), motionEvent.getY())) {
                        float fDot = transition2.mTouchResponse.dot(f4, f8);
                        if (transition2.mTouchResponse.mIsRotateMode && motionEvent != null) {
                            fDot = ((float) (Math.atan2(f8 + r10, f4 + r9) - Math.atan2(motionEvent.getX() - transition2.mTouchResponse.mRotateCenterX, motionEvent.getY() - transition2.mTouchResponse.mRotateCenterY))) * 10.0f;
                        }
                        float f10 = fDot * (transition2.mConstraintSetEnd == i2 ? -1.0f : 1.1f);
                        if (f10 > f9) {
    ...
    public Key getKeyFrame(Context context, int i2, int i8, int i9) {
        Transition transition = this.mCurrentTransition;
        if (transition == null) {
            return null;
        }
            ...
            for (Integer num : keyFrames.getKeys()) {
                if (i8 == num.intValue()) {
                    ...
                    while (i11 < size2) {
                        ...
                        i11++;
                        Key key2 = key;
                        if (key2.mFramePosition == i9 && key2.mType == i2) {
                            return key2;
                        }
                    }
                }
    ...
    public int[] getMatchingStateLabels(String... strArr) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ConstraintSet constraintSetValueAt = this.mConstraintSetMap.valueAt(i8);
    ...
    public float getProgressDirection(float f4, float f8) {
        Transition transition = this.mCurrentTransition;
        if (transition == null || transition.mTouchResponse == null) {
            return 0.0f;
        }
        return this.mCurrentTransition.mTouchResponse.getProgressDirection(f4, f8);
    }
    ...
    public List<Transition> getTransitionsWithState(int i2) {
        ...
        int i8 = 0;
        while (i8 < size) {
            Transition transition = arrayList2.get(i8);
            i8++;
            Transition transition2 = transition;
    ...
    public void processScrollMove(float f4, float f8) {
        Transition transition = this.mCurrentTransition;
        if (transition == null || transition.mTouchResponse == null) {
            return;
        }
        this.mCurrentTransition.mTouchResponse.scrollMove(f4, f8);
    }

    public void processScrollUp(float f4, float f8) {
        Transition transition = this.mCurrentTransition;
        if (transition == null || transition.mTouchResponse == null) {
            return;
        }
        this.mCurrentTransition.mTouchResponse.scrollUp(f4, f8);
    }
    ...
    public void setKeyframe(View view, int i2, String str, Object obj) {
        ...
        while (i8 < size) {
            ...
            while (i9 < size2) {
                Key key = keyFramesForView.get(i9);
                i9++;
                if (key.mFramePosition == i2 && obj != null) {
                }
            }
        }
    }
    ...
    */
    ...
    public static class Transition {
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == R.styleable.Transition_constraintSetEnd) {
                    ...
                    int i9 = typedArray.getInt(index, this.mDuration);
                    this.mDuration = i9;
                    if (i9 < 8) {
                        this.mDuration = 8;
                    }
        ...
        public void addOnClick(int i2, int i8) {
            ArrayList<TransitionOnClick> arrayList = this.mOnClicks;
            int size = arrayList.size();
            int i9 = 0;
            while (i9 < size) {
                TransitionOnClick transitionOnClick = arrayList.get(i9);
                i9++;
                TransitionOnClick transitionOnClick2 = transitionOnClick;
                if (transitionOnClick2.mTargetId == i2) {
                    transitionOnClick2.mMode = i8;
                    return;
                }
            }
            this.mOnClicks.add(new TransitionOnClick(this, i2, i8));
        }
        ...
        public String debugString(Context context) {
            ...
            if (this.mConstraintSetEnd == -1) {
                return a.C(resourceEntryName, " -> null");
            }
        ...
        public void removeOnClick(int i2) {
            ...
            while (true) {
                ...
                TransitionOnClick transitionOnClick2 = arrayList.get(i8);
                i8++;
        ...
        public void setInterpolatorInfo(int i2, String str, int i8) {
            this.mDefaultInterpolator = i2;
            this.mDefaultInterpolatorString = str;
            this.mDefaultInterpolatorID = i8;
        }
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i2, Transition transition) {
                ...
                int i11 = this.mMode;
                boolean z2 = false;
                boolean z7 = ((i11 & 1) != 0 && i2 == i9) | ((i11 & 1) != 0 && i2 == i9) | ((i11 & 256) != 0 && i2 == i9) | ((i11 & 16) != 0 && i2 == i10);
                if ((i11 & 4096) != 0 && i2 == i10) {
                    z2 = true;
                }
                if (z7 || z2) {
                    viewFindViewById.setOnClickListener(this);
            ...
            public void onClick(View view) {
                ...
                if (motionLayout.isInteractionEnabled()) {
                    ...
                    int i2 = this.mMode;
                    boolean z2 = false;
                    boolean z7 = ((i2 & 1) == 0 && (i2 & 256) == 0) ? false : true;
                    boolean z8 = ((i2 & 16) == 0 && (i2 & 4096) == 0) ? false : true;
                    if (z7 && z8) {
            ...
            public TransitionOnClick(Transition transition, int i2, int i8) {
                this.mTransition = transition;
                this.mTargetId = i2;
                this.mMode = i8;
            }
        ...
        public Transition(int i2, MotionScene motionScene, int i8, int i9) {
            this.mId = -1;
            this.mIsAbstract = false;
            this.mConstraintSetEnd = -1;
            this.mConstraintSetStart = -1;
    ...
    public ConstraintSet getConstraintSet(int i2, int i8, int i9) {
        int iStateGetConstraintID;
        StateSet stateSet = this.mStateSet;
        if (stateSet != null && (iStateGetConstraintID = stateSet.stateGetConstraintID(i2, i8, i9)) != -1) {
