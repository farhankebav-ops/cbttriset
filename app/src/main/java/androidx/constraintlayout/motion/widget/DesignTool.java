...
public class DesignTool {
    ...
    private static void connect(int i2, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i8, int i9) {
        String str = sAllAttributes.get(Pair.create(Integer.valueOf(i8), Integer.valueOf(i9)));
        String str2 = map.get(str);
        if (str2 != null) {
            String str3 = sAllMargins.get(str);
            constraintSet.connect(view.getId(), i8, Integer.parseInt(str2), i9, str3 != null ? getPxFromDp(i2, map.get(str3)) : 0);
        }
    }
    ...
    private static void setDimensions(int i2, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i8) {
    ...
    public int designAccess(int i2, String str, Object obj, float[] fArr, int i8, float[] fArr2, int i9) {
    ...
    public float getKeyFramePosition(Object obj, int i2, float f4, float f8) {
        MotionController motionController;
        if ((obj instanceof View) && (motionController = this.mMotionLayout.mFrameArrayList.get((View) obj)) != null) {
            return motionController.getKeyFrameParameter(i2, f4, f8);
        }
        return 0.0f;
    }
    ...
    public Object getKeyframe(int i2, int i8, int i9) {
        MotionLayout motionLayout = this.mMotionLayout;
        MotionScene motionScene = motionLayout.mScene;
        if (motionScene == null) {
            return null;
        }
        return motionScene.getKeyFrame(motionLayout.getContext(), i2, i8, i9);
    }

    public Object getKeyframeAtLocation(Object obj, float f4, float f8) {
        MotionController motionController;
        View view = (View) obj;
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
        ...
        return motionController.getPositionKeyframe(viewGroup.getWidth(), viewGroup.getHeight(), f4, f8);
    }

    public Boolean getPositionKeyframe(Object obj, Object obj2, float f4, float f8, String[] strArr, float[] fArr) {
        if (!(obj instanceof KeyPositionBase)) {
            return Boolean.FALSE;
        }
        View view = (View) obj2;
        this.mMotionLayout.mFrameArrayList.get(view).positionKeyframe(view, (KeyPositionBase) obj, f4, f8, strArr, fArr);
    ...
    public boolean setKeyFramePosition(Object obj, int i2, int i8, float f4, float f8) {
        ...
        if (motionLayout.mScene != null) {
            ...
            if (motionController != null) {
                ...
                if (motionLayout2.mScene.hasKeyFramePosition(view, i9)) {
                    float keyFrameParameter = motionController.getKeyFrameParameter(2, f4, f8);
                    float keyFrameParameter2 = motionController.getKeyFrameParameter(5, f4, f8);
    ...
    public Object getKeyframe(Object obj, int i2, int i8) {
        if (this.mMotionLayout.mScene == null) {
            return null;
        }
        int id = ((View) obj).getId();
        MotionLayout motionLayout = this.mMotionLayout;
        return motionLayout.mScene.getKeyFrame(motionLayout.getContext(), i2, id, i8);
    }
}
