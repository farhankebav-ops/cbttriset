...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i2, int i8) {
            return i2 == this.mCachedBitmap.getWidth() && i8 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int i2, int i8) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i2, i8)) {
                this.mCachedBitmap = Bitmap.createBitmap(i2, i8, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i2, int i8) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i2, i8, null);
        }
    ...
    public static int applyAlpha(int i2, float f4) {
    ...
    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setHotspot(float f4, float f8) {
        super.setHotspot(f4, f8);
    }

    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setHotspotBounds(int i2, int i8, int i9, int i10) {
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
                ...
                sbR.append(pathDataNodeArr[i2].mType);
                sbR.append(":");
                string = sbR.toString();
                for (float f4 : pathDataNodeArr[i2].mParams) {
                    StringBuilder sbR2 = androidx.camera.core.processing.util.a.r(string);
                    sbR2.append(f4);
                    sbR2.append(",");
        ...
        public void printVPath(int i2) {
            ...
            StringBuilder sbX = a.x(strC, "current path is :");
    ...
    public static class VPathRenderer {
        ...
        private static float cross(float f4, float f8, float f9, float f10) {
            return (f4 * f10) - (f8 * f9);
        }

        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i2, int i8, ColorFilter colorFilter) {
            VGroup vGroup2 = vGroup;
            vGroup2.mStackedMatrix.set(matrix);
            vGroup2.mStackedMatrix.preConcat(vGroup2.mLocalMatrix);
            canvas.save();
            int i9 = 0;
            while (i9 < vGroup2.mChildren.size()) {
                VObject vObject = vGroup2.mChildren.get(i9);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i2, i8, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i2, i8, colorFilter);
                }
                i9++;
                vGroup2 = vGroup;
            }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i2, int i8, ColorFilter colorFilter) {
            float f4 = i2 / this.mViewportWidth;
            float f8 = i8 / this.mViewportHeight;
            float fMin = Math.min(f4, f8);
            Matrix matrix = vGroup.mStackedMatrix;
            this.mFinalPathMatrix.set(matrix);
            this.mFinalPathMatrix.postScale(f4, f8);
        ...
        public void draw(Canvas canvas, int i2, int i8, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i2, i8, colorFilter);
        }
