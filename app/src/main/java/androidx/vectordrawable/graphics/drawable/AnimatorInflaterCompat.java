...
public class AnimatorInflaterCompat {
    ...
    public static class PathDataEvaluator implements TypeEvaluator<PathParser.PathDataNode[]> {
        ...
        public PathParser.PathDataNode[] evaluate(float f4, PathParser.PathDataNode[] pathDataNodeArr, PathParser.PathDataNode[] pathDataNodeArr2) {
            ...
            for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
                this.mNodeArray[i2].interpolatePathDataNode(pathDataNodeArr[i2], pathDataNodeArr2[i2], f4);
            }
    ...
    private static void distributeKeyframes(Keyframe[] keyframeArr, float f4, int i2, int i8) {
        float f8 = f4 / ((i8 - i2) + 2);
        while (i2 <= i8) {
            keyframeArr[i2].setFraction(keyframeArr[i2 - 1].getFraction() + f8);
            i2++;
        }
    }
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            StringBuilder sbV = a.v(i2, "Keyframe ", ": fraction ");
            Object value = "null";
    ...
    private static PropertyValuesHolder getPVH(TypedArray typedArray, int i2, int i8, int i9, String str) {
        ...
        if (i2 == 4) {
            i2 = ((z2 && isColorType(i10)) || (z7 && isColorType(i11))) ? 3 : 0;
        }
        boolean z8 = i2 == 0;
        ...
        if (i2 == 2) {
            ...
            if (pathDataNodeArrCreateNodesFromPathData != null || pathDataNodeArrCreateNodesFromPathData2 != null) {
                if (pathDataNodeArrCreateNodesFromPathData != null) {
                    ...
                    throw new InflateException(a.n(" Can't morph from ", string, " to ", string2));
                }
                if (pathDataNodeArrCreateNodesFromPathData2 != null) {
    ...
    private static int inferValueTypeFromValues(TypedArray typedArray, int i2, int i8) {
        TypedValue typedValuePeekValue = typedArray.peekValue(i2);
        boolean z2 = typedValuePeekValue != null;
        int i9 = z2 ? typedValuePeekValue.type : 0;
        TypedValue typedValuePeekValue2 = typedArray.peekValue(i8);
        boolean z7 = typedValuePeekValue2 != null;
        int i10 = z7 ? typedValuePeekValue2.type : 0;
        if (z2 && isColorType(i9)) {
            return 3;
        }
        return (z7 && isColorType(i10)) ? 3 : 0;
    }
    ...
    private static PropertyValuesHolder loadPvh(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, String str, int i2) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (xmlPullParser.getName().equals("keyframe")) {
                ...
                Keyframe keyframeLoadKeyframe = loadKeyframe(context2, resources, theme2, Xml.asAttributeSet(xmlPullParser), i8, xmlPullParser2);
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f4, XmlPullParser xmlPullParser) {
        long namedInt = TypedArrayUtils.getNamedInt(typedArray, xmlPullParser, "duration", 1, MlKitException.LOW_LIGHT_AUTO_EXPOSURE_COMPUTATION_FAILURE);
    ...
    private static void setupObjectAnimator(ValueAnimator valueAnimator, TypedArray typedArray, int i2, float f4, XmlPullParser xmlPullParser) {
