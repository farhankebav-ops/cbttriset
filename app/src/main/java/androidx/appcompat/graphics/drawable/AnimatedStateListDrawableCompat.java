...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        private static long generateTransitionKey(int i2, int i8) {
            return ((long) i8) | (((long) i2) << 32);
        }
        ...
        public int addTransition(int i2, int i8, @NonNull Drawable drawable, boolean z2) {
            int iAddChild = addChild(drawable);
            long jGenerateTransitionKey = generateTransitionKey(i2, i8);
            long j = z2 ? REVERSIBLE_FLAG_BIT : 0L;
            long j3 = iAddChild;
            this.mTransitions.append(jGenerateTransitionKey, Long.valueOf(j3 | j));
            if (z2) {
                this.mTransitions.append(generateTransitionKey(i8, i2), Long.valueOf(REVERSED_BIT | j3 | j));
            }
            return iAddChild;
        }
        ...
        public int indexOfTransition(int i2, int i8) {
            return (int) this.mTransitions.get(generateTransitionKey(i2, i8), -1L).longValue();
        }

        public boolean isTransitionReversed(int i2, int i8) {
            return (this.mTransitions.get(generateTransitionKey(i2, i8), -1L).longValue() & REVERSED_BIT) != 0;
        }
        ...
        public boolean transitionHasReversibleFlag(int i2, int i8) {
            return (this.mTransitions.get(generateTransitionKey(i2, i8), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        public AnimationDrawableTransition(AnimationDrawable animationDrawable, boolean z2, boolean z7) {
            super();
            ...
            ObjectAnimator objectAnimatorOfInt = ObjectAnimator.ofInt(animationDrawable, "currentIndex", i2, i8);
    ...
    public static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f4) {
            int i2 = (int) ((f4 * this.mTotalDuration) + 0.5f);
            int i8 = this.mFrames;
            ...
            return (i9 / i8) + (i9 < i8 ? i2 / this.mTotalDuration : 0.0f);
        }
        ...
        public int updateFrames(AnimationDrawable animationDrawable, boolean z2) {
            ...
            for (int i8 = 0; i8 < numberOfFrames; i8++) {
                int duration = animationDrawable.getDuration(z2 ? (numberOfFrames - i8) - 1 : i8);
                iArr2[i8] = duration;
                i2 += duration;
            }
    ...
    public <T extends Drawable & Animatable> void addTransition(int i2, int i8, @NonNull T t3, boolean z2) {
        ObjectsCompat.requireNonNull(t3);
        this.mState.addTransition(i2, i8, t3, z2);
    }
