...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public void growArray(int i2, int i8) {
        ...
        public final boolean setLayoutDirection(int i2, int i8) {
    ...
    */
    ...
    public void setHotspotBounds(int i2, int i8, int i9, int i10) {
        Rect rect = this.mHotspotBounds;
        if (rect == null) {
            this.mHotspotBounds = new Rect(i2, i8, i9, i10);
        } else {
            rect.set(i2, i8, i9, i10);
        }
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            DrawableCompat.setHotspotBounds(drawable, i2, i8, i9, i10);
        }
    }
    ...
    public boolean setVisible(boolean z2, boolean z7) {
        ...
        Drawable drawable = this.mLastDrawable;
        if (drawable != null) {
            drawable.setVisible(z2, z7);
        }
        Drawable drawable2 = this.mCurrDrawable;
        if (drawable2 != null) {
            drawable2.setVisible(z2, z7);
        }
        return visible;
    }
