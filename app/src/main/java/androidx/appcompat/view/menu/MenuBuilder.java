...
public class MenuBuilder implements SupportMenu {
    ...
    private MenuItemImpl createNewMenuItem(int i2, int i8, int i9, int i10, CharSequence charSequence, int i11) {
        return new MenuItemImpl(this, i2, i8, i9, i10, charSequence, i11);
    }
    ...
    private void setHeaderInternal(int i2, CharSequence charSequence, int i8, Drawable drawable, View view) {
    ...
    */
    ...
    public int addIntentOptions(int i2, int i8, int i9, ComponentName componentName, Intent[] intentArr, Intent intent, int i10, MenuItem[] menuItemArr) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            MenuItem intent3 = add(i2, i8, i9, resolveInfo.loadLabel(packageManager)).setIcon(resolveInfo.loadIcon(packageManager)).setIntent(intent2);
    ...
    public MenuItem addInternal(int i2, int i8, int i9, CharSequence charSequence) {
        int ordering = getOrdering(i9);
        MenuItemImpl menuItemImplCreateNewMenuItem = createNewMenuItem(i2, i8, i9, ordering, charSequence, this.mDefaultShowAsAction);
    ...
    public int findItemIndex(int i2) {
        int size = size();
        for (int i8 = 0; i8 < size; i8++) {
            if (this.mItems.get(i8).getItemId() == i2) {
                return i8;
            }
        }
        return -1;
    ...
    public boolean performIdentifierAction(int i2, int i8) {
        return performItemAction(findItem(i2), i8);
    }
    ...
    public void removeGroup(int i2) {
        ...
        if (iFindGroupIndex >= 0) {
            ...
            while (true) {
                int i9 = i8 + 1;
                if (i8 >= size || this.mItems.get(iFindGroupIndex).getGroupId() != i2) {
                    break;
                }
    ...
    public int findGroupIndex(int i2, int i8) {
        int size = size();
        if (i8 < 0) {
            i8 = 0;
        }
        while (i8 < size) {
            if (this.mItems.get(i8).getGroupId() == i2) {
                return i8;
            }
            i8++;
        }
    ...
    public MenuItem add(int i2, int i8, int i9, CharSequence charSequence) {
        return addInternal(i2, i8, i9, charSequence);
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i2, int i8, int i9, CharSequence charSequence) {
        MenuItemImpl menuItemImpl = (MenuItemImpl) addInternal(i2, i8, i9, charSequence);
    ...
    public MenuItem add(int i2, int i8, int i9, int i10) {
        return addInternal(i2, i8, i9, this.mResources.getString(i10));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i2, int i8, int i9, int i10) {
        return addSubMenu(i2, i8, i9, this.mResources.getString(i10));
    }
