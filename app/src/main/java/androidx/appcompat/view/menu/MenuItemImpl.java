...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public MenuItemImpl(MenuBuilder menuBuilder, int i2, int i8, int i9, int i10, CharSequence charSequence, int i11) {
    ...
    private static void appendModifier(StringBuilder sb, int i2, int i8, String str) {
        if ((i2 & i8) == i8) {
            sb.append(str);
        }
    }
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    @NonNull
    public MenuItem setAlphabeticShortcut(char c7, int i2) {
        if (this.mShortcutAlphabeticChar == c7 && this.mShortcutAlphabeticModifiers == i2) {
            return this;
        }
        this.mShortcutAlphabeticChar = Character.toLowerCase(c7);
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    @NonNull
    public MenuItem setNumericShortcut(char c7, int i2) {
        if (this.mShortcutNumericChar == c7 && this.mShortcutNumericModifiers == i2) {
            return this;
        }
        this.mShortcutNumericChar = c7;
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    @NonNull
    public MenuItem setShortcut(char c7, char c8, int i2, int i8) {
        this.mShortcutNumericChar = c7;
        this.mShortcutNumericModifiers = KeyEvent.normalizeMetaState(i2);
        this.mShortcutAlphabeticChar = Character.toLowerCase(c8);
