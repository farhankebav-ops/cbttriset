...
public class MenuPopupHelper implements MenuHelper {
    ...
    private void showPopup(int i2, int i8, boolean z2, boolean z7) {
        ...
        if (z2) {
            ...
            popup.setEpicenterBounds(new Rect(i2 - i9, i8 - i9, i2 + i9, i8 + i9));
        }
        popup.show();
    }
    ...
    public void show(int i2, int i8) {
        if (!tryShow(i2, i8)) {
            throw new IllegalStateException("MenuPopupHelper cannot be used without an anchor");
        }
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z2, @AttrRes int i2, @StyleRes int i8) {
    ...
    public boolean tryShow(int i2, int i8) {
        if (isShowing()) {
            return true;
        }
        if (this.mAnchorView == null) {
