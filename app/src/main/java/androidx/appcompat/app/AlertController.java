...
class AlertController {
    ...
    public class AnonymousClass2 implements NestedScrollView.OnScrollChangeListener {
        ...
        public void onScrollChange(NestedScrollView nestedScrollView, int i2, int i8, int i9, int i10) {
            ...
            if (alertParams.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.3
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i8, long j) {
                        AlertParams.this.mOnClickListener.onClick(alertController2.mDialog, i8);
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i8, long j) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController2.mDialog, i8, recycleListView.isItemChecked(i8));
                    }
                });
            }
    ...
    public static class CheckedItemAdapter extends ArrayAdapter<CharSequence> {
        public CheckedItemAdapter(Context context, int i2, int i8, CharSequence[] charSequenceArr) {
    ...
    public static class RecycleListView extends ListView {
        ...
        public void setHasDecor(boolean z2, boolean z7) {
            ...
            setPadding(getPaddingLeft(), z2 ? getPaddingTop() : this.mPaddingTopNoTitle, getPaddingRight(), z7 ? getPaddingBottom() : this.mPaddingBottomNoButtons);
        }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i2, int i8) {
        ...
        ViewCompat.setScrollIndicators(view, i2, i8);
    ...
    public void setView(View view, int i2, int i8, int i9, int i10) {
        this.mView = view;
        this.mViewLayoutResId = 0;
