...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d8, double d9) {
        double d10 = (0.01720197f * ((j - UTC_2000) / 8.64E7f)) + 6.24006f;
        ...
        double dSin2 = (Math.sin(2.0d * dSin) * (-0.0069d)) + (Math.sin(d10) * 0.0053d) + ((double) (Math.round(((double) (r2 - J0)) - r6) + J0)) + ((-d9) / 360.0d);
