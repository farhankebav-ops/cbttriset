...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            j.l(obj).registerOnBackInvokedCallback(1000000, r02);
            return r02;
        }

        @DoNotInline
        public static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            j.l(obj).unregisterOnBackInvokedCallback(j.i(obj2));
        }
    }
    ...
    public class ListMenuDecorView extends ContentFrameLayout {
        ...
        private boolean isOutOfBounds(int i2, int i8) {
            return i2 < -5 || i8 < -5 || i2 > getWidth() + 5 || i8 > getHeight() + 5;
        }
    ...
    private Configuration createOverrideAppConfiguration(@NonNull Context context, int i2, @Nullable LocaleListCompat localeListCompat, @Nullable Configuration configuration, boolean z2) {
        int i8 = i2 != 1 ? i2 != 2 ? z2 ? 0 : context.getApplicationContext().getResources().getConfiguration().uiMode & 48 : 32 : 16;
    ...
    private ViewGroup createSubDecor() {
        ...
        if (viewGroup == null) {
            ...
            throw new IllegalArgumentException(a1.a.u(sb, this.mWindowNoTitle, " }"));
        }
    ...
    */
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i2, KeyEvent keyEvent, int i8) {
        MenuBuilder menuBuilder;
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            zPerformShortcut = menuBuilder.performShortcut(i2, keyEvent, i8);
        }
    ...
    */
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z2, z7, true, VectorEnabledTintResources.shouldBeUsed());
    }
    ...
    */
    ...
    private boolean applyApplicationSpecificConfig(boolean z2, boolean z7) {
        if (this.mDestroyed) {
            return false;
        }
