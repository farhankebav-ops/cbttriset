...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public interface SuperCaller {
        ...
        void setAutoSizeTextTypeUniformWithConfiguration(int i2, int i8, int i9, int i10);
        ...
        void setLineHeight(int i2, @FloatRange(from = 0.0d) float f4);
    ...
    public class SuperCallerApi34 extends SuperCallerApi28 {
        ...
        @Override // androidx.appcompat.widget.AppCompatTextView.SuperCallerApi26, androidx.appcompat.widget.AppCompatTextView.SuperCaller
        public void setLineHeight(int i2, float f4) {
            AppCompatTextView.super.setLineHeight(i2, f4);
        }
    }
    ...
    public void onLayout(boolean z2, int i2, int i8, int i9, int i10) {
        ...
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onLayout(z2, i2, i8, i9, i10);
        }
    }
    ...
    @Override // android.widget.TextView, androidx.core.widget.AutoSizeableTextView
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setAutoSizeTextTypeUniformWithConfiguration(int i2, int i8, int i9, int i10) throws IllegalArgumentException {
        if (ViewUtils.SDK_LEVEL_SUPPORTS_AUTOSIZE) {
            getSuperCaller().setAutoSizeTextTypeUniformWithConfiguration(i2, i8, i9, i10);
            return;
        }
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.setAutoSizeTextTypeUniformWithConfiguration(i2, i8, i9, i10);
        }
    }
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) @Px int i2) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) @Px int i2) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) @Px int i2) {
    ...
    public void setTextSize(int i2, float f4) {
        ...
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.setTextSize(i2, f4);
        }
    }
    ...
    @Override // android.widget.TextView
    public void setLineHeight(int i2, @FloatRange(from = 0.0d) float f4) {
        if (Build.VERSION.SDK_INT >= 34) {
            getSuperCaller().setLineHeight(i2, f4);
        } else {
            TextViewCompat.setLineHeight(this, i2, f4);
        }
    }
    ...
    @Override // android.widget.TextView
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int i2, int i8, int i9, int i10) {
        Context context = getContext();
        setCompoundDrawablesRelativeWithIntrinsicBounds(i2 != 0 ? AppCompatResources.getDrawable(context, i2) : null, i8 != 0 ? AppCompatResources.getDrawable(context, i8) : null, i9 != 0 ? AppCompatResources.getDrawable(context, i9) : null, i10 != 0 ? AppCompatResources.getDrawable(context, i10) : null);
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onSetCompoundDrawables();
        }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(int i2, int i8, int i9, int i10) {
        Context context = getContext();
        setCompoundDrawablesWithIntrinsicBounds(i2 != 0 ? AppCompatResources.getDrawable(context, i2) : null, i8 != 0 ? AppCompatResources.getDrawable(context, i8) : null, i9 != 0 ? AppCompatResources.getDrawable(context, i9) : null, i10 != 0 ? AppCompatResources.getDrawable(context, i10) : null);
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onSetCompoundDrawables();
        }
    ...
    public class SuperCallerApi26 implements SuperCaller {
        ...
        @Override // androidx.appcompat.widget.AppCompatTextView.SuperCaller
        public void setAutoSizeTextTypeUniformWithConfiguration(int i2, int i8, int i9, int i10) {
            AppCompatTextView.super.setAutoSizeTextTypeUniformWithConfiguration(i2, i8, i9, i10);
        }
