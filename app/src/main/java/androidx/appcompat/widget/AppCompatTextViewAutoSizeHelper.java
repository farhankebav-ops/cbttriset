...
class AppCompatTextViewAutoSizeHelper {
    ...
    public static final class Api23Impl {
        ...
        @NonNull
        @DoNotInline
        public static StaticLayout createStaticLayoutForMeasuring(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i2, int i8, @NonNull TextView textView, @NonNull TextPaint textPaint, @NonNull Impl impl) {
    ...
    private void validateAndSetAutoSizeTextTypeUniformConfiguration(float f4, float f8, float f9) throws IllegalArgumentException {
        if (f4 <= 0.0f) {
            throw new IllegalArgumentException("Minimum auto-size text size (" + f4 + "px) is less or equal to (0px)");
        }
        if (f8 <= f4) {
            throw new IllegalArgumentException("Maximum auto-size text size (" + f8 + "px) is less or equal to minimum auto-size text size (" + f4 + "px)");
        }
        if (f9 <= 0.0f) {
    ...
    @NonNull
    @VisibleForTesting
    public StaticLayout createLayout(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i2, int i8) {
        return Api23Impl.createStaticLayoutForMeasuring(charSequence, alignment, i2, i8, this.mTextView, this.mTempTextPaint, this.mImpl);
    }
    ...
    public void setAutoSizeTextTypeUniformWithConfiguration(int i2, int i8, int i9, int i10) throws IllegalArgumentException {
        if (supportsAutoSizeText()) {
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
            validateAndSetAutoSizeTextTypeUniformConfiguration(TypedValue.applyDimension(i10, i2, displayMetrics), TypedValue.applyDimension(i10, i8, displayMetrics), TypedValue.applyDimension(i10, i9, displayMetrics));
            ...
            if (length > 0) {
                ...
                if (i2 == 0) {
                    ...
                    for (int i8 = 0; i8 < length; i8++) {
                        iArrCopyOf[i8] = Math.round(TypedValue.applyDimension(i2, iArr[i8], displayMetrics));
                    }
                }
    ...
    public void setAutoSizeTextTypeWithDefaults(int i2) {
        if (supportsAutoSizeText()) {
            ...
            if (i2 != 1) {
                throw new IllegalArgumentException(a1.a.g(i2, "Unknown auto-size text type: "));
            }
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setTextSizeInternal(int i2, float f4) {
        Context context = this.mContext;
        setRawTextSize(TypedValue.applyDimension(i2, f4, (context == null ? Resources.getSystem() : context.getResources()).getDisplayMetrics()));
    }
