...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private boolean hitThumb(float f4, float f8) {
        ...
        Rect rect = this.mTempRect;
        return f4 > ((float) i10) && f4 < ((float) (((i11 + rect.left) + rect.right) + i8)) && f8 > ((float) i9) && f8 < ((float) (this.mSwitchBottom + i8));
    }
    ...
    private void setSwitchTypefaceByIndex(int i2, int i8) {
        setSwitchTypeface(i2 != 1 ? i2 != 2 ? i2 != 3 ? null : Typeface.MONOSPACE : Typeface.SERIF : Typeface.SANS_SERIF, i8);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (opticalBounds != null) {
                ...
                this.mTrackDrawable.setBounds(i9, i2, i11, i8);
            } else {
                i2 = i10;
            }
            i8 = i12;
    ...
    public void drawableHotspotChanged(float f4, float f8) {
        super.drawableHotspotChanged(f4, f8);
        Drawable drawable = this.mThumbDrawable;
        if (drawable != null) {
            DrawableCompat.setHotspot(drawable, f4, f8);
        }
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
            DrawableCompat.setHotspot(drawable2, f4, f8);
        }
    }
    ...
    */
    ...
    public void setSwitchTypeface(Typeface typeface, int i2) {
        if (i2 <= 0) {
            ...
            int i8 = (~(typefaceDefaultFromStyle != null ? typefaceDefaultFromStyle.getStyle() : 0)) & i2;
