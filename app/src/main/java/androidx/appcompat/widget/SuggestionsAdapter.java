...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbV = a1.a.v(iconResource, "Invalid icon resource ", " for ");
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e8.getMessage());
            return null;
        }
        Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e8.getMessage());
        return null;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int i8 = i2 != -1 ? cursor.getInt(i2) : 0;
    ...
    public Drawable getDrawableFromResourceUri(Uri uri) throws FileNotFoundException {
        ...
        if (TextUtils.isEmpty(authority)) {
            throw new FileNotFoundException(a1.a.k("No authority: ", uri));
        }
        try {
            ...
            if (pathSegments == null) {
                throw new FileNotFoundException(a1.a.k("No path: ", uri));
            }
            ...
            if (size == 1) {
                try {
                    ...
                    throw new FileNotFoundException(a1.a.k("Single path segment is not a resource ID: ", uri));
                }
            } else {
                if (size != 2) {
                    throw new FileNotFoundException(a1.a.k("More than two path segments: ", uri));
                }
            ...
            throw new FileNotFoundException(a1.a.k("No resource found for: ", uri));
        } catch (PackageManager.NameNotFoundException unused2) {
            throw new FileNotFoundException(a1.a.k("No package found for authority: ", uri));
        }
    }
