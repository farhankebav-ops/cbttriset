...
public class ToolbarWidgetWrapper implements DecorToolbar {
        ...
        if (i2 != i8) {
            ...
            if (i2 != 0) {
                if (i2 == 1) {
                    ...
                    if (i2 != 2) {
                        throw new IllegalArgumentException(a1.a.g(i2, "Invalid navigation mode "));
                    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z2, int i2, int i8) {
        Drawable drawable;
