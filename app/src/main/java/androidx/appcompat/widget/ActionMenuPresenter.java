...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public boolean setFrame(int i2, int i8, int i9, int i10) {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            i2 = ((i10 % i15) / iMeasureChildForCells) + i15;
        } else {
        ...
        while (i16 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (r03.mStrictWidthLimit) {
                    iMeasureChildForCells -= ActionMenuView.measureChildForCells(itemView, i2, iMeasureChildForCells, iMakeMeasureSpec, r32);
                } else {
                ...
                boolean z8 = (i14 > 0 || z7) && i10 > 0 && (!r03.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z9 = z8;
                i8 = size;
                if (z8) {
