...
public class ThemeUtils {
    ...
    @NonNull
    public static ColorStateList createDisabledStateList(int i2, int i8) {
        return new ColorStateList(new int[][]{DISABLED_STATE_SET, EMPTY_STATE_SET}, new int[]{i8, i2});
    }
    ...
    public static int getThemeAttrColor(@NonNull Context context, int i2, float f4) {
        return ColorUtils.setAlphaComponent(getThemeAttrColor(context, i2), Math.round(Color.alpha(r0) * f4));
    }
}
