...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int i2, int i8, int i9, int i10, int i11) {
            return super.measureHeightOfChildrenCompat(i2, i8, i9, i10, i11);
        }
    ...
    public MenuPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i8) {
