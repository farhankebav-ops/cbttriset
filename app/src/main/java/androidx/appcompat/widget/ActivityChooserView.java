...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public void setShowDefaultActivity(boolean z2, boolean z7) {
            if (this.mShowDefaultActivity == z2 && this.mHighlightDefaultActivity == z7) {
                return;
            }
    ...
    public void onLayout(boolean z2, int i2, int i8, int i9, int i10) {
        this.mActivityChooserContent.layout(0, 0, i9 - i2, i10 - i8);
        if (isShowingPopup()) {
            return;
        }
        dismissPopup();
