...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i2, int i8) throws Resources.NotFoundException {
        return super.getDrawableForDensity(i2, i8);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ float getFraction(int i2, int i8, int i9) {
        return super.getFraction(i2, i8, i9);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i2, int i8) throws Resources.NotFoundException {
        return super.getQuantityString(i2, i8);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ CharSequence getQuantityText(int i2, int i8) throws Resources.NotFoundException {
        return super.getQuantityText(i2, i8);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValueForDensity(int i2, int i8, TypedValue typedValue, boolean z2) throws Resources.NotFoundException {
        super.getValueForDensity(i2, i8, typedValue, z2);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    @RequiresApi(21)
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i2, int i8, Resources.Theme theme) {
        return super.getDrawableForDensity(i2, i8, theme);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i2, int i8, Object[] objArr) throws Resources.NotFoundException {
        return super.getQuantityString(i2, i8, objArr);
    }
