...
class TooltipPopup {
    ...
    private void computePosition(View view, int i2, int i8, boolean z2, WindowManager.LayoutParams layoutParams) {
        int height;
        int i9;
        ...
        layoutParams.x = (i11 + i2) - (appRootView.getWidth() / 2);
    ...
    public void show(View view, int i2, int i8, boolean z2, CharSequence charSequence) {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i2, i8, z2, this.mLayoutParams);
