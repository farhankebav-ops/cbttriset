...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public static int next(int i2, int i8, boolean z2) {
        return z2 ? i2 - i8 : i2 + i8;
    }
    ...
    public int measureChildView(View view, int i2, int i8, int i9) {
    ...
    public int positionChild(View view, int i2, int i8, int i9, boolean z2) {
