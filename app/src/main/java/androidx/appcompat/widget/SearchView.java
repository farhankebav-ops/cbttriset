...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            ...
            return a1.a.u(sb, this.isIconified, "}");
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i2 >= 960 && i8 >= 720 && configuration.orientation == 2) {
                return 256;
            }
            if (i2 < 600) {
                return (i2 < 640 || i8 < 480) ? 160 : 192;
            }
            return 192;
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z7 && !this.mSlopBounds.contains(x2, y)) {
                        z8 = z7;
                        z2 = false;
                    }
                } else {
                ...
                z8 = z7;
                z2 = true;
            } else if (this.mTargetBounds.contains(x2, y)) {
            ...
            if (!z2 || this.mActualBounds.contains(x2, y)) {
    ...
    private boolean launchSuggestion(int i2, int i8, String str) {
    ...
    public boolean onItemClicked(int i2, int i8, String str) {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        int i8 = tintTypedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (i8 != -1) {
            setImeOptions(i8);
        }
        int i9 = tintTypedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (i9 != -1) {
            setInputType(i9);
        }
