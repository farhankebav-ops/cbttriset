...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    */
    ...
    private static boolean pointInView(View view, float f4, float f8, float f9) {
        float f10 = -f9;
        return f4 >= f10 && f8 >= f10 && f4 < ((float) (view.getRight() - view.getLeft())) + f9 && f8 < ((float) (view.getBottom() - view.getTop())) + f9;
    }
