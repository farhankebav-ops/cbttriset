...
class ResourcesWrapper extends Resources {
    ...
    @Override // android.content.res.Resources
    public Drawable getDrawableForDensity(int i2, int i8) throws Resources.NotFoundException {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i2, i8, null);
    }

    @Override // android.content.res.Resources
    public float getFraction(int i2, int i8, int i9) {
        return this.mResources.getFraction(i2, i8, i9);
    }
    ...
    @Override // android.content.res.Resources
    public String getQuantityString(int i2, int i8, Object... objArr) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i2, i8, objArr);
    }

    @Override // android.content.res.Resources
    public CharSequence getQuantityText(int i2, int i8) throws Resources.NotFoundException {
        return this.mResources.getQuantityText(i2, i8);
    }
    ...
    @Override // android.content.res.Resources
    public void getValueForDensity(int i2, int i8, TypedValue typedValue, boolean z2) throws Resources.NotFoundException {
        this.mResources.getValueForDensity(i2, i8, typedValue, z2);
    }
    ...
    @Override // android.content.res.Resources
    @RequiresApi(21)
    public Drawable getDrawableForDensity(int i2, int i8, Resources.Theme theme) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i2, i8, theme);
    }

    @Override // android.content.res.Resources
    public String getQuantityString(int i2, int i8) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i2, i8);
    }
