...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    public void onMeasure(int i2, int i8) {
        int measuredHeight;
        pullChildren();
        measureChildWithMargins(this.mActionBarTop, i2, 0, i8, 0);
        ...
        measureChildWithMargins(this.mContent, i2, 0, i8, 0);
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(getPaddingRight() + getPaddingLeft() + iMax3, getSuggestedMinimumWidth()), i2, iCombineMeasuredStates2), View.resolveSizeAndState(Math.max(getPaddingBottom() + getPaddingTop() + iMax4, getSuggestedMinimumHeight()), i8, iCombineMeasuredStates2 << 16));
    }
    ...
    public void onNestedScroll(View view, int i2, int i8, int i9, int i10, int i11, int[] iArr) {
        onNestedScroll(view, i2, i8, i9, i10, i11);
    }
    ...
    public void onWindowSystemUiVisibilityChanged(int i2) {
        ...
        pullChildren();
        int i8 = this.mLastSystemUiVisibility ^ i2;
    ...
    public void onNestedPreScroll(View view, int i2, int i8, int[] iArr, int i9) {
        if (i9 == 0) {
            onNestedPreScroll(view, i2, i8, iArr);
        }
    }
