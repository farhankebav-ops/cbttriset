...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    */
    ...
    private boolean tryOnMeasure(int i2, int i8) {
        ...
        if (view3 != null && i10 > 0) {
            view3.measure(i2, View.MeasureSpec.makeMeasureSpec(measuredHeight2 + i10, mode));
        ...
        setMeasuredDimension(View.resolveSizeAndState(getPaddingRight() + getPaddingLeft() + iMax, i2, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i8, 0));
        if (mode2 == 1073741824) {
            return true;
        }
