...
class AppCompatTextHelper {
    ...
    private void setTextSizeInternal(int i2, float f4) {
        this.mAutoSizeTextHelper.setTextSizeInternal(i2, f4);
    }
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i2) {
        ...
        if (resourceId != -1) {
            ...
            string = (i8 < 26 || !tintTypedArrayObtainStyledAttributes2.hasValue(R.styleable.TextAppearance_fontVariationSettings)) ? null : tintTypedArrayObtainStyledAttributes2.getString(R.styleable.TextAppearance_fontVariationSettings);
        ...
        if (i9 >= 26 && tintTypedArrayObtainStyledAttributes3.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
            string = tintTypedArrayObtainStyledAttributes3.getString(R.styleable.TextAppearance_fontVariationSettings);
        }
        if (i9 >= 28 && tintTypedArrayObtainStyledAttributes3.hasValue(R.styleable.TextAppearance_android_textSize) && tintTypedArrayObtainStyledAttributes3.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, -1) == 0) {
    ...
    public void onSetTextAppearance(Context context, int i2) {
        ...
        if (i8 >= 26 && tintTypedArrayObtainStyledAttributes.hasValue(R.styleable.TextAppearance_fontVariationSettings) && (string = tintTypedArrayObtainStyledAttributes.getString(R.styleable.TextAppearance_fontVariationSettings)) != null) {
            Api26Impl.setFontVariationSettings(this.mView, string);
        }
        tintTypedArrayObtainStyledAttributes.recycle();
        Typeface typeface = this.mFontTypeface;
    ...
    public void setAutoSizeTextTypeUniformWithConfiguration(int i2, int i8, int i9, int i10) throws IllegalArgumentException {
        this.mAutoSizeTextHelper.setAutoSizeTextTypeUniformWithConfiguration(i2, i8, i9, i10);
    }
