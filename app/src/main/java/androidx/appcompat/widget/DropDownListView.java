...
class DropDownListView extends ListView {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static void drawableHotspotChanged(View view, float f4, float f8) {
            view.drawableHotspotChanged(f4, f8);
        }
    }
    ...
    private void positionSelectorLikeTouchCompat(int i2, View view, float f4, float f8) {
        positionSelectorLikeFocusCompat(i2, view);
        Drawable selector = getSelector();
        if (selector == null || i2 == -1) {
            return;
        }
        DrawableCompat.setHotspot(selector, f4, f8);
    }

    private void setPressedItem(View view, int i2, float f4, float f8) {
        View childAt;
        this.mDrawsInPressedState = true;
        Api21Impl.drawableHotspotChanged(this, f4, f8);
        if (!isPressed()) {
            setPressed(true);
        }
        layoutChildren();
        ...
        Api21Impl.drawableHotspotChanged(view, f4 - view.getLeft(), f8 - view.getTop());
        if (!view.isPressed()) {
            view.setPressed(true);
        }
        positionSelectorLikeTouchCompat(i2, view, f4, f8);
    ...
    public int measureHeightOfChildrenCompat(int i2, int i8, int i9, int i10, int i11) {
        ...
        while (i12 < count) {
            ...
            view.measure(i2, i15 > 0 ? View.MeasureSpec.makeMeasureSpec(i15, BasicMeasure.EXACTLY) : View.MeasureSpec.makeMeasureSpec(0, 0));
            view.forceLayout();
            if (i12 > 0) {
