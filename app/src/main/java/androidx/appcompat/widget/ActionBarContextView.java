...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z2, int i2, int i8, int i9, int i10) {
        ...
        int paddingRight = zIsLayoutRtl ? (i9 - i2) - getPaddingRight() : getPaddingLeft();
        ...
        int paddingLeft = zIsLayoutRtl ? getPaddingLeft() : (i9 - i2) - getPaddingRight();
    ...
    public void onMeasure(int i2, int i8) {
        ...
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i11), View.MeasureSpec.makeMeasureSpec(iMin, i9));
        }
