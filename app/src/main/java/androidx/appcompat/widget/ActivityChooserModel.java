...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            return "[resolveInfo:" + this.resolveInfo.toString() + "; weight:" + new BigDecimal(this.weight) + C2300e4.i.e;
        }
    ...
    public static final class HistoricalRecord {
        ...
        public HistoricalRecord(String str, long j, float f4) {
            this(ComponentName.unflattenFromString(str), j, f4);
        }
        ...
        public String toString() {
            return "[; activity:" + this.activity + "; time:" + this.time + "; weight:" + new BigDecimal(this.weight) + C2300e4.i.e;
        }

        public HistoricalRecord(ComponentName componentName, long j, float f4) {
