...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (i9 < size) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            int i10 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin - i2;
    ...
    private int layoutChildLeft(View view, int i2, int[] iArr, int i8) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        int i9 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin - iArr[0];
        int iMax = Math.max(0, i9) + i2;
    ...
    private int layoutChildRight(View view, int i2, int[] iArr, int i8) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        int i9 = ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin - iArr[1];
        int iMax = i2 - Math.max(0, i9);
    ...
    private int measureChildCollapseMargins(View view, int i2, int i8, int i9, int i10, int[] iArr) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        ...
        view.measure(ViewGroup.getChildMeasureSpec(i2, getPaddingRight() + getPaddingLeft() + iMax + i8, marginLayoutParams.width), ViewGroup.getChildMeasureSpec(i9, getPaddingBottom() + getPaddingTop() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + i10, marginLayoutParams.height));
        return view.getMeasuredWidth() + iMax;
    }

    private void measureChildConstrained(View view, int i2, int i8, int i9, int i10, int i11) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        ...
        if (mode != 1073741824 && i11 >= 0) {
            ...
            childMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i11, BasicMeasure.EXACTLY);
        }
    ...
    */
    ...
    public void onMeasure(int i2, int i8) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            measureChildConstrained(this.mNavButtonView, i2, 0, i8, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            measureChildConstrained(this.mCollapseButtonView, i2, 0, i8, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mMenuView)) {
            measureChildConstrained(this.mMenuView, i2, iMax3, i8, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            iArr = iArr2;
            iMax4 += measureChildCollapseMargins(this.mExpandedActionView, i2, iMax4, i8, 0, iArr);
        ...
        if (shouldLayout(this.mLogoView)) {
            iMax4 += measureChildCollapseMargins(this.mLogoView, i2, iMax4, i8, 0, iArr);
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                iMax4 += measureChildCollapseMargins(childAt, i2, iMax4, i8, 0, iArr);
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i2, i11 + i13, i8, i12, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            iMax2 = Math.max(iMax2, measureChildCollapseMargins(this.mSubtitleTextView, i2, i11 + i13, i8, i12 + measuredHeight, iArr));
    ...
    public void setContentInsetsAbsolute(int i2, int i8) {
        ensureContentInsets();
        this.mContentInsets.setAbsolute(i2, i8);
    }

    public void setContentInsetsRelative(int i2, int i8) {
        ensureContentInsets();
        this.mContentInsets.setRelative(i2, i8);
    }
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z2 && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new b(this, 0));
                }
    ...
    public static class LayoutParams extends ActionBar.LayoutParams {
        ...
        public LayoutParams(int i2, int i8, int i9) {
            super(i2, i8);
            this.mViewType = 0;
            this.gravity = i9;
        }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new b(this, 1));
