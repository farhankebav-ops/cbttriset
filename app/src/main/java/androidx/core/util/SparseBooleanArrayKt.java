...
public final class SparseBooleanArrayKt {
    ...
    public static final boolean getOrElse(SparseBooleanArray sparseBooleanArray, int i2, e6.a aVar) {
    ...
    public static final v keyIterator(final SparseBooleanArray sparseBooleanArray) {
