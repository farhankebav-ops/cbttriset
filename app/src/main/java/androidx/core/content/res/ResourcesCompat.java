...
public final class ResourcesCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static Drawable getDrawableForDensity(Resources resources, int i2, int i8, Resources.Theme theme) {
            return resources.getDrawableForDensity(i2, i8, theme);
        }
    }
    ...
    */
    ...
    @Nullable
    public static Drawable getDrawableForDensity(@NonNull Resources resources, @DrawableRes int i2, int i8, @Nullable Resources.Theme theme) throws Resources.NotFoundException {
        return Api21Impl.getDrawableForDensity(resources, i2, i8, theme);
    }
    ...
    private static Typeface loadFont(@NonNull Context context, int i2, @NonNull TypedValue typedValue, int i8, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z2, boolean z7) {
        Resources resources = context.getResources();
        resources.getValue(i2, typedValue, true);
        Typeface typefaceLoadFont = loadFont(context, resources, typedValue, i2, i8, fontCallback, handler, z2, z7);
    ...
    */
    ...
    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static Typeface getFont(@NonNull Context context, @FontRes int i2, @NonNull TypedValue typedValue, int i8, @Nullable FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, i2, typedValue, i8, fontCallback, null, true, false);
    }
}
