...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i2, @ColorInt int i8, boolean z2, @ColorInt int i9) {
        return colorStops != null ? colorStops : z2 ? new ColorStops(i2, i9, i8) : new ColorStops(i2, i8);
    }
    ...
    */
    ...
    public static final class ColorStops {
        ...
        public ColorStops(@ColorInt int i2, @ColorInt int i8) {
            this.mColors = new int[]{i2, i8};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        public ColorStops(@ColorInt int i2, @ColorInt int i8, @ColorInt int i9) {
            this.mColors = new int[]{i2, i8, i9};
