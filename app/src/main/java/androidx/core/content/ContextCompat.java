...
public class ContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            map.put(BluetoothManager.class, C2228a4.f7948d);
            ...
            map.put(StorageManager.class, C2300e4.a.k);
            ...
            map.put(WifiManager.class, C2228a4.f7946b);
    ...
    public static String obtainAndCheckReceiverPermission(Context context) {
        ...
        throw new RuntimeException(a1.a.m("Permission ", str, " is required by your application to receive broadcasts, please add it to your manifest"));
    }
    ...
    public static Intent registerReceiver(@NonNull Context context, @Nullable BroadcastReceiver broadcastReceiver, @NonNull IntentFilter intentFilter, @Nullable String str, @Nullable Handler handler, int i2) {
        ...
        return i11 >= 33 ? Api33Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i9) : i11 >= 26 ? Api26Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i9) : ((i9 & 4) == 0 || str != null) ? context.registerReceiver(broadcastReceiver, intentFilter, str, handler) : context.registerReceiver(broadcastReceiver, intentFilter, obtainAndCheckReceiverPermission(context), handler);
    }
