    ...
    public static <T> T[] readParcelableArray(@NonNull Parcel parcel, @Nullable ClassLoader classLoader, @NonNull Class<T> cls) {
        ...
        for (int i2 = 0; i2 < tArr.length; i2++) {
            try {
                ...
                StringBuilder sbV = a.v(i2, "Parcelable at index ", " is not a subclass of required class ");
                sbV.append(cls.getName());
                sbV.append(" provided in the parameter");
                throw new BadParcelableException(sbV.toString());
            }
        }
        return tArr2;
    }
