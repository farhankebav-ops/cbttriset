...
public final class DrawableCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static void setHotspot(Drawable drawable, float f4, float f8) {
            drawable.setHotspot(f4, f8);
        }

        @DoNotInline
        public static void setHotspotBounds(Drawable drawable, int i2, int i8, int i9, int i10) {
            drawable.setHotspotBounds(i2, i8, i9, i10);
        }
    ...
    public static void setHotspot(@NonNull Drawable drawable, float f4, float f8) {
        Api21Impl.setHotspot(drawable, f4, f8);
    }

    public static void setHotspotBounds(@NonNull Drawable drawable, int i2, int i8, int i9, int i10) {
        Api21Impl.setHotspotBounds(drawable, i2, i8, i9, i10);
    }
