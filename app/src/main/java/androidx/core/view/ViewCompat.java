...
public class ViewCompat {
    ...
    public static abstract class AccessibilityViewProperty<T> {
        ...
        public AccessibilityViewProperty(int i2, Class<T> cls, int i8) {
            this(i2, cls, 0, i8);
        }
        ...
        public boolean shouldUpdate(T t3, T t7) {
            return !t7.equals(t3);
        }

        public AccessibilityViewProperty(int i2, Class<T> cls, int i8, int i9) {
            this.mTagKey = i2;
            this.mType = cls;
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static boolean dispatchNestedFling(@NonNull View view, float f4, float f8, boolean z2) {
            return view.dispatchNestedFling(f4, f8, z2);
        }

        @DoNotInline
        public static boolean dispatchNestedPreFling(@NonNull View view, float f4, float f8) {
            return view.dispatchNestedPreFling(f4, f8);
        }

        @DoNotInline
        public static boolean dispatchNestedPreScroll(View view, int i2, int i8, int[] iArr, int[] iArr2) {
            return view.dispatchNestedPreScroll(i2, i8, iArr, iArr2);
        }

        @DoNotInline
        public static boolean dispatchNestedScroll(View view, int i2, int i8, int i9, int i10, int[] iArr) {
            return view.dispatchNestedScroll(i2, i8, i9, i10, iArr);
        }
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        public static void setScrollIndicators(@NonNull View view, int i2, int i8) {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static void saveAttributeDataForStyleable(@NonNull View view, @NonNull Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i2, int i8) {
            view.saveAttributeDataForStyleable(context, iArr, attributeSet, typedArray, i2, i8);
        }
    ...
    @Deprecated
    public static int combineMeasuredStates(int i2, int i8) {
        return View.combineMeasuredStates(i2, i8);
    }
    ...
    public static boolean dispatchNestedFling(@NonNull View view, float f4, float f8, boolean z2) {
        return Api21Impl.dispatchNestedFling(view, f4, f8, z2);
    }

    public static boolean dispatchNestedPreFling(@NonNull View view, float f4, float f8) {
        return Api21Impl.dispatchNestedPreFling(view, f4, f8);
    }

    public static boolean dispatchNestedPreScroll(@NonNull View view, int i2, int i8, @Nullable int[] iArr, @Nullable int[] iArr2) {
        return Api21Impl.dispatchNestedPreScroll(view, i2, i8, iArr, iArr2);
    }

    public static boolean dispatchNestedScroll(@NonNull View view, int i2, int i8, int i9, int i10, @Nullable int[] iArr) {
        return Api21Impl.dispatchNestedScroll(view, i2, i8, i9, i10, iArr);
    }
    ...
    private static int getAvailableActionIdFromResources(View view, @NonNull CharSequence charSequence) {
        ...
        while (true) {
            ...
            for (int i11 = 0; i11 < actionList.size(); i11++) {
                z2 &= actionList.get(i11).getId() != i10;
            }
            if (z2) {
                i8 = i10;
            }
    ...
    public static ContentInfoCompat performReceiveContent(@NonNull View view, @NonNull ContentInfoCompat contentInfoCompat) {
        if (Log.isLoggable(TAG, 3)) {
            Log.d(TAG, "performReceiveContent: " + contentInfoCompat + ", view=" + view.getClass().getSimpleName() + C2300e4.i.f8403d + view.getId() + C2300e4.i.e);
        }
    ...
    @Deprecated
    public static int resolveSizeAndState(int i2, int i8, int i9) {
        return View.resolveSizeAndState(i2, i8, i9);
    }
    ...
    public static void saveAttributeDataForStyleable(@NonNull View view, @NonNull Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i2, int i8) {
        if (Build.VERSION.SDK_INT >= 29) {
            Api29Impl.saveAttributeDataForStyleable(view, context, iArr, attributeSet, typedArray, i2, i8);
        }
    }
    ...
    public static void setElevation(@NonNull View view, float f4) {
        Api21Impl.setElevation(view, f4);
    }
    ...
    @Deprecated
    public static void setPaddingRelative(@NonNull View view, @Px int i2, @Px int i8, @Px int i9, @Px int i10) {
    ...
    public static void setPointerIcon(@NonNull View view, @Nullable PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            Api24Impl.setPointerIcon(view, androidx.core.location.a.j(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null));
        }
    }
    ...
    public static void setTranslationZ(@NonNull View view, float f4) {
        Api21Impl.setTranslationZ(view, f4);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedPreScroll(@NonNull View view, int i2, int i8, @Nullable int[] iArr, @Nullable int[] iArr2, int i9) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).dispatchNestedPreScroll(i2, i8, iArr, iArr2, i9);
        }
        if (i9 == 0) {
            return dispatchNestedPreScroll(view, i2, i8, iArr, iArr2);
        }
        return false;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static void dispatchNestedScroll(@NonNull View view, int i2, int i8, int i9, int i10, @Nullable int[] iArr, int i11, @NonNull int[] iArr2) {
        if (view instanceof NestedScrollingChild3) {
            ((NestedScrollingChild3) view).dispatchNestedScroll(i2, i8, i9, i10, iArr, i11, iArr2);
        } else {
            dispatchNestedScroll(view, i2, i8, i9, i10, iArr, i11);
        }
    }
    ...
    @Deprecated
    public static void postInvalidateOnAnimation(@NonNull View view, int i2, int i8, int i9, int i10) {
        view.postInvalidateOnAnimation(i2, i8, i9, i10);
    }

    public static void setScrollIndicators(@NonNull View view, int i2, int i8) {
        Api23Impl.setScrollIndicators(view, i2, i8);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static boolean startNestedScroll(@NonNull View view, int i2, int i8) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).startNestedScroll(i2, i8);
        }
        if (i8 == 0) {
    ...
    public static boolean performHapticFeedback(@NonNull View view, int i2, int i8) {
        int feedbackConstantOrFallback = HapticFeedbackConstantsCompat.getFeedbackConstantOrFallback(i2);
        if (feedbackConstantOrFallback == -1) {
            return false;
        }
        return view.performHapticFeedback(feedbackConstantOrFallback, i8);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedScroll(@NonNull View view, int i2, int i8, int i9, int i10, @Nullable int[] iArr, int i11) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).dispatchNestedScroll(i2, i8, i9, i10, iArr, i11);
        }
        if (i11 == 0) {
            return dispatchNestedScroll(view, i2, i8, i9, i10, iArr);
        }
        return false;
    }
