...
public class AccessibilityNodeInfoCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat createCollectionItemInfo(int i2, int i8, int i9, int i10, boolean z2, boolean z7) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i2, i8, i9, i10, z2, z7));
        }
    }
    ...
    public static class Api30Impl {
        ...
        @DoNotInline
        public static Object createRangeInfo(int i2, float f4, float f8, float f9) {
            return new AccessibilityNodeInfo.RangeInfo(i2, f4, f8, f9);
        }
    ...
    public static class Api33Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat buildCollectionItemInfoCompat(boolean z2, int i2, int i8, int i9, int i10, boolean z7, String str, String str2) {
            return new CollectionItemInfoCompat(new AccessibilityNodeInfo.CollectionItemInfo.Builder().setHeading(z2).setColumnIndex(i2).setRowIndex(i8).setColumnSpan(i9).setRowSpan(i10).setSelected(z7).setRowTitle(str).setColumnTitle(str2).build());
        }

        @DoNotInline
        public static AccessibilityNodeInfoCompat getChild(AccessibilityNodeInfo accessibilityNodeInfo, int i2, int i8) {
            return AccessibilityNodeInfoCompat.wrapNonNullInstance(accessibilityNodeInfo.getChild(i2, i8));
        }
    ...
    public static class CollectionInfoCompat {
        ...
        public static CollectionInfoCompat obtain(int i2, int i8, boolean z2, int i9) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i2, i8, z2, i9));
        }
        ...
        public static CollectionInfoCompat obtain(int i2, int i8, boolean z2) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i2, i8, z2));
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int i2, int i8, int i9, int i10, boolean z2, boolean z7) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i2, i8, i9, i10, z2, z7));
        }
        ...
        public static CollectionItemInfoCompat obtain(int i2, int i8, int i9, int i10, boolean z2) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i2, i8, i9, i10, z2));
        }
    }
    ...
    private int idForClickableSpan(ClickableSpan clickableSpan, SparseArray<WeakReference<ClickableSpan>> sparseArray) {
        ...
        int i8 = sClickableSpanId;
        sClickableSpanId = i8 + 1;
        return i8;
    }
    ...
    private void setBooleanProperty(int i2, boolean z2) {
        Bundle extras = getExtras();
        if (extras != null) {
            int i8 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~i2);
            if (!z2) {
                i2 = 0;
            }
            extras.putInt(BOOLEAN_PROPERTY_KEY, i2 | i8);
        }
    }
    ...
    public void setTextSelection(int i2, int i8) {
        this.mInfo.setTextSelection(i2, i8);
    }
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int i2, float f4, float f8, float f9) {
            return new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(i2, f4, f8, f9));
        }
        ...
        public RangeInfoCompat(int i2, float f4, float f8, float f9) {
            if (Build.VERSION.SDK_INT >= 30) {
                this.mInfo = Api30Impl.createRangeInfo(i2, f4, f8, f9);
            } else {
                this.mInfo = AccessibilityNodeInfo.RangeInfo.obtain(i2, f4, f8, f9);
            }
        }
    }
    ...
    @Nullable
    public AccessibilityNodeInfoCompat getChild(int i2, int i8) {
        return Build.VERSION.SDK_INT >= 33 ? Api33Impl.getChild(this.mInfo, i2, i8) : getChild(i2);
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        @Nullable
        public Region getRegionAt(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
