...
public class WindowInsetsCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        public WindowInsetsCompat inset(int i2, int i8, int i9, int i10) {
            Builder builder = new Builder(WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets));
            builder.setSystemWindowInsets(WindowInsetsCompat.insetInsets(getSystemWindowInsets(), i2, i8, i9, i10));
            builder.setStableInsets(WindowInsetsCompat.insetInsets(getStableInsets(), i2, i8, i9, i10));
        ...
        private Insets getInsets(int i2, boolean z2) {
            ...
            for (int i8 = 1; i8 <= 256; i8 <<= 1) {
                if ((i2 & i8) != 0) {
                    insetsMax = Insets.max(insetsMax, getInsetsForType(i8, z2));
                }
            }
            return insetsMax;
        }
    ...
    public static final class Type {
        ...
        public static int indexOf(int i2) {
            ...
            throw new IllegalArgumentException(a1.a.g(i2, "type needs to be >= FIRST and <= LAST, type="));
        }
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i2, int i8, int i9, int i10) {
        ...
        return (iMax == i2 && iMax2 == i8 && iMax3 == i9 && iMax4 == i10) ? insets : Insets.of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    @NonNull
    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(int i2, int i8, int i9, int i10) {
        return new Builder(this).setSystemWindowInsets(Insets.of(i2, i8, i9, i10)).build();
    }
    ...
    @NonNull
    public WindowInsetsCompat inset(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i9, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i10) {
        return this.mImpl.inset(i2, i8, i9, i10);
    }
    ...
    public static class Impl29 extends Impl28 {
        ...
        @NonNull
        public WindowInsetsCompat inset(int i2, int i8, int i9, int i10) {
            return WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets.inset(i2, i8, i9, i10));
        }
