...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f4, int i2) {
            ...
            for (int i8 = 1; i8 <= 256; i8 <<= 1) {
                if ((i2 & i8) == 0) {
                    ...
                    float f8 = 1.0f - f4;
                    builder.setInsets(i8, WindowInsetsCompat.insetInsets(insets, (int) (((double) ((insets.left - insets2.left) * f8)) + 0.5d), (int) (((double) ((insets.top - insets2.top) * f8)) + 0.5d), (int) (((double) ((insets.right - insets2.right) * f8)) + 0.5d), (int) (((double) ((insets.bottom - insets2.bottom) * f8)) + 0.5d)));
                }
            }
    ...
    public static class Impl30 extends Impl {
        ...
        public static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(@NonNull WindowInsets windowInsets, @NonNull List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationM = androidx.camera.camera2.internal.a.m(list.get(size));
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(@NonNull BoundsCompat boundsCompat) {
            ...
            return androidx.camera.camera2.internal.a.k(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
        ...
        public Impl30(int i2, Interpolator interpolator, long j) {
            this(androidx.camera.camera2.internal.a.l(i2, interpolator, j));
        }
    }
