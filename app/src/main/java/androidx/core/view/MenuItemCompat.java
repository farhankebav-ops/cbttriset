...
public final class MenuItemCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c7, int i2) {
            return menuItem.setAlphabeticShortcut(c7, i2);
        }
        ...
        @DoNotInline
        public static MenuItem setNumericShortcut(MenuItem menuItem, char c7, int i2) {
            return menuItem.setNumericShortcut(c7, i2);
        }

        @DoNotInline
        public static MenuItem setShortcut(MenuItem menuItem, char c7, char c8, int i2, int i8) {
            return menuItem.setShortcut(c7, c8, i2, i8);
        }
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c7, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c7, i2);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setAlphabeticShortcut(menuItem, c7, i2);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c7, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c7, i2);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNumericShortcut(menuItem, c7, i2);
        }
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c7, char c8, int i2, int i8) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c7, c8, i2, i8);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c7, c8, i2, i8);
        }
    }
