...
public final class LinkifyCompat {
    ...
    private static void applyLink(String str, int i2, int i8, Spannable spannable) {
        spannable.setSpan(new URLSpan(str), i2, i8, 33);
    }
    ...
    private static String makeUrl(@NonNull String str, @NonNull String[] strArr, Matcher matcher, @Nullable Linkify.TransformFilter transformFilter) {
        ...
        while (true) {
            ...
            if (string.regionMatches(true, 0, str2, 0, str2.length())) {
                ...
                if (!string.regionMatches(false, 0, str2, 0, str2.length())) {
                    StringBuilder sbR = androidx.camera.core.processing.util.a.r(str2);
        ...
        return (z2 || strArr.length <= 0) ? string : a1.a.r(new StringBuilder(), strArr[0], string);
    }
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        while (i8 < size - 1) {
            ...
            int i9 = i8 + 1;
            LinkSpec linkSpec3 = arrayList.get(i9);
            int i10 = linkSpec2.start;
            int i11 = linkSpec3.start;
            if (i10 <= i11 && (i2 = linkSpec2.end) > i11) {
                int i12 = linkSpec3.end;
                int i13 = (i12 > i2 && i2 - i10 <= i12 - i11) ? i2 - i10 < i12 - i11 ? i8 : -1 : i9;
                if (i13 != -1) {
