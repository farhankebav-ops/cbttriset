...
public final class TextDirectionHeuristicsCompat {
    ...
    public static class AnyStrong implements TextDirectionAlgorithm {
        ...
        public int checkRtl(CharSequence charSequence, int i2, int i8) {
            int i9 = i8 + i2;
            boolean z2 = false;
            while (i2 < i9) {
    ...
    public static class FirstStrong implements TextDirectionAlgorithm {
        ...
        public int checkRtl(CharSequence charSequence, int i2, int i8) {
            ...
            while (i2 < i9 && iIsRtlTextOrFormat == 2) {
    ...
    public interface TextDirectionAlgorithm {
        int checkRtl(CharSequence charSequence, int i2, int i8);
    }
    ...
    public static abstract class TextDirectionHeuristicImpl implements TextDirectionHeuristicCompat {
        ...
        private boolean doCheck(CharSequence charSequence, int i2, int i8) {
            int iCheckRtl = this.mAlgorithm.checkRtl(charSequence, i2, i8);
            if (iCheckRtl == 0) {
                return true;
            }
            if (iCheckRtl != 1) {
        ...
        public boolean isRtl(char[] cArr, int i2, int i8) {
            return isRtl(CharBuffer.wrap(cArr), i2, i8);
        }

        @Override // androidx.core.text.TextDirectionHeuristicCompat
        public boolean isRtl(CharSequence charSequence, int i2, int i8) {
            if (charSequence == null || i2 < 0 || i8 < 0 || charSequence.length() - i8 < i2) {
                throw new IllegalArgumentException();
            }
            return this.mAlgorithm == null ? defaultIsRtl() : doCheck(charSequence, i2, i8);
        }
    }
