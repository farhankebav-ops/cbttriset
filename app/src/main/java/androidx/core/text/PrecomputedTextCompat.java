...
public class PrecomputedTextCompat implements Spannable {
    ...
    @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG)
    public int getParagraphEnd(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
    ...
    @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG)
    public int getParagraphStart(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
        Preconditions.checkArgumentInRange(i2, 0, getParagraphCount(), "paraIndex");
    ...
    public <T> T[] getSpans(int i2, int i8, Class<T> cls) {
        return Build.VERSION.SDK_INT >= 29 ? (T[]) this.mWrapped.getSpans(i2, i8, cls) : (T[]) this.mText.getSpans(i2, i8, cls);
    }
    ...
    public int nextSpanTransition(int i2, int i8, Class cls) {
        return this.mText.nextSpanTransition(i2, i8, cls);
    }
    ...
    public void setSpan(Object obj, int i2, int i8, int i9) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            this.mWrapped.setSpan(obj, i2, i8, i9);
        } else {
            this.mText.setSpan(obj, i2, i8, i9);
        }
    }

    @Override // java.lang.CharSequence
    public CharSequence subSequence(int i2, int i8) {
        return this.mText.subSequence(i2, i8);
    }
    ...
    public static final class Params {
        ...
        public Params(@NonNull TextPaint textPaint, @NonNull TextDirectionHeuristic textDirectionHeuristic, int i2, int i8) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = k.n(textPaint).setBreakStrategy(i2).setHyphenationFrequency(i8).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
