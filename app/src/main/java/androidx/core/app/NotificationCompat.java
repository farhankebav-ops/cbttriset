...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable RemoteInput[] remoteInputArr, boolean z2, int i2, boolean z7, boolean z8, boolean z9) {
        ...
        public Action(int i2, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z2, int i8, boolean z7, boolean z8, boolean z9) {
            this(i2 != 0 ? IconCompat.createWithResource(null, "", i2) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z2, i8, z7, z8, z9);
        }

        public Action(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z2, int i2, boolean z7, boolean z8, boolean z9) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat;
    ...
    public static final class BubbleMetadata {
        ...
        private BubbleMetadata(@Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable IconCompat iconCompat, int i2, @DimenRes int i8, int i9, @Nullable String str) {
            this.mPendingIntent = pendingIntent;
            this.mIcon = iconCompat;
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i2 < size) {
                    ...
                    i2++;
                    addPerson(Person.fromAndroidPerson(k.g(obj)));
                }
            }
        ...
        @NonNull
        public Builder setLights(@ColorInt int i2, int i8, int i9) {
            Notification notification = this.mNotification;
        ...
        @NonNull
        public Builder setProgress(int i2, int i8, boolean z2) {
        ...
        @NonNull
        public Builder setSmallIcon(int i2, int i8) {
            Notification notification = this.mNotification;
    ...
    public static class CallStyle extends Style {
        ...
        @NonNull
        @RequiresApi(20)
        private Action makeAction(int i2, int i8, Integer num, int i9, PendingIntent pendingIntent) {
            if (num == null) {
                num = Integer.valueOf(ContextCompat.getColor(this.mBuilder.mContext, i9));
            }
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            spannableStringBuilder.append((CharSequence) this.mBuilder.mContext.getResources().getString(i8));
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z2 ? i2 : i8, z2 ? R.string.call_notification_answer_video_action : R.string.call_notification_answer_action, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
        ...
        public ArrayList<Action> getActionsListWithSystemActions() {
            ...
            if (arrayList2 != null) {
                ...
                int i8 = 0;
                while (i8 < size) {
                    Action action = arrayList2.get(i8);
                    i8++;
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(k.f(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z2) {
            ...
            if (!z2 || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i8 = 0; i8 < iMin; i8++) {
                    remoteViewsApplyStandardTemplate.addView(R.id.actions, generateActionButton(nonContextualActions.get(i8)));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static float constrain(float f4, float f8, float f9) {
        ...
        private static Style constructCompatStyleByPlatformName(@Nullable String str) {
            ...
            if (str.equals(androidx.appcompat.app.c.o().getName())) {
                return new MessagingStyle();
            }
            if (str.equals(androidx.appcompat.app.c.B().getName())) {
                return new DecoratedCustomViewStyle();
            }
            return null;
        }
        ...
        private Bitmap createIconWithBackground(int i2, int i8, int i9, int i10) {
        ...
        */
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Bitmap createColoredBitmap(int i2, int i8) {
            return createColoredBitmap(i2, i8, 0);
        }
        ...
        private Bitmap createColoredBitmap(int i2, int i8, int i9) {
            return createColoredBitmap(IconCompat.createWithResource(this.mBuilder.mContext, i2), i8, i9);
        }

        private Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i2, int i8) {
            Drawable drawableLoadDrawable = iconCompat.loadDrawable(this.mBuilder.mContext);
            int intrinsicWidth = i8 == 0 ? drawableLoadDrawable.getIntrinsicWidth() : i8;
            if (i8 == 0) {
                i8 = drawableLoadDrawable.getIntrinsicHeight();
            }
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(intrinsicWidth, i8, Bitmap.Config.ARGB_8888);
            drawableLoadDrawable.setBounds(0, 0, intrinsicWidth, i8);
            if (i2 != 0) {
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i8 = 0; i8 < remoteInputs.length; i8++) {
                ...
                remoteInputArr2[i8] = new RemoteInput(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, Api20Impl.getExtras(remoteInput), null);
            }
            remoteInputArr = remoteInputArr2;
        }
        int i9 = Build.VERSION.SDK_INT;
        boolean z2 = i9 >= 24 ? Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action) : Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies");
        boolean z7 = Api20Impl.getExtras(action).getBoolean("android.support.action.showsUserInterface", true);
        int semanticAction = i9 >= 28 ? Api28Impl.getSemanticAction(action) : Api20Impl.getExtras(action).getInt("android.support.action.semanticAction", 0);
        boolean zIsContextual = i9 >= 29 ? Api29Impl.isContextual(action) : false;
        boolean zIsAuthenticationRequired = i9 >= 31 ? Api31Impl.isAuthenticationRequired(action) : false;
        if (Api23Impl.getIcon(action) != null || (i2 = action.icon) == 0) {
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z7, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(i2, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z7, zIsContextual, zIsAuthenticationRequired);
    }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i2 < size) {
                    Object obj = parcelableArrayList.get(i2);
                    i2++;
                    arrayList.add(Person.fromAndroidPerson(k.g(obj)));
                }
            }
        } else {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i2 >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(androidx.appcompat.app.c.g(messagingStyleCreateMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(androidx.appcompat.app.c.g(messagingStyleCreateMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(androidx.appcompat.app.c.g(messagingStyleCreateMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(androidx.appcompat.app.c.g(messagingStyleCreateMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
