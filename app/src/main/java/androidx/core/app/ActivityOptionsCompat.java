...
public class ActivityOptionsCompat {
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        public static ActivityOptions makeClipRevealAnimation(View view, int i2, int i8, int i9, int i10) {
            return ActivityOptions.makeClipRevealAnimation(view, i2, i8, i9, i10);
        }
    ...
    @NonNull
    public static ActivityOptionsCompat makeClipRevealAnimation(@NonNull View view, int i2, int i8, int i9, int i10) {
        return new ActivityOptionsCompatImpl(Api23Impl.makeClipRevealAnimation(view, i2, i8, i9, i10));
    }

    @NonNull
    public static ActivityOptionsCompat makeCustomAnimation(@NonNull Context context, int i2, int i8) {
        return new ActivityOptionsCompatImpl(ActivityOptions.makeCustomAnimation(context, i2, i8));
    }

    @NonNull
    public static ActivityOptionsCompat makeScaleUpAnimation(@NonNull View view, int i2, int i8, int i9, int i10) {
        return new ActivityOptionsCompatImpl(ActivityOptions.makeScaleUpAnimation(view, i2, i8, i9, i10));
    }
    ...
    @NonNull
    public static ActivityOptionsCompat makeThumbnailScaleUpAnimation(@NonNull View view, @NonNull Bitmap bitmap, int i2, int i8) {
        return new ActivityOptionsCompatImpl(ActivityOptions.makeThumbnailScaleUpAnimation(view, bitmap, i2, i8));
    }
