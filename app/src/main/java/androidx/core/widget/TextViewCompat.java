...
public final class TextViewCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static void setAutoSizeTextTypeUniformWithConfiguration(TextView textView, int i2, int i8, int i9, int i10) {
            textView.setAutoSizeTextTypeUniformWithConfiguration(i2, i8, i9, i10);
        }
    ...
    public static class Api34Impl {
        ...
        @DoNotInline
        public static void setLineHeight(@NonNull TextView textView, int i2, @FloatRange(from = 0.0d) float f4) {
            textView.setLineHeight(i2, f4);
        }
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static void setAutoSizeTextTypeUniformWithConfiguration(@NonNull TextView textView, int i2, int i8, int i9, int i10) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
            Api26Impl.setAutoSizeTextTypeUniformWithConfiguration(textView, i2, i8, i9, i10);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeUniformWithConfiguration(i2, i8, i9, i10);
        }
    }
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) @Px int i2) {
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) @Px int i2) {
        Preconditions.checkArgumentNonnegative(i2);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
    ...
    public static void setLineHeight(@NonNull TextView textView, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) @Px int i2) {
        Preconditions.checkArgumentNonnegative(i2);
    ...
    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(@NonNull TextView textView, @DrawableRes int i2, @DrawableRes int i8, @DrawableRes int i9, @DrawableRes int i10) {
        textView.setCompoundDrawablesRelativeWithIntrinsicBounds(i2, i8, i9, i10);
    }

    public static void setLineHeight(@NonNull TextView textView, int i2, @FloatRange(from = 0.0d) float f4) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setLineHeight(textView, i2, f4);
        } else {
            setLineHeight(textView, Math.round(TypedValue.applyDimension(i2, f4, textView.getResources().getDisplayMetrics())));
        }
    }
