...
public abstract class Lifecycle {
    ...
    public static final class Event {
        ...
        static {
            ...
            $ENTRIES = n7.b.n(eventArr$values);
    ...
    public static final class State {
        ...
        static {
            ...
            $ENTRIES = n7.b.n(stateArr$values);
        }
    ...
    public static final void _get_currentStateFlow_$lambda$0(q0 q0Var, LifecycleOwner lifecycleOwner, Event event) {
        kotlin.jvm.internal.k.e(lifecycleOwner, "<unused var>");
        kotlin.jvm.internal.k.e(event, "event");
        ((d1) q0Var).h(event.getTargetState());
    }
    ...
    public b1 getCurrentStateFlow() {
        d1 d1VarC = x0.c(getCurrentState());
        addObserver(new i(d1VarC, 1));
        return new s0(d1VarC);
    }
    ...
    public final void setInternalScopeRef(AtomicReference<Object> atomicReference) {
        kotlin.jvm.internal.k.e(atomicReference, "<set-?>");
