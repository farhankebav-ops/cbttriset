...
public class LifecycleRegistry extends Lifecycle {
    ...
    private final q0 _currentStateFlow;
    ...
    public static final class ObserverWithState {
        ...
        public ObserverWithState(LifecycleObserver lifecycleObserver, Lifecycle.State initialState) {
            ...
            kotlin.jvm.internal.k.b(lifecycleObserver);
        ...
        public final void setLifecycleObserver(LifecycleEventObserver lifecycleEventObserver) {
            kotlin.jvm.internal.k.e(lifecycleEventObserver, "<set-?>");
    ...
    public /* synthetic */ LifecycleRegistry(LifecycleOwner lifecycleOwner, boolean z2, kotlin.jvm.internal.f fVar) {
    ...
    private final void backwardPass(LifecycleOwner lifecycleOwner) {
        ...
        kotlin.jvm.internal.k.d(itDescendingIterator, "descendingIterator(...)");
    ...
    private final void forwardPass(LifecycleOwner lifecycleOwner) {
        ...
        kotlin.jvm.internal.k.d(iteratorWithAdditions, "iteratorWithAdditions(...)");
    ...
    private final boolean isSynced() {
        ...
        kotlin.jvm.internal.k.b(entryEldest);
        ...
        kotlin.jvm.internal.k.b(entryNewest);
    ...
    private final void sync() {
        ...
        this.newEventOccurred = false;
        ((d1) this._currentStateFlow).h(getCurrentState());
    }
    ...
    @Override // androidx.lifecycle.Lifecycle
    public b1 getCurrentStateFlow() {
        return new s0(this._currentStateFlow);
    }
