...
public final class MetadataList extends Table {
    ...
    public static int createMetadataList(FlatBufferBuilder flatBufferBuilder, int i2, int i8, int i9) {
        flatBufferBuilder.startTable(3);
        addSourceSha(flatBufferBuilder, i9);
        addList(flatBufferBuilder, i8);
