...
public class FlexBuffersBuilder {
    ...
    public static class Value {
        ...
        public Value(int i2, int i8, int i9, long j) {
            this.key = i2;
            this.type = i8;
            this.minBitWidth = i9;
            this.iValue = j;
        ...
        public static Value blob(int i2, int i8, int i9, int i10) {
            return new Value(i2, i9, i10, i8);
        }
        ...
        public int elemWidth(int i2, int i8) {
            return elemWidth(this.type, this.minBitWidth, this.iValue, i2, i8);
        }

        public static Value float32(int i2, float f4) {
            return new Value(i2, 3, 2, f4);
        }

        public static Value float64(int i2, double d8) {
            return new Value(i2, 3, 3, d8);
        }

        public static Value int16(int i2, int i8) {
            return new Value(i2, 1, 1, i8);
        }

        public static Value int32(int i2, int i8) {
            return new Value(i2, 1, 2, i8);
        }
        ...
        public static Value int8(int i2, int i8) {
            return new Value(i2, 1, 0, i8);
        }

        private static byte packedType(int i2, int i8) {
            return (byte) (i2 | (i8 << 2));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static int paddingBytes(int i2, int i8) {
            return ((~i2) + 1) & (i8 - 1);
        }
        ...
        public static Value uInt16(int i2, int i8) {
            return new Value(i2, 2, 1, i8);
        }

        public static Value uInt32(int i2, int i8) {
            return new Value(i2, 2, 2, i8);
        }
        ...
        public static Value uInt8(int i2, int i8) {
            return new Value(i2, 2, 0, i8);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static int elemWidth(int i2, int i8, long j, int i9, int i10) {
            if (FlexBuffers.isTypeInline(i2)) {
                return i8;
            }
            for (int i11 = 1; i11 <= 32; i11 *= 2) {
                int iWidthUInBits = FlexBuffersBuilder.widthUInBits((int) (((long) ((i10 * i11) + (paddingBytes(i9, i11) + i9))) - j));
        ...
        public Value(int i2, int i8, int i9, double d8) {
            this.key = i2;
            this.type = i8;
            this.minBitWidth = i9;
            this.dValue = d8;
    ...
    private int align(int i2) {
        int i8 = 1 << i2;
        int iPaddingBytes = Value.paddingBytes(this.bb.writePosition(), i8);
        while (true) {
            int i9 = iPaddingBytes - 1;
            if (iPaddingBytes == 0) {
                return i8;
            }
            this.bb.put((byte) 0);
    ...
    private Value createKeyVector(int i2, int i8) {
        long j = i8;
        int iMax = Math.max(0, widthUInBits(j));
        int i9 = i2;
        while (i9 < this.stack.size()) {
            int i10 = i9 + 1;
            iMax = Math.max(iMax, Value.elemWidth(4, 0, this.stack.get(i9).key, this.bb.writePosition(), i10));
            i9 = i10;
        }
    ...
    private Value createVector(int i2, int i8, int i9, boolean z2, boolean z7, Value value) {
        int i10;
        int typedVector;
        int i11 = i9;
        long j = i11;
        ...
        int i12 = 4;
        int iMax2 = iMax;
        for (int i13 = i8; i13 < this.stack.size(); i13++) {
            iMax2 = Math.max(iMax2, this.stack.get(i13).elemWidth(this.bb.writePosition(), i13 + i10));
            if (z2 && i13 == i8) {
        ...
        if (!z2) {
            while (i14 < this.stack.size()) {
                this.bb.put(this.stack.get(i14).storedPackedType(iMax2));
                i14++;
            }
        }
        if (value != null) {
    ...
    private Value writeBlob(int i2, byte[] bArr, int i8, boolean z2) {
        ...
        return Value.blob(i2, iWritePosition, i8, iWidthUInBits);
    }

    private void writeDouble(double d8, int i2) {
        if (i2 == 4) {
    ...
    private void writeOffset(long j, int i2) {
        writeInt((int) (((long) this.bb.writePosition()) - j), i2);
    }
    ...
    public int endVector(String str, int i2, boolean z2, boolean z7) {
        Value valueCreateVector = createVector(putKey(str), i2, this.stack.size() - i2, z2, z7, null);
        while (this.stack.size() > i2) {
            this.stack.remove(r9.size() - 1);
        }
        this.stack.add(valueCreateVector);
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i2) {
        ...
        this.keyComparator = new Comparator<Value>() { // from class: androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.1
            ...
            public int compare(Value value, Value value2) {
                ...
                int i9 = value2.key;
                do {
                    b8 = FlexBuffersBuilder.this.bb.get(i8);
                    b9 = FlexBuffersBuilder.this.bb.get(i9);
                    if (b8 == 0) {
                        return b8 - b9;
                    }
                    i8++;
