...
final class EmojiProcessor {
    ...
    public static final class CodepointIndexFinder {
        ...
        public static int findIndexBackward(CharSequence charSequence, int i2, int i8) {
            int length = charSequence.length();
            if (i2 < 0 || length < i2 || i8 < 0) {
                return -1;
            }
            while (true) {
                boolean z2 = false;
        ...
        public static int findIndexForward(CharSequence charSequence, int i2, int i8) {
            int length = charSequence.length();
            if (i2 < 0 || length < i2 || i8 < 0) {
                return -1;
            }
    ...
    public static class EmojiProcessAddSpanCallback implements EmojiProcessCallback<UnprecomputeTextOnModificationSpannable> {
        ...
        public boolean handleEmoji(@NonNull CharSequence charSequence, int i2, int i8, TypefaceEmojiRasterizer typefaceEmojiRasterizer) {
            ...
            this.spannable.setSpan(this.mSpanFactory.createSpan(typefaceEmojiRasterizer), i2, i8, 33);
            return true;
        }
    ...
    public interface EmojiProcessCallback<T> {
        ...
        boolean handleEmoji(@NonNull CharSequence charSequence, int i2, int i8, TypefaceEmojiRasterizer typefaceEmojiRasterizer);
    }
    ...
    public static class MarkExclusionCallback implements EmojiProcessCallback<MarkExclusionCallback> {
        ...
        @Override // androidx.emoji2.text.EmojiProcessor.EmojiProcessCallback
        public boolean handleEmoji(@NonNull CharSequence charSequence, int i2, int i8, TypefaceEmojiRasterizer typefaceEmojiRasterizer) {
            if (!TextUtils.equals(charSequence.subSequence(i2, i8), this.mExclusion)) {
                return true;
            }
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, boolean z2) {
        int iMax;
        int iMin;
        if (editable != null && inputConnection != null && i2 >= 0 && i8 >= 0) {
            int selectionStart = Selection.getSelectionStart(editable);
            int selectionEnd = Selection.getSelectionEnd(editable);
            ...
            if (z2) {
                ...
                iMin = CodepointIndexFinder.findIndexForward(editable, selectionEnd, Math.max(i8, 0));
                if (iMax == -1 || iMin == -1) {
                    return false;
                }
            } else {
    ...
    private boolean hasGlyph(CharSequence charSequence, int i2, int i8, TypefaceEmojiRasterizer typefaceEmojiRasterizer) {
        if (typefaceEmojiRasterizer.getHasGlyph() == 0) {
            typefaceEmojiRasterizer.setHasGlyph(this.mGlyphChecker.hasGlyph(charSequence, i2, i8, typefaceEmojiRasterizer.getSdkAdded()));
        }
        return typefaceEmojiRasterizer.getHasGlyph() == 2;
    }

    private static boolean hasInvalidSelection(int i2, int i8) {
        return i2 == -1 || i8 == -1 || i2 != i8;
    }
    ...
    public int getEmojiEnd(@NonNull CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
    ...
    public int getEmojiStart(@NonNull CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
        if (i2 < 0 || i2 >= charSequence.length()) {
            return -1;
        }
        if (charSequence instanceof Spanned) {
    ...
    */
    public java.lang.CharSequence process(@androidx.annotation.NonNull java.lang.CharSequence r11, @androidx.annotation.IntRange(from = com.google.firebase.remoteconfig.FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int r12, @androidx.annotation.IntRange(from = com.google.firebase.remoteconfig.FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int r13, @androidx.annotation.IntRange(from = com.google.firebase.remoteconfig.FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int r14, boolean r15) throws java.lang.Throwable {
        /*
            r10 = this;
    ...
    private <T> T process(@NonNull CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i9, boolean z2, EmojiProcessCallback<T> emojiProcessCallback) {
        int i10;
        ProcessorSm processorSm = new ProcessorSm(this.mMetadataRepo.getRootNode(), this.mUseEmojiAsDefaultStyle, this.mEmojiAsDefaultStyleExceptions);
        ...
        loop0: while (true) {
            ...
            while (true) {
                i10 = i2;
                while (i2 < i8 && i11 < i9 && zHandleEmoji) {
                    ...
                    if (iCheck == 1) {
                        ...
                        int iCharCount = Character.charCount(iCodePointAt2) + i2;
                        if (iCharCount < i8) {
                            iCodePointAt2 = Character.codePointAt(charSequence, iCharCount);
                        }
                        i2 = iCharCount;
                    } else if (iCheck == 3) {
                        if (z2 || !hasGlyph(charSequence, i10, i2, processorSm.getFlushMetadata())) {
                            zHandleEmoji = emojiProcessCallback.handleEmoji(charSequence, i10, i2, processorSm.getFlushMetadata());
                            i11++;
                        }
                    }
                }
        ...
        if (processorSm.isInFlushableState() && i11 < i9 && zHandleEmoji && (z2 || !hasGlyph(charSequence, i10, i2, processorSm.getCurrentMetadata()))) {
