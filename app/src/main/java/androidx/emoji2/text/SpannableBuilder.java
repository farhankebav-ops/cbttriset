...
public final class SpannableBuilder extends SpannableStringBuilder {
    ...
    public static class WatcherWrapper implements TextWatcher, SpanWatcher {
        ...
        public void beforeTextChanged(CharSequence charSequence, int i2, int i8, int i9) {
            ((TextWatcher) this.mObject).beforeTextChanged(charSequence, i2, i8, i9);
        }
        ...
        public void onSpanAdded(Spannable spannable, Object obj, int i2, int i8) {
            if (this.mBlockCalls.get() <= 0 || !isEmojiSpan(obj)) {
                ((SpanWatcher) this.mObject).onSpanAdded(spannable, obj, i2, i8);
            }
        }
  ...
  0x001e: PHI (r11v1 int) = (r11v0 int), (r11v3 int) binds: [B:8:0x0013, B:12:0x0019] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        @Override // android.text.SpanWatcher
        public void onSpanRemoved(Spannable spannable, Object obj, int i2, int i8) {
            if (this.mBlockCalls.get() <= 0 || !isEmojiSpan(obj)) {
                ((SpanWatcher) this.mObject).onSpanRemoved(spannable, obj, i2, i8);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i2, int i8, int i9) {
            ((TextWatcher) this.mObject).onTextChanged(charSequence, i2, i8, i9);
        }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Spanned
    public <T> T[] getSpans(int i2, int i8, @NonNull Class<T> cls) {
        if (!isWatcher((Class<?>) cls)) {
            return (T[]) super.getSpans(i2, i8, cls);
        }
        WatcherWrapper[] watcherWrapperArr = (WatcherWrapper[]) super.getSpans(i2, i8, WatcherWrapper.class);
        T[] tArr = (T[]) ((Object[]) Array.newInstance((Class<?>) cls, watcherWrapperArr.length));
        for (int i9 = 0; i9 < watcherWrapperArr.length; i9++) {
            tArr[i9] = watcherWrapperArr[i9].mObject;
        }
        return tArr;
    }

    @Override // android.text.SpannableStringBuilder, android.text.Spanned
    public int nextSpanTransition(int i2, int i8, @Nullable Class cls) {
        if (cls == null || isWatcher((Class<?>) cls)) {
            cls = WatcherWrapper.class;
        }
        return super.nextSpanTransition(i2, i8, cls);
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Spannable
    public void setSpan(@Nullable Object obj, int i2, int i8, int i9) {
        if (isWatcher(obj)) {
            WatcherWrapper watcherWrapper = new WatcherWrapper(obj);
            this.mWatchers.add(watcherWrapper);
            obj = watcherWrapper;
        }
        super.setSpan(obj, i2, i8, i9);
    }

    @Override // android.text.SpannableStringBuilder, java.lang.CharSequence
    public CharSequence subSequence(int i2, int i8) {
        return new SpannableBuilder(this.mWatcherClass, this, i2, i8);
    }
    ...
    public SpannableStringBuilder delete(int i2, int i8) {
        super.delete(i2, i8);
        return this;
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable
    public SpannableStringBuilder replace(int i2, int i8, CharSequence charSequence) {
        blockWatchers();
        super.replace(i2, i8, charSequence);
        unblockwatchers();
        return this;
    }

    @Override // android.text.SpannableStringBuilder, android.text.Editable
    public SpannableStringBuilder insert(int i2, CharSequence charSequence, int i8, int i9) {
        super.insert(i2, charSequence, i8, i9);
        return this;
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable
    public SpannableStringBuilder replace(int i2, int i8, CharSequence charSequence, int i9, int i10) {
        blockWatchers();
        super.replace(i2, i8, charSequence, i9, i10);
        unblockwatchers();
        return this;
    }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public SpannableBuilder(@NonNull Class<?> cls, @NonNull CharSequence charSequence, int i2, int i8) {
        super(charSequence, i2, i8);
        this.mWatchers = new ArrayList();
        Preconditions.checkNotNull(cls, "watcherClass cannot be null");
        this.mWatcherClass = cls;
    }
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable, java.lang.Appendable
    @NonNull
    public SpannableStringBuilder append(CharSequence charSequence, int i2, int i8) {
        super.append(charSequence, i2, i8);
        return this;
    }
