...
class MetadataListReader {
    ...
    public static class InputStreamOpenTypeReader implements OpenTypeReader {
        ...
        private void read(@IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG, to = 4) int i2) throws IOException {
    ...
    public static class OffsetInfo {
        ...
        public OffsetInfo(long j, long j3) {
            this.mStartOffset = j;
            this.mLength = j3;
        }
    ...
    private static OffsetInfo findOffsetInfo(OpenTypeReader openTypeReader) throws IOException {
        ...
        if (unsignedInt != -1) {
            ...
            for (int i8 = 0; i8 < unsignedInt2; i8++) {
