...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i9, boolean z2) {
            return charSequence;
        }
    }
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public CharSequence process(@NonNull CharSequence charSequence, int i2, int i8, int i9, boolean z2) {
            return this.mProcessor.process(charSequence, i2, i8, i9, z2);
        }
    ...
    public interface GlyphChecker {
        boolean hasGlyph(@NonNull CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i9);
    }
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, boolean z2) {
        return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, i2, i8, z2);
    }
    ...
    public int getEmojiMatch(@NonNull CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8) {
        return process(charSequence, i2, i8, Integer.MAX_VALUE);
    }

    @Deprecated
    public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "sequence cannot be null");
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i9) {
        return process(charSequence, i2, i8, i9, 0);
    }

    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i2, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i8, @IntRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_LONG) int i9, int i10) {
        boolean z2;
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        ...
        Preconditions.checkArgument(i2 <= i8, "start should be <= than end");
        ...
        if (charSequence.length() == 0 || i2 == i8) {
            return charSequence;
        }
        if (i10 != 1) {
            z2 = i10 != 2 ? this.mReplaceAll : false;
        } else {
            z2 = true;
        }
        return this.mHelper.process(charSequence, i2, i8, i9, z2);
    }
