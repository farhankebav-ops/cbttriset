...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract q getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract q getWorkInfoById(@NonNull UUID uuid);
    ...
    @NonNull
    public abstract q getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract q getWorkInfosForUniqueWork(@NonNull String str);
    ...
    @NonNull
    public abstract q updateWork(@NonNull WorkRequest workRequest);
