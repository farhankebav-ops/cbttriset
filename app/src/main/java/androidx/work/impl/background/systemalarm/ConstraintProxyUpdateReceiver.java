...
public class ConstraintProxyUpdateReceiver extends BroadcastReceiver {
    ...
    @NonNull
    public static Intent newConstraintProxyUpdateIntent(@NonNull Context context, boolean z2, boolean z7, boolean z8, boolean z9) {
        Intent intent = new Intent(ACTION);
        intent.setComponent(new ComponentName(context, (Class<?>) ConstraintProxyUpdateReceiver.class));
        intent.putExtra(KEY_BATTERY_NOT_LOW_PROXY_ENABLED, z2).putExtra(KEY_BATTERY_CHARGING_PROXY_ENABLED, z7).putExtra(KEY_STORAGE_NOT_LOW_PROXY_ENABLED, z8).putExtra(KEY_NETWORK_STATE_PROXY_ENABLED, z9);
        return intent;
    }
