...
public class ForceStopRunnable implements Runnable {
    ...
    public boolean isForceStopped() {
        try {
            ...
            PendingIntent pendingIntent = getPendingIntent(this.mContext, i2 >= 31 ? 570425344 : 536870912);
            if (i2 >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i8 = 0; i8 < historicalProcessExitReasons.size(); i8++) {
                        ApplicationExitInfo applicationExitInfoF = q.f(historicalProcessExitReasons.get(i8));
                        if (applicationExitInfoF.getReason() == 10 && applicationExitInfoF.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (i2 >= 3) {
                                ...
                                Logger.get().debug(TAG, "Retrying after " + (((long) i2) * 300), e);
